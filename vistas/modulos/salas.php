        ...
        <div class="col-xs-12 col-md-12">
            ...
            <div class="widget">
                ...
                <div class="widget-header bordered-bottom bordered-yellow">
                    <span class="widget-caption">Catálogo de Salas</span>
...
<script type="text/javascript">
    ...
    var carga_tabla = peticion_ajax + "procesar_tabla_generica&tabla=" + id_tabla + "&f=salas&columnas=sNombre,iId_Edificio,iSorteo,iComodin,iEstado,iId";
    ...
    $(".page-body").on("click", ".abre_modal", function () {
        ...
        $.getJSON(carga_ruta, function (json) {
            ...
            $.each(json, function (campo, valor) {
                if (campo != 'tabs') {
                    ...
                    if (valor.nombre == "REFERENCIA") {
                        ...
                        if (valor.tipo == 'int' && valor.nombre == "iId_Edificio") {
                        ...
                        } else if (valor.tipo == 'int' && valor.referencia_tabla != '' && valor.referencia_tabla != null) {
                            var input = $("<input/>", {
                                "type": 'hidden',
                                "style": 'width:100%;',
                                "class": 'select2',
            ...
            $.getJSON('inc/ajax.php?solicitud=getEdificios', function (json) {

                $("#iId_Edificio").select2({
                    placeholder: "SELECCIONA UN EDIFICIO",
                    data: json
                });

            }).error(function () {
                OpenWarning("Error al solicitar los edificios.");
            });


            $.each($('.select2').not('#iId_Edificio'), function (index) {
                var seleccion = this;
