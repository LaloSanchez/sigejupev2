                        ...
                        <div class="col-xs-12 col-md-12">
                            ...
                            <div class="widget">
                                ...
                                <div class="widget-header bordered-bottom bordered-yellow">
                                    <span class="widget-caption">Catálogo de Horarios</span>
                                                ...
                                                <div class="col-lg-4 col-sm-4 col-xs-4">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="hidden" data-tabla="cat_juzgados" data-campo="sNombre" data-llave="iId" style="width:100%" id="filtro_juzgado" name="filtro_juzgado" class="selecto2" placeholder="Por Juzgado">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <script type="text/javascript">
        ...
        var carga_tabla             = peticion_ajax + "procesar_tabla_generica&tabla=" + id_tabla + "&f=s&columnas=sNombre,dHorarioInicial,dHorarioFinal,iId_Juzgado,iId";
            ...
            $.getJSON( carga_ruta, function( json ) {
                    ...
                    buttons: {
                        success: {
                            ...
                            callback: function ()   {
                                ...
                                if(valido)  {
                                    url_registro_ruta = registro_ruta + "&" + $(formulario_tabla).serialize();
                ...
                $( "#sNombre" ).autocomplete({
                    ...
                    select: function( event, ui ) {
                        $("#iClaveUsuario").val(ui.item.clave);
                        $("#sNumEmpleado").val(ui.item.numeroEmpleado);
                        $("#sPaterno").val(ui.item.paterno);
                        $("#sMaterno").val(ui.item.materno);
                        $("#sNombreJuzgador").val(ui.item.nombre);
                    },
                    open: function() {
        ...
        $.each($('.selecto2'),function(index)    {
            ...
            $(this).select2({
                ...
                $('.selecto2').on('change', function()  {
                    var selector_actual = this;
                    var selector = $(this).attr('id');
                    var valor = $(this).val();
                    var tabla = $(this).data('tabla');
                    var tabla_referenciada = "ref_mascotas_clientes";
                    var selector_apuntado = "";
                    var tabla_valores = "";
                    var columna_identificadora = "";
                    var urlBusqueda = "";
                    if(selector == 'filtro_juzgado')  {
                        urlBusqueda = peticion_ajax + "procesar_tabla_generica&tabla=" + id_tabla + "&f=s&columnas=sNombre,dHorarioInicial,dHorarioFinal,iId_Juzgado,iId&buscapor_columna=iId_Juzgado&buscapor_valor="+valor;
                    }
                    oTable.api().ajax.url(urlBusqueda).load();
