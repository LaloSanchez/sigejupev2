                ...
                <div class="widget-body padding-5">
                    ...
                    <form id="form-salas-juzgadores" action="#" style="display: none;">
                        ...
                        <table class="table table-bordered table-hover table-striped" id="searchable">
                            ...
                            <input style="height: 50px; border: 1px red solid;" id="searchInput" type="text" class="form-control" placeholder="Buscar Sala..."/>
            ...
            success: function (datos) {
                ...
                $.each(datos.salas, function (i, v) {
                    ...
                    $.each(datos.juzgadores, function (i, v) {
                        var select_juzgador = "";
                        if (parseInt(sala_juzgador) > 0 && sala_juzgador == v.id) select_juzgador = "selected";
