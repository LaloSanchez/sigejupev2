                        ...
                        <div class="col-xs-12 col-md-12">
                            ...
                            <div class="widget">
                                ...
                                <div class="widget-header bordered-bottom bordered-yellow">
                                    <span class="widget-caption">Catálogo de Programaciones</span>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 col-sm-4 col-xs-4">
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="hidden" data-tabla="cat_meses" data-campo="sNombre" data-llave="iId" style="width:100%" id="filtro_mes" name="filtro_mes" class="selecto2" placeholder="Por Mes">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-sm-4 col-xs-4">
                                            ...
                                            <div class="col-lg-4 col-sm-4 col-xs-4">
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <span class="input-group-addon no-padding-top no-padding-bottom padding-left-5 padding-right-5"><img src="assets/img/iconos/user-id.png" style="height:24px;width:24px;"></span>
                                                        <input type="text" style="width:100%" id="filtro_anio" name="filtro_anio" placeholder="Por A&ntilde;o" value="<?php echo date("Y")?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
