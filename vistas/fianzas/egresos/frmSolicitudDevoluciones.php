...
<div id="ifrm_provisional" class="bg-white" >
    <iframe id="frmProvisional" onload="iframeLoaded()" frameborder="0" src="http://10.22.165.204/fianzas_prod/vista/sigejupe/vista/egresos/frmSolicitudDevoliciones.php" height="100%" width="100%" >t</iframe>
    <!--<iframe id="frmProvisional" onload="iframeLoaded()" frameborder="0" src="http://localhost/fianzasSVN/vista/sigejupe/vista/egresos/frmSolicitudDevoliciones.php" height="100%" width="100%" >t</iframe>-->
</div>
