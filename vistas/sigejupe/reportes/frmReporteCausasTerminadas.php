            ...
            <div id="divPanelControl">
                ...
                <div class="form-group" style="display:none" id="cmbM">                                                                
                    ...
                    <div  class=" form-group" style="">
                        <label class="control-label col-md-5 needed" >Mes (Termino)</label>
                    ...
                    <div class=" form-group">
                        <label class="control-label col-md-5 needed" >A&ntilde;o (Termino)</label>
                ...
                <div class="form-group" id="divConclusiones" style="" > 
        ...
        switch ($("#hiddenNivel").val()) {
            ...
            case "5":
                ...
                if ($("#checkDetalle").is(":checked")) {
                    ...
                    table += '<th>A&ntildeo</th><th>Numero de Investigaci&oacute;n</th><th>Nuc</th><th>fecha terminaci&oacute;n</th>';
                } else {
                    table += '<th>N&uacute;m.</th><th>A&ntildeo</th><th>Numero de Investigaci&oacute;n</th><th>Nuc</th><th>fecha terminaci&oacute;n</th>';
                }
                ...
                for (var i = 0; i < json.totalCount; i++) {
                    if ($("#checkDetalle").is(":checked")) {
                        ...
                        if (json.resultados[i].fechaTermino != "") {
...
//        strDatos += "&cveEstatusCarpeta=" + $("#cmbEstatusCarpeta").val();
        ...
        $.ajax({
            type: "POST",
            url: "../fachadas/sigejupe/reportes/ReporteCausasTerminadasFacade.Class.php",
            data: strDatos,
            async: true,
            dataType: "html",
        ...
        switch ($("#hiddenNivel").val()) {
            case "1":
                ...
                for (var i = 0; i < json.totalCount; i++) {
                    ...
                    } else if ($("#checkConclusiones").is(":checked")) {
                        categorias[i] = json.resultados[i].desConclusion;
                    } else if ($("#checkIncompetencia").is(":checked")) {
                        categorias[i] = "INCOMPETENCIAS";
                    } else {
                        categorias[i] = "CAUSAS";
                    }
...
//        }
    ...
    calcularPaginas = function () {
        ...
        $("#inputRegresar2").hide();
        var url = "../fachadas/sigejupe/reportes/ReporteCausasTerminadasFacade.Class.php";
        var strDatos = "accion=ConsultarCarpetaRadicada_Reporte";
        var cantReg = $("#cmbNumReg").val();
                ...
                if (json.totalCount > 0) {
                    for (var i = 0; i < json.totalCount; i++) {
                        if (json.data[i].juicio == 'N') {
                            $("#cmbConclusiones").append($('<option id="cmbConclusiones' + json.data[i].cveConclusion + '"></option>').val(json.data[i].cveConclusion).html(json.data[i].desConclusion));
                        } else {
                            $("#cmbConclusiones").append($('<option id="cmbConclusiones' + json.data[i].cveConclusion + '"></option>').val(json.data[i].cveConclusion).html(json.data[i].desConclusion + "(JUICIO)"));
                        }
                    }
                }
            },
...
//                            $("#cmbTipoCarpeta option[value=7]").show();
    ...
    $(function () {
        ...
        obtenerPermisosFormulario('REPORTES', 'CAUSAS TERMINADAS');
        cargarRegiones();
        cargarDistritos();
        cargarJuzgado();
        cargarTipoJuzgado();
