...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
    ...
    <input type="hidden" id="hiddenDesTipoAmparo" value="">
    <input type="hidden" id="hiddenCveTipoAmparo" value="">
    <input type="hidden" id="hiddenDesEstatusAmparo" value="">
    <input type="hidden" id="hiddenCveEstatusAmparo" value="">
    <input type="hidden" id="hiddenTituloReporte" value="">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h5 class="panel-title" id="h5titulo">                                                            
                Reporte de Amparos en el Estado de M&eacute;xico.
            </h5>
        </div>
            ...
            <div id="divFormulario" class="form-horizontal">
                <div id="divPanelControl">
                    <div class="form-group">                                                                
                        <label class="control-label col-md-4" id="lblRelationName">A&ntilde;o del Amparo</label>
                    ...
                    <div class="form-group">                                                                
                        <label class="control-label col-md-4" >Mes (Registro)</label>
                    ...
                    <div class="form-group">                                                                
                        <label class="control-label col-md-4" >Rango de fecha (Registro)</label>
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-4">Tipo de Amparo</label>
                        <div class="col-md-5">
                            <input type="checkbox" id="TipoAmparo" class="form-inline" onclick="tiposAmparo()">
                        </div>
                    </div>
                    <div id="divTipoAmparo" style="display:none;">
                        <div class="form-group"> 
                            <label class="control-label col-md-4"></label>
                            <div class="col-md-5">
                                <div id="divCmbRelaciones" class="logobox"></div>
                                <select class="form-control Relacionado" name="cmbTipoAmparo" id="cmbTipoAmparo">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="checkbox" id="EstatusAmparo" class="form-inline" onclick="estatusAmparo()">
                        </div>
                    </div>
                    <div id="divEstatusAmparo" style="display:none;">
                        <div class="form-group"> 
                            <label class="control-label col-md-4"></label>
                            <div class="col-md-5">
                                <div id="divCmbRelaciones" class="logobox"></div>
                                <select class="form-control Relacionado" name="cmbEstatusAmparo" id="cmbEstatusAmparo">
                                    <option value="0">Seleccione una opci&oacute;n</option>
                                </select>
                            </div>                                
                        </div>
    ...
    <script type="text/javascript">
        ...
        exportar = function (accion, div) {
            ...
            var nombreArchivo = "REPORTE_AMPAROS";
        ...
        limpiar = function () {
            ...
            $("#txtfechaFinal").val("");
            $("#cmbTipoAmparo").val(0);
            $("#cmbEstatusAmparo").val(0);
            $("#divEstatusAmparo").hide();
            $("#divTipoAmparo").hide();
            $("#EstatusAmparo").prop("checked", "");
            $("#EstatusAmparo").prop("disabled", false);
            $("#TipoAmparo").prop("disabled", false);
            $("#TipoAmparo").prop("checked", "");
            ...
            $("#divGrafica").hide();
            $("#paginacion").hide();
            $("#h5titulo").html("<span style='text-decoration: underline; cursor:pointer;' onclick='regresar(0,false);'>Reporte de Amparos en el Estado de M\u00e9xico.</span>");
        };
        tiposAmparo = function () {
            if ($("#TipoAmparo").is(':checked')) {
                //$("#TipoAmparo").prop("disabled", true);
                $("#EstatusAmparo").prop("disabled", false);
                $("#divTipoAmparo").show();
                $("#EstatusAmparo").prop("checked", "");
                $("#divEstatusAmparo").hide();
        ...
        estatusAmparo = function () {
            if ($("#EstatusAmparo").is(':checked')) {
                //$("#EstatusAmparo").prop("disabled", true);
                $("#TipoAmparo").prop("disabled", false);
                $("#divEstatusAmparo").show();
                $("#TipoAmparo").prop("checked", "");
                $("#divTipoAmparo").hide();
                $("#cmbTipoAmparo").val(0);
                $("#cmbEstatusAmparo").val(0);
        ...
        filtro = function () {
            ...
            if ($("#cmbTipoAmparo").val() == 0 && $("#hiddenNivel").val() == 1) {
                strDatos += "&cveTipoAmparo=0";
            } else {
                if ($("#cmbTipoAmparo").val() != 0) {
                    strDatos += "&cveTipoAmparo=" + $("#cmbTipoAmparo").val();
                } else {
                    strDatos += "&cveTipoAmparo=" + $("#hiddenCveTipoAmparo").val();
                }
            }
            if ($("#cmbEstatusAmparo").val() == 0 && $("#hiddenNivel").val() == 1) {
                strDatos += "&cveEstatusAmparo=0";
            } else {
                if ($("#cmbEstatusAmparo").val() != 0) {
                    strDatos += "&cveEstatusAmparo=" + $("#cmbEstatusAmparo").val();
                } else {
                    strDatos += "&cveEstatusAmparo=" + $("#hiddenCveEstatusAmparo").val();
                }
            }
            if ($("#TipoAmparo").is(':checked')) {
                strDatos += "&filtroTA=true";
            }
            if ($("#EstatusAmparo").is(':checked')) {
                strDatos += "&filtroEA=true";
            }
        ...
        etiquetas = function () {
            ...
            if ($("#EstatusAmparo").is(':checked')) {
                etiqueta += " por Estatus";
            }
            return etiqueta;
        };
        titulos = function () {
            var etiqueta = etiquetas();
            var titulo = "Reporte de Amparos" + etiqueta;
            if ($("#txtAnio").val() != "") {
        ...
        gestorConsulta = function (bandera, nivel, json, i) {
            ...
            if (nivel == 2) {
                if ($("#TipoAmparo").is(':checked')) {
                    $("#hiddenCveTipoAmparo").val(json.resultados[i].cveTipoAmparo);
                }
                if ($("#EstatusAmparo").is(':checked')) {
                    $("#hiddenCveEstatusAmparo").val(json.resultados[i].cveEstatusAmparo);
                }
            }
            if (nivel == 3) {
        ...
        gestorNivel = function (json, bandera) {
            ...
            switch ($("#hiddenNivel").val()) {
                case "1":
                    ...
                    if ($("#TipoAmparo").is(':checked')) {
                        table += "<th>Tipos de Amparo</th>";
                    }
                    if ($("#EstatusAmparo").is(':checked')) {
                        table += "<th>Estatus Amparo</th>";
                    }
                    ...
                    for (var i = 0; i < json.totalCount; i++) {
                        ...
                        table += "<td>M\u00C9XICO</td>";
                        if ($("#TipoAmparo").is(":checked")) {
                            table += "<td>" + json.resultados[i].DesTipoAmparo + "</td>";
                        }
                        if ($("#EstatusAmparo").is(":checked")) {
                            table += "<td>" + json.resultados[i].desEstatus + "</td>";
                        }
                        if (json.totalCount > 0) {
                            table += "<td>" + json.resultados[i].totalCount + "</td>";
                            subTotal = subTotal - json.resultados[i].totalCount.replace(",", "");
                        } else {
                            table += "<td>0</td>";
                        }
                        aux = "";
                ...
                case "5":
                    ...
                    //table += "<th>N&uacute;m.</th><th>Estado</th><th>Regi\u00f3n</th><th>Distrito</th><th>Juzgado</th><th>Tipo Juzgado</th>";
                    table += "<th>N&uacute;m.</th><th>Tipo Juzgado</th>";
                    table += "<th>Amparo</th>";
                    table += "<th>Fecha de Registro</th><th>Acto Reclamado</th>><th>Autoridad Federal</th><th>No. Amparo Federal</th><th>Antecedente</th>";
                    if ($("#TipoAmparo").is(':checked')) {
                        table += "<th>Tipos de Amparo</th>";
                    }
                    if ($("#EstatusAmparo").is(':checked')) {
                    ...
                    for (var i = 0; i < json.totalCount; i++) {
                        ...
                        table += "<td>AMPARO: " + json.resultados[i].numAmparo + "/" + json.resultados[i].aniAmparo + "</td>";
                        table += "<td>" + fechaMySQLaNormal(json.resultados[i].fechaRegistro) + "</td>";
                        table += "<td>" + json.resultados[i].actoReclamado + "</td>";
                        table += "<td>" + json.resultados[i].autoridadProcedencia + "</td>";
                        table += "<td>" + json.resultados[i].numeroProcedencia + "</td>";
        ...
        consultar = function (bandera, nivel) {
            ...
            var strDatos = "accion=consultar_Amparos_Reporte";
            strDatos += "&activo=S";
            ...
            $.ajax({
                type: "POST",
                url: "../fachadas/sigejupe/reportes/ReporteAmparosFacade.Class.php",
                data: strDatos,
                async: true,
                dataType: "html",
            ...
            switch ($("#hiddenNivel").val()) {
                case "1":
                    ...
                    for (var i = 0; i < json.totalCount; i++) {
                        ...
                        if ($("#EstatusAmparo").is(":checked")) {
                            categorias[i] = json.resultados[i].desEstatus;
                        } else if ($("#TipoAmparo").is(":checked")) {
                            categorias[i] = json.resultados[i].DesTipoAmparo;
                        } else {
                            categorias[i] = "AMPAROS";
                        }

    //                            alert(json.resultados[i].totalCJ);
    //                            alert(json.resultados[i].totalCJ.replace(",",""));
    ...
    //        }
        ...
        calcularPaginas = function () {
            $("#divRegresar").hide();
            var url = "../fachadas/sigejupe/reportes/ReporteAmparosFacade.Class.php";
            var strDatos = "accion=consultar_Amparos_Reporte";
        ...
        encabezado = function () {
            ...
            $("#h5titulo").html("<span style='text-decoration: underline; cursor:pointer;' onclick='regresar(0,false);'>Reporte de Amparos en el Estado de M&eacute;xico.</span>" + mensaje);
        };
        regresar = function (nivel, bandera) {
            ...
            var strDatos = "";
            if (nivel == 0) {
                $("#h5titulo").html("Reporte de Amparos en el Estado de M&eacute;xico.");
                $("#divConsulta").hide("slide");
                $("#paginacion").hide();
                $("#inputImprimir").hide();
                $("#inputExportarPDF").hide();
        ...
        cargarTiposAmparo = function () {
            var strDatos = "accion=consultarOrdenado";
            strDatos += "&activo=S";
            strDatos += "&orden= ORDER BY DesTipoAmparo";
            $.ajax({
                type: "POST",
                ...
                success: function (datos) {
                    ...
                    if (json.totalCount > 0) {
                        for (var i = 0; i < json.totalCount; i++) {
                            $("#cmbTipoAmparo").append($('<option></option>').val(json.data[i].CveTipoAmparo).html(json.data[i].DesTipoAmparo));
                        }
                    }
                },
                error: function (objeto, quepaso, otroobj) {
        ...
        cargarEstatusAmparo = function () {
            var strDatos = "accion=consultarOrdenado";
            strDatos += "&activo=S";
            strDatos += "&orden= ORDER BY desEstatus";
            $.ajax({
                type: "POST",
        ...
        $(function () {
            obtenerPermisosFormulario('REPORTES', 'AMPAROS EDO MEX');
            //obtenerPermisos();
            cargarTiposAmparo();
            cargarEstatusAmparo();
            cargarTipoJuzgado();
