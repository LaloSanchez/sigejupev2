...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h5 class="panel-title">                                                            
                Reporte Disponibilidad de Jueces para Toma de Muestras                           
            </h5>
        </div>
            ...
            <div id="divFormulario" class="form-horizontal">
                <form method="post" id="formProgramacionJuzgadores">
                    ...
                    <div class="form-group">                                                                
                        <label class="control-label col-xs-12 col-sm-2 col-md-2">Grupo Toma de Muestras <span class="requerido">(*)</span></label>
    ...
    <script type="text/javascript">
        ...
        exportarReporte = function (accion, div) {
            ...
            var nombreArchivo = "REPORTE_DISPONIBILIDAD_TOMA_MUESTRAS";
            ...
            if (cveGrupoMuestra == "") {
                ...
                $.ajax({
                    ...
                    success: function (datos) {
                        try {
                            var nombreJuzgado = $("#cveGrupoMuestra :selected").text();
                            var texto = ucFirstAllWords(nombreJuzgado) + " de " + fechaInicio + " a " + fechaFin;
                            $("#encabezado").html("Horarios de disponibilidad de Jueces Toma de Muestras, " + texto);
            ...
            $.ajax({
                ...
                success: function (datos) {
                    try {
                        ...
                        window.open('../fachadas/sigejupe/programacionmuestras/' + datos);
                    } catch (e) {
    ...
    //        });
            ...
            var permisos = obtenerPermisosFormulario("REPORTES", "DISPONIBILIDAD DE JUECES  CATEOS");
