...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h5 class="panel-title">                                                            
                Reporte Disponibilidad de Jueces Por Juzgado                           
            </h5>
        </div>
    ...
    <script type="text/javascript">
                ...
                $.ajax({
                    ...
                    success: function (datos) {
                        try {
                            ...
                            $("#encabezado").html("Horarios de disponibilidad de Jueces, " + texto);
        ...
        exportarReporte = function (accion, div) {
            ...
            var nombreArchivo = "REPORTE_DISPONIBILIDAD_JUECES_J";
        ...
        $(function () {
            ...
            var permisos = obtenerPermisosFormulario("REPORTES", "DISPONIBILIDAD DE JUECES JUZGADO");
