...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h5 class="panel-title">                                                            
                Reporte Disponibilidad de Jueces para &Oacute;rdenes de Aprehensi&oacute;n
            </h5>
        </div>
    ...
    <script type="text/javascript">
        ...
        exportarReporte = function (accion, div) {
            ...
            var nombreArchivo = "REPORTE_DISPONIBILIDAD_ORDENES";
    ...
    //        });
            ...
            var permisos = obtenerPermisosFormulario("REPORTES", "DISPONIBILIDAD JUECES ORDENES");
