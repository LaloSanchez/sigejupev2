...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h5 class="panel-title" id="h5titulo">                                                            
                Reporte de ordenes en el Estado de M&eacute;xico.
            </h5>
        </div>
            ...
            <div id="divFormulario" class="form-horizontal">
                <div id="divPanelControl">
                    <div class="form-group">                                                                
                        <label class="control-label col-md-4" id="lblRelationName">A&ntilde;o del Orden</label>
                    ...
                    <div class="form-group" id="divEstatussolicitudorden"> 
                        <label class="control-label col-md-4">Estatus de Orden</label>
                        <div class="col-md-5">
                            <div id="divCmbEstatussolicitudorden" class="logobox"></div>
                            <select class="form-control Relacionado" name="cmbEstatussolicitudorden" id="cmbEstatussolicitudorden">
                                <option value="0">Seleccione una opci&oacute;n</option>
                            </select>
                        </div>                                
                    </div>
    ...
    <script type="text/javascript">
        ...
        exportar = function (accion, div) {
            ...
            var nombreArchivo = "REPORTE_ORDENES";
        ...
        limpiar = function () {
            ...
            $("#cmbEstatussolicitudorden").val(0);
            $("#labelSubTotal").text("");
            $("#divTableNivel").html("");
            $("#divGrafica").html("");
            $("#divConsulta").hide();
            ...
            $("#divGrafica").hide();
            $("#paginacion").hide();
            $("#h5titulo").html("<span style='text-decoration: underline; cursor:pointer;' onclick='regresar(0,false);'>Reporte de Ordenes en el Estado de M&eacute;xico.</span>");
        };
        ...
        filtro = function () {
            ...
            //        }
            if ($("#cmbEstatussolicitudorden").val() != 0) {
                strDatos += "&cveEstatusSolicitudOrden=" + $("#cmbEstatussolicitudorden").val();
            }
        ...
        titulos = function () {
            ...
            var titulo = "Reporte de Ordenes" + etiqueta;
            if ($("#txtAnio").val() != "") {
        ...
        gestorNivel = function (json, bandera) {
            ...
            switch ($("#hiddenNivel").val()) {
                ...
                case "5":
                    ...
                    table += "<th>Orden</th><th>Juez</th><th>Fecha de Solicitud</th><th>Estatus</th>";
                    table += "</tr></thead><tbody>";
                    for (var i = 0; i < json.totalCount; i++) {
                        table += "<tr>";
                        table += "<td> " + (i + 1 + indice) + "</td>";
                        ...
                        table += "<td>Orden: " + json.resultados[i].numeroOrden + "/" + json.resultados[i].anioOrden + "</td>";
                        ...
                        table += "<td>" + json.resultados[i].desEstatusSolicitudOrdenes + "</td>";
                        table += "</tr> ";
                        subTotal = -(i + 1 + indice);
                        aux = "";
                    }
        ...
        consultar = function (bandera, nivel) {
            ...
            var strDatos = "accion=consultar_Ordenes_Reporte";
            strDatos += "&activo=S";
            ...
            $.ajax({
                type: "POST",
                url: "../fachadas/sigejupe/reportes/ReporteOrdenesFacade.Class.php",
                data: strDatos,
                async: true,
                dataType: "html",
    ...
    //        }
        ...
        calcularPaginas = function () {
            $("#divRegresar").hide();
            var url = "../fachadas/sigejupe/reportes/ReporteOrdenesFacade.Class.php";
            var strDatos = "accion=consultar_Ordenes_Reporte";
        ...
        encabezado = function () {
            ...
            $("#h5titulo").html("<span style='text-decoration: underline; cursor:pointer;' onclick='regresar(0,false);'>Reporte de ordenes en el Estado de M&eacute;xico.</span>" + mensaje);
        };
        regresar = function (nivel, bandera) {
            ...
            var strDatos = "";
            if (nivel == 0) {
                $("#h5titulo").html("Reporte de ordenes en el Estado de M&eacute;xico.");
                $("#divConsulta").hide("slide");
                $("#paginacion").hide();
                $("#inputImprimir").hide();
                $("#inputExportarPDF").hide();
        ...
        //        });
        //    };
        cargarEstatusOrden = function () {
            var strDatos = "accion=consultarOrdenado";
            strDatos += "&activo=S";
            strDatos += "&orden= order by desEstatusSolicitudOrdenes";
            $.ajax({
                type: "POST",
                url: "../fachadas/sigejupe/estatussolicitudesordenes/EstatussolicitudesordenesFacade.Class.php",
                data: strDatos,
                async: true,
                dataType: "html",
                beforeSend: function (objeto) {
                ...
                success: function (datos) {
                    ...
                    if (json.totalCount > 0) {
                        for (var i = 0; i < json.totalCount; i++) {
                            if (json.data[i].cveEstatusSolicitudOrdenes != 4) {
                                $("#cmbEstatussolicitudorden").append($('<option></option>').val(json.data[i].cveEstatusSolicitudOrdenes).html(json.data[i].desEstatusSolicitudOrdenes));
                            }
                        }
                                ...
                                $.each(response.perfiles[0].perfil[i].permisos, function (k, vnombre) {
                                    if (vnombre.nomFormulario == "REPORTES") {
                                        ...
                                        $.each(hijos, function (k2, nombreHijo) {
                                            if (nombreHijo.nomFormulario == 'ORDENES') {
        ...
        $(function () {
            obtenerPermisosFormulario('REPORTES', 'ORDENES');
            //obtenerPermisos();
            cargarEstatusOrden();
            //cargarTipoJuzgado();
