...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h5 class="panel-title" id="h5titulo">                                                            
                Reporte de Duraci&oacute;n Promedio de Sentencia
            </h5>
        </div>
                ...
                <div id="divPanelControl">
                    <div class="form-group">
                        ...
                        <div class="radio col-md-5">
                            <label><input type="radio" name="optradio" value="1" id="radio1" onclick="radio()">A&ntilde;o de la causa</label>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-4 control-label">&nbsp;</label>
                    ...
                    <div id="divCarpeta" style="display: none">
                        <div class="form-group">
                            <label class="col-md-4 control-label needed">A&ntilde;o de la causa</label>
                            <div class="col-md-5">
                    ...
                    <div id="divMes"style="display: none">
                        <div class="form-group">
                            <label class="col-md-4 control-label needed">Mes (Registro)</label>
                            <div class="col-md-8">
                            ...
                            <div  class=" col-md-5" >
                                <input type="text" class="form-control" id="txtAnio" placeholder="A&ntilde;o" onkeypress="return validarNumeros(event)">                           
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group"> 
                        ...
                        <div class="col-md-1">
                            <input type="checkbox" id="checkTipoSentencia" class="form-inline" onclick="tipoSentencia()">
                        </div>
                        <div class="col-md-3" id="divTipoSentencia" style="display:none">
                            <select class="form-control" name="cmbTipoSentencia" id="cmbTipoSentencia">
                                <option value="0">Seleccione una opci&oacute;n</option>
                            </select>
                        </div>                                
                    </div>
                    <div class="form-group"> 
                        <label class="control-label col-md-4">Rango</label>
                        <div class="col-md-1">
                            <input type="checkbox" id="checkIntervaloDuracion" class="form-inline" onclick="intervaloDuracion()">
                        </div>
                        <div class="col-md-3" id="divIntervaloDuracion" style="display:none">
                            <select class="form-control" name="cmbIntervaloDuracion" id="cmbIntervaloDuracion">
                                <option value="0">Seleccione una opci&oacute;n</option>
                                <option value="1">Menos de un mes</option>
                                <option value="2">1 a 3 meses</option>
                                <option value="3">4 a 6 meses</option>
                                <option value="4">7 a 11 meses</option>
                                <option value="5">1 a 6 a&ntilde;os</option>
                                <option value="6">7 a 15 a&ntilde;os</option>
                                <option value="7">M&aacute;s de 15 a&ntilde;os</option>
                            </select>
                        </div> 
                    </div>
                    <div class="form-group">
    ...
    <script type="text/javascript">
        ...
        limpiar = function (bandera) {
            ...
            $("#hiddenVariables").val("");
            $("#h5titulo").html("Reporte de Duraci&oacute;n Promedio de Sentencia");
            $("#checkTipoSentencia").prop("checked", "");
            tipoSentencia();
            $("#checkIntervaloDuracion").prop("checked", "");
            intervaloDuracion();
            $("#divGrafica").html("");
            $("#divConsulta").hide();
            $("#cmbGrafica").val(1);
        ...
        intervaloDuracion = function () {
            $("#cmbIntervaloDuracion").val(0);
            if ($("#checkIntervaloDuracion").is(":checked")) {
                $("#divIntervaloDuracion").show();
            } else {
                $("#divIntervaloDuracion").hide();
            }
        };
        tipoSentencia = function () {
            $("#cmbTipoSentencia").val(0);
            if ($("#checkTipoSentencia").is(":checked")) {
                $("#divTipoSentencia").show();
            } else {
                $("#divTipoSentencia").hide();
            }
        };
        radio = function () {
            $("#txtAnioCarpeta").val("");
        ...
        filtro = function () {
            ...
            $("#idLabelDescripcion").text("Reporte Durac\u00F3n Promedio Juicio" + mensaje);
            if ($("#checkTipoSentencia").is(":checked")) {
                strDatos += "&porSentencia=S";
                if ($("#cmbTipoSentencia").val() != 0) {
                    strDatos += "&cveTipoSentencia=" + $("#cmbTipoSentencia").val();
                }
            }
            if ($("#checkIntervaloDuracion").is(":checked")) {
                strDatos += "&porIntervaloDuracion=S";
                if ($("#cmbIntervaloDuracion").val() != 0) {
                    strDatos += "&cveIntervaloDuracion=" + $("#cmbIntervaloDuracion").val();
                }
            }
            return strDatos;
        };
        ...
        preGestorConsulta = function (nivel, json, i) {
            var strDatos = "";
            $("#cmbNumReg").val(100);
            $("#hiddenTipoMedida").val(json.resultados[i].origen);
            if ($("#checkIntervaloDuracion").is(':checked')) {
                if (json.resultados[i].rangoDuracion != null) {
                    $("#cmbIntervaloDuracion").val(json.resultados[i].rangoDuracion);
                }
            }
            if (nivel == 3) {
            ...
            switch ($("#hiddenNivel").val()) {
                case "1":
                    ...
                    if (json.totalCount > 0) {
                        ...
                        if ($("#checkIntervaloDuracion").is(":checked")) {
                            table += "<th>Duraci&oacute;n</th>";
                        } else {
                            table += "<th>Duraci&oacute;n Promedio (D&iacute;as)</th>";
                        }
                        ...
                        for (var i = 0; i < json.totalCount; i++) {
                            ...
                            if ($("#checkIntervaloDuracion").is(":checked")) {
                                table += "<td>" +
                                        $("#cmbIntervaloDuracion option[value='" + json.resultados[i].rangoDuracion + "']").text()
                                        + "</td>";
                            } else {
                                table += "<td>" + json.resultados[i].duracionPromedio + "</td>";
                            }
                        ...
                        table += "<tr>";
                        table += "<td>Autos</td><td>Edo. M&eacute;x.</td>";
                        table += "<td>0</td>";
                        table += "</tr> ";
                    }
                    break;
                case "2":
                    table += "<th>N&uacute;m.</th><th>Regi&oacute;n</th><th>Subtotal</th>";
                    if ($("#checkTipoSentencia").is(":checked")) {
                        table += "<th>Tipo Sentencia</th>>";
                    }
                    if ($("#checkIntervaloDuracion").is(":checked")) {
                    ...
                    break;
                case "3":
                    table += "<th>N&uacute;m.</th><th>Distrito</th><th>Subtotal</th>";
                    if ($("#checkTipoSentencia").is(":checked")) {
                        table += "<th>Tipo Sentencia</th>>";
                    }
                    if ($("#checkIntervaloDuracion").is(":checked")) {
                    ...
                    break;
                case "4":
                    table += "<th>N&uacute;m.</th><th>Juzgado</th><th>Subtotal</th>";
                    if ($("#checkTipoSentencia").is(":checked")) {
                        table += "<th>Tipo Sentencia</th>>";
                    }
                    if ($("#checkIntervaloDuracion").is(":checked")) {
                    ...
                    break;
                case "5":
                    table += "<th>N&uacute;m.</th><th>Tipo de sentencia</th><th>Duraci&oacute;n (D&iacute;as)</th>";
                    table += "<th>Carpeta</th><th>Fecha Registro</th><th>Fecha Sentencia</th><th>Fecha Ejecutoria</th>";
                    table += "</tr></thead><tbody>";
                    for (var i = 0; i < json.totalCount; i++) {
                        table += "<tr>";
                        table += "<td> " + (i + 1 + indice) + "</td>";
                        table += "<td>" + json.resultados[i].desTipoSentencia + "</td>";
                        table += "<td>" + json.resultados[i].duracion + "</td>";
                        ...
                        table += "<td>" + fechaMySQLaNormal(json.resultados[i].fechaSentencia) + "</td>";
                        table += "<td>" + fechaMySQLaNormal(json.resultados[i].fechaEjecutoria) + "</td>";
                        table += "</tr> ";
                    }
                    break;
            }
        ...
        consultar = function (bandera, nivel) {
            ...
            var strDatos = "accion=consultar_duracionSentencia_Reporte";
            strDatos += "&activo=S";
            ...
            $.ajax({
                type: "POST",
                url: "../fachadas/sigejupe/reportes/ReporteduracionpromediosentenciaFacade.Class.php",
                data: strDatos,
                async: true,
                dataType: "html",
            ...
            switch ($("#hiddenNivel").val()) {
                case "1":
                    ...
                    for (var i = 0; i < json.totalCount; i++) {
                        ...
                        if ($("#checkIntervaloDuracion").is(":checked")) {
                            categorias[i] = $("#cmbIntervaloDuracion option[value='" + json.resultados[i].rangoDuracion + "']").text();
                        } else if ($("#checkTipoSentencia").is(":checked")) {
                            categorias[i] = json.resultados[i].desTipoSentencia;
                        } else {
                            categorias[i] = "DIAS";
                        }
    ...
    //        }
        ...
        calcularPaginas = function () {
            $("#inputRegresar2").hide();
            var url = "../fachadas/sigejupe/reportes/ReporteduracionpromediosentenciaFacade.Class.php";
            var strDatos = "accion=consultar_duracionSentencia_Reporte";
        ...
        encabezado = function () {
            ...
            $("#h5titulo").html("<span style='text-decoration: underline; cursor:pointer;' onclick='regresar(0,false);'>Reporte de Duraci&oacute;n Promedio de Sentencia</span>" + mensaje);
        };
        ...
        cargarTipoSentencia = function () {
            ...
            $.ajax({
                ...
                error: function (objeto, quepaso, otroobj) {
                    mostrarMensaje("Error en la peticion (cargar Tipos de sentencias):\n\n" + quepaso, 3);
                }
            });
        };
                                ...
                                $.each(response.perfiles[0].perfil[i].permisos, function (k, vnombre) {
                                    if (vnombre.nomFormulario == "REPORTES") {
                                        ...
                                        $.each(hijos, function (k2, nombreHijo) {
                                            if (nombreHijo.nomFormulario == 'DURACION PROMEDIO SENTENCIA') {
