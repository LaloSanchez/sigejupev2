...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h5 class="panel-title" id="h5titulo">                                                            
                Reporte de Promociones que Generan Carpeta Judicializada en el Estado de M&eacute;xico.
            </h5>
        </div>
            ...
            <div id="divFormulario" class="form-horizontal">
                <div id="divPanelControl">
                    <div class="form-group">                                                                
                        <label class="control-label col-md-4" id="lblRelationName">A&ntilde;o de la Promoci&oacute;n</label>
                    ...
                    <div class="form-group" id="divTipoCarpeta"> 
    ...
    <script type="text/javascript">
        ...
        exportar = function (accion, div) {
            ...
            var nombreArchivo = "REPORTE_PROMOCIONES_QUE_GENERAN_CJ";
        ...
        limpiar = function () {
            ...
            $("#divGrafica").hide();
            $("#paginacion").hide();
            $("#h5titulo").html("<span style='text-decoration: underline; cursor:pointer;' onclick='regresar(0,false);'>Reporte de Promociones que Generan Carpeta Judicializada en el Estado de M&eacute;xico.</span>");
        };
        ...
        titulos = function () {
            ...
            var titulo = "Reporte de Promociones que Generan Carpeta Judicializada" + etiqueta;
            if ($("#txtAnio").val() != "") {
        ...
        gestorConsulta = function (bandera, nivel, json, i) {
            var strDatos;
            if (nivel == 2) {
                strDatos += "&cveTipoCarpeta=" + json.resultados[i].cveTipoCarpeta;
                $("#hiddenCveTipoCarpeta").val(json.resultados[i].cveTipoCarpeta);
            }
            if (nivel == 3) {
        ...
        gestorNivel = function (json, bandera) {
            ...
            switch ($("#hiddenNivel").val()) {
                case "1":
                    ...
                    table += "<th>Tipo de Carpeta</th><th>Subtotal</th>";
                    table += "</thead><tbody>";
                ...
                case "5":
                    ...
                    table += "<th>Tipo de Carpeta</th><th>Promoci&oacute;n</th><th>Fecha de Registro</th>";
                    table += "</tr></thead><tbody>";
                    for (var i = 0; i < json.totalCount; i++) {
                        table += "<tr>";
                        table += "<td> " + (i + 1 + indice) + "</td>";
                        ...
                        table += "<td>" + json.resultados[i].desTipoCarpeta + "</td>";
                        table += "<td>PROMOCI&Oacute;N: " + json.resultados[i].numActuacion + "/" + json.resultados[i].aniActuacion + "</td>";
                        if (json.resultados[i].fechaRegistro != "") {
                            table += "<td>" + fechaMySQLaNormal(json.resultados[i].fechaRegistro) + "</td>";
                        } else {
                            table += "<td>NO ESPECIFICADO</td>";
                        }
                        table += "</tr> ";
                        subTotal = -(i + 1 + indice);
                        aux = "";
        ...
        consultar = function (bandera, nivel) {
            ...
            var strDatos = "accion=consultar_Promociones_Reporte";
            strDatos += "&activo=S";
            ...
            $.ajax({
                type: "POST",
                url: "../fachadas/sigejupe/reportes/ReportePromocionesFacade.Class.php",
                data: strDatos,
                async: true,
                dataType: "html",
    ...
    //        }
        ...
        calcularPaginas = function () {
            $("#divRegresar").hide();
            var url = "../fachadas/sigejupe/reportes/ReportePromocionesFacade.Class.php";
            var strDatos = "accion=consultar_Promociones_Reporte";
        ...
        encabezado = function () {
            ...
            $("#h5titulo").html("<span style='text-decoration: underline; cursor:pointer;' onclick='regresar(0,false);'>Reporte de Promociones que Generan Carpeta Judicializada en el Estado de M&eacute;xico.</span>" + mensaje);
        };
        regresar = function (nivel, bandera) {
            ...
            var strDatos = "";
            if (nivel == 0) {
                $("#h5titulo").html("Reporte de Promociones que Generan Carpeta Judicializada en el Estado de M&eacute;xico.");
                $("#divConsulta").hide("slide");
                $("#paginacion").hide();
                $("#inputImprimir").hide();
                $("#inputExportarPDF").hide();
                ...
                success: function (datos) {
                    ...
                    if (json.totalCount > 0) {
                        for (var i = 0; i < json.totalCount; i++) {
                            ...
                            //                        if(json.data[i].cveTipoCarpeta==1 || json.data[i].cveTipoCarpeta==3){
                            //                            $("#cmbTipoCarpeta").append($('<option></option>').val(json.data[i].cveTipoCarpeta).html(json.data[i].desTipoCarpeta));
                            //                        }
                            /*Para obtener todos los tipos de careptas*/
                            $("#cmbTipoCarpeta").append($('<option></option>').val(json.data[i].cveTipoCarpeta).html(json.data[i].desTipoCarpeta));
                        }
                    }
                },
                                ...
                                $.each(response.perfiles[0].perfil[i].permisos, function (k, vnombre) {
                                    if (vnombre.nomFormulario == "REPORTES") {
                                        ...
                                        $.each(hijos, function (k2, nombreHijo) {
                                            if (nombreHijo.nomFormulario == 'PROMOCIONES QUE GENERAN CARPETAS JUDICIALIZADAS') {
        ...
        $(function () {
            obtenerPermisosFormulario('REPORTES', 'PROMOCIONES QUE GENERAN CARPETAS JUDICIALIZADAS');
            //obtenerPermisos();
            cargarTipoCarpeta();
            cargarTipoJuzgado();
