...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h5 class="panel-title" id="h5titulo">                                                            
                Reporte de Carga Jeces General
            </h5>
        </div>
        <div  id="panelPrincipal" class="panel-body">
            <div id="divFormulario" class="form-horizontal">
                <div id="divPanelControl">
                    ...
                    <div class="form-group">                                                                
                        <label class="control-label col-md-3" >Programada/Urgente</label>
                        <input type="checkbox"  value="" class="form-inline" id="checkProgramada" > 
                    </div>
                    <div class="form-group">                                                                
                        <label class="control-label col-md-3" >Publica/Privada</label>
                        <input type="checkbox" value="" class="form-inline" id="checkPrivada" > 
                    </div>
                    <div class="form-group">
    ...
    <script type="text/javascript">
        ...
        exportar = function (accion, div) {
            ...
            var nombreArchivo = "REPORTE_CARGAJUECESGRAL";
        ...
        limpiar = function () {
            $("#h5titulo").html("Reporte de Carga Jeces General");
        ...
        filtro = function () {
            ...
            if ($("#checkProgramada").is(":checked")) {
                strDatos += "&checkProgramada=true";
            }
            if ($("#checkPrivada").is(":checked")) {
                strDatos += "&checkPrivada=true";
            }
            return strDatos;
        };
        ...
        gestorNivel = function (json, bandera) {
            ...
            switch ($("#hiddenNivel").val()) {
                ...
                case "2":
                    ...
                    table += '<th>Juzgado</th><th>SubTotal</th>';
                    table += "</thead><tbody>";
                    for (var i = 0; i < json.totalCount; i++) {
                ...
                case "3":
                    ...
                    table += '<th>F. Audiencia</th><th >Des. Audiencia</th> <th>Juzgado</th><th>Sala</th><th>Detenido</th><th>Status</th>';
                    table += "</thead><tbody>";
                    for (var i = 0; i < json.totalCount; i++) {
            ...
            if (subtotal != 0 && $("#hiddenNivel").val() < 2) {
                $("#labelSubTotal").show();
                $("#labelSubTotal").text("Total de audiencias: " + subtotal.toLocaleString("en-US"));
            } else {
                $("#labelSubTotal").hide();
            }
            $("#inputImprimir").show();
    ...
    //        }
        ...
        encabezado = function () {
            ...
            if ($("#hiddenNivel").val() == 3) {
                mensaje = " /<span style='text-decoration: underline; cursor:pointer;' onclick='regresar(1,false);'>Total</span>/ <span style='text-decoration: underline; cursor:pointer;' onclick='regresar(2,false);'>Juzgado</span>";
                mensaje += " / Detalles";
            }

            $("#h5titulo").html("<span style='text-decoration: underline; cursor:pointer;' onclick='regresar(0,false);'>Reporte de Carga Jeces General</span>" + mensaje);
        };
