...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <div class="panel-heading">
                <h4>Administraci&oacute;n de Solicitudes de Ordenes de Aprehensi&oacute;n</h4>
            </div>
        </div>
                ...
                <div class='content col-xs-12' id="Paso1" >
                    <div class="col-md-12" >
                        <div class="form-group" >
                            <label for="txtNumOrdenConsultar" class="col-xs-3 control-label" >N&uacute;mero de Orden:</label>
                            <div class="col-md-9 col-xs-9" >
                                <div class="col-md-6 col-xs-12" >
                                    <input type="text" placeholder="N&uacute;mero de Orden" name="txtNumOrdenConsultar" id="txtNumOrdenConsultar" class="form-control" onkeypress=" return validateNumber(event)" size="5">
                                </div>
                                <div class="col-md-6 col-xs-12" >
                                    <input type="text" placeholder="A&ntilde;o de Orden" name="txtAniOrdenConsultar" id="txtAniOrdenConsultar" class="form-control" maxlength="4" size="5" onkeypress=" return validateNumber(event)" >
                                </div>
                            </div>
                        </div>
                        <div class="form-group text-center buttons" >
                            <button class="btn btn-primary" onclick="javascript:bitacora.searchOrden('1')">Consultar</button>
                    ...
                    <div class="paginacion col-md-12" style="display:none" >    
                        ...
                        <div class="col-md-8">
                            ...
                            <div id="divPaginador" class="form-group col-md-3" >
                                ...
                                <select  name="cmbPaginacion" id="cmbPaginacion" onchange="javascript:bitacora.searchOrden(0)">
                                    <option value="1"></option>
                                </select>
                            </div>
                            <div id="divPaginador" class="form-group col-md-4" >
                                <label class="control-label">Registros por p&aacute;gina:</label>
                                <select  name="cmbNumReg" id="cmbNumReg" onchange="javascript:bitacora.searchOrden(1)">
                        ...
                        <div class="col-xs-4" >
                            <div class="table-responsive" >
                                ...
                                <div class="text-center" id="imprimir" >
                                    ...
                                    <button class="btn btn-primary" onclick="javascript:bitacora.modificaOrden()" >Guardar</button>
    ...
    <script src="sigejupe/reportes/bitacoraOrden.js" ></script>
    <script src="sigejupe/solicitudesCateos/ordenes.js" type="text/javascript"></script>
    <script>
                                        var bitacora = new BitacoraOrden();
