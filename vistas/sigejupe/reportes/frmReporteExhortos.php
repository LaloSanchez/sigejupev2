...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
    ...
    <input type="hidden" id="hiddenCveEstatusExhorto" value="">
    <input type="hidden" id="hiddenTituloReporte" value="">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h5 class="panel-title" id="h5titulo">                                                            
                Reporte de Exhortos en el Estado de M&eacute;xico.
            </h5>
        </div>
            ...
            <div id="divFormulario" class="form-horizontal">
                <div id="divPanelControl">
                    <div class="form-group">                                                                
                        <label class="control-label col-md-4" id="lblRelationName">A&ntilde;o del Exhorto</label>
    ...
    <script type="text/javascript">
        ...
        exportar = function (accion, div) {
            ...
            var nombreArchivo = "REPORTE_EXHORTOS";
        ...
        limpiar = function () {
            ...
            $("#divGrafica").hide();
            $("#paginacion").hide();
            $("#h5titulo").html("<span style='text-decoration: underline; cursor:pointer;' onclick='regresar(0,false);'>Reporte de Exhortos en el Estado de M&eacute;xico.</span>");
        };
        filtro = function () {
            var strDatos = "";
        ...
        titulos = function () {
            ...
            var titulo = "Reporte de Exhortos" + etiqueta;
            if ($("#txtAnio").val() != "") {
        ...
        gestorConsulta = function (bandera, nivel, json, i) {
            var strDatos;
            if (nivel == 2) {
                strDatos += "&cveEstatusExhorto=" + json.resultados[i].cveEstatusExhorto;
                $("#hiddenCveEstatusExhorto").val(json.resultados[i].cveEstatusExhorto);
            }
            if (nivel == 3) {
                ...
                strDatos += "&cveEstatusExhorto=" + $("#hiddenCveEstatusExhorto").val();
            }
            if (nivel == 4) {
                strDatos = "&cveRegion=" + json.resultados[i].cveRegion;
            ...
            switch ($("#hiddenNivel").val()) {
                case "1":
                    ...
                    for (var i = 0; i < json.totalCount; i++) {
                        ...
                        table += "<td>M\u00c9XICO</td>";
                        table += "<td>" + json.resultados[i].desEstatusExhorto + "</td>";
                ...
                case "5":
                    ...
                    table += "<th>Exhorto:</th><th>Estatus Exhorto</th><th>Sintesis</th><th>Fecha de Registro</th>";
                    table += "</tr></thead><tbody>";
                    for (var i = 0; i < json.totalCount; i++) {
                        table += "<tr>";
                        table += "<td> " + (i + 1 + indice) + "</td>";
                        ...
                        table += "<td>EXHORTO: " + json.resultados[i].numExhorto + "/" + json.resultados[i].aniExhorto + "</td>";
                        table += "<td>" + json.resultados[i].desEstatusExhorto + "</td>";
        ...
        consultar = function (bandera, nivel) {
            ...
            var strDatos = "accion=consultar_Exhortos_Reporte";
            strDatos += "&activo=S";
            if ($("#checkDetalle").is(":checked")) {
            ...
            $.ajax({
                type: "POST",
                url: "../fachadas/sigejupe/reportes/ReporteExhortosFacade.Class.php",
                data: strDatos,
                async: true,
                dataType: "html",
        ...
        graficar = function (json) {
            ...
            switch ($("#hiddenNivel").val()) {
                case "1":
                    nombreX = "M\u00C9XICO";
                    for (var i = 0; i < json.totalCount; i++) {
                        categorias[i] = json.resultados[i].desEstatusExhorto;
    ...
    //        }
        ...
        calcularPaginas = function () {
            $("#divRegresar").hide();
            var url = "../fachadas/sigejupe/reportes/ReporteExhortosFacade.Class.php";
            var strDatos = "accion=consultar_Exhortos_Reporte";
        ...
        encabezado = function () {
            ...
            $("#h5titulo").html("<span style='text-decoration: underline; cursor:pointer;' onclick='regresar(0,false);'>Reporte de Exhortos en el Estado de M&eacute;xico.</span>" + mensaje);
        };
        regresar = function (nivel, bandera) {
            ...
            var strDatos = "";
            if (nivel == 0) {
                $("#h5titulo").html("Reporte de Exhortos en el Estado de M&eacute;xico.");
                $("#divConsulta").hide("slide");
                $("#paginacion").hide();
                $("#inputImprimir").hide();
                $("#inputExportarPDF").hide();
                                ...
                                $.each(response.perfiles[0].perfil[i].permisos, function (k, vnombre) {
                                    if (vnombre.nomFormulario == "REPORTES") {
                                        ...
                                        $.each(hijos, function (k2, nombreHijo) {
                                            if (nombreHijo.nomFormulario == 'EXHORTOS') {
        ...
        $(function () {
            ...
            obtenerPermisosFormulario('REPORTES', 'EXHORTOS');
            //obtenerPermisos();
            cargarRegiones();
            cargarDistritos();
            cargarJuzgado();
