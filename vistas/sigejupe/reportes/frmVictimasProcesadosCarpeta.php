...
<div class="panel panel-default">
    <div class="panel-heading">
        <h5 class="panel-title" id="h5titulo">                                                            
            Reporte de Procesados y V&iacute;ctimas por Carpeta
        </h5>
    </div>
...
//                    var juzgado = $("#cmbJuzgado").find('option:selected').text();
                    ...
                    if (json.status == 'Ok' && json.totalCount > 0) {
                            ...
                            table += '<td rowspan=2 width="15%" align="center" style="vertical-align: middle;"><b>ORGANO JURISDICCIONAL</b></td>';
                            ...
                            table += '<td rowspan=2 width="10%" align="center" style="vertical-align: middle;"><b>FECHA RADICACI&Oacute;N</b></td>';
                            table += '<td colspan=3 align="center"><b>NO. PROCESADOS</b></td>';
                            table += '<td colspan=3 align="center"><b>NO. V&Iacute;CTIMAS</b></td>';
                            
                            table += '</tr>';
                            table += '<tr>';
                            table += '<th width="6%" align="center"><b>MASC</b></td>';
                            table += '<th width="6%" align="center"><b>FEM</b></td>';
                            table += '<th width="6%" align="center"><b>INDEF</b></td>';
                            table += '<th width="6%" align="center"><b>MASC</b></td>';
                            table += '<th width="6%" align="center"><b>FEM</b></td>';
                            table += '<th width="6%" align="center"><b>INDEF</b></td>';
                            table += '</tr>';
                            ...
                            for (var i = 0; i < (parseInt(json.totalCount)); i++) {
                                ...
                                var juzgado = '';
                                var distrito = '';
                                var IH = json.data[i].imputadosHombres;
                                var IM = json.data[i].imputadosMujeres;
                                var II = json.data[i].imputadosIndefinidos;
                                
                                var OH = json.data[i].ofendidosHombres;
                                var OM = json.data[i].ofendidosMujeres;
                                var OI = json.data[i].ofendidosIndefinidos;
...
//        table3 += "<center><table style='border-collapse:collapse;' id='tblTitulo' class='list-unstyled'>";
//        table3 += "<tr><td ALIGN='center' whidth=10%> <img src='img/logoPjAcuses.jpg' width=310px></td>";
//        table3 += "</tr>";
//        table3 += '<tr><td colspan=4><br><label style="font-family: Arial; font-weight:501 !important; font-size:20px; ">' + juzgado + '</label><br></td></tr>';
        
        table3 += ' <center><table width=90%; style="border-collapse:collapse;" class="Arial11">';
        table3 += ' <thead style="table-header-group"><tr>';
        table3 += ' <th> </th>';
        table3 += ' <th> </th>';
        table3 += ' <th colspan=6 class="esc"><img src="img/logoPj.png" style="width:300px"></td> </tr>';
//        table3 += ' <th class="tit" colspan="5"><h3>GOBIERNO DEL ESTADO DE M&Eacute;XICO<br>PODER JUDICIAL<br>' + juzgado + '<br><br> </h3> </td> ';
//        table3 += ' <th> </th>';
        table3 += ' <tr> <th></th>';
        table3 += ' <th></th>';
        table3 += '<th colspan=6><br><label style="font-family: Arial; font-weight:501 !important; font-size:20px; ">' + juzgado + '</label><br></td></tr>';
