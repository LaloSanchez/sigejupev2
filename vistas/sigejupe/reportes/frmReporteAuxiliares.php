...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h5 class="panel-title" id="h5titulo">                                                            
                Reporte de Auxiliares Radicados en el Estado de M&eacute;xico.
            </h5>
        </div>
            ...
            <div id="divFormulario" class="form-horizontal">
                <div id="divPanelControl">
                    <div class="form-group">                                                                
                        <label class="control-label col-md-4" id="lblRelationName">A&ntilde;o del Auxiliar</label>
    ...
    <script type="text/javascript">
        ...
        exportar = function (accion, div) {
            ...
            var nombreArchivo = "REPORTE_AUXILIARES_RADICADAS";
        ...
        limpiar = function () {
            ...
            $("#divGrafica").hide();
            $("#paginacion").hide();
            $("#h5titulo").html("<span style='text-decoration: underline; cursor:pointer;' onclick='regresar(0,false);'>Reporte de Auxiliares Radicados en el Estado de M&eacute;xico.</span>");
        };
        ...
        titulos = function () {
            ...
            var titulo = "Reporte de Auxiliares Radicados" + etiqueta;
            if ($("#txtAnio").val() != "") {
        ...
        gestorNivel = function (json, bandera) {
            ...
            switch ($("#hiddenNivel").val()) {
                ...
                case "5":
                    ...
                    table += "<th>Estatus Auxiliar</th><th>Carpeta</th><th>Fecha de Radicaci\u00f3n</th>";
                    table += "</tr></thead><tbody>";
                    for (var i = 0; i < json.totalCount; i++) {
                        table += "<tr>";
                        table += "<td> " + (i + 1 + indice) + "</td>";
                        ...
                        table += "<td>" + json.resultados[i].desEstatusCarpeta + "</td>";
                        table += "<td>N&Uacute;MERO AUXILIAR: " + json.resultados[i].numero + "/" + json.resultados[i].anio + "</td>";
        ...
        consultar = function (bandera, nivel) {
            ...
            var strDatos = "accion=consultar_Auxiliares_Reporte";
            strDatos += "&activo=S";
            ...
            $.ajax({
                type: "POST",
                url: "../fachadas/sigejupe/reportes/ReporteAuxiliaresFacade.Class.php",
                data: strDatos,
                async: true,
                dataType: "html",
            ...
            switch ($("#hiddenNivel").val()) {
                case "1":
                    ...
                    for (var i = 0; i < json.totalCount; i++) {
                        ...
                        if (json.resultados[i].cveEstatusCarpeta == 2) {
                            categorias[i] = json.resultados[i].desEstatusCarpeta;
                        } else {
                            categorias[i] = "EN TRAMITE";
                        }
    ...
    //        }
        ...
        calcularPaginas = function () {
            $("#divRegresar").hide();
            var url = "../fachadas/sigejupe/reportes/ReporteAuxiliaresFacade.Class.php";
            var strDatos = "accion=consultar_Auxiliares_Reporte";
        ...
        encabezado = function () {
            ...
            $("#h5titulo").html("<span style='text-decoration: underline; cursor:pointer;' onclick='regresar(0,false);'>Reporte de Auxiliares Radicados en el Estado de M&eacute;xico.</span>" + mensaje);
        };
        regresar = function (nivel, bandera) {
            ...
            var strDatos = "";
            if (nivel == 0) {
                $("#h5titulo").html("Reporte de Auxiliares Radicados en el Estado de M&eacute;xico.");
                $("#divConsulta").hide("slide");
                $("#paginacion").hide();
                $("#inputImprimir").hide();
                $("#inputExportarPDF").hide();
                                ...
                                $.each(response.perfiles[0].perfil[i].permisos, function (k, vnombre) {
                                    if (vnombre.nomFormulario == "REPORTES") {
                                        ...
                                        $.each(hijos, function (k2, nombreHijo) {
                                            if (nombreHijo.nomFormulario == 'AUXILIARES RADICADAS') {
        ...
        $(function () {
            obtenerPermisosFormulario('REPORTES', 'AUXILIARES RADICADAS');
            //obtenerPermisos();
            cargarTipoJuzgado();
            $("#cmbTipoJuzgado").val(1);
