...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
            ...
            <div id="divFormulario" class="form-horizontal">
                ...
                <div class="form-group">
                    <div class="col-md-offset-3 col-md-9">
                        ...
                        <div class="col-md-2 botonesAdaptar">
                            <input type="submit" class="btn btn-primary btn-adaptar" id="inputExportarExcel" value="Exportar Excel" onclick="exportar('exportarExcel', 'divTableNivel');" style="display:none;"><div class="col-md-2 botonesAdaptar">
                            </div>
                            <div class="col-md-2 botonesAdaptar">
    ...
    //                    if ($("#cmbConclusion").val() != 0) {
    //                        table += "<th>Tipo de Conclusi&oacute;n</th>";
    //                    }
                        ...
                        for (var i = 0; i < json.totalCount; i++) {
                            ...
                            table += "<td>M\u00C9XICO</td>";
                            if (json.resultados[i].cveEstatusCarpeta) {
                                table += "<td>" + estatus_carpeta + "</td>";
                            } else {
                                table += "<td>SIN RESULTADOS</td>";
                            }
    //                        if ($("#cmbConclusion").val() != 0) {
    //                            if (json.resultados[0].desConclusion) {
    ...
    //                    }
                        table += "<th>Toca</th>";
                        table += "<th>Fecha de Radicaci&oacute;n</th>";
                        table += "</tr></thead><tbody>";
                        for (var i = 0; i < json.totalCount; i++) {
                            if (json.resultados[i].cveEstatusCarpeta == 1) {
                                estatus_carpeta = "EN TR&Aacute;MITE";
    ...
    //                        }
            ...
            consultar = function (bandera, nivel) {
                ...
                var strDatos = "accion=consultar_Tocas_Reporte";
                strDatos += "&activo=S";
