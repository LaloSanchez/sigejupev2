...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h5 class="panel-title" id="h5titulo">                                                            
                Reporte de Duraci&oacute;n Promedio de un Juicio
            </h5>
        </div>
        <div  id="panelPrincipal" class="panel-body">
            <div id="divFormulario" class="form-horizontal">
                <div id="divPanelControl">
                    ...
                    <div class="form-group"> 
                        <label class="control-label col-md-4">Intervalo</label>
                        <div class="col-md-1">
    ...
    <script type="text/javascript">
        ...
        exportar = function (accion, div) {
            var usuario = '<?php echo $_SESSION["nombre"]; ?>';
            var nombreArchivo = "REPORTE_DURACION_JUICIO";
        ...
        limpiar = function (bandera) {
            ...
            $("#cmbGrafica").val(1);
            $("#divGrafica").hide();
            $("#h5titulo").html("Reporte de Duraci&oacute;n Promedio de un Juicio");
        ...
        filtro = function () {
            ...
            $("#idLabelDescripcion").text("Reporte Duraci\u00F3n Promedio Juicio" + mensaje);
            if ($("#checkIntervaloDuracion").is(":checked")) {
        ...
        gestorNivel = function (json, bandera) {
            ...
            switch ($("#hiddenNivel").val()) {
                case "1":
                    table += "<th>N&uacute;m.</th><th>Estado</th><th>Sub. Total</th>";
                    if (json.totalCount > 0) {
                        ...
                        for (var i = 0; i < json.totalCount; i++) {
                            ...
                            table += "<td>" + json.resultados[i].totalCount.toLocaleString("en-US") + "</td>";
                            if ($("#checkIntervaloDuracion").is(":checked")) {
                                table += "<td>" + procesarRango(json.resultados[i].rangoDuracion) + "</th>";
                            } else {
                    ...
                    break;
                case "2":
                    table += "<th>N&uacute;m.</th><th>Regi&oacute;n</th><th>Sub. Total</th>";
                    if ($("#checkIntervaloDuracion").is(":checked")) {
                        table += "<th>Duraci&oacute;n</th>";
                    } else {
                        table += "<th>Duraci&oacute;n Promedio (D&iacute;as)</th>";
                    ...
                    break;
                case "3":
                    table += "<th>N&uacute;m.</th><th>Distrito</th><th>Sub. Total</th>";
                    if ($("#checkIntervaloDuracion").is(":checked")) {
                        table += "<th>Duraci&oacute;n</th>";
                    } else {
                        table += "<th>Duraci&oacute;n Promedio (D&iacute;as)</th>";
                    ...
                    break;
                case "4":
                    table += "<th>N&uacute;m.</th><th>Juzgado</th><th>Sub. Total</th>";
                    if ($("#checkIntervaloDuracion").is(":checked")) {
                        table += "<th>Duraci&oacute;n</th>";
                    } else {
                        table += "<th>Duraci&oacute;n Promedio (D&iacute;as)</th>";
                    ...
                    break;
                case "5":
                    table += "<th>N&uacute;m.</th><th>Duraci&oacute;n (D&iacute;as)</th>";
                    table += "<th>Carpeta</th><th>Fecha radicacion</th><th>Fecha Sentencia</th>";
                    table += "</tr></thead><tbody>";
                    for (var i = 0; i < json.totalCount; i++) {
                        table += "<tr>";
                        table += "<td> " + (i + 1 + indice) + "</td>";
        ...
        consultar = function (bandera, nivel) {
            ...
            var strDatos = "accion=consultar_duracionJuicio_Reporte";
            strDatos += "&activo=S";
            ...
            $.ajax({
                type: "POST",
                url: "../fachadas/sigejupe/reportes/ReporteduracionpromediojuicioFacade.Class.php",
                data: strDatos,
                async: true,
                dataType: "html",
            ...
            switch ($("#hiddenNivel").val()) {
                case "1":
                    ...
                    for (var i = 0; i < json.totalCount; i++) {
                        ...
                        if ($("#checkIntervaloDuracion").is(":checked")) {
                            categorias[i] = procesarRango(json.resultados[i].rangoDuracion);
                        } else {
                            categorias[i] = "DIAS";
                        }
    ...
    //        }
        ...
        calcularPaginas = function () {
            $("#inputRegresar2").hide();
            var url = "../fachadas/sigejupe/reportes/ReporteduracionpromediojuicioFacade.Class.php";
            var strDatos = "accion=consultar_duracionJuicio_Reporte";
        ...
        encabezado = function () {
            ...
            $("#h5titulo").html("<span style='text-decoration: underline; cursor:pointer;' onclick='regresar(0,false);'>Reporte de Duraci&oacute;n Promedio de un Juicio</span>" + mensaje);
        };
                                ...
                                $.each(response.perfiles[0].perfil[i].permisos, function (k, vnombre) {
                                    if (vnombre.nomFormulario == "REPORTES") {
                                        ...
                                        $.each(hijos, function (k2, nombreHijo) {
                                            if (nombreHijo.nomFormulario == 'DURACION JUICIO') {
        ...
        procesarRango = function (num) {
            switch (num) {
                ...
                case "4":
                    return "7 a 11 meses";
                case "5":
                    return "1 a 6 a&ntilde;os";
                case "6":
                    return "7 a 15 a&ntilde;os";
                case "7":
                    return "M&aacute;s de 15 a&ntilde;os";
            }
        };
