...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h5 class="panel-title" id="h5titulo">                                                            
                Reporte de Medidas Cautelares y de Protecci&oacute;n por Carpeta Judicial Estado de M&eacute;xico.
            </h5>
        </div>
    ...
    <script type="text/javascript">
        ...
        exportar = function (accion, div) {
            ...
            var nombreArchivo = "REPORTE_MCPCJ";
    ...
    //        $("#cmbTipoJuzgado").val(0);
            ...
            $("#divTableNivel").html("");
            $("#paginacion").hide();
            $("#h5titulo").html("<span style='text-decoration: underline; cursor:pointer;' onclick='regresar(0,false);'>Reporte de Medidas Cautelares y de Protecci&oacute;n por Carpeta Judicial en el Estado de M&eacute;xico.</span>");
        };
        ...
        titulos = function () {
            ...
            var titulo = "Reporte de Medidas Cautelares y Protecci\u00f3n por Carpeta Judicial " + etiqueta;
            if ($("#txtAnio").val() != "") {
    ...
    //                    table += "<td>" + json.resultados[i].desDistrito + "</td>";
                ...
                case "5":
                    ...
                    table += "<th>Delito</th><th>Imputado</th><th>Medida cautelar</th><th>Fecha en que se dict\u00f3 la medida cautelar</th>";
                    table += "<th>Ofendido</th><th>Orden de protecci\u00f3n</th><th>Fecha en que se dict\u00f3 la orden de protecci\u00f3n</th>";
                    table += "</tr></thead><tbody>";
                    for (var i = 0; i < json.totalCount; i++) {
                        table += "<tr>";
                        table += "<td> " + (i + 1 + indice) + "</td>";
                        ...
                        if(json.resultados[i].iNombreMoral != "" && json.resultados[i].iNombreMoral != null){
                        ...
                        if(json.resultados[i].desTipoMedidaCautelar != "" && json.resultados[i].desTipoMedidaCautelar != null){
                            table += "<td>" + json.resultados[i].desTipoMedidaCautelar + "</td>";
                        } else{
                            table += "<td></td>";
                        }
                        if(json.resultados[i].fechaInicioMC != "" && json.resultados[i].fechaInicioMC != null){
                            table += "<td>" + fechaMySQLaNormal(json.resultados[i].fechaInicioMC) + "</td>";
                        } else{
                            table += "<td></td>";
                        }
                        if(json.resultados[i].oNombreMoral != "" && json.resultados[i].oNombreMoral != null){
                        ...
                        if(json.resultados[i].desTipoProteccion != "" && json.resultados[i].desTipoProteccion != null){
                            table += "<td>" + json.resultados[i].desTipoProteccion + "</td>";
                        } else{
                            table += "<td></td>";
                        }
                        if(json.resultados[i].fechaInicioMP != "" && json.resultados[i].fechaInicioMP != null){
                            table += "<td>" + fechaMySQLaNormal(json.resultados[i].fechaInicioMP) + "</td>";
                        } else{
                            table += "<td></td>";
                        }
                        table += "</tr> ";
    ...
    //            }
        ...
        consultar = function (bandera, nivel) {
            ...
            var strDatos = "accion=consultar_MCPCJ_Reporte";
            strDatos += "&activo=S";
            ...
            $.ajax({
                type: "POST",
                url: "../fachadas/sigejupe/reportes/ReporteMCPCJFacade.Class.php",
                data: strDatos,
                async: true,
                dataType: "html",
    ...
    //                console.log(datos);
        ...
        calcularPaginas = function () {
            $("#divRegresar").hide();
            var url = "../fachadas/sigejupe/reportes/ReporteMCPCJFacade.Class.php";
            var strDatos = "accion=consultar_MCPCJ_Reporte";
    ...
    //                alert(datos);
        ...
        encabezado = function () {
            ...
            $("#h5titulo").html("<span style='text-decoration: underline; cursor:pointer;' onclick='regresar(0,false);'>Reporte de Medidas Cautelares y de Protecci&oacute;n por Carpeta Judicial en el Estado de M&eacute;xico.</span>" + mensaje);
        };
        regresar = function (nivel, bandera) {
            ...
            var strDatos = "";
            if (nivel == 0) {
                $("#h5titulo").html("Reporte de Medidas Cautelares y de Protecci&oacute;n por Carpeta Judicial en el Estado de M&eacute;xico.");
                $("#divConsulta").hide("slide");
                $("#paginacion").hide();
                $("#inputImprimir").hide();
                $("#inputExportarPDF").hide();
                                ...
                                $.each(response.perfiles[0].perfil[i].permisos, function (k, vnombre) {
                                    if (vnombre.nomFormulario == "REPORTES") {
                                        ...
                                        $.each(hijos, function (k2, nombreHijo) {
                                            if (nombreHijo.nomFormulario == 'MEDIDAS CAUTELARES Y PROTECCION DE CJ') {
