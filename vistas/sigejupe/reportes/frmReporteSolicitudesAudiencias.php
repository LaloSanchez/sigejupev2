...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
    ...
    <input type="hidden" id="hiddenEstatusSolicitud" value="">
    ...
    <input type="hidden" id="hiddenTerminaciones" value="">
    ...
    <div class="panel panel-default">
        ...
        <div  id="panelPrincipal" class="panel-body">
            <div id="divFormulario" class="form-horizontal">
                <div id="divPanelControl">
                    ...
                    <div class="form-group">                                                                
                        <label class="control-label col-md-4" >A&ntilde;o de solicitud</label>
                    ...
                    <div class="form-group" style="display:none" id="cmbM">                                                                
                        ...
                        <div class=" form-group">
                            <label class="control-label col-md-5 needed" >A&ntilde;o.</label>
                    ...
                    <div class="form-group">                                                                
                        <label class="control-label col-md-4" >Rango de fecha</label>
                    ...
                    <div class="form-group"> 
                        <label class="control-label col-md-4 needed">Estatus Solicitud</label>
                        <div class="col-md-3">
                            <div id="divCmbRelaciones" class="logobox"></div>
                            <select class="form-control Relacionado" name="cmbEstatusSolicitudes" id="cmbEstatusSolicitudes">
                                <option value="">Seleccione una opci&oacute;n</option>
                            </select>
                        </div> 
                    </div>

                    <!--                    <div class="form-group" id="divTerminaciones"  > 
                                            <label class="control-label col-md-4">Terminaci&oacute;n</label>
                                            <input type="checkbox" class="col-md-1" id="checkTerminaciones" >
                                            <div id="divCmbTerminaciones" class="logobox col-md-3" style="display:none">
                                                <select class="form-control Relacionado" name="cmbTerminaciones" id="cmbTerminaciones">
                                                    <option value="">Seleccione una opci&oacute;n</option>
                                                </select>
                                            </div>
                                        </div>-->
                    ...
                    <div class="form-group" id="divCaracteristicasEjecucion" style="display:none" > 
                        ...
                        <div class="col-md-5">
                            <div id="divCmbComision" class="logobox col-md-5" style="display:none">
                                <label class="control-label">Forma de comisi&oacute;n</label>
            ...
            <div class="form-group">
                <div class="col-md-offset-3 col-md-9">
                    <div class="col-md-2 botonesAdaptar">
                        <input type="submit" class="btn btn-primary btn-adaptar" id="inputConsultar" value="Buscar" onclick="consultarSolicitudes(true, 1);" style="display: none"> 
                    </div>
                    <div class="col-md-2 botonesAdaptar">
    ...
    <script type="text/javascript">
        ...
        filtro = function () {
            ...
            //            }
            //        if ($("#cmbEstatusSolicitudes").val() != "") {
            strDatos += "&cveEstatusSolicitud=" + $("#cmbEstatusSolicitudes").val();
            ...
            //            if ($("#checkTerminaciones").is(":checked")) {
            //                strDatos += "&checkTerminaciones=true";
            //            }
            ...
            //            }
            //            if ($("#cmbTerminaciones").val() != "") {
            //                strDatos += "&cveConclusion=" + $("#cmbTerminaciones").val();
            //            }
        ...
        paginacion = function (paginar) {
            consultarSolicitudes(paginar, $("#hiddenNivel").val());
        ...
        gestorConsulta = function (bandera, nivel, json, i) {
            ...
            consultarSolicitudes(bandera, nivel);
        };
        gestorNivel = function (json, bandera) {
            ...
            switch ($("#hiddenNivel").val()) {
                case "1":
                    table += "<th>Reporte</th><th>Estado</th>";
                    if ($("#checkConsumaciones").is(":checked")) {
                    ...
                    for (var i = 0; i < json.totalCount; i++) {
                        ...
                        //                        if ($("#checkTerminaciones").is(":checked")) {
                        //                            table += "<td>" + json.resultados[i].desTerminacion + "</td>";
                        //                        }
                        if ($("#checkDetenido").is(":checked")) {
                        ...
                        if (opcCheck.length != 0) {
                            subtotal += parseInt(json.resultados[i].totalCJ);
                ...
                case "2":
                    ...
                    if ($("#checkClasDelitos").is(":checked")) {
                        table += "<th>Clasificaci&oacuten Delitos Orden</th>";
                    }
                    if ($("#checkCarEjecu").is(":checked")) {
                        table += "<th>Comisi&oacute;n</th>";
                    }
                ...
                case "4":
                    ...
                    break;
                case "5":
                    table += "<th>N&uacute;m.</th><th>A&ntildeo</th><th>Numero de Investigaci&oacute;n</th>"
                    titulo2 += "<label>Estado: M\u00C9XICO </label><br>";
                    titulo2 += "<label>Regi\u00F3n: " + json.resultados[0].desRegion + "</label><br>";
                    titulo2 += "<label>Distrito: " + json.resultados[0].desDistrito + "</label><br>";
                    ...
                    table += "  <th>Tipo</th><th>Tipo Solicitud</th>";
                    table += "</tr></thead><tbody>";
        ...
        consultarSolicitudes = function (bandera, nivel) {

            //  $("#hiddenEstatusSolicitud").val($("#cmbEstatusSolicitudes").val());
            ...
            var strDatos = "accion=ConsultarSolicitudAudiencia_Reporte";
            ...
            $.ajax({
                type: "POST",
                url: "../fachadas/sigejupe/reportes/ReporteSolicitudesAudienciasFacade.Class.php",
                data: strDatos,
                async: true,
                dataType: "html",
        ...
        calcularPaginas = function () {
            ...
            $("#inputRegresar2").hide();
            var url = "../fachadas/sigejupe/reportes/ReporteSolicitudesAudienciasFacade.Class.php";
            var strDatos = "accion=ConsultarSolicitudAudiencia_Reporte";
            var cantReg = $("#cmbNumReg").val();
            ...
            $.ajax({
                ...
                success: function (datos) {
                    ...
                    if (json.Estatus == "ok") {
                        ...
                        $("#totalReg").text("Total: " + totalRegistros.toLocaleString('en-US'));
        ...
        encabezado = function () {
            ...
            $("#h5titulo").html("<span style='text-decoration: underline; cursor:pointer;' onclick='regresar(0,false);'>Reporte de Solicitudes</span>" + mensaje);
        };
        regresar = function (nivel, bandera) {
            ...
            var strDatos = "";
            if (nivel == 0) {
                $("#h5titulo").html("Reporte de Solicitudes");
                $("#divConsulta").hide();
                $("#paginacion").hide();
                $("#inputImprimir").hide();
            } else {
            ...
            if (nivel > 0) {
                consultarSolicitudes(true, nivel);
            }
        };
        ...
        cargarEstatusSolicitud = function () {
            var strDatos = "accion=consultar";
            strDatos += "&activo=S";
            $.ajax({
                type: "POST",
                url: "../fachadas/sigejupe/estatussolicitudes/EstatussolicitudesFacade.Class.php",
                data: strDatos,
                async: true,
                dataType: "html",
                beforeSend: function (objeto) {
                ...
                success: function (datos) {
                    ...
                    if (json.totalCount > 0) {
                        ...
                        for (var i = 0; i < json.totalCount; i++) {
                            ...
                            $("#cmbEstatusSolicitudes").append($('<option id="cmbEstatus' + json.data[i].cveEstatusSolicitud + '"></option>').val(json.data[i].cveEstatusSolicitud).html(json.data[i].desEstatusSolicitud));
                        }
                    }
                },
                error: function (objeto, quepaso, otroobj) {
        ...
        cargarConsumaciones = function () {
            ...
            $.ajax({
                ...
                success: function (datos) {
                    ...
                    if (json.totalCount > 0) {
                        for (var i = 0; i < json.totalCount; i++) {
                            $("#cmbConsumaciones").append($('<option id="cmbConsumacion' + json.data[i].cveEstatusSolicitud + '"></option>').val(json.data[i].cveConsumacion).html(json.data[i].desConsumacion));
                        }
                    }
                },
                error: function (objeto, quepaso, otroobj) {
        ...
        cargarTerminaciones = function () {
            var strDatos = "accion=consultar";
            strDatos += "&activo=S";
            $.ajax({
                type: "POST",
                url: "../fachadas/sigejupe/terminaciones/TerminacionesFacade.Class.php",
                data: strDatos,
                async: true,
                dataType: "html",
                beforeSend: function (objeto) {
                ...
                success: function (datos) {
                    ...
                    if (json.totalCount > 0) {
                        for (var i = 0; i < json.totalCount; i++) {
                            $("#cmbTerminaciones").append($('<option id="cmbTerminaciones' + json.data[i].cveTerminacion + '"></option>').val(json.data[i].cveTerminacion).html(json.data[i].desTerminacion));
                        }
                    }
                },
                error: function (objeto, quepaso, otroobj) {
        ...
        $(function () {
            ...
            //        $("#cmbEstatusSolicitudes").change(function () {
            //            opcCheck = [];
            //            limpiarTabla();
            //            if ($("#checkDetenido").is(":checked")) {
            //                $("#checkDetenido").removeAttr("checked");
            ...
            ////            }
            //
            //            if ($("#cmbEstatusSolicitudes").val() == 2) {
            //                esconderConsumaciones();
            //                opcCheck = [];
            //                $("#divConsumacion").show();
            ...
            //            } else if ($("#cmbEstatusSolicitudes").val() == 1) {
            //                esconderConsumaciones();
            //                opcCheck = [];
            ////                $("#divConclusiones").hide();
            //                $("#divCheckDetenido").hide();
            ...
            $("#checkConsumaciones").click(function () {
                if ($("#checkConsumaciones").is(":checked")) {
                    ...
                    if ($("#checkTerminaciones").is(":checked")) {
                        opcCheck.pop();
                        $("#divCmbTerminaciones").hide();
                        $("#cmbTerminaciones").val("");
                        $("#checkTerminaciones").removeAttr("checked");
                    }
            ...
            $("#checkTerminaciones").click(function () {
                if ($("#checkTerminaciones").is(":checked")) {
                    if ($("#checkDetenido").is(":checked")) {
                        opcCheck.pop();
                        $("#checkDetenido").removeAttr("checked");
