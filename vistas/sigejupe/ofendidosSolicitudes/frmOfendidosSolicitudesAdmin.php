...
<script type="text/javascript">
    ...
    var permisos = obtenerPermisosFormulario("ADMON. JUZGADO", "ADMINISTRACION DE SOLICITUDES");
    ...
    cargarTablaDefensores = function (idofendido) {
        $.ajax({
            type: "POST",
            url: "../fachadas/sigejupe/defensoresofendidossolicitudes/DefensoresofendidossolicitudesadminFacade.Class.php",
            data: {accion: 'consultar', idOfendidoSolicitud: idofendido, activo: 'S'},
            dataType: "json",
            beforeSend: function () {
            },
