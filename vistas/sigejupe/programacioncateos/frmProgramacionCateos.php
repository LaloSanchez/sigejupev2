    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h5 class="panel-title">                                                            
                Modificaci&oacute;n de Disponibilidad de Jueces de Cateos                           
            </h5>
        </div>
        <div class="panel-body">
            ...
            <div id="divFormulario" class="form-horizontal">
                ...
                <form method="post" id="formProgramacionJuzgadores">
                    ...
                    <input type="hidden" id="hddIdProgramacionCateo" name="hddIdProgramacionCateo">
    ...
    //        } else 
                                ...
                                if ($("#mostrarCalendario").is(":checked")) {
                                    ...
                                    for (var n = 0; n < result.totalCount; n++) {
                                        ...
                                        events.push({
                                            ...
                                            url: result.data[n].idProgramacionCateo,
                                            color: 'green'
                                        });
                                    }
                                    ...
                                    var calendar = $("#contenidoReporte").fullCalendar({
                                        ...
                                        eventClick: function (event) {
                                            if (event) {
                                                seleccionarProgramacionCateo(event.url);
                                                return false;
                                            }
                                        },
                                        allDay: false
                                    ...
                                    html += '<table class="table" id="datosProgramacionCateos">';
                                    html += '<thead>';
                                    html += '<th>No</th>';
                                    ...
                                    for (var n = 0; n < result.totalCount; n++) {
                                        ...
                                        html += "<tr class='datosProgramacion' id='" + result.data[n].idProgramacionCateo + "' style='border: solid 1px #000;' >";
                                        if (result.data[n].Dia == "SABADO" || result.data[n].Dia == "DOMINGO") {
                                            html += "<td style='border: solid 1px #000; background-color: #ddd !important;' onClick='seleccionarProgramacionCateo(" + result.data[n].idProgramacionCateo + ")'>" + c + "</td>";
                                            html += "<td style='border: solid 1px #000; background-color: #ddd !important;' onClick='seleccionarProgramacionCateo(" + result.data[n].idProgramacionCateo + ")'>" + result.data[n].Dia + "</td>";
                                            html += "<td style='border: solid 1px #000; background-color: #ddd !important;' onClick='seleccionarProgramacionCateo(" + result.data[n].idProgramacionCateo + ")'><b>" + formatoFecha(fechaHoraInicio[0]) + "</b>&nbsp;&nbsp;&nbsp;" + fechaHoraInicio[1] + "&nbsp;&nbsp;-&nbsp;&nbsp;<b>" + formatoFecha(fechaHoraTermino[0]) + "</b>&nbsp;&nbsp;&nbsp;" + fechaHoraTermino[1] + "</td>";
                                            html += "<td style='border: solid 1px #000; background-color: #ddd !important;' onClick='seleccionarProgramacionCateo(" + result.data[n].idProgramacionCateo + ")'>" + result.data[n].Nombre + '</td>';
                                            html += "<td style='border: solid 1px #000; background-color: #ddd !important;'><input type='checkbox' onClick='registrosEliminarCateo()' class='eliminarCateo' value='" + result.data[n].idProgramacionCateo + "'></td>";
                                        } else {
                                            html += "<td style='border: solid 1px #000;' onClick='seleccionarProgramacionCateo(" + result.data[n].idProgramacionCateo + ")'>" + c + "</td>";
                                            html += "<td style='border: solid 1px #000;' onClick='seleccionarProgramacionCateo(" + result.data[n].idProgramacionCateo + ")'>" + result.data[n].Dia + "</td>";
                                            html += "<td style='border: solid 1px #000;' onClick='seleccionarProgramacionCateo(" + result.data[n].idProgramacionCateo + ")'><b>" + formatoFecha(fechaHoraInicio[0]) + "</b>&nbsp;&nbsp;&nbsp;" + fechaHoraInicio[1] + "&nbsp;&nbsp;-&nbsp;&nbsp;<b>" + formatoFecha(fechaHoraTermino[0]) + "</b>&nbsp;&nbsp;&nbsp;" + fechaHoraTermino[1] + "</td>";
                                            html += "<td style='border: solid 1px #000;' onClick='seleccionarProgramacionCateo(" + result.data[n].idProgramacionCateo + ")'>" + result.data[n].Nombre + '</td>';
                                            html += "<td style='border: solid 1px #000;'><input type='checkbox' onClick='registrosEliminarCateo()' class='eliminarCateo' value='" + result.data[n].idProgramacionCateo + "'></td>";
                                        }
                                        html += "</tr>";
                                    }
                                    /*html += '<th>FECHA</th>';
                                     ...
                                     html += "<tr class='datosProgramacion' style='border: solid 1px #000;' onClick='seleccionarProgramacionCateo(" + result.data[i].idProgramacionCateo + ")'>";
        ...
        function seleccionaTodo() {
            if ($("#seleccionaTodo").is(":checked")) {
                $('.eliminarCateo').prop("checked", true);
            } else {
                $('.eliminarCateo').prop("checked", false);
            }
            registrosEliminarCateo();
        }

        //$(document).on('click', '.eliminarCateo', function(){
        function registrosEliminarCateo() {
            var registros = new Array();
            var idCateos = new Array();
            $('#datosProgramacionCateos tr').each(function () {
                if ($(this).find('.eliminarCateo').is(':checked')) {
                    idCateos = {
                        idProgramacionCateo: $(this).find('.eliminarCateo').val()
                    };
            ...
            var idCateosJson = JSON.stringify(registros);
            idCateosJson = decodeURIComponent(idCateosJson);
            $("#hddIdProgramacionCateo").val("");
            if (parseInt(registros.length) > 0) {
                $("#hddIdProgramacionCateo").val(idCateosJson);
            }
        }
        //});

        function seleccionarProgramacionCateo(obj) {

            $.ajax({
                type: "POST",
                url: "../fachadas/sigejupe/programacioncateos/ProgramacioncateosFacade.Class.php",
                data: {idProgramacionCateo: obj, accion: 'seleccionar'},
                async: true,
                dataType: "json",
                beforeSend: function (objeto) {
                    ToggleLoading(1);
                ...
                success: function (datos) {
                    try {
                        if (datos.totalCount > 0) {
                            ...
                            $("#idProgramacionCateo").val(datos.data[0].idProgramacionCateo);
                            $("#cveJuzgado option").filter('[data-grupojuzgado="' + datos.data[0].cveGrupoJuzgado + '"]').prop("selected", true);
                            ...
                            $("#" + datos.data[0].idProgramacionCateo).addClass("success");
        ...
        function guardar() {
            if (validar()) {
                ...
                $.ajax({
                    ...
                    url: "../fachadas/sigejupe/programacioncateos/ProgramacioncateosFacade.Class.php",
                    data: {
                        idProgramacionCateo: $("#idProgramacionCateo").val(),
                        idJuzgador: $("#idJuzgador").val(),
                        cveGrupoJuzgado: $("#cveJuzgado option:selected").data("grupojuzgado"),
                            ...
                            if ($("#hddIdProgramacionCateo").val() != "") {
                                $.ajax({
                                    ...
                                    data: {
                                        ...
                                        activo: 'N',
                                        idProgramacionesCateos: $("#hddIdProgramacionCateo").val()
                                    },
                                    async: true,
                                    dataType: "json",
                                    beforeSend: function (objeto) {
