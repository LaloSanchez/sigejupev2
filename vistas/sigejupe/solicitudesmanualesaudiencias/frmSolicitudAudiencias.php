...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
        ...
        <div class="panel-body">
            ...
            <div id="divFormulario" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-9">
                        <input type="text" maxlength="4" id="txtNumero" class="form-inline" id="txtNumero"
                               placeholder="N&uacute;mero">/<input type="text" maxlength="4" class="form-inline"
                               id="txtAnio" id="txtAnio"
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-6">
                        <input type="text" class="form-control mayuscula" id="txtCarpetaInvestigacion"
                               placeholder="Carpeta de Investigaci&oacute;n">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-xs-3">NUC (N&uacute;mero &uacute;nico de causa)</label>
                    <div class="col-xs-6">
                        <input type="text" class="form-control mayuscula " id="txtNumeroUnicoCausa" placeholder="NUC">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-xs-3">N&uacute;mero de Imputados <span class="requerido">(*)</span>
                    </label>
                    <div class="col-xs-6">
                        <input type="text" class="form-control" id="txtNumeroImputados"
                               placeholder="N&uacute;mero de Imputados" onchange="validaConsignacion();" maxlength="3">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-xs-3">N&uacute;mero de Ofendidos <span
                            class="requerido">(*)</span></label>
                    <div class="col-xs-6">
                        <input type="text" class="form-control" id="txtNumeroOfendidos"
                               placeholder="N&uacute;mero de Ofendidos" maxlength="3">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-xs-3">N&uacute;mero de Delitos <span
                            class="requerido">(*)</span></label>
                    <div class="col-xs-6">
            ...
            <div id="divConsulta" class="form-horizontal" style="display: none">
                ...
                <div class="form-group">
                    <label class="control-label col-xs-3">N&uacute;mero</label>
                    <div class="col-xs-9">
                        <input type="text" maxlength="4" id="txtNumeroConsulta" class="form-inline" id="txtNumeroConsulta"
                               placeholder="N&uacute;mero">/<input maxlength="4" type="text" class="form-inline"
                               id="txtAnioConsulta"
                               name="txtAnioConsulta" placeholder="A&ntilde;o">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-xs-3">Carpeta de Investigaci&oacute;n</label>
    ...
    //                            dropdownFilter: "Todas",
        ...
        selectStepOne = function (pagAux = 0) {
        var error = false;
