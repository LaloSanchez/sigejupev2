            ...
            <div class="col-lg-12">
                ...
                <form id="guardar-solicitud-audiencia">
                    ...
                    <div id="no_tribunal_por_ejercicio">
                        <div class="form-group">
                            <label for="juez1">Juez Presidente</label>
                        ...
                        <div class="form-group">
                            <label for="juez2">Juez Secretario</label>
                        ...
                        <div class="form-group">
                            <label for="juez3">Juez Vocal</label>
                            <select name="juez3" id="juez3" class="form-control">
                                <option value="0">Selecciona un juez</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <button class="btn btn-primary">Asignar audiencia a la solicitud</button>
    ...
    <script>
        ...
        $(function () {
            ...
            $("#btnAcuse").on('click', function (e) {
                ...
                window.open("../fachadas/sigejupe/resumensolicitudaudiencia/ResumensolicitudaudienciaFacade.php?idSolicitud=" + idSolicitud + "&accion=consultaAcuseAuto&toca=S&leyendajuez=Juez", 'Reporte', '"scrollbars=1,width=800, height=1000');
            });
