...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4>Solicitudes de audiencia manuales</h4>
        </div>
                    ...
                    <div class="steps">
                        <ul>
                            ...
                            <li id="liPaso3" class="step step-3 Paso3">
                                <a href="#" onclick="siguientePaso(3);"><strong>Paso 3</strong><br>
                                    <label class="subtitulo">
                                        Captura de sujeto(s) pasivo(s) del delito
                                    </label>
                                </a>
                            </li>
                            <li id="liPaso4" class="step step-4 Paso4">
                                <a href="#" onclick="siguientePaso(4);"><strong>Paso 4</strong><br><label class="subtitulo">Captura
                                        de delito(s)</label></a>
                            </li>
                            <li id="liPaso5" class="step step-5 Paso5">
                                <a href="#" onclick="siguientePaso(5);"><strong>Paso 5</strong><br><label class="subtitulo">Definici&oacute;n
                                        de relaci&oacute;n</label></a>
                            </li>
                            <li id="liPaso6" class="step step-6 Paso6">
                                <a href="#" onclick="siguientePaso(6);"><strong>Paso 6</strong><br><label class="subtitulo">Violencia
                            ...
                            <li id="liPaso8" class="step step-8 Paso8">
                                <a href="#" onclick="siguientePaso(8);"><strong>Paso 8</strong><br>
                                    <label class="subtitulo">Asignaci&oacute;n de Audiencia</label>
                                </a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="col-xs-12" style="border: solid 3px #881518; width: 98%">
                ...
                <form name="frmSolicitud" class="form-horizontal" id="frmSolicitud" method="POST" action="#" target="oculto"
                    ...
                    <div id="btnPaso7" style="display:none;">
                        ...
                        <button class="btn btn-primary" onclick="siguientePaso(8)"> Siguiente ></button>
                    </div>
                    <br>
                </form>
    ...
    <script type="text/javascript">
        ...
        siguientePaso = function (paso) {
            if (paso == 1) {
                siguiente('divGeneral', 'sigejupe/solicitudesmanualesaudiencias/frmSolicitudAudiencias.php', 1);
                ...
                if (!validaPasoUno()) {
                    ...
                    $('#liPaso7').find("a").removeClass("active");
                    $('#liPaso8').find("a").removeClass("active");
                    siguiente('divGeneral', 'sigejupe/imputadosSolicitudes/frmImputadosSolicitudes.php', 2);
                    $('#divDatosAudiencias').hide('');
                    $('#btnPaso2').show();
                    $('#btnPaso1').hide();
                    $('#btnPaso3').hide();
                ...
                if (!validaPasoUno() && !validaPasoDos()) {
                    ...
                    $('#liPaso7').find("a").removeClass("active");
                    $('#liPaso8').find("a").removeClass("active");
                    siguiente('divGeneral', 'sigejupe/ofendidosSolicitudes/frmOfendidosSolicitudes.php', 3);
                    $('#divDatosAudiencias').hide('');
                    $('#btnPaso3').show();
                    $('#btnPaso2').hide();
                    $('#btnPaso1').hide();
                ...
                if (!validaPasoUno() && !validaPasoDos() && !validaPasoTres()) {
                    ...
                    $('#liPaso7').find("a").removeClass("active");
                    $('#liPaso8').find("a").removeClass("active");
                    siguiente('divGeneral', 'sigejupe/delitosSolicitudes/frmDelitos.php', 4);
                    $('#divDatosAudiencias').hide('');
                    $('#btnPaso4').show();
                    $('#btnPaso2').hide();
                    $('#btnPaso1').hide();
                ...
                if (!validaPasoUno() && !validaPasoDos() && !validaPasoTres() && !validaPasoCuatro()) {
                    ...
                    $('#liPaso7').find("a").removeClass("active");
                    $('#liPaso8').find("a").removeClass("active");
                    siguiente('divGeneral', 'sigejupe/impofedelsolicitudes/frmImpofedelsolicitudes.php', 5);
                    $('#divDatosAudiencias').hide('');
                    $('#btnPaso5').show();
                    $('#btnPaso2').hide();
                    $('#btnPaso1').hide();
    ...
    //            if (!validaPasoUno() && !validaPasoDos() && !validaPasoTres() && !validaPasoCuatro() && !validaPasoCinco()) {
                    ...
                    $('#liPaso7').find("a").removeClass("active");
                    $('#liPaso8').find("a").removeClass("active");
                    siguiente('divGeneral', 'sigejupe/victimas/frmVictimaSolicitud.php', 6);
                    $('#divDatosAudiencias').hide('');
                    $('#btnPaso6').show();
                    $('#btnPaso2').hide();
                    $('#btnPaso1').hide();
                ...
                if (!validaPasoUno() && !validaPasoDos() && !validaPasoTres() && !validaPasoCuatro() && !validaPasoCinco()) {
                    ...
                    $('#liPaso6').find("a").removeClass("active");
                    $('#liPaso8').find("a").removeClass("active");
                    siguiente('divGeneral', 'sigejupe/resumensolicitudaudiencia/frmResumensolicitudaudiencia.php', 7);
                    $('#btnPaso7').show();
                    $('#btnPaso2').hide();
                    $('#btnPaso1').hide();
                    $('#btnPaso3').hide();
                ...
                if (!validaPasoUno() && !validaPasoDos() && !validaPasoTres() && !validaPasoCuatro() && !validaPasoCinco()) {
                    ...
                    $('#liPaso6').find("a").removeClass("active");
                    $('#liPaso7').find("a").removeClass("active");
                    siguiente('divGeneral', 'sigejupe/solicitudesmanualesaudiencias/frmAsignaraudienciamanual.php', 8);
                    $('#btnPaso8').show();
                    $('#btnPaso1').hide();
                    $('#btnPaso2').hide();
                    $('#btnPaso3').hide();
