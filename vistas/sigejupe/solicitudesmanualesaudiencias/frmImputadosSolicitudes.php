                ...
                <div class="tabbable tabs-left">
                    <ul id="myTab3" class="nav nav-tabs">
                        <li class="tab-sky active">
                            <a href="#divGeneralImputado" data-toggle="tab" aria-expanded="true">General</a>
                        </li>
                        <li class="tab-sky ">
                        ...
                        <li class="tab-sky ">
                            <a href="#divDefendores" data-toggle="tab" aria-expanded="false">Defensor </a>
                        </li>
                        <li class="tab-sky ">
                        ...
                        <li class="tab-sky ">
                            <a href="#divNacionalidades" data-toggle="tab" aria-expanded="false"> Nacionalidades</a>
                        </li>
                    </ul>
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="divGeneralImputado">
                            ...
                            <div id="divPersonaFisicaImputado">
                                ...
                                <div class="col-lg-3" id="divFechaNacimientoImputado">
                                    <label class="control-label" for="txtFechaNacimientoImputado">Fecha Nacimiento (dd/mm/aaaa) <span class="requerido">(*)</span></label>
                                    <div>
                                ...
                                <div class="col-lg-3" id="divEdadImputado">
                                    <label class="control-label" for="txtEdadImputado">Edad <span class="requerido">(*)</span></label>
                                    <div>
                                ...
                                <div class="col-lg-3" id="divDielectoIndigenaImputado">
                                    <label class="control-label" for="cmbDielectoIndigenaImputado">&#191;Habla dialecto Indigena? <span class="requerido">(*)</span></label>
                                    <div>
                                ...
                                <div class="col-lg-3" id="divPsicofisicoImputado">
                                    <label class="control-label" for="cmbPsicofisicoImputado"> Estado psicofisico en el momento de la detenci&oacute;n <span class="requerido">(*)</span></label>
                                    <div>
                                ...
                                <!--                                <div class="col-lg-3" id="divFecTermCons">
                                                                    <label class="control-label" for="txtFecTermCons">Fecha T&eacute;rmino Cons</label>
                                                                    <div>
                                                                        <input type="text" class="form-control mayuscula" id="txtFecTermCons" name="txtFecTermCons">
                                                                    </div>
                                                                </div>-->
                                <!--                                <div class="col-lg-3" id="divFecTermInv">
                                                                    <label class="control-label" for="txtFecTermCons">Fecha cierrer Inv</label>
                                                                    <div>
                                ...
                                <div class="col-lg-3" id="divRelacionPersonaMoralImputado">
                                    <label class="control-label" for="chkRelacionPersonaMoralImputado">&#191;Tiene relaci&oacute;n con persona moral?</label>
                                    <div>
                                ...
                                <div class="col-lg-3" id="divingresoMensual">
                                    <label class="control-label" for="txtingresoMensual">Ingreso Menusal <span class="requerido">(*)</span></label>
                                    <div>
                                ...
                                <div id="divDetenido" class="col-lg-12">
                                    ...
                                    <div class="col-lg-3" id="divFechaControlDet">
                                        <label class="control-label" for="txtFechaControlDet">Fecha Detenci&oacute;n (dd/mm/aaaa)</label>
                                        <div>
                                    ...
                                    <div class="col-lg-3" id="divbTipoDetencion">
                                        <label class="control-label" for="cmbTipoDetencion">Tipo Detenci&oacute;n</label>
                                        <div>
                                    ...
                                    <div class="col-lg-3" id="divReincidencias">
                                        <label class="control-label" for="cmbReincidencias">Tipo de reincidencia</label>
                                        <div>
                                    ...
                                    <div class="col-lg-3" id="divTipoDetencion">
                                        <label class="control-label" for="cmbTipoDetencion">Cereso</label>
                                        <div>
                        ...
                        <div class="tab-pane" id="divDomicilios">
                            ...
                            <div class="col-lg-2">
                                <label class="control-label" for="cmbTipoViviendaImputado"> Tipo vivienda <span class="requerido">(*)</span></label>
                                <div>
                        ...
                        <div class="tab-pane" id="divTelefonos">
                            <div class="col-lg-4">
                                <label class="control-label" for="">Tel&eacute;fono <span class="requerido">(*)</span></label>
                                <div>
                        ...
                        <div class="tab-pane" id="divDefendores">
                            <div class="col-lg-4">
                                ...
                                <div>
                                    <select id="cmbTipoDefensorImputado" class="form-control mayuscula" name="cmbTipoDefensorImputado">
                                        <option value="0">Seleccione una opcion</option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="divTutores">
                            ...
                            <div class="col-lg-4">
                                <label class="control-label" for="fechaNacimientoTutorImputados">Fecha de nacimiento (dd/mm/aaaa)<span class="requerido">(*)</span></label>
                                <div>
                            ...
                            <div class="col-lg-4">
                                <label class="control-label" for="txtEdadTutorImputado">Edad <span class="requerido">(*)</span></label>
                                <div>
...
//            $('#txtFechaImputacion').val('');
    ...
    fechaNacimiento = function (curp) {
        ...
        $("#txtFechaNacimientoImputado").datepicker('setValue', fecha).datepicker('update');
...
//            }
            ...
            if ($('#txtingresoMensual').val() == "" || $('#txtingresoMensual').val() == "0") {
...
//                        fecTerminoCons: $("#txtFecTermInv").val(),
//                        fecCierreInv: $("#txtFecTermCons").val(),
...
//                        ////ToggleLoading(2);
                        ...
                        if (datos.status == 'Ok') {
                            ...
                            $("#divAlertInfoImputado").html("");
                            $("#divAlertInfoImputado").html(datos.msj);
                            $("#divAlertInfoImputado").show("");
                            setTimeAlert("divAlertInfoImputado");
                        }
                    },
                    error: function (objeto, quepaso, otroobj) {
    ...
    agregaDomicilioImputado = function () {
        if ($("#hddIdImputadoSolicutd").val() != "") {
            ...
            if (validateDomiclioStep2()) {
                ...
                $.ajax({
                    type: "POST",
                    url: "../fachadas/sigejupe/domiciliosimputadossolicitudes/DomiciliosimputadossolicitudesFacade.Class.php",
                    async: false,
                    dataType: "json",
                    data: {accion: "guardar",
    ...
    agregaTelImputado = function () {
        if ($("#hddIdImputadoSolicutd").val() != "") {
            ...
            if (validateTelStep2()) {
                $.ajax({
                    type: "POST",
                    url: "../fachadas/sigejupe/telefonosimputadossolicitudes/TelefonosimputadossolicitudesFacade.Class.php",
                    async: false,
                    dataType: "json",
                    data: {accion: "guardar",
    ...
    agregaDefensorImputado = function () {
        if ($("#hddIdImputadoSolicutd").val() != "") {
            ...
            if (validateDefensorStep2()) {
                $.ajax({
                    type: "POST",
                    url: "../fachadas/sigejupe/defensoresimputadossolicitudes/DefensoresimputadossolicitudesFacade.Class.php",
                    async: false,
                    dataType: "json",
                    data: {accion: "guardar",
    ...
    agregarDrogas = function () {
        if ($("#hddIdImputadoSolicutd").val() != "") {
            ...
            if (validateDrogasStep2()) {
                $.ajax({
                    type: "POST",
                    url: "../fachadas/sigejupe/imputadosdrogas/ImputadosdrogasFacade.Class.php",
                    async: false,
                    dataType: "json",
                    data: {accion: "guardar",
    ...
    agregaTutoresImputados = function () {
        if ($("#hddIdImputadoSolicutd").val() != "") {
            ...
            if (validateTutorStep2()) {
                ...
                $.ajax({
                    type: "POST",
                    url: "../fachadas/sigejupe/tutoresimputados/TutoresimputadosFacade.Class.php",
                    async: false,
                    dataType: "json",
                    data: {accion: "guardar",
    ...
    agregarNacionalidad = function () {
        if ($("#hddIdImputadoSolicutd").val() != "") {
            ...
            if (validateNacionalidadStep2()) {
                $.ajax({
                    type: "POST",
                    url: "../fachadas/sigejupe/nacionalidadesimputadossolicitudes/NacionalidadesimputadossolicitudesFacade.Class.php",
                    async: false,
                    dataType: "json",
                    data: {accion: "guardar",
            ...
            success: function (datos) {
                ...
                if (datos.status == 'Ok') {
                    ...
                    for (var i = 0; i < datos.totalCount; i++) {
                        table += '<tr class="trSeleccion" ><td id="' + datos.data[i].idImputadoSolicitud + '" style="cursor:pointer;" onclick="seleccionaImputado(' + datos.data[i].idImputadoSolicitud + ')" >' + datos.data[i].desTipoPersona + "</td>";
        ...
        $.ajax({
            ...
            success: function (datos) {
                ...
                if (datos.status == 'Ok') {
                    ...
                    for (var i = 0; i < datos.totalCount; i++) {
                        table += '<tr class="trSeleccion" id="' + datos.data[i].idDomicilioImputadoSolicitud + '"><td onclick="seleccionaDireccion(' + datos.data[i].idDomicilioImputadoSolicitud + ')">' + datos.data[i].desPais + '</td>';
...
//                    $("#divGeneralImputado").addClass("tab-pane active");
                    ...
                    if (datos.data[0].cveTipoPersona == 1) {
                        ...
                        $("#cmbReincidencias").val(datos.data[0].cveEstadoPsicofisico);
//                        $("#txtFechaImputacion").val(datos.data[0].fechaImputacion);
...
//                        $("#txtFecTermInv").val(datos.data[0].fecCierreInv);
//                        $("#txtFecTermCons").val(datos.data[0].fecTerminoCons);
...
//                //ToggleLoading(2);
    ...
    eliminaImputado = function (id) {
        if ($("#hddIdSolicitudAudiencia").val() != "") {
            if (confirm('\u00bf Desea eliminar al imputado?')) {
    ...
    eliminarTelefono = function (id) {
        if ($("#hddIdImputadoSolicutd").val() != "") {
            if (confirm('\u00bf Desea eliminar el telefono?')) {
                $.ajax({
                    type: "POST",
                    url: "../fachadas/sigejupe/telefonosimputadossolicitudes/TelefonosimputadossolicitudesFacade.Class.php",
                    async: false,
    ...
    eliminarDefensor = function (id) {
        if ($("#hddIdImputadoSolicutd").val() != "") {
            if (confirm('\u00bf Desea eliminar el defensor?')) {
                $.ajax({
                    type: "POST",
                    url: "../fachadas/sigejupe/defensoresimputadossolicitudes/DefensoresimputadossolicitudesFacade.Class.php",
                    async: false,
    ...
    eliminarDroga = function (id) {
        if ($("#hddIdImputadoSolicutd").val() != "") {
            if (confirm('\u00bf Desea eliminar la droga?')) {
                $.ajax({
                    type: "POST",
                    url: "../fachadas/sigejupe/imputadosdrogas/ImputadosdrogasFacade.Class.php",
                    async: false,
    ...
    limpiarImputado = function () {
        ...
        $("#txAliasImputado").val("");
        $("#txtFechaDeclaracion").val("");
        $("#cmbPaisNacimientoImputado").val(0);
...
//        $("#txtFechaImputacion").val("");
        ...
        $("#cmbFamiliaLinguistica").val(0);
//        $("#txtFecTermInv").val("");
//        $("#txtFecTermCons").val("");
        $("#cmbGrupoEdnico").val(0);
        $('#divPersonaMoralImputado').hide();
        validaDetenido();
        muestraOcultaCampos(2);
        $("#btnAgregarImputado").text("Agregar Imputado");
    ...
    limpiarDomicilios = function () {
        ...
        $("#cmbPaisDomicilioImputado").val(0);
        $("#cmbEstadoDomicilioImputado").val(0);
...
//        $("#hddIdImputadoSolicutd").val("");
    ...
    limpiarNacionalidad = function () {
        ...
        $("#cmbPaisNacionalidadImputado").val(0);
        $("#bntAgregaNacionalidad").text("Agregar Nacionalidad");
    }
    ubica = function () {
        $("#ubicacion").empty();
