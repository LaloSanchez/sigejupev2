...
//ini_set('error_reporting', E_ALL ^ E_NOTICE);
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading" id="regtop">
            <h5 class="panel-title" id="tituloregistro">                                                            
                Registro Promociones  de Termino
            </h5>
            <h5 class="panel-title" id="tituloactualizacion" style="display: none">                                                            
                Actualizar Promociones de Termino
            </h5>
        </div>
        <div class="panel-body">        
            ...
            <div id="divCamposConsulta" class="form-horizontal" style="display: none">
                <div class="form-group">
                    ...
                    <label class="control-label col-md-5 ">Consulta Promociones de Termino</label>
                </div>

                <div class="form-group col-md-12">                                                                
                    <label class="control-label col-md-3 ">Juzgado a consultar:</label>
                    <div class="col-md-6">
                        <div id="divCmbRelaciones" class="logobox"></div>
                        <select class="form-control Relacionado" name="cmbJuzgado" id="cmbJuzgado" onchange="cargaTipoCarpeta(2)">
                ...
                <div class="form-group">                                                                
                    ...
                    <div class="col-md-6">
                        <div id="divCmbRelaciones" class="logobox"></div>
                        <select class="form-control Relacionado2" name="cmbTipoCarpeta2" id="cmbTipoCarpeta2" onchange="changeLabel(this, 2)">
                            <option value="0">Seleccione una opcion</option>
                        </select>
                    </div>                                
                </div>
                <div class="form-group">                                                                
                    ...
                    <div id="divSinRelacion" class="col-md-9" style="">
                        <div class="col-md-3">
                            <input type="text"  class="form-inline Relacionado2 form-control" id="txtNumero2" placeholder="N&uacute;mero">
                        </div>
                        <div class="col-md-3">
                            <input type="text" class="form-inline Relacionado2 form-control" maxlength="4" id="txtAnio2"  placeholder="A&ntilde;o">
                        </div>  
                        <div id="divSinRelacionMsg2" class="col-md-3">
                ...
                <div class="form-group" style="clear: both; padding-top: .5%;">                                                                
                    ...
                    <div id="divSinRelacion" class="col-md-6">
                        <div class="col-md-3">
                            <input type="text" class="form-inline Relacionado2 form-control" id="txtNumActuacion" placeholder="N&uacute;mero Promoci&oacute;n">
                        </div>
                        <div class="col-md-3">
                            <input type="text" maxlength="4" class="form-inline Relacionado2 form-control" id="txtAniActuacion"  placeholder="A&ntilde;o Promoci&oacute;n">
                        </div>
                    </div>                                      
                </div>
                <div class="form-group">
                        ...
                        <div class="steps">
                            <ul>
                                ...
                                <li id="liPaso2" class="step step-2 Paso2">
                                    <a href="#" onclick="siguientePaso(2);"><strong>Paso 2</strong><br><label class="subtitulo">Imputados</label></a>
                                ...
                                <li id="liPaso3" class="step step-3 Paso3">
                                    <a href="#" onclick="siguientePaso(3);"><strong>Paso 3</strong><br><label class="subtitulo">Ofendidos</label></a>
                                </li>
                                <li id="liPaso4" class="step step-4 Paso4">
                                    <a href="#" onclick="siguientePaso(4);"><strong>Paso 4</strong><br><label class="subtitulo">Delitos</label></a>
                                </li>
                                <li id="liPaso5" class="step step-5 Paso5">
                                    <a href="#" onclick="siguientePaso(5);"><strong>Paso 5</strong><br><label class="subtitulo">Relaci&oacute;n</label></a>
                                </li>
                                <li id="liPaso6" class="step step-6 Paso6">
                                    <a href="#" onclick="siguientePaso(6);"><strong>Paso 6</strong><br><label class="subtitulo">Trata</label></a>
                                </li>
                            </ul>
                        </div>  
                    </div>
                    ...
                    <div id="divCampos">
                        <div id="refpromocion1">
                            ...
                            <div class="form-group">                                                                
                                <label class="control-label col-md-3" id="lblRelationName2">No.</label>
                                <div id="divSinRelacion" class="col-md-6">
                                    <input type="text"  class="form-inline Relacionado" id="txtNumero" placeholder="N&uacute;mero">/<input type="text" maxlength="4" class="form-inline Relacionado" onchange="validaAnio(this.value)" id="txtAnio"  placeholder="A&ntilde;o">
                                </div>                                
                            ...
                            <div class="form-group">                                                                
                                ...
                                <label class="control-label col-md-1">Sintesis <b style="color: darkred">(*)</b></label>
                            ...
                            <div class="form-group"> 
                                ...
                                <div class="col-md-1">
                                    ...
                                    <input maxlength="4" type="text" id="txtAniActuacion2" placeholder="" class="form-control" value="" />
    ...
    //                + $('#' + identificador).find('option:selected').text())) {
    //            $("#" + identificador).remove();
    //            limpiarPromovente();
    //        }
            bootbox.dialog({
                message: "\u00bf Desea eliminar al promovente?",
                buttons: {
                    danger: {
                        label: "Aceptar",
                ...
                success: function (datos) {
                    ...
                    if (json.totalCount > 0) {
                        ...
                        if (typeof grt !== "undefined") {
                            $("#cmbJuzgado").append($('<option></option>').val("0").html("seleccione una opcion"));
    ...
    //                        $("#cveTipoCarpetaPromo").append($('<option></option>').val(9).html("SIN RELACI&Oacute;N"));
        ...
        consultar = function (elementomostrar) {
            ...
            var permisos = obtenerPermisosFormulario("ATENCION PUBLICO", "PROMOCIONES TERMINO");
        ...
        validaconsulta = function () {
            ...
            if ($("#cmbJuzgado").val() == "0") {
                consultar = 0;
                $('#cmbJuzgado').parent().append("<br class='required'><label class='Arial13Rojo required'>Seleccione el tipo de Juzgado</label>");
            }
            return consultar;
        }
        buscarPromocion = function (pag) {
            ...
            var cveJuzgado = "";
            if ($("#cmbJuzgado").val() != 0) {
                cveJuzgado = $("#cmbJuzgado").val().split("/");
            ...
            if (consultar = 1) {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        accion: "consultarPromocion_Termino",
                    ...
                    success: function (data, textStatus, jqXHR) {
                        if (data.estatus == "ok") {
                            ...
                            $.each(data.datos, function (index, element) {
                                ...
                                table += "        <td style='cursor: pointer' onclick=\"buscarPromocionById('" + element.idActuacion + "')\" >" + element.descJuzgado + "</td>";
            ...
            $.ajax({
                ...
                success: function (data, textStatus, jqXHR) {
                    ...
                    if (data.estatus == "ok") {
                        ...
                        cargaJuzgados(actuacion[0].cveJuzgado);
    //                    $("#cveTipoJuzgado").val(actuacion[0].cveJuzgado);                    
    ...
    //        var s = document.selectedJuzgado.cveTipoJuzgado;
    //        var descJuzgado = s.options[s.selectedIndex].text;
    //        
    //   var params =  {
    ...
    //      Descripcion:"PROMOCIONES DE TERMINO",                     //descripción de lo que se va a digitalizar(promociones, acuerdos, exhortos, etc.)
    //      descJuzgado: descJuzgado,     //descripcion del juzgado al que pertenede la carpeta judicial o actuacion
    //      anio: $("#txtAniActuacion2").val(),                //año de la actuacion o carpeta judicial
    //      cveDocumento: "12"    //clave del documento que se va a digitalizar lo encuentrar la tabla tbltiposdocumentos
    //   }; 
    ...
    //        var observaciones = $("#txtNotas").val();
            ...
            if (intentoGuardar == 1) {
                ...
                if (cveTipoJuzgado == 0) {
                    guardar = 0;
                    $('#cveTipoJuzgado').parent().append("<br class='required'><label class='Arial13Rojo required'>Seleccione el tipo de Juzgado</label>");
                }
                if (numero === "" && cveTipoCarpeta != 0) {
                    guardar = 0;
    ...
    //            observaciones=observaciones.replace(pe, "");
            ...
            var totalRenglones = $("#ltsPromoventes tr").length;
    //        alert('totalrengolones='+totalRenglones);
            if (totalRenglones > 1) {
    //            alert('entre a renglones');
    ...
    //                alert('entre a json de promovenete y guardar ='+guardar);
            ...
            if (guardar == 1) {
                ...
                if (idActuacion > 0) {
                    ...
                    accion = "guardarActuacion_Promociontermino";
                }
    //            alert(accion);
                $.ajax({
                    type: "POST",
                ...
                $.ajax({
                    ...
                    success: function (data, textStatus, jqXHR) {
                        ...
                        if (data.estatus == "ok") {
                            ...
                            tabla += "<tr><td colspan='4'>&nbsp;</td></tr>";
                            tabla += "<tr><td align='right' style='width:30%; font-weight:bold;'>Tipo Juzgado:</td><td align='left' style='padding-left:5px;'>" + actuacion[0].descJuzgado + "</td></tr>";
    ...
    //            alert('error al obtener los juzgados');
        ...
        validaAnio = function (data) {
            ...
            if (data > anio) {
                alert("El Anio es MAYOR al Anio Actual");
    ...
    //                                        $.each(datos.data, function (index, element) {
    ////                                            validarFormulario();
    //                                            $("#divSinRelacionMsg2").append("<b>encontrado</b>");  
    //                                            $("#inputGuardar").attr('disabled', false);
    //                                            if (cveTipoCarpeta == 8) {
    //                                                $("#hiddenIdCarpetaJudicial").val(element.idAmparo);
    //                                            } else if (cveTipoCarpeta == 7) {
    ...
    //                                        });
    //                                    } else {
    //                                        $("#divSinRelacionMsg2").append("<b>Sin Antecedentes</b>");
    //                                        $("#hiddenIdCarpetaJudicial").val("");
    //                                        $("#inputGuardar").attr('disabled', true);                                        
    //                                    }
    //                                },
    ...
    //        cargaTipoCarpeta();        
            cargarTiposPersonas();
            cargarGeneros();
            var permisos = obtenerPermisosFormulario("ATENCION PUBLICO", "PROMOCIONES DE TERMINO");
            if (permisos.Update == "N") {
                $("#inputGuardar").hide();
            }
            if (permisos.Delete == "N") {
