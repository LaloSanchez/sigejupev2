...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
    $type = 1; //--> General
    $title = "Consulta de Solicitudes de Ordenes de Aprehensi&oacute;n Administrador Gral.";
    if (isset($_GET['tipoConsulta'])) {
        switch ($_GET['tipoConsulta']) {
            case "mp":
                $type = 2;
                $title = "Consulta de Solicitudes de Ordenes de Aprehensi&oacute;n M.P.";
                break;
            case "juzgador":
                $title = "Consulta de Solicitudes de Ordenes de Aprehensi&oacute;n Juez";
                $type = 3;
                break;
            case "adminJuzgado" :
                $title = "Consulta de Solicitudes de Ordenes de Aprehensi&oacute;n Administrador";
                $type = 4;
                break;
        }
    }
    ...
    <?php } else { ?>
                                con.seleccionaRegistro(<?php echo $idOrden; ?>, 1);
    <?php } ?>
                        });
