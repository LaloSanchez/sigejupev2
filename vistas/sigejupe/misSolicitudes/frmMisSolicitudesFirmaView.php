...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
    ...
    <!--<script type="text/javascript" src="/sigejupev2/vistas/chat/js/windowsevents.js"></script>-->
    <script>
    ...
    <div class="panel panel-default">
        ...
        <div>
            ...
            <input type="hidden" style="display:none" id="rutaDestino" value="C:\\archivosFirmados\\sigejupe\\cateos\\" name="rutaDestino" size="5" readonly/>
            <input type="hidden" style="display:none" id="idCateo" name="idCateo" value="" readonly/>
        </div>
            ...
            <div class="col-xs-12" style="border: solid 4px #881518;" >
                ...
                <form name="frmSolicitud" class="form-horizontal" id="frmSolicitud" method="POST" action="solicitudCateoController.php" target="oculto" enctype="multipart/form-data" onsubmit="return false;">            
                    ...
                    <div id="divPaso3" class='content' style='display:none;'>
                        <h3 class="text-center" >RESPUESTA DE SOLICITUD DE CATEO</h3>
                        <div class="col-xs-12" >
                                    ...
                                    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                        <div class="panel panel-default">
                                            ...
                                            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="form-group text-center" > 
                                                        <button onclick="javascript:mS.insertRowPersonas()" class="btn btn-primary addPerson" >Agregar + </button> 
                                                    ...
                                                    <table id="tblPersonasAprehenderse" class="table table-striped table-bordered">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th>Domicilio</th>
                                                                <th>G&eacute;nero</th>
                                                                <th class="text-center" ><button class="btn btn-danger" onclick="javascript:mS.deleteRow(this)">Eliminar</button></th>
                                                            </tr>
                                                        </thead>
                                                    </table>
                                                </div>
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                                <div class="panel-body">
                                                    <div class="form-group" >
                                                        <label for="txtNombreObjeto" class="control-label col-xs-2">Objeto: </label>
                                                        <div class="col-md-10 col-xs-12" >
                                                            <input type="text" placeholder="Objeto" class="form-control" id="txtNombreObjeto" name="txtNombreObjeto">
                                                        </div>
                                                    </div>
                                                    <div class="form-group" >
                                                        <label for="txtDomicioloObjeto" class="control-label col-xs-2">Domicilio:</label>
                                                        <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12" >
                                                            <input type="text" placeholder="Domicilio" class="form-control" id="txtDomicioloObjeto" name="txtDomicioloObjeto">
                                                        </div>
                                                    </div>
                                                    <div class="form-group text-center" >
                                                        <button onclick="javascript:mS.insertRowObjetos()" class="btn btn-primary addObjeto" >Agregar + </button>
                                                        <div class="editObjeto" style="display:inline" ></div>
                                                    </div>
                                                    <div class="table-responsive" >
                                                        <table id="tblObjetosAprehenderse" class="table table-bordered table-striped table-hover">
                                                            <thead>
                                                                <tr>
                                                                    <th>Objeto</th>
                                                                    <th>Domicilio</th>
                                                                    <th  class="text-center"><button onclick="javascript:mS.deleteRow(this)" class="btn btn-danger" >Eliminar</button></th>
                                                                </tr>
                                                            </thead>
                                                        </table>                                                       
                                                    </div>
                    ...
                    <div id="divPaso4" class='content' style='display:none;'>
                        <div id="divNotaNegado" class="col-xs-12" >
                            <h3 class="text-center" >Cateo Negado</h3>
                            <div class="form-group" >
                                <label class="col-xs-12" >La orden de cateo se niega para:</label>
                                <div class="col-xs-12" >
                                    <!--<textarea rows="10" class="form-control" cols="100" id="descCateoNegado"></textarea>-->
                    ...
                    <div id="divPaso6" class='content' style='display:none;'>
                        ...
                        <div class="col-xs-12" >
                            <div id="terminos" style="border: 4px solid rgb(30, 165, 132); font-size: 12px; padding: 20px;"></div>
                        </div>
                        ...
                        <div id="botonesTerminar">
                            ...
                            <div class="form-group text-center" >
                                ...
                                <button class="btn btn-primary" id="enviar" name="enviar" onclick="javascript:mS.validarPaso6()">Guardar - Pendiente Firma</button>
    ...
    <script src="sigejupe/misSolicitudes/missolicitudesFirma.js" ></script>
    <script src="sigejupe/solicitudesCateos/helpers.js?v=<?php echo date('His'); ?>" type="text/javascript"></script>
    <script>
