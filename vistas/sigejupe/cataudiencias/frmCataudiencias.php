...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
  ...
  <div class="panel panel-default">
     ...
     <div class="panel-body">
        <!--    NUEVO-->        
        <div id="nuevo" style="display:none" class="form-horizontal">
           <input type="submit" class="btn btn-primary" id="inputRegresar" value="Regresar" onclick="regresaraudiencia();">
           <input type="submit" class="btn btn-primary" id="inputRegresar2" value="Regresar" onclick="regresar();" style="display: none">
           <div class="form-group" id="claveregistro">
              <label class="control-label col-xs-3" id="lblRelationName">Clave:</label>
              <div class="col-xs-9">
                 <input type="text" id="cveCatAudiencia" class="form-inline" name="cveCatAudiencia" readonly="readonly" >
              </div>
           </div>
           <div class="form-group">
              <label class="control-label col-xs-3 needed" id="lblRelationName">Descripci&oacute;n.</label>
              <div class="col-xs-9">
                 <input type="text" id="desCatAudiencia" class="form-control" name="desCatAudiencia" placeholder="Descripci&oacute;n" maxlength="500" style="text-transform:uppercase; resize: none;">
              </div>
           </div>
           <div class="form-group">
              <label class="control-label col-xs-3 needed">Naturaleza</label>
              <div class="col-xs-9">
                 <div class="logobox"></div>
                 <select class="form-control" name="cveNaturaleza" id="cveNaturaleza">
                    <option value="0">Seleccione una opci&oacute;n</option>
                 </select>
              </div>
           </div>
           <div class="form-group">
              <label class="control-label col-xs-3 needed">Fase</label>
              <div class="col-xs-9">
                 <div class="logobox"></div>
                 <select class="form-control" name="cveEtapaProcesal" id="cveEtapaProcesal">
                    <option value="0">Seleccione una opci&oacute;n</option>
                 </select>
              </div>
           </div>
           <div class="form-group">
              <label class="control-label col-xs-3 needed">Tipo</label>
              <div class="col-xs-9">
                 <div class="logobox"></div>
                 <select class="form-control" name="cveTipoAudiencia" id="cveTipoAudiencia">
                    <option value="0">Seleccione una opci&oacute;n</option>
                 </select>
              </div>
           </div>
           <div class="form-group">
              <label class="control-label col-xs-3 needed">Genera Causa</label>
              <div class="col-xs-9">
                 <div class="logobox"></div>
  ...
  <!--         <div class="form-group">
              <label class="control-label col-xs-3 needed">Distrito:</label>
              <div class="col-xs-9">
                 <div class="logobox"></div>
                 <select class="form-control" name="cveDistrito" id="cveDistrito">
                    <option value="0">Seleccione una opci&oacute;n</option>
                 </select>
              </div>
           </div>-->
           <div class="form-group">
              <label class="control-label col-xs-3 needed">C&oacute;digo:</label>
              <div class="col-xs-9">
                 <div class="logobox"></div>
                 <select class="form-control" name="cveCodigo" id="cveCodigo">
                    <option value="0">Seleccione una opci&oacute;n</option>
                 </select>
              </div>
           </div>
           <div class="form-group">
              <label class="control-label col-xs-3 needed" id="lblRelationName">Audiencia Inicial</label>
              <div class="col-xs-9">
                 <select class="form-control" name="audienciaInicial" id="audienciaInicial">
                    <option value="0">Seleccione una opci&oacute;n</option>
                    <option value="N">NO</option>
                    <option value="S">SI</option>
                 </select> 
           ...
           <div class="form-group">
              <label class="control-label col-xs-3 needed" id="lblfinicio">Fecha Inicio de Vigencia</label>
              <div class="col-xs-9">
                 <input type="text" id="fechaInicia" class="input-sm datepicker" name="fechaInicia"  value="<?= date("d/m/Y") ?>" readonly data-date-format="dd/mm/yyyy">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;               
              </div>
           </div>

           <div class="form-group">
              <label class="control-label col-xs-3 needed" id="lblffinal">Fecha Fin de Vigencia:</label>
              <div class="col-xs-9">
                 <input type="text" id="fechaVigencia" class="input-sm datepicker" name="fechaVigencia"  value="<?= date("d/m/Y") ?>" readonly data-date-format="dd/mm/yyyy">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                 
              </div>
           </div>
          <div class="form-group" >
              <label class="control-label" id="lblffinal">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>           
              <div class="col-xs-9">
                  <label class="control-label" id="nota" style="display:none">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Nota: La consulta se realiza en base a la fecha de inicio de vigencia.</label>   
              </div>
           </div>
           <br>
           <br>
           ...
           <div class="form-group">
              <label class="control-label col-xs-3" id="lblRelationName"></label>
              <div class="col-xs-9">
                 <input type="submit" class="btn btn-primary text-center" id="inputLimpiar2" value="Limpiar" onclick="limpiar3();">
                 <input type="submit" class="btn btn-primary" id="inputBuscar" value="Buscar" onclick="consultarCeresosAds(2);" style="display: none">                                
                 <input type="submit" class="btn btn-primary text-center" id="inputGuardar" name="inputGuardar" value="Guardar" onclick="guardar();">
                 <input type="submit" class="btn btn-primary text-center" id="inputModificar" name="inputModificar" value="Modificar" onclick="modificar();">
                 <input type="submit" class="btn btn-primary text-center" id="inputEliminar" name="inputEliminar" value="Eliminar" onclick="eliminaraudiencia();">
                 <input type="submit" class="btn btn-primary text-center" id="inputLimpiar" name="inputLimpiar" value="Limpiar" onclick="limpiar2();" style="display: none">
           ...
           <div class="section">
              ...
              <input type="hidden" name="cadenadistrito" id="cadenadistrito"/><input type="hidden" name="modificacvedistrito" id="modificacvedistrito"/>
              <div class="panel panel-default" id="divdistrito">
                 <div class="panel-heading" role="tab" id="headingThree2">
                    <h4 class="panel-title">
                       <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree2" aria-expanded="true" aria-controls="collapseThree">
                       Distritos
                       </a>
                    </h4>
                 </div>
                 <div id="collapseThree2" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree2">
                    <div class="panel-body">
                      <div class="form-group">
                          <label class="control-label col-xs-3 needed">Distrito:</label>
                          <div class="col-xs-5">
                              <input type="text" id="eldistrito" class="input-sm" name="eldistrito" readonly="readonly">
                          </div>
                      </div>
                        
                      <div class="form-group">
                          <label class="control-label col-xs-3 needed">Fin de semana:</label>
                          
                              <div class="col-md-4">
                              <select class="form-control" name="finSemana" id="finSemana">
                                  <option value="0">Seleccione una opci&oacute;n</option>
                                  <option value="N">NO</option>
                                  <option value="S">SI</option>
                              </select>
                        ...
                        <div class="form-group">
                          <label class="control-label col-xs-3 needed">Activo:</label>
                          <div>
                             <div class="col-md-4">
                       ...
                       <div class="col-md-4" id="duracionmin">
                          <br>
                          <div class="panel-heading">
                             <h5 class="panel-title" id="h5titulo">                                                            
                                Duraci&oacute;n en Minutos
                             </h5>
                          </div>
                          <br>
                          <div class="form-group">
                             <label class="control-label col-xs-3" id="lblRelationName">M&iacute;nimo:<label style='color:darkred'>(*)</label></label>
                             <div class="col-xs-9">
                                <input type="text" id="minDuracion" class="input-sm" name="minDuracion" maxlength="3" onkeyup="calcula()">
                             </div>
                          </div>
                          <div class="form-group">
                             <label class="control-label col-xs-3" id="lblRelationName">M&aacute;ximo:<label style='color:darkred'>(*)</label></label>
                             <div class="col-xs-9">
                                <input type="text" id="maxDuracion" class="input-sm" name="maxDuracion" maxlength="3" onkeyup="calcula()">
                             </div>
                          </div>
                          <div class="form-group">
                             <label class="control-label col-xs-3" id="lblRelationName">Holgura:<label style='color:darkred'>(*)</label></label>
                             <div class="col-xs-9">
                                <input type="text" id="holgura" class="input-sm" name="holgura" maxlength="2" readonly="readonly">
                             </div>
                          </div>
                       </div>
                       <div class="col-md-4">                                
                       </div>
                       <div class="col-md-4" id="duracionhor">
                          <br>
                          <div class="panel-heading">
                             <h5 class="panel-title" id="h5titulo">                                                            
                                Horas p/Desahogo
                          ...
                          <br>
                          <div class="form-group">
                             <label class="control-label col-xs-3 text-right" id="lblRelationName">M&iacute;nimo:<label style='color:darkred'>(*)</label></label>
                             <div class="col-xs-9">
                                <input type="text" id="minHorasDesahogar" class="input-sm" name="minHorasDesahogar" maxlength="5">
                             </div>
                          </div>
                          <div class="form-group">
                             <label class="control-label col-xs-3" id="lblRelationName">M&aacute;ximo:<label style='color:darkred'>(*)</label></label>
                             <div class="col-xs-9">
                                <input type="text" id="maxHorasDesahogar" class="input-sm" name="maxHorasDesahogar" maxlength="5">
                             </div>
                          </div>
                       </div>
                       <br>
                       <div id="divTableResult3" class="col-xs-12">
                       </div>
                    </div>
                 </div>
              </div>
              <input type="hidden" name="cadena" id="cadena"/>
              <div class="panel panel-default" id="f2">
                 ...
                 <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                    <div class="panel-body">
                       <div id="divTableResult2" class="col-xs-12">
                       </div>
                    </div>
                 </div>
              </div>
        ...
        <div id="divConsulta" class="col-xs-12">
           <div class="col-xs-12">
            ...
            <br>
                 ...
                 &nbsp;<input style="display:none" type="submit" class="btn btn-primary" id="pdf" value="Imprimir" onclick="reporte()">
                 <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
