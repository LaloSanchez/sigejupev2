...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4>Solicitud de Ordenes de Aprehensi&oacute;n</h4>
        </div>
        <div>
            <input type="hidden" style="display:none" id="rutaArchivoSolicitud" value="" name="rutaArchivoSolicitud" size="5" readonly/>
            <input type="hidden" style="display:none" id="rutaArchivoAdjunto" value="" name="rutaArchivoAdjunto" size="5" readonly/>
            <input type="hidden" style="display:none" id="nameArchivoSolicitud" value="" name="nameArchivoSolicitud" size="5" readonly/>
            <input type="hidden" style="display:none" id="rutaDestino" value="/home/system/sigejupe/cateos/" name="rutaDestino" size="5" readonly/>
            <input type="hidden" style="display:none" id="idOrden" name="idOrden" value="" readonly/>
        </div>
        <div class="panel-body">
            <div id="divNumeroCateo" style="display:none;">
                <table border='0' cellpadding="2" align="right" cellspacing="0" class="Arial12" width="20%">
                    <tr>
                        <td align="right"><strong>N&uacute;mero Orden:</strong></td>
                        <td align="left"><input type="text" class="frmcaja" id="numOrden" value="" name="numOrden" size="5" readonly></td>
                        <td align="center">/</td>
                        <td align="left"><input type="text" class="frmcaja" id="aniOrden" value="" name="aniOrden" size="5" readonly></td>
                    </tr>
                </table>
            </div>
            <div class="row" >
                    ...
                    <div class="steps">
                        <ul>
                            ...
                            <li class="step step-2 Paso2">
                                <a href="#"><strong>Paso 2</strong><br>Persona(s)</a>
                            </li>
            ...
            <div class="col-xs-12" style="border: solid 4px #881518;" >
                <br />
                <form name="frmSolicitud" class="form-horizontal" id="frmSolicitud" method="POST" action="solicitudOrdenesController.php" target="oculto" enctype="multipart/form-data" onsubmit="return false;">
                    ...
                    <fieldset>
                        <div id="divPaso1" class="content col-xs-12" style="display:block;">
                            <div class="form-group" >
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                    <select class="form-control" name="cmbJuzgadoSolicitar" id="cmbJuzgadoSolicitar">
                                        <option value="0">Seleccione el juzgado a solicitar orden de aprehensi&oacute;n</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group" >
                                <label for="txtCarpeta" class="control-label col-lg-3 col-md-3 col-sm-12 col-xs-12" >
                                    <input type="radio" value="2" name="tipoNumero" id="tipoNumero" onclick="javascript:oredenes.seleccionTipo(this)">&nbsp;Otro:
                                </label>
                                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 row">
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" >
                                        <label class="control-label col-lg-3 col-md-3 col-sm-12 col-xs-12" >Carpeta de Investigaci&oacute;n:</label>
                                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12" >
                                            <input type="text" placeholder="Carpeta de Investigaci&oacute;n" name="txtCarpeta" id="txtCarpeta" class="form-control" size="20" disabled="" onkeypress="return validateNumber(event)"/>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" >
                                        <label class="control-label col-lg-3 col-md-3 col-sm-12 col-xs-12" >NUC:</label>
                                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12" >
                                            <input type="text" placeholder="NUC" name="txtNuc" id="txtNuc" class="form-control" size="20" disabled="" onkeypress="return validateNumber(event)"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group text-center" >
                                <button class="btn btn-primary text-right" id="btnStart" onclick="javascript:oredenes.validarPaso1(true)">Siguiente &gt;</button>
                            </div>
                        </div>
                        <div id="divPaso2" class="content col-xs-12" style="display:none;">
                            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                <div class="panel panel-default">
                                    ...
                                    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group text-center" >
                                                <button onclick="javascript:oredenes.addPersona()" class="btn btn-primary addPerson" >Agregar + </button>
                                            ...
                                            <table id="tblPersonas" class="table table-striped table-bordered">
                                                <thead>
                                                    <tr>
                                                        <th>Nombre</th>
                                                        <th>Domicilio</th>
                                                        <th class="text-center" ><button class="btn btn-danger" onclick="javascript:oredenes.deleteRow(this)">Eliminar</button></th>
                                                    </tr>
                                                </thead>
                                            </table>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group text-center" >
                                                <button onclick="javascript:oredenes.addObjeto()" class="btn btn-primary addObjeto" >Agregar + </button>
                                                ...
                                                <table id="tblObjetos" class="table table-bordered table-striped table-hover">
                                                    <thead>
                                                        <tr>
                                                            <th>Descripcion</th>
                                                            <th>Domicilio</th>
                                                            <th  class="text-center"><button onclick="javascript:oredenes.deleteRow(this)" class="btn btn-danger" >Eliminar</button></th>
                                                        </tr>
                                                    </thead>
                                                </table>
                                            </div>
                                ...
                                <div class="form-group text-center" >
                                    <br />
                                    <button class="btn btn-primary" onclick="javascript:oredenes.siguiente('liPaso1', 'liPaso2')">&lt; Anterior </button>
                                    <button class="btn btn-primary" onclick="javascript:oredenes.validaPasos2()">Siguiente &gt;</button>
                                </div>
                        ...
                        <div id="divPaso3" class="content  col-xs-12" style="display:none">
                            <div class="panel-group" id="accordiont" role="tablist" aria-multiselectable="true">
                                        ...
                                        <div class="panel-body">
                                            <div class="form-group" >
                                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" >
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12" >
                                                        <select onchange="javascript:oredenes.TipoPersona(this, 1)" name="cmbTipoPersona" id="cmbTipoPersona" class="form-control">
                                            ...
                                            <div class="form-group text-center" >
                                                <button class="btn btn-primary addImputado" onclick="javascript:oredenes.addImputados()">Agregar + </button>
                                                                    ...
                                                                    <table id="tblImputadosCausa" class="table table-bordered table-condensed table-hover">
                                                                        <thead>
                                                                            <tr>
                                                                                ...
                                                                                <th>Domicilio</th>
                                                                                <th>G&eacute;nero</th>
                                                                                <th class="text-center" ><button class="btn btn-primary" onclick="javascript:oredenes.addImputadosCausa(this, 'tblImputados')">Agregar</button></th>
                                                                            </tr>
                                                                        </thead>
                                                                    </table>
                                                                </div>
                                        ...
                                        <div class="panel-body">
                                            <div class="form-group" >
                                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" >
                                                    <label class="control-label col-lg-3 col-md-3 col-sm-12 col-xs-12">* Tipo de Persona:</label>
                                                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12" >
                                                        <select onchange="javascript:oredenes.TipoPersona(this, 2)" name="cmbTipoPersonaVictima" id="cmbTipoPersonaVictima" class="form-control">
                                                            <option value="0" >Selecciona una Opci&oacute;n</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group text-center " >
                                                <button onclick="javascript:oredenes.addVictimas()" class="btn btn-primary addOfendido" >Agregar +</button>
                                                                    ...
                                                                    <table id="tblVictimasCausa" class="table table-bordered table-condensed table-hover table-striped" >
                                                                        <thead>
                                                                            <tr>
                                                                                ...
                                                                                <th>Domicilio</th>
                                                                                <th>G&eacute;nero</th>
                                                                                <th class="text-center"><button class="btn btn-primary" onclick="javascript:oredenes.addVictimasCausa(this, 'tblVictimas')">Agregar</button></th>
                                                                            </tr>
                                                                        </thead>
                                                                    </table>
                                                                </div>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div id="DelitosThreeTabCollapse" class="panel-collapse collapse" role="tabpanel" aria-labelledby="DelitosThreeTabCollapse">
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group text-center" >
                                                <button class="btn btn-primary addDelito" onclick="javascript:oredenes.addDelito()">Agregar</button>
                                                                ...
                                                                <div class="table-responsive" >
                                                                    <table id="tblDelitosCausa" class="table table-bordered table-striped table-condensed">
                                                                        <thead>
                                                                            <tr>
                                                                                <th>Delitos</th>
                                                                                <th class="text-center"><button onclick="javascrip:oredenes.addDelitosCausa(this, 'tblDelitos')" class="btn btn-primary" >Agregar</button></th>
                                                                            </tr>
                                                                        </thead>
                                                                    </table>
                                                                </div>
                                ...
                                <div class="form-group text-center" >
                                    <br />
                                    <button class="btn btn-primary" onclick="javascript:oredenes.siguiente('liPaso2', 'liPaso3')">< Anterior </button>
                                    <button class="btn btn-primary" onclick="javascript:oredenes.siguiente('liPaso4', 'liPaso3')">Siguiente ></button>
                                </div>
                        ...
                        <div id="divPaso4" class='content col-xs-12' style='display:none;'>
                            ...
                            <div class="form-group" >
                                <div class="col-md-12 col-xs-12 text-center" >Formatos validos del archivo: <span>doc, docx y pdf</span>; tama&ntilde;o m&aacute;ximo: <span>2MB</span></div>
                                <label class="control-label col-lg-2 col-md-2 col-sm-12 col-xs-12" >Solicitud Digitalizada:</label>
                                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12" >
                                    <input type="file" name="fileSolicitud" id="fileSolicitud" size="60" onchange="if (!oredenes.formato(this)) {
                                                this.value = ''
                                            }">
                                </div>
                            </div>
                            ...
                            <div class="form-group text-center" >
                                <button class="btn btn-primary" onclick="javascript:oredenes.siguiente('liPaso3', 'liPaso4')">< Anterior </button>
                                <button class="btn btn-primary" onclick="javascript:oredenes.validaPasos4()">Siguiente ></button>
                            </div>
                        ...
                        <div id="divPaso5" class='content col-xs-12' style='display:none;'>
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12" >
                                    <fieldset style='width:100%'>
                                        ...
                                        <div class="form-group" >
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" >
                                                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12" >
                                                    <button onclick="javascript:oredenes.addMPs('')" class="btn btn-primary" >Agregar + </button>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="form-group text-center registerOrden" style="display:none">
                                <h3>N&uacute;mero de Orden de Aprehensi&oacute;n Registrado : <ordennumber></ordennumber></h3>
                            </div>

                            <div class="form-group text-center" >
                                <button id="btnAnterior" class="btn btn-primary" onclick="javascript:oredenes.siguiente('liPaso4', 'liPaso5')">< Anterior </button>
                                <button id="btnEnviar" class="btn btn-primary" onclick="javascript:oredenes.enviar()">Enviar</button>
                            </div>
                        </div>
                ...
                <form id="frmGeneraJar" method="POST" target="_blank" action="../controladores/sigejupe/firmaelectronica/FirmaElectronicaController.php">
                    <input type="hidden" value="GeneracionJarFirma" id="action" name="action">
    ...
    <script src="sigejupe/solicitudesCateos/ordenesFirma.js" charset="UTF-8" ></script>
    <script>
                                    var oredenes = new Ordenes();
                                    ...
                                    $(function () {
                                        ...
                                        var renderGenero = ["cmbGenPersona", "cmbGenImputado", "cmbGenVictima"];
                                        var colGenero = ["cveGenero", "desGenero"];
                                        helper.loadCombos("", renderGenero, colGenero, urlGenero);
                                        var urlGenero = "Tipospersonas";
                                        var renderGenero = ["cmbTipoPersona", "cmbTipoPersonaVictima"];
                                        ...
                                        getMP = function () {
                                            ...
                                            $.getJSON(url, function (json) {
                                                if (json !== "") {
                                                    oredenes.addMPs(json.nombre, json.paterno, json.materno);
                                                }
                                            });
                                        }
                                        getMP();
