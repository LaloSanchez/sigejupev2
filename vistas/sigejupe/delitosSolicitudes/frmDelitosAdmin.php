                    ...
                    <div class="row">
                        <div class="col-lg-10 col-sm-10 col-xs-10 col-md-offset-1" id="datos-juzgado">
                            ...
                            <br><div class="col-lg-3">
                                <button type="button" name="btnAgregaDelito" id="btnAgregaDelito" onclick="agregaDelito();" class="btn btn-primary">Agregar</button>
                            ...
                            <div class="form-group" >
                                <div id="divAlertWarningDelito" class="alert alert-warning alert-dismissable" style="display:none;">                    
                                    <strong>Advertencia!</strong> Mensaje
                                </div>
                                <div id="divAlertSuccesDelito" class="alert alert-success alert-dismissable" style="display:none;">

                                    <strong>Correcto!</strong> Mensaje
                                </div>
                                <div id="divAlertDagerDelito" class="alert alert-danger alert-dismissable" style="display:none;">

                                    <strong>Error!</strong> Mensaje
                                </div>
                                <div id="divAlertInfoDelito" class="alert alert-info alert-dismissable" style="display:none;">
    ...
    <script type="text/javascript">
        cargaDelitosSolicitudes = function () {
            ...
            $.ajax({
                type: "POST",
                global: false,
                url: "../fachadas/sigejupe/delitossolicitudes/DelitossolicitudesadminFacade.Class.php",
                async: false,
                dataType: "json",
