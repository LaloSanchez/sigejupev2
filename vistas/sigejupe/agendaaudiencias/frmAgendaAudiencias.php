        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="col-md-6 col-xs-12">
                    <div class="col-md-4 col-xs-12">
                        <input type="text" placeholder="Fecha de consulta" id="fechaConsultar" name="fechaConsultar" class="form-control" size="10" value="<?php echo date('d/m/Y'); ?>" >
                    </div>
                    <div class="col-md-4 col-xs-12">
                        <input type="button" value="Consultar" class="form-control btn-primary" id="btncns" onclick="consultaaudiencias()">
                    </div>
                    <div class="col-md-4 col-xs-12">
                        <input type="button" value="Imprimir" class="form-control btn-primary" id="btnPrint" onclick="PrintElem('#tablac')" style="display:none;">
                    </div>
                </div>
            </div>
            <br>
            ...
            <div class="list-group ">
                <div class="col-sm-12 col-xs-12">
                    ...
                    <p>&nbsp;</p>
                        <table class="table-autosort table table table-hover table-striped table-bordered overflow">
                            <thead>
                                <tr>
                                    <th colspan="9" align="center"><span id="fechaseleccionada" /></th>
                                </tr>
                                <tr>
                                    <th>#</th>
                                    <th align="center">Horario</th>
                                    <th align="center">Audiencia</th>
                                    <th align="center">Causa</th>
                                    <th align="center">Tipo de carpeta</th>
                                    <th align="center">Sala</th>
                                    <th align="center">Detenido</th>
