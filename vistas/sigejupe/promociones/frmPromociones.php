    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h5 class="panel-title">        
                <?php if ($promocionTermino == 1) { ?>
                    Registro de Promociones de Termino
                <?php } else { ?>
        ...
        <div class="panel-body">
            ...
            <div id="divFormulario" class="form-horizontal">
                <div id="divCampos">
                    ...
                    <div class="form-group"> 
                        <?php if ($promocionTermino == 1) { ?>
                            ...
                            <?php } else { ?>
                                ...
                                <div class="col-md-5">
                                    <div class="col-md-5">
                                        <input type="radio" class="form-control"  checked  value="0" name="asigNumero"  ><label >Automatico</label>
                                    </div>
                                    <div class="col-md-5">
                                        <input type="radio"   class="form-control"  value="1" name="asigNumero"  ><label>Manual</label>
                                    </div>
                                </div>  
                            </div>
                            <div class="form-group">                                                                
                                <label class="control-label col-md-3 "><?php echo $origen == 1 ? ( "Tribunal de alzada") : ( "Juzgado"); ?>:  <b style="color: darkred">(*)</b></label>
                                <div class="col-md-9">
                            ...
                            <div class="form-group">                                                                
                                ...
                                <div class="col-md-9">
                                    ...
                                    <select class="form-control Relacionado" name="cmbTipoCarpeta" id="cmbTipoCarpeta" onchange="changeLabel(this, '')">
                                        <option value="0">Seleccione una opcion</option>
                                        <option value="00" id="sinRelacion">Sin Relaci&oacute;n</option>
                                    </select>
                                </div>                                
                            </div>
                            <div class="form-group">                                                                
                                <label class="control-label col-md-3 labelRelacion" id="lblRelationName">No. <b style="color: darkred">(*)</b></label>
                                <div id="divSinRelacion" class="col-md-5">
                                    <div class="col-md-4">
                                        <input type="text" id="txtNumero" class="form-inline Relacionado form-control" id="txtNumero" placeholder="N&uacute;mero">
                                    </div>                        
                                    <div class="col-md-4">
                                        <input type="text" class="form-inline Relacionado form-control" id="txtAnio" maxlength="4" onchange="validaAnio(this.value)"  id="txtAnio" placeholder="A&ntilde;o">
                                    </div>

                                </div>
                                <label class="control-label col-md-1 labelFojas">No. Fojas <b style="color: darkred">(*)</b></label>
                                <div class="col-md-2">
                            ...
                            <div class="form-group"> 
                                <div id="divListaApelantes" class="form-group" style="display:none" >
                            ...
                            <div class="form-group">                                                                
                                ...
                                <div class="col-md-3" id="divTiposPersonas">
                            ...
                            <div id="divPromoventes" class="form-group rnActor">
                                <label class="control-label col-md-3">Promovente:</label>
                                <div class="col-md-2 divNombre" ><input
                                        type="text" name="txtPaternoAct" id="txtPaternoAct"
                                        value="" placeholder="Paterno" class="form-control txtActor mayuscula"
                                        onKeyPress="return capturaNombrePersona(event, 'txtMaternoAct', 'txtActor', 'lstActores', 'cmbTiposPersonas');" /></div>
                                <div class="col-md-2 divNombre" ><input
                                        type="text" name="txtMaternoAct" id="txtMaternoAct"
                                        value="" placeholder="Materno" class="form-control txtActor mayuscula"
                                        onKeyPress="return capturaNombrePersona(event, 'txtNombreAct', 'txtActor', 'lstActores', 'cmbTiposPersonas');" /></div>
                                <div class="col-md-2"><input
                                        type="text" name="txtNombreAct" id="txtNombreAct"
                                        value="" placeholder="Nombre(s)" class="form-control txtActor mayuscula"
                                        onKeyPress="return capturaNombrePersona(event, 'agregaPersona', 'txtActor', 'lstActores', 'cmbTiposPersonas');" /></div>
                            </div>
                            <div  class="form-group">
                            ...
                            <div id="divListaPromoventes" class="form-group">
                                ...
                                <label class="control-label col-md-3">Lista promovente(s):  <b style="color: darkred">(*)</b></label>
                                <div class="col-lg-6">
                                    <table id="ltsPromoventes" class="table table-bordered tblGridAgrega  " ></table>
                                </div>
                            </div>
                            <div id="divNotas" class="form-group">
                                <label class="control-label col-md-3">Observaciones/Anexos:  <b style="color: darkred">(*)</b></label>
                                <div class="col-md-9">
                            ...
                            <div class="form-group">
                                <div class="col-md-offset-3 col-md-5">
                                    <div class="col-md-2 botonesAdaptar"> 
                                        <input type="submit" class="btn btn-primary  btn-adaptar" id="inputGuardar" value="Guardar" onclick="guardarPromocion();"> 
                                    </div>
                                    <div class="col-md-2 botonesAdaptar"> 
                                    ...
                                    <div class="col-md-2 botonesAdaptar"> 
                                        <input type="submit" style="display: none" class="btn btn-primary  btn-adaptar" id="inputLimpiarArbol" value="Limpiar" onclick="limpiarArbol();">   
                                    </div>
                                    <div class="col-md-2 botonesAdaptar"> 
                                        <input type="submit" class="btn btn-primary  btn-adaptar" id="inputConsultar"  value="Consultar" onclick="consultar('divCamposConsulta');">                                    
                                    </div>
                                    <div class="col-md-2 botonesAdaptar"> 
                                    ...
                                    <div class="col-md-2 botonesAdaptar"> 
                                        <input type="submit" class="btn btn-primary  btn-adaptar" id="inputEliminar" value="Eliminar" style="display: none" onclick="eliminarPromocion()">                                    
                                    </div>
                                    <div class="col-md-2 botonesAdaptar"> 
                                        <input type="submit" class="btn btn-primary print-link no-print  btn-adaptar" id="inputImprimir" value="Imprimir" style="display: none" onclick="imprimirRecibo()">                                    
                                    </div>
                                    <!--<button class="btn btn-primary" id="inputDigitalizar" style="display: none" onclick="javascript:digitalizarPromocion();">Digitalizar</button>-->
                                    <div class="col-md-2 botonesAdaptar">                        
                    ...
                    <div id="divCamposConsulta" class="form-horizontal" style="display: none">
                        <div class="form-group">
                            ...
                            <label class="control-label col-md-5 ">Consulta de Promociones</label>
                        </div>

                        <div class="form-group">                                                                
                            <label class="control-label col-md-3 "><?php echo $origen == 1 ? ( "Tribunal de alzada") : ( "Juzgado"); ?>:</label>
                            <div class="col-md-9">
                                <div id="divCmbRelaciones" class="logobox"></div>
                        ...
                        <div class="form-group">                                                                
                            ...
                            <div id="divSinRelacion" class="col-md-9">
                                <input type="text"  class="form-inline Relacionado" id="txtNumero2" placeholder="N&uacute;mero">/<input type="text" maxlength="4" class="form-inline Relacionado" id="txtAnio2"  placeholder="A&ntilde;o">
                            </div>                                
                            <div id="divSinRelacionMsg" class="col-md-9">
                        ...
                        <div class="form-group">                                                                
                            ...
                            <div id="divSinRelacion" class="col-md-9">
                                <input type="text"  class="form-inline Relacionado" id="txtNumActuacion" placeholder="N&uacute;mero Promoci&oacute;n">/<input type="text" maxlength="4" class="form-inline Relacionado" id="txtAniActuacion"  placeholder="A&ntilde;o Promoci&oacute;n">
                            </div>                    
                            <div id="divSinRelacionMsg" class="col-md-9 ">
                        ...
                        <div class="form-group">
                            <div class="col-md-offset-3 col-md-9">
                                <div class="col-md-1">
                                    <input type="submit" class="btn btn-primary" id="inputBuscar" value="Buscar" onclick="consultaPromocion(1);" style="display: block">                                    
                                </div>
                    ...
                    <div id="divConsulta" style="display: none" class="col-md-12">
                        <div class="col-md-12">
                            <div class="col-md-3">
                                <input type="hidden" id="totalRegistros" value=""/>
                            ...
                            <div id="divPaginador" class="form-group col-md-2" >
                                ...
                                <select  name="cmbPaginacion" id="cmbPaginacion" onchange="consultaPromocion(0);">
                                    <option value="1">1</option>
                                </select>
                            </div>
                            <div id="divPaginador" class="form-group col-md-2" >
                                <label class="control-label">Registros por p&aacute;gina:</label>
                                <select  name="cmbNumReg" id="cmbNumReg" onchange="consultaPromocion(1);">
                            ...
                            <div class="col-md-3">
                                <input type="submit" class="btn btn-primary" value="imprimir" onclick="imprimir()">                                                    
                            </div>
                        </div>
                ...
                <script type="text/javascript">
                    ...
                    var promocionTermino = "<?php echo $promocionTermino; ?>";
                    if (editor != undefined) {
                        editor.destroy();
                    } else {
                    ...
                    digitalizarAcuerdo = function () {
                        ...
                        //usuario
                        var strl;
                        strl = "0-" + $("#hiddenIdActuacion").val() + "-PROMOCIONES-<?php echo $_SESSION["desAdscripcion"]; ?>-" + $("#txtNumero").val() + "-" + $("#txtAnio").val() + "-13-<?php echo $_SESSION["cveUsuarioSistema"]; ?>";
                    ...
                    cargaJuzgados = function (grt) {
                        ...
                        var validaArbolParaBusqueda = "<?php echo $_POST["idActuacion"]; ?>";
        //                  alert($("#hiddenIdActuacion").val());
                        if (validaArbolParaBusqueda != "") {
                            if (hiddencveAdcripcion == hiddencveJuzgadoOrigenArbol) {
                                if (OrigenSegundaInstancia == "") {
                                    strDatos = "accion=getJuzgadoActuacion&idActuacion=" + validaArbolParaBusqueda;
                                } else {
                                }
                            } else {
        ...
        //                                    }
                    ...
                    cargaTipoCarpeta = function (grt) {
                        if (grt == 1) {
                            ...
                            var tipoJuzgado = $("#cveTipoJuzgado2").val().split("/");
                        }
                                    ...
                                    for (var i = 0; i < json.totalCount; i++) {
                                        if (origen == 1) {
                                            if (grt == 1) {
                                                ...
                                                $("#cmbTipoCarpeta2").append($('<option></option>').val("00").html("SIN RELACION"));
                                            }
                                        } else {
                                            if (grt == 1) {
                                                $("#cmbTipoCarpeta").empty();
                    ...
                    buscarPromocion = function (pag, cantReg, imprimir) {
                        ...
                        if (cantReg == "") {
                            cantReg = $("#cmbNumReg").val();
                        } else {
                            cantReg = totalRegistros;
                        }
                        var table = "";

                        if (promocionTermino == 1) {
                            var accion = "consultarPromocion_Termino";
                        } else {
                            var accion = "consultarActuacion_Promocion";
                        }
                        ...
                        if (cveAdscripcion != "") {
                                    ...
                                    if (data.estatus == "ok") {
                                        if (pag == 1) {
                                            if (data.totalCount.totalCount > 0) {
                                                ...
                                                $("#totalReg").html("<b> Total: " + data.totalCount.totalCount + "</b>");
                                                $("#totalRegistros").val(data.totalCount.totalCount);
                                            }
                                        ...
                                        $("#divConsulta").show();
                                        if (imprimir === true)
                                            table += "&nbsp;&nbsp;<label>Total de registros: " + data.totalCount.totalCount + " </label>";
                                        ...
                                        $.each(data.datos, function (index, element) {
                                            ...
                                            var fecharegistro = datepartes[2] + "/" + datepartes[1] + "/" + datepartes[0] + " " + resDate[1];
                                            var estilo = "";
                                            if (element.cveTipoActuacion == 1) {
                                                estilo = "style='color:red'";
                                            }
                                            if (element.cveTipoActuacion == 13) {
                                                estilo = "style='color:green'";
                                            }
                                            if (element.cveTipoActuacion == 17) {
                                                estilo = "style='color:blue'";
                                            }
                                            table += "<tr " + estilo + ">";
                                            table += "        <td onclick=\"consutaIdAcuerdo('" + element.idActuacion + "','" + element.descTipoCarpeta + "')\" > " + (index + 1) + "</td>";
                                            table += "        <td onclick=\"buscarPromocionById('" + element.idActuacion + "')\" >" + element.numActuacion + "/" + element.aniActuacion + "</td>";
                                            table += "        <td onclick=\"buscarPromocionById('" + element.idActuacion + "')\" >" + fecharegistro + "</td>";
                                            table += "        <td onclick=\"buscarPromocionById('" + element.idActuacion + "')\" >" + element.sintesis + "</td>";
                                            if (element.idReferencia === null) {
                                                table += "        <td onclick=\"buscarPromocionById('" + element.idActuacion + "')\" >SIN RELACION</td>";
                                            } else {
                                                table += "        <td onclick=\"buscarPromocionById('" + element.idActuacion + "')\" >" + element.numero + "/" + element.anio + " " + element.descTipoCarpeta + "</td>";
                                            }
                                            table += "        <td onclick=\"buscarPromocionById('" + element.idActuacion + "')\" >" + element.desTipoActuacion + "</td>";
                                            table += "        <td onclick=\"buscarPromocionById('" + element.idActuacion + "')\" >" + promoventes + "</td>";
                                            table += "    </tr> ";
                                        });
                                        table += "</tbody>";
                                        table += "</table>";
                            ...
                            $("#divTableResult").empty();
                            $("#divAlertDager2").html("Seleccione un Juzgado");
                            $("#divAlertDager2").show("slide");
                            setTimeAlert("divAlertDager2");
                        }
                    ...
                    validaconsulta = function () {
                        ...
                        if ($('#txtfechaInicial').val() != "" && $('#txtfechaFinal').val() == "") {
                            mensaje += "*Seleccione fecha final <br>";
                            error = true;
                        }
                        if ($('#txtfechaInicial').val() == "" && $('#txtfechaFinal').val() != "") {
                            mensaje += "*Seleccione fecha inicial <br>";
                            error = true;
                        }
                        if ($('#cveTipoJuzgado2').val() == "0" || $('#cveTipoJuzgado2').val() == "") {
                            mensaje += "*Seleccione un juzgado <br>";
                            error = true;
                        }


                        if ($("#txtNumero2").val() == "" && $("#txtAnio2").val() == "" && $("#txtNumActuacion").val() == "" && $("#txtAniActuacion").val() == ""
                                && $('#txtfechaInicial').val() == "" && $('#txtfechaFinal').val() == "") {
                            mensaje += "*Ingrese un criterio de busqueda <br>";
                            error = true;
                        }

                        if (error) {
                            $("#divAlertWarning2").html(mensaje);
                            $("#divAlertWarning2").show("slide");
                            setTimeAlert("divAlertWarning2");
                        }
                    ...
                    consultaPromocion = function (pagAux) {
                        var error = false;
                        if (!validaconsulta()) {
                            ...
                            if (cveAdscripcion != "") {
                                ...
                                $.ajax({
                                    ...
                                    data: {
                                        ...
                                        anio: $("#txtAnio2").val(),
                                        numActuacion: $("#txtNumActuacion").val(),
                                        aniActuacion: $("#txtAniActuacion").val(),
                                        cveTipoCarpeta: $("#cmbTipoCarpeta2").val(),
                                        accion: "consultaPromocion",
                                        cveJuzgado: cveAdscripcion,
                                        cveTipoActuacion: "1,13,17",
                                        pag: pag,
                                        activo: "S",
                                    ...
                                    success: function (datos) {
                                        if (datos.totalCount > 0) {
                                            ...
                                            table += '<th>Tipo promocion</th>';
                                            table += '<th>Promoventes</th>';
                                    table += '<th>Acordada</th>';
                                            table += '</tr>';
                                            table += '</thead>';
                                            table += "<tbody>";
                                            for (var i = 0; i < datos.totalCount; i++) {
                                                var estilo = "";
                                                if (datos.data[i].cveTipoActuacion == 1) {
                                                    estilo = "style='color:red'";
                                                }
                                                if (datos.data[i].cveTipoActuacion == 13) {
                                                    estilo = "style='color:green'";
                                                }
                                                if (datos.data[i].cveTipoActuacion == 17) {
                                                    estilo = "style='color:blue'";
                                                }
                                                table += "<tr " + estilo + ">";
                                                table += "<td width='1%' onclick='buscarPromocionById(" + datos.data[i].idActuacion + ")' >" + (i + 1) + "</td>";
                                                table += "<td width='5%' onclick='buscarPromocionById(" + datos.data[i].idActuacion + ")' >" + datos.data[i].numPromocion + "</td>";
                                                table += "<td width='5%' onclick='buscarPromocionById(" + datos.data[i].idActuacion + ")' >" + datos.data[i].fechaRegistro + "</td>";
                                                table += "<td width='30%' onclick='buscarPromocionById(" + datos.data[i].idActuacion + ")' >" + datos.data[i].sintesis + "</td>";
                                                table += "<td width='15%' onclick='buscarPromocionById(" + datos.data[i].idActuacion + ")' >" + datos.data[i].numCausa + "</td>";
                                                table += "<td width='15%' onclick='buscarPromocionById(" + datos.data[i].idActuacion + ")' >" + datos.data[i].tipoPromocion + "</td>";
                                                table += "<td width='30%' onclick='buscarPromocionById(" + datos.data[i].idActuacion + ")' >" + datos.data[i].promovente + "</td>";
                                        table += "<td width='30%' onclick='buscarPromocionById(" + datos.data[i].idActuacion + ")' >" + datos.data[i].acordada + "</td>";
                                                table += "</tr>";
                                            }
                                            table += "</tbody>";
                                            table += "</table>";
                                            ...
                                            $("#divAlertWarning2").html("");
                                            $("#divAlertWarning2").html("No se encontraron resultados");
                                            $("#divAlertWarning2").show("");
                                            setTimeAlert("divAlertWarning2");
                                        }
                                    },
                                    error: function (jqXHR, textStatus, errorThrown) {
                                ...
                                $("#divTableResult").empty();
                                $("#divAlertWarning2").html("Seleccione un Juzgado");
                                $("#divAlertWarning2").show("slide");
                                setTimeAlert("divAlertWarning2");
                            }
                        } else {
                        ...
                        $.ajax({
                            ...
                            success: function (datos) {
                                ...
                                if (json.totalCount > 0) {
                                    ...
                                    $("#totalRegistros").val(json.totalCount);
                                    $("#cmbPaginacion").val(pag);
                                } else {
                    ...
                    imprimir = function () {
                        var html = buscarPromocion(0, 10000, true);
                        html = html.replace(/red/g, "black");
                        ...
                        tableHTML += '    </td>';
                        tableHTML += '    <td style="font-size:12px; font-weight:bold; border-bottom:solid black 2px;">';
                        tableHTML += '        Gobierno del Estado de M&eacute;xico<br> Poder Judicial del Estado de M&eacute;xico<br>Consejo de la Judicatura<br>Consulta de Promociones';
                        tableHTML += '    </td>';
                        ...
                        tableHTML += '<br>Promociones del periodo ' + $("#txtfechaInicial").val() + ' al ' + $("#txtfechaFinal").val();
                    ...
                    buscarPromocionByIdAR = function (idActuacion) {
                        limpiar();
                        var nombre = "";
                        var paterno = "";
                        var materno = "";
                        ...
                        $.ajax({
                            ...
                            success: function (data, textStatus, jqXHR) {
                                ...
                                if (data.estatus == "ok") {
                                    ...
                                    cargaJuzgados(actuacion[0].cveJuzgado);
                                    if (origen == 1) {
                                        buscarApelantes();
                                    }
                                }
                        ...
                        $('#inputVisor').show();
                        if (origen == 1) {
                            var permisos = obtenerPermisosFormulario("OFICIALIA DE TRIBUNAL DE ALZADA", "PROMOCIONES");
                        } else {
                            var permisos = obtenerPermisosFormulario("ATENCION PUBLICO", "PROMOCIONES");
                        }
                        ...
                        $.ajax({
                            ...
                            success: function (data, textStatus, jqXHR) {
                                ...
                                if (data.estatus == "ok") {
                                    var actuacion = data.datos;
                                    cargaJuzgados(actuacion[0].cveJuzgado);
                                    // alert(actuacion[0].cveTipoCarpeta);
                                    $("#txtNumero").val(actuacion[0].numero);
                                    $("#txtAnio").val(actuacion[0].anio);
                                    ...
                                    if (actuacion[0].cveTipoCarpeta === null) {
                                        $("#cmbTipoCarpeta").val("00");
                                        $("#divSinRelacion").hide();
                                        $(".labelRelacion").hide();
                                        $(".labelFojas").addClass("col-md-3");
                                        $(".labelFojas").toggleClass('col-md-1');
                                    } else {
                                        ...
                                        $("#divSinRelacion").show();
                                        $(".labelRelacion").show();
                                        $(".labelFojas").addClass("col-md-1");
                                        $(".labelFojas").toggleClass('col-md-3');
                    ...
                    digitalizarPromocion = function () {
                        var params = {
                            ...
                            Descripcion: "PROMOCIONES", //descripci�n de lo que se va a digitalizar(promociones, acuerdos, exhortos, etc.)
                            descJuzgado: "JUZGADO DE CONTROL DE TOLUCA", //descripcion del juzgado al que pertenede la carpeta judicial o actuacion
                            anio: $("#txtAniActuacion2").val(), //a�o de la actuacion o carpeta judicial
                            cveDocumento: "13"    //clave del documento que se va a digitalizar lo encuentrar la tabla tbltiposdocumentos
                        };
                    ...
                    ocultarCampos = function (cveTipoPersona) {
                        ...
                        if (cveTipoPersona == 1) {
                            ...
                            $(".divNombre").show("slow");
                            if (myClass === "col-md-9") {
                                $("#txtNombreAct").parent().toggleClass('col-md-9');
                    ...
                    changeLabel = function (objOption, clave) {
                        ...
                        if ($("#cmbTipoCarpeta" + clave).val() == "00") {
                    ...
                    validarFormulario = function () {
                        ...
                        if (intentoGuardar == 1) {
                            ...
                            if ($("input:radio[name=asigNumero]:checked").val() == 1) {
                                ...
                                } else if (aniActuacion.length < 4) {
                                    $("#txtAniActuacion2").parent().append("<br class='required'><label class='Arial13Rojo required'>El A&ntilde;o debe ser de 4 digitos yyyy</label>");
                                } else if (aniActuacion < 1980) {
                                    $("#txtAniActuacion2").parent().append("<br class='required'><label class='Arial13Rojo required'>El A&ntilde;o debe ser mayor a 1980</label>");
                                } else if (aniActuacion > anioActual) {
                                    $("#txtAniActuacion2").parent().append("<br class='required'><label class='Arial13Rojo required'>El A&ntilde;o no puede ser mayor a " + anioActual + "</label>");
                                }
                            }
                            if (cveTipoCarpeta == "0") {
                                guardar = 0;
                                $('#cmbTipoCarpeta').parent().append("<br class='required'><label class='Arial13Rojo required'>Seleccione el tipo de carpeta relacionado con la promocion</label>");
                            }
                            if (numero === "" && cveTipoCarpeta != "00") {
                                guardar = 0;
                            ...
                            if (fojas === "") {
                                guardar = 0;
                                $('#txtFojas').parent().append("<br class='required'><label class='Arial13Rojo required'>Debe ingresar el n&uacute;mero de fojas de la promocion</label>");
                            }
                            if (sintesis === "") {
                                guardar = 0;
                            ...
                            if (observaciones === "") {
                                guardar = 0;
                                $('#txtNotas').parent().append("<br class='required'><label class='Arial13Rojo required'>Debe ingresar el Observaciones de la promocion</label>");
                            }
                            if (idReferencia === "" && cveTipoCarpeta != "00") {
                                guardar = 0;
                    ...
                    guardarPromocion = function () {
                        ...
                        var cveTipoCarpeta = $("#cmbTipoCarpeta").val() == "00" ? "" : $("#cmbTipoCarpeta").val();
                        var numero = $("#txtNumero").val();
                        var anio = $("#txtAnio").val();
                        var idReferencia = $("#hiddenIdCarpetaJudicial").val();
                        var idActuacion = $("#hiddenIdActuacion").val();
                        ...
                        if (guardar == 1) {
                            ...
                            if (promocionTermino == 1) {
                                var accion = "guardarActuacion_Promociontermino";
                            } else {
                            ...
                            if (idActuacion > 0) {
                                if (promocionTermino == 1) {
                                    accion = "actualizarActuacion_Promociontermino";
                                } else {
                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    if (data.totalCount > 0) {
                                        ...
                                        $("#divAlertDager").html("<label style='color:black;'>Error en la peticion:\n\n" + data.text + "</label>");
                                        $("#divAlertDager").show("slide");
                                        setTimeAlert("divAlertDager");
                                    }
                            ...
                            if (totalRenglones == 0 || hiddenIdentificador !== "") {
                                ...
                                $('#ltsPromoventes tr').each(function () {
                                    ...
                                    if (nombrePromo != undefined) {
                                        ...
                                        //                       var NombrecadenaPromo = nombrePromo[0]+nombrePromo[1]+nombrePromo[2];                       
                    ...
                    validaAnio = function (data) {
                        ...
                        if (data.length > 0 & data < "1980") {
                            alert("La Fecha es MENOR a la Fecha Limite 1980");
                            $("#txtAnio").val("");
                        }
                        if (data > anio) {
                            ...
                            $.ajax({
                                ...
                                success: function (data, textStatus, jqXHR) {
                                    ...
                                    if (data.estatus == "ok") {
                                        ...
                                        var numeroCarpeta = "";
                                        var anioCarpeta = "";
                                        if (actuacion[0].descTipoCarpeta !== null) {
                                            tipoCarpeta = actuacion[0].descTipoCarpeta;
                                        } else {
                                            tipoCarpeta = "SIN RELACION ";
                                        }
                                        if (actuacion[0].numero != null)
                                            numeroCarpeta = actuacion[0].numero + "/";
                                        if (actuacion[0].anio != null)
                                            anioCarpeta = actuacion[0].anio;
                                        var carpeta = numeroCarpeta + anioCarpeta + " " + tipoCarpeta;
                                        var tabla = "<table style='width:100%; font-size:14px; border-collapse:collapse; font-family: \"Courier New\", Courier, monospace;''>";
                                        if (promocionTermino == 1) {
                                            tabla += "<tr><td align='left' style='width:30%; font-weight:bold; border-bottom:solid black 2px;'><img src='../vistas/img/EscudoEstadoMexico.png' width='85' height='90'></td><td style='font-size:16px; font-weight:bold; border-bottom:solid black 2px;'>Gobierno del Estado de M&eacute;xico<br> Poder Judicial del Estado de M&eacute;xico<br>Consejo de la Judicatura<br>Comprobante de Promoci&oacute;n de Termino</td><td align='left' style='padding-left:5px; border-bottom:solid black 2px;'><img src='../vistas/img/EscudoPoderJudicial.png' width='85' height='90'></td></tr>";
                                        }else{
                                        ...
                                        tabla += "<tr><td align='right' style='width:30%; font-weight:bold;'>Relacionado con:</td><td align='left' style='padding-left:5px;'>" + carpeta + "</td></tr>";
                                        ...
                                        tabla += "<tr><td align='right' style='width:30%; font-weight:bold;'>Observaciones/Anexos:</td><td align='left' style='padding-left:5px;'>" + actuacion[0].observaciones + "</td></tr>";
                    ...
                    eliminarPromocion = function () {
                        ...
                        if (idActuacion > 0) {
                            bootbox.dialog({
                                message: "Advertencia!! <br><br> Esta seguro de eliminar  la promoci&oacute;n??",
                                buttons: {
                                    danger: {
                                        label: "Aceptar",
                    ...
                    buscarApelantes = function () {
                        ...
                        $.ajax({
                            ...
                            data: {
                                ...
                                numero: numero,
                                anio: Anio,
                                accion: "consultarApelantesParaActuacion"
                            },
                            beforeSend: function (datos) {
                            },
                            success: function (datos) {
                                if (datos.totalCount > 0 && datos.Estatus == "ok") {
                                    ...
                                    if (datos.mnj == "NO EXISTE LA TOCA") {
                                        ...
                                        //                            $("#divAlertInfo").html("NO EXISTEN APELANTES PARA ESTA TOCA VERIFICAR");
                                            ...
                                            success: function (datos) {
                                                ...
                                                if (datos.totalCount > 0) {
                                                    $.each(datos.data, function (index, element) {
                                                        ...
                                                        $("#divSinRelacionMsg").append("<b>encontrado</b>");
                                                        if (cveTipoCarpeta == 8) {
                                                    ...
                                                    $("#divSinRelacionMsg").append("<b>Sin Antecedentes</b>");
                                                    $("#hiddenIdCarpetaJudicial").val("");
                                                }
                                            },
                                            error: function (jqXHR, textStatus, errorThrown) {
