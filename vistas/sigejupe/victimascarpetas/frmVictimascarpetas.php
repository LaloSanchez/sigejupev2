...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <input type="hidden" id="IdCarpetaJudicial" name="IdCarpetaJudicial" value="<?php echo $idCarpetaJudicial ?>">
        </div>
        <div class="panel-body">
            <div id="divMensaje"></div>
            <div id="divFormularioVictimas" style="display:none;" class="form-horizontal">
                <div class="tab-content tabs-flat">
                    <div class="tabbable tabs-left">
                        ...
                        <ul id="myTab3" class="nav nav-tabs">
                            ...
                            <li class="tab-sky ">
                                <a href="#divEfectosSecuales" data-toggle="tab" aria-expanded="false">Efectos s-exuales</a>
                            </li>
                        </ul>
        ...
        <!--                                                            <input type="hidden" id="hddIdTestigoSexual" name="hddIdTestigoSexual">-->
                            ...
                            <div class="tab-pane" id="divTrataPersonas">
                                <div id="divLlenaInfoTrata" style="display:none;">
                                    ...
                                    <div class="col-lg-3" id="divEstadoOrigen">
                                        ...
                                        <div>
                                            <select id="cmbEstadoOrigen" class="form-control" name="cmbEstadoOrigen" onchange="comboMunicipioOrigen();" >
                                                <option value="0">Seleccione una opci&oacute;n</option>
                                            </select>
                                    ...
                                    <div class="col-lg-3" id="divEstadoDestino">
                                        ...
                                        <div>
                                            <select id="cmbEstadoDestino" class="form-control" name="cmbEstadoDestino" onchange="comboMunicipioDestino();" >
                                                <option value="0">Seleccione una opci&oacute;n</option>
                                            </select>
                            ...
                            <div class="tab-pane" id="divEfectosSecuales">
                                <div id="divLlenaEfectos" style="display:none;">
                                    <div id="divFormularioVictimas" class="form-horizontal">
                                        <div class="tab-content tabs-flat">
                                            <div class="tabbable tabs-left">
                                                <input type="hidden" id="hddIdSexual" name="hddIdSexual">
                                                <div class="tab-content">
                    ...
                    <div class="form-group" >
                        ...
                        <div id="divAlertInfoViolencia" class="alert alert-info alert-dismissable" style="display:none;">
            ...
            <script type="text/javascript">
                ...
                comboEfectos = function () {
                    $.ajax({
                        ...
                        success: function (datos) {
                            try {
                                $('#cmbEfecto').empty();
                                $('#cmbEfecto').append('<option value="0">Seleccione una opci&oacute;n</option>');
                    ...
                    $.ajax({
                        ...
                        success: function (datos) {
                            try {
                                ...
                                $('#cmbDetalleEfecto').append('<option value="0">Seleccione una opci&oacute;n</option>');
                                if (datos.totalCount > 0) {
                                    $.each(datos.data, function (count, object) {
                    ...
                    $.ajax({
                        ...
                        success: function (datos) {
                            try {
                                ...
                                $('#cmbFactorSocial').append('<option value="0">Seleccione una opci&oacute;n</option>');
                                if (datos.totalCount > 0) {
                                    $.each(datos.data, function (count, object) {
                    ...
                    $.ajax({
                        ...
                        success: function (datos) {
                            try {
                                ...
                                $('#cmbHomicidioDoloso').append('<option value="0">Seleccione una opci&oacute;n</option>');
                                if (datos.totalCount > 0) {
                                    $.each(datos.data, function (count, object) {
                ...
                comboPaisOrigen = function () {
                    $.ajax({
                        ...
                        success: function (datos) {
                            try {
                                $('#cmbPaisOrigen').empty();
                                $('#cmbPaisOrigen').append('<option value="0">Seleccione una opci&oacute;n</option>');
                                if (datos.totalCount > 0) {
                                    $.each(datos.data, function (count, object) {
                ...
                comboEstadoOrigen = function () {
                    ...
                    $('#cmbEstadoOrigen').append('<option value="0">Seleccione una opci&oacute;n</option>');
                    $('#cmbMunicipioOrigen').empty();
                    $('#cmbMunicipioOrigen').append('<option value="0">Seleccione una opci&oacute;n</option>');
                    $("#txtestadoOrigen").val("");
                    ...
                    $.ajax({
                        ...
                        success: function (datos) {
                            try {
                                ...
                                $('#cmbPaisDestino').append('<option value="0">Seleccione una opci&oacute;n</option>');
                                if (datos.totalCount > 0) {
                                    $.each(datos.data, function (count, object) {
                ...
                comboEstadoDestino = function () {
                    ...
                    $('#cmbEstadoDestino').append('<option value="0">Seleccione una opci&oacute;n</option>');
                    $('#cmbMunicipioDestino').empty();
                    $('#cmbMunicipioDestino').append('<option value="0">Seleccione una opci&oacute;n</option>');
                ...
                comboTipoTrata = function () {
                    $.ajax({
                        ...
                        success: function (datos) {
                            try {
                                $('#cmbTipoTrata').empty();
                                $('#cmbTipoTrata').append('<option value="0">Seleccione una opci&oacute;n</option>');
                                if (datos.totalCount > 0) {
                                    $.each(datos.data, function (count, object) {
                    ...
                    $.ajax({
                        ...
                        success: function (datos) {
                            try {
                                ...
                                $('#cmbTransportacion').append('<option value="0">Seleccione una opci&oacute;n</option>');
                                if (datos.totalCount > 0) {
                                    $.each(datos.data, function (count, object) {
                ...
                comboAmbitoAcoso = function () {
                    $.ajax({
                        type: "POST", url: "../fachadas/sigejupe/ambitosacosos/AmbitosacososFacade.Class.php",
                        global: false,
                        async: false,
                        dataType: "json",
                        data: {accion: "consultar", obligaPermiso: "false"},
                        ...
                        success: function (datos) {
                            try {
                                $('#cmbAmbito').empty();
                                $('#cmbAmbito').append('<option value="0">Seleccione una opci&oacute;n</option>');
                                if (datos.totalCount > 0) {
                                    $.each(datos.data, function (count, object) {
                ...
                comboConducta = function () {
                    $.ajax({
                        type: "POST",
                        url: "../fachadas/sigejupe/conductas/ConductasFacade.Class.php",
                        global: false,
                        async: false, dataType: "json",
                        data: {accion: "consultar", obligaPermiso: "false"},
                        beforeSend: function (objeto) {
                        ...
                        success: function (datos) {
                            try {
                                $('#cmbCondcuta').empty();
                                $('#cmbCondcuta').append('<option value="0">Seleccione una opci&oacute;n</option>');
                                if (datos.totalCount > 0) {
                                    $.each(datos.data, function (count, object) {
                    ...
                    $.ajax({
                        ...
                        success: function (datos) {
                            try {
                                ...
                                $('#cmbDetalleConducta').append('<option value="0">Seleccione una opci&oacute;n</option>');
                                if (datos.totalCount > 0) {
                                    $.each(datos.data, function (count, object) {
                ...
                comboGenero = function () {
                    $.ajax({
                        ...
                        success: function (datos) {
                            try {
                                $('#cmbGenero').empty();
                                $('#cmbGenero').append('<option value="0">Seleccione una opci&oacute;n</option>');
                                if (datos.totalCount > 0) {
                                    $.each(datos.data, function (count, object) {
    ...
    //                if ($('#chbxRalacion').is(':checked')) {
    //                    alert(id);
    //                    $("tr").filter('[data-relacion="' + id + '"]').addClass('success');
    //                    consultarEfecto();
    //                    consultarGeneralSecual();
    //                    consultarTrata();
    //                    validaOpcionesRelacion(id);
    //                } else {
    //                    limpiarGeneralViolencia();
    ...
    //                    $("tr").filter('[data-relacion="' + id + '"]').removeClass('success');
    //                }
    //                if ($('input[name=chbxRalacion]').is(':checked')) {
    //                        $("tr").filter('[data-relacion="' + id + '"]').addClass('success');
    //                        consultarEfecto();
    //                        consultarGeneralSecual();
    //                        consultarTrata();
    ...
    //                }
                ...
                validaOpcionesRelacion = function (id) {
                    $.ajax({
                        type: "POST", url: "../fachadas/sigejupe/impofedelcarpetas/ImpofedelcarpetasFacade.Class.php",
                        global: false,
                        async: false,
                        dataType: "json",
                        data: {accion: "consultarRelacionPaso6",
                            idImpOfeDelCarpeta: id,
                            activo: 'S'
                        },
                        beforeSend: function (objeto) {
                        },
                        success: function (datos) {
                            if (datos.status == 'ok') {
                                ...
                                if (datos.data[0].dataOfendidos[0].cveVictimaDeViolenciaDeGenero == "1") {
                                    ...
                                    $('#divMensajeDatosViolencia').html("");
                                    console.log(datos.data[0].dataDelitos[0].cveDelito);
                                    ...
                                    //console.log(datos.data[0].dataOfendidos[0].cveVictimaDeViolenciaDeGenero);
                                    $('#divLlenaDatosViolencia').hide("");
                                    //$('#divMensajeDatosViolencia').show("");
                                    $('#divMensajeDatosViolencia').html("<center>El ofendido no fue victima de violencia de genero</center>").show();
                                }
                                if (datos.data[0].dataOfendidos[0].cveVictimaDeAcoso == "1") {
                                    $('#divLlenaEfectos').show("");
                                    $('#divMensajeEfectos').hide("");
                                    $('#divMensajeEfectos').html("");
                                } else {
                                    $('#divLlenaEfectos').hide("");
                    ...
                    $.ajax({
                        ...
                        success: function (datos) {
                            ...
                            if (datos.status == 'ok') {
                                ...
                                table += '<th width="40%" >Sujetos Pasivos del Delito</th>';
                                table += '<th width="40%" >Delito</th>';
                                table += '<th width="10%">Seleccionar</td></tr>';
                                for (var i = 0; i < datos.data.length; i++) {
                                    table += "<tr class='trSeleccion' data-relacion='" + datos.data[i].idImpOfeDelCarpeta + "'>";
                                    ...
                                    if (datos.data[i].dataOfendidos[0].cveTipoPersona == 1 || datos.data[i].dataOfendidos[0].cveTipoPersona == 4 || datos.data[i].dataOfendidos[0].cveTipoPersona == 5) {
                                    ...
                                    table += "<td><input type='radio' id='chbxRalacion' name='chbxRalacion' value='" + datos.data[i].idImpOfeDelCarpeta + "' onclick='seleccionaRelacion(" + datos.data[i].idImpOfeDelCarpeta + ");'></td>";
                                    table += "</tr>";
                                }
                                table += '</table>';
                                $('#divResultadosRelacion').html(table);
                            } else {
                                $("#divFormularioVictimas").hide("");
                                $("#divMensaje").show("");
                ...
                agregaEfecto = function () {
                    ...
                    if (validaAEfectos()) {
                        $.ajax({
                            type: "POST",
                            url: "../fachadas/sigejupe/violenciacarpetas/ViolenciacarpetasFacade.php",
                            async: false,
                            dataType: "json",
                            data: {accion: "guardaEfectosViolencia",
                                ...
                                idImpOfeDelCarpeta: $('input:radio[name=chbxRalacion]:checked').val(),
                                activo: 'S'
                            },
                            beforeSend: function (objeto) {
                            },
                    ...
                    $.ajax({
                        ...
                        success: function (datos) {
                            ...
                            if (datos.status == 'ok') {
                                ...
                                table += '</tr>';
                                table += '<tbody id="tabla-efectos">';
                                for (var i = 0; i < datos.totalCount; i++) {
                                    for (var x = 0; x < datos.data[i].dataDetalle.length; x++) {
                                        table += '<tr class="trSeleccion" id="' + datos.data[i].idViolenciaDeGeneroCarpeta + '" data-efecto="' + datos.data[i].idViolenciaDeGeneroCarpeta + '">';
                                        table += "<td><input type='radio' id='chbxEfecto' name='chbxEfecto' value='" + datos.data[i].idViolenciaDeGeneroCarpeta + "' onclick='seleccionaEfecto(" + datos.data[i].idViolenciaDeGeneroCarpeta + "," + datos.data[i].dataDetalle[x].idEfectoOfendidoCarpeta + ");'></td>";
                                        table += '<td>' + datos.data[i].desEfecto + '</td>';
                                        table += '<td>' + datos.data[i].dataDetalle[x].desDetalleEfecto + '</td>';
                                        table += "<td><center><img src='img/eliminar.png' width='27px' style='cursor:pointer;' onclick='eliminaEfecto(" + datos.data[i].idViolenciaDeGeneroCarpeta + "," + datos.data[i].dataDetalle[x].idEfectoOfendidoCarpeta + ")'></center></td></tr>";
                ...
                seleccionaEfecto = function (id, idDet) {
                    $("#tabla-efectos > tr").removeClass('success');
                    $.ajax({
                        type: "POST",
                        url: "../fachadas/sigejupe/violenciacarpetas/ViolenciacarpetasFacade.php",
                        global: false,
                        ...
                        success: function (datos) {
                            ...
                            $("#cmbHomicidioDoloso").val(0);
                            if (datos.status == 'ok') {
                                $('#hddIdViolenciaDeGenero').val(datos.data[0].idViolenciaDeGeneroCarpeta);
                                $('#hddIdEfectoOfendido').val(datos.data[0].dataDetalle[0].idEfectoOfendidoCarpeta);
                                $('#cmbEfecto').val(datos.data[0].cveEfecto);
                                comboEfectosDetalle();
                                $('#cmbDetalleEfecto').val(datos.data[0].dataDetalle[0].cveDetalleEfecto);
                                //$("tr").filter('[data-efecto="' + id + '"]').addClass('success');
                    ...
                    $.ajax({
                        ...
                        success: function (datos) {
                            ...
                            if (datos.status == 'ok') {
                                ...
                                for (var i = 0; i < datos.totalCount; i++) {
                                    table += '<tr class="trSeleccion" id="' + datos.data[i].idViolenciaFactorSocialCarpeta + '">';
                                    table += '<td onclick = "seleccionaFactorSocial(' + datos.data[i].idViolenciaFactorSocialCarpeta + ')">' + datos.data[i].desFactorCultural + '</td>';
                                    table += "<td><center><img src='img/eliminar.png' width='27px' style='cursor:pointer;' onclick='eliminaFactorSocial(" + datos.data[i].idViolenciaFactorSocialCarpeta + ")'></center></td></tr>";
                                }
                                table += '</table>';
                ...
                seleccionaFactorSocial = function (id) {
                    $.ajax({
                        ...
                        success: function (datos) {
                            if (datos.status == 'ok') {
                                $("#hddIdViolenciaFactorSocial").val(datos.data[0].idViolenciaFactorSocialCarpeta);
                    ...
                    $.ajax({
                        ...
                        success: function (datos) {
                            ...
                            if (datos.status == 'ok') {
                                ...
                                table += '<th>Eliminar</th>';
                                for (var i = 0; i < datos.totalCount; i++) {
                                    table += '<tr class="trSeleccion" id="' + datos.data[i].idViolenciaHomicidioDolosoCarpetaCarpeta + '">';
                                    table += '<td onclick = "seleccionaHomicidio(' + datos.data[i].idViolenciaHomicidioDolosoCarpeta + ')">' + datos.data[i].desHomicidioDoloso + '</td>';
                                    table += "<td><center><img src='img/eliminar.png' width='27px' style='cursor:pointer;' onclick='eliminaHomicidio(" + datos.data[i].idViolenciaHomicidioDolosoCarpeta + ")'></center></td></tr>";
                                }
                                table += '</table>';
                ...
                seleccionaHomicidio = function (id) {
                    $.ajax({
                        ...
                        success: function (datos) {
                            if (datos.status == 'ok') {
                                $("#hddIdViolenciaHomicidioDoloso").val(datos.data[0].idViolenciaHomicidioDolosoCarpeta);
                ...
                validaTrataPersonas = function () {
                    ...
                    if ($('#cmbPaisDestino').val() != "" || $('#cmbPaisDestino').val() != "0") {
                        if ($('#cmbPaisDestino').val() == "119") {
                            if ($('#cmbEstadoDestino').val() == "" || $('#cmbEstadoDestino').val() == "0") {
                                mensaje += "*Seleccione un estado destino\n";
                                error = false;
                            }
                            if ($('#cmbMunicipioDestino').val() == "" || $('#cmbMunicipioDestino').val() == "0") {
                                mensaje += "*Seleccione un municipio destino\n";
                                error = false;
                            }
                        } else {
                            if ($('#txtestadoDestino').val() == "" || $('#txtestadoDestino').val() == "0") {
                                mensaje += "*ingrese un estado destino\n";
                                error = false;
                            }
                            if ($('#txtmunicipioDestino').val() == "" || $('#txtmunicipioDestino').val() == "0") {
                                mensaje += "*ingrese un municipio destino\n";
                                error = false;
                            }
                        }
                    }
                    ...
                    $.ajax({
                        ...
                        success: function (datos) {
                            ...
                            if (datos.status == 'ok') {
                                ...
                                for (var i = 0; i < datos.totalCount; i++) {
                                    table += '<tr class="trSeleccion" id="' + datos.data[i].idTrataPersonaCarpetaCarpeta + '"><td onclick="seleccionaTrata(' + datos.data[i].idTrataPersonaCarpeta + ')">' + datos.data[i].desPaisOrigen + '</td>';
                                    if (datos.data[i].cvePaisOrigen == "119") {
                                        table += '<td onclick="seleccionaTrata(' + datos.data[i].idTrataPersonaCarpeta + ')">' + datos.data[i].desEstadoOrigen + '</td>';
                                        table += '<td onclick="seleccionaTrata(' + datos.data[i].idTrataPersonaCarpeta + ')">' + datos.data[i].desMunicipioOrigen + '</td>';
                                    } else {
                                        table += '<td onclick="seleccionaTrata(' + datos.data[i].idTrataPersonaCarpeta + ')">' + datos.data[i].estadoOrigen + '</td>';
                                        table += '<td onclick="seleccionaTrata(' + datos.data[i].idTrataPersonaCarpeta + ')">' + datos.data[i].municipioOrigen + '</td>';
                                    }
                                    table += '<td onclick="seleccionaTrata(' + datos.data[i].idTrataPersonaCarpeta + ')">' + datos.data[i].desPaisDestino + '</td>';
                                    if (datos.data[i].cvePaisDestino == "119") {
                                        table += '<td onclick="seleccionaTrata(' + datos.data[i].idTrataPersonaCarpeta + ')">' + datos.data[i].desEstadoDestino + '</td>';
                                        table += '<td onclick="seleccionaTrata(' + datos.data[i].idTrataPersonaCarpeta + ')">' + datos.data[i].desMunicipioDestino + '</td>';
                                    } else {
                                        table += '<td onclick="seleccionaTrata(' + datos.data[i].idTrataPersonaCarpeta + ')">' + datos.data[i].estadoDestino + '</td>';
                                        table += '<td onclick="seleccionaTrata(' + datos.data[i].idTrataPersonaCarpeta + ')">' + datos.data[i].municipioDestino + '</td>';
                                    }
                                    table += "<td><center><img src='img/eliminar.png' width='27px' style='cursor:pointer;' onclick='eliminaTrara(" + datos.data[i].idTrataPersonaCarpeta + ")'></center></td></tr>";
                                }
                                table += '</table>';
                ...
                seleccionaTrata = function (id) {
                    $.ajax({
                        ...
                        success: function (datos) {
                            if (datos.status == 'ok') {
                                $('#hddIdTrataPersona').val(datos.data[0].idTrataPersonaCarpeta);
                                ...
                                $('#chbxRalacion').val(datos.data[0].idImpOfeDelCarpeta);
                            } else {
                                $("#divAlertWarningViolencia").html("");
                                $("#divAlertWarningViolencia").html(datos.mnj);
                                $("#divAlertWarningViolencia").show("");
                    ...
                    $.ajax({
                        ...
                        success: function (datos) {
                            ...
                            if (datos.status == 'ok') {
                                ...
                                table += '<th>Eliminar</th>';
                                for (var i = 0; i < datos.totalCount; i++) {
                                    table += '<tr class="trSeleccion" id="' + datos.data[i].idSexualCarpeta + '">';
                                    table += "<td><input type='radio' id='chbxSexual' name='chbxSexual' value='" + datos.data[i].idSexualCarpeta + "' onclick='seleccionaSexualGeneral(" + datos.data[i].idSexualCarpeta + ");'></td>";
                                    table += '<td>' + datos.data[i].desModalidad + '</td>';
                                    table += '<td>' + datos.data[i].desAmbito + '</td>';
                                    table += "<td><center><img src='img/eliminar.png' width='27px' style='cursor:pointer;' onclick='eliminaSexualGeneral(" + datos.data[i].idSexualCarpeta + ")'></center></td></tr>";
                                }
                                table += '</table>';
                ...
                seleccionaSexualGeneral = function (id) {
                    $.ajax({
                        ...
                        success: function (datos) {
                            ...
                            $("#cmbGenero").val(0);
                            if (datos.status == 'ok') {
                                $('#hddIdSexual').val(datos.data[0].idSexualCarpeta);
                    ...
                    $.ajax({
                        ...
                        success: function (datos) {
                            ...
                            if (datos.status == 'ok') {
                                ...
                                table += '<th>Eliminar</th>';
                                for (var i = 0; i < datos.totalCount; i++) {
                                    table += '<tr class="trSeleccion" id="' + datos.data[i].idSexualConductaCarpetaCarpeta + '">';
                                    table += '<td onclick = "seleccionaConducta(' + datos.data[i].idSexualConductaCarpeta + ')">' + datos.data[i].desConducta + '</td>';
                                    table += '<td onclick = "seleccionaConducta(' + datos.data[i].idSexualConductaCarpeta + ')">' + datos.data[i].dataDetalle[0].desDetalleConducta + '</td>';
                                    table += "<td><center><img src='img/eliminar.png' width='27px' style='cursor:pointer;' onclick='eliminaConducta(" + datos.data[i].idSexualConductaCarpeta + "," + datos.data[i].dataDetalle[0].idDetalleSexualConductaCarpeta + ")'></center></td></tr>";
                                }
                                table += '</table>';
                ...
                seleccionaConducta = function (id) {
                    $.ajax({
                        ...
                        success: function (datos) {
                            if (datos.status == 'ok') {
                                $('#hddIdSexualConducta').val(datos.data[0].idSexualConductaCarpeta);
                                $('#hddIdDetalleSexualConducta').val(datos.data[0].dataDetalle[0].idDetalleSexualConductaCarpeta);
                    ...
                    $.ajax({
                        ...
                        success: function (datos) {
                            ...
                            if (datos.status == 'ok') {
                                ...
                                table += '<th>Eliminar</th>';
                                for (var i = 0; i < datos.totalCount; i++) {
                                    table += '<tr class="trSeleccion" id="' + datos.data[i].idTestigoSexualCarpeta + '">';
                                    table += '<td onclick = "seleccionaTestigo(' + datos.data[i].idTestigoSexualCarpeta + ')">' + datos.data[i].nombre + " " + datos.data[i].paterno + " " + datos.data[i].materno + '</td>';
                                    table += "<td><center><img src='img/eliminar.png' width='27px' style='cursor:pointer;' onclick='eliminaTestigo(" + datos.data[i].idTestigoSexualCarpeta + ")'></center></td></tr>";
                                }
                                table += '</table>';
                ...
                seleccionaTestigo = function (id) {
                    $.ajax({
                        ...
                        success: function (datos) {
                            if (datos.status == 'ok') {
                                $('#hddIdTestigoSexual').val(datos.data[0].idTestigoSexualCarpeta);
