...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div id="divAcuerdo" class="form-horizontal" style="display:none;">
                ...
                <p>&nbsp;</p>
                <div id="divAcuerdoJuez"></div>
                <p>&nbsp;</p>
                <div class="form-group">
                    <div class="col-md-10 col-md-offset-1">
                        <label class="control-label needed" id="">Texto de la Resoluci&oacute;n</label>
                        <p>&nbsp;</p>
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        <div class="col-md-2">
                            <input type="button" class="btn btn-primary" id="btnResolver" value="Resolver" onclick="javascript:queja.resolver()" style="display: block">
                        </div>
                        <div class="col-md-2">
    ...
    <script src="sigejupe/resolucionquejas/quejaConsejo.js" charset="UTF-8" ></script>
    <script>
                                if (editor != undefined) {
                                    editor.destroy();
                                }
