...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
    ...
    <input type="hidden" id="hiddenOrigenSegundaInstancia" value="<?php echo $OrigenSegundaInstancia; ?>" >
    ...
    <div class="panel panel-default">
                ...
                <div id="divCampos">
                    <div class="form-group">                                                                
                        <label class="control-label col-md-3 "><?php
                            $etiqueta = $OrigenSegundaInstancia == 1 ? ( "Tribunal de alzada:") : ( "Juzgado:");
                            echo $etiqueta;
                            ?></label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group">    
                        <label class="control-label col-md-3 ">No. Amparo a Radicar:</label>

                        <div class="col-md-1">

                            <input type="text" id="txtNumAmparo" placeholder="" class="form-control" value="" />
                        </div>                           
                        <label class="control-label col-md-1 ">A&ntilde;o Amparo a Radicar:</label>
                        <div class="col-md-1">
                            <input maxlength="4" minlength="4" type="text" id="txtAniAmparo" placeholder="" class="form-control" value="" />
                        </div>    
                    ...
                    <div class="form-group">                                                                
                        ...
                        <label class="control-label col-md-1">No. Oficio: <b class='requerido'>(*)</b></label>
                        <div class="col-md-1">
                            <input  type="text" id="txtOficio" placeholder="Numero de Oficio" class="form-control" value="" />
                        </div>    
                        <label class="control-label col-md-1">A&ntilde;o Oficio: <b class='requerido'>(*)</b></label>
                        <div class="col-md-1">
                    ...
                    <div class="form-group" style="display: <?php echo $OrigenSegundaInstancia == 1 ? 'none' : '' ?>">    
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group" style="display: block">
                                        ...
                                        <div class="col-md-6"> 
                                            ...
                                            <select required class="form-control bloqueoE" name="cmbTipopersonaQuejoso" id="cmbTipopersonaQuejoso" onchange="seleccionaTipoQue()">
                                    ...
                                    <div id="divImputados" style="display:block">
                                        ...
                                        <div class="col-md-12" id="ImputadosAccion" style="display:none;">
                                            ...
                                            <div id="divBotonAgregaImputado" style="display:inline-block">
                                                <input type="submit" class="btn btn-primary" id="inputAgregarImputado" value="Agregar Quejoso" onclick="    if ($('#idPersonaAddQ').val() != '') {
                                                                tablaQuejoso(true)
                                                            } else {
                                                                tablaQuejoso()
                                                            }">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div id="divOfendidos">
                                        ...
                                        <div class="form-group" id="OfendidosAccion" style="display:none;">  
                                            ...
                                            <div class="col-md-6">
                                                <div id="divBotonAgregaOfendido" style="display:inline-block">
                                                    <input type="submit" class="btn btn-primary" id="inputAgregarOfendido" value="Agregar Perjudicado" onclick="return tablaPerjudicado();">
                                                </div>
                                        ...
                                        <div class="form-group col-md-12" id="PerjudicadoAccion" style="display:none;">  
                                            <label class="control-label col-md-3"> </label>  
                                            <div id="divBotonAgregaOfendido" style="display:inline-block">
                                                <input type="submit" class="btn btn-primary" id="inputAgregarOfendido" value="Modificar Perjudicado" onclick="return tablaPerjudicadoRes();">
                                            </div>
                                            <div id="divBotonActualizarOfendido" style="display:inline-block"></div>
                                            <input type="submit" class="btn btn-primary" id="inputLimpiarOfendido" value="Regresar Perjudicado a la Lista sin modificar" onclick="return limpiarperjudicadoRes();">
                                            <input type="submit" class="btn btn-primary" id="inputLimpiarOfendido" value="Registrar nuevo Perjudicado" onclick="return limpiarperjudicadoRes();">                                                                                    
                                        </div> 
                                    </div>
                                    <br>
                                    <br>                                
                                    ...
                                    <div class="form-group" style="display:none">
                                        <label class="control-label col-md-3">Lista Perjudicado(s):</label>
                                        <div class="col-md-6">
                                            <select
        ...
        <script type="text/javascript">
            ...
            var origen = "<?php echo $OrigenSegundaInstancia; ?>";
            if (editor != undefined) {
                editor.destroy();
            } else {
                ...
                launchDigitalizador(strl);
                    ...
                    visorDocuemntos = function () {
                        $.ajax({
                            ...
                            data: {idCarpetaJudicial: 0, idActuacion: $('#hiddenIdAmparo').val(), cveTipoDocumento: 2},
                            async: false,
                            dataType: 'html',
                            beforeSend: function () {
            ...
            consultar = function (elementomostrar) {
                ...
                var permisos = null;
                                if($("#hiddenOrigenSegundaInstancia").val() == ""){
                                   permisos = obtenerPermisosFormulario("ATENCION PUBLICO", "AMPAROS");
                                }else{
                                    if($("#hiddenOrigenSegundaInstancia").val() == "1"){
                                       permisos = obtenerPermisosFormulario("HERRAMIENTAS", "RADICAR AMPAROS");
                                    }
                                }
            ...
            buscarAmparo = function (pag) {
                ...
                $.ajax({
                    type: "POST",
                    url: "../fachadas/sigejupe/amparos/RadicarAmparosFacade.Class.php",
                    data: {
            ...
            validarFormulario = function () {
                ...
                if (activaValidacion == 1) {
                    ...
                    if (aniAmparo.length < 4) {
                        $('#txtAniAmparo').parent().append("<br class='required'><label class='Arial13Rojo required'>Debe ingresar el numero y a&ntilde;o  valido</label>");
                        guardar = 0;
                    }
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data.totalCount > 0) {
                                ...
                                $("#hiddenIdAmparo").val(data.amparo.idAmparo);
                                $("#txtNumAmparo").val(data.amparo.numAmparo);
                                $("#txtAniAmparo").val(data.amparo.aniAmparo);
                                buscarAmparoById(data.amparo.idAmparo);
                            } else {
                                $("#divAlertDager").html("Error en la peticion:\n\n" + data.text);
                                $("#divAlertDager").show("slide");
                                setTimeAlert("divAlertDager");
            ...
            $(function () {
                cargaInstancia();
                $("#txtAniAmparo").focusout(function () {
                    //                    alert($("#txtAniAmparo").val().length);
                    if ($("#txtAniAmparo").val().length < 4) {
                        $("#txtAniAmparo").val("");
                        alert("A\u00F1o no valido");
                    }
                });
                $("#txtOficio2").focusout(function () {
                    //                    alert($("#txtAniAmparo").val().length);
                    if ($("#txtOficio2").val().length < 4) {
                        $("#txtOficio2").val("");
                        alert("A\u00F1o no valido");
                    }
                });
                ...
                $("#txtNumAmparo").validaCampo('0123456789');
                $("#txtAniAmparo").validaCampo('0123456789');
                $("#txtOficio2").validaCampo('0123456789');
