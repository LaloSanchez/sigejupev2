...
<div class="panel panel-default">
    <div class="panel-heading">
        <h5 class="panel-title">
            Sujeto(s) pasivo(s) del delito Carpetas Judiciales
        </h5>
    </div>
            ...
            <div class="tab-content tabs-flat">
                ...
                <div class="tabbable tabs-left">
                    <ul id="myTab3" class="nav nav-tabs">
                        ...
                        <li class="tab-orange">
                            <a href="#divNacionalidadesPaso3" data-toggle="tab" aria-expanded="false"><span class="requerido">(*)</span>Nacionalidades</a>
                        </li>
                    </ul>
...
//            }
            ...
            if ($('#nombreMoral').val() == "" || $('#nombreMoral').val() == "0") {
                mensaje += "*Escribe el Nombre del sujeto pasivo del delito\n";
                error = false;
            }
            ...
            if ($("#txtRfcMoralOfendido").val() != "") {
                ...
                if (!regex.test(rfcStr)) {
                    mensaje += "*Ingresa un RFC válido para el sujeto pasivo del delito \n";
                    error = false;
                }
