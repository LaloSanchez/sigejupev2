...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
    ...
    $formularioImputados = (  isset($_POST['formularioImputados']) ?  @$_POST['formularioImputados'] : '' );
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <input type="hidden" id="formularioImputados" name="procedencia" value="<?=$formularioImputados?>" />
        ...
        <div id="divFormulario" class="form-horizontal" data-step="1" data-intro="Este m&oacute;dulo le permite registrar una nueva Suspensi&oacute;n Condicional, el cual puede ser modificado y/o eliminado." data-position='left'>
...
<!-- fin acordeon -->
            ...
            <div class="form-group">
                <div class="col-md-offset-3 col-md-9">
                                    <div class="col-md-2 botonesAdaptar" data-step="3" data-intro="Presi&oacute;nelo para guardar o actualizar una Suspensi&oacute;n Condicional." data-position='top'>                                        
                                        <input type="submit" class="btn btn-primary btn-adaptar" value="Guardar" onclick="saveMcautelares()" id="btn_mcautelares_save"/>
                </div>
                                    <div class="col-md-2 botonesAdaptar" data-step="5" data-intro="Util&iacute;celo para limpiar la informaci&oacute;n seleccionada/introducida." data-position='top'>                                        
                                        <input type="submit" class="btn btn-primary btn-adaptar" value="Limpiar" onclick="cleanFields()" id="btn_mcautelares_clean"/>
            </div>
                                    <div class="col-md-2 botonesAdaptar botonesArbol" data-step="4" data-intro="De clic para buscar una Suspensi&oacute;n Condicional." data-position='top'>                                        
                        ...
                        $.each(response.perfiles[0].perfil[i].permisos, function (k, vnombre) {
                            if(vnombre.nomFormulario == "CARPETAS JUDICIALES"){
                                ...
                                $.each(hijos, function (k2, nombreHijo) {
                                    if (nombreHijo.nomFormulario == 'MEDIDAS CAUTELARES') { //SUSPENSION CONDICIONAL
    ...
    */
    function changeModule(idModule){
        ...
        if(idModule == 6){
            changeDivForm(2);
            //cambia el titulo
            var titulo = '<a href="#" onclick="changeModule(1)" style="text-decoration:underline;">Suspensi&oacute;n Condicional</a> / B&uacute;squeda';
            $('#medidasCautelaresTitulo').empty().append(titulo);
        }
        return;
    }
            ...
            $.each(list, function(k,v){
                ...
                if( controlador){
                    if( v.imputadoCheck == false && v.imputadoActivoDiferenteActuacion!=''){
                        ...
                        name += '<span class="pull-right"><span class="glyphicon glyphicon-pushpin"></span>&nbsp;&nbsp;<span style="font-size:10pt;">Suspensi&oacute;n Condicional asignada el ' + v.imputadoActivoDiferenteActuacion + '</span></span>';
                        medidaImputado = true;
                    }
                }else{
                    $.each( medidasAplicadas, function(llave, valor){
                        if( imputadoId == valor.idImputado){
                            name += '<span class="pull-right"><span class="glyphicon glyphicon-pushpin"></span>&nbsp;&nbsp;<span style="font-size:10pt;">Suspensi&oacute;n Condicional asignada el ' + valor.fecha + '</span></span>';
                            medidaImputado = true;
                        }
                    });
                }
...
//                        if( medidaImputado == false ){
                ...
                tbody += '              <a id="collapsed' + imputadoId +'" class="collapsed imputadoDesc" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse' + imputadoId +'" aria-expanded="false" aria-controls="collapse' + imputadoId +'" "disabled">'
                        + '                 ' + name
                        + '             </a>';
//                        }else{
...
//                        }
                tbody += '          </h4>'
                        ...
                        + '         <div class="panel-body" id="panel-imputado_' + imputadoId +'"> <!-- inicio div Suspensi&oacute;n Condicional --> '
                        + '         <div class="form-group"> <!-- Suspensi&oacute;n Condicional -->'
                        + '             <label class="control-label col-xs-12 col-sm-2 col-md-2 needed">Suspensi&oacute;n Condicional</label>'
                        + '             <div class="col-xs-12 col-sm-10 col-md-10">'
                        + '                 <select id="select_mcautelares_medidas_' + imputadoId +'" class="form-control" tabindex="" onchange="selectMedidasCautelares(' + imputadoId +')" ></select>'
                        + '             </div>'
                        + '         </div>'
                        + '         <div class="form-group" id="listaMedidasCautelares_' + imputadoId +'"> <!-- lista de medidas cautelares --> '
                        + '             <table style="width:95%; margin-left:auto; margin-right:auto;" class="table table-responsive table-striped table-hover"><thead><tr><th colspan="2">Suspensi&oacute;n Condicional</th></tr></thead><tbody id="tablaMedidasCautelares_' + imputadoId +'"></tbody></table>'
                        + '         </div> <!-- lista de medidas cautelares/ -->'
                        + '         <!-- *** seccion de informacion de Suspensi&oacute;n Condicional eliminada *** -->'
                        + '         <div class="form-group"> <!-- checkbox para todas las medidas -->'
                        + '             <div class="col-xs-1 col-sm-1 col-md-1" style="text-align:right;">'
                        + '                 <input type="checkbox" id="medidasDatosIguales_' + imputadoId + '" class="medidasDatosIguales" disabled="disabled"/>'
                        + '             </div>'
                        + '             <label for="medidasDatosIguales_' + imputadoId + '" class="control-label col-xs-11 col-sm-11 col-md-11" style="text-align:left;">Aplicar los mismos datos de Autoriad Emisora y Periodo de tiempo a todas las Suspensiones Condicionales de este Imputado.</label>'
                        + '         </div> <!-- /checkbox para todas las medidas -->'
                        + '         <!-- seccion de datos para todas las medidas -->'
                        + '         <div class="form-group" style="display:none;" id="divMedidasDatosIguales_' + imputadoId + '" class="divMedidasDatosIguales"><!-- <div class="form-group"> <!-- Autoridad Emisora - - >'
                        + '             <label class="control-label col-xs-12 col-sm-2 col-md-2">Autoridad emisora</label>'
                        + '             <div class="col-xs-12 col-sm-10 col-md-10">'
                        + '                 <select id="select_mcautelares_autoridad_' + imputadoId + '" class="form-control select_mcautelares_autoridad" tabindex=""></select>'
                        + '             </div>'
                        + '         </div>-->'
                        + '         <div class="form-group">'
                        + '             <label class="control-label col-xs-12 col-sm-2 col-md-2">Periodo de tiempo</label>'
                        + '             <div class="col-xs-6 col-sm-4 col-md-3">'
                        + '                 <input type="text" id="input_mcautelares_finicial_' + imputadoId + '" placeholder="FECHA DE INICIO" class="form-control fecha fechaMedidasIgualesInicio"/>'
                        + '             </div>'
                        + '             <div class="col-xs-6 col-sm-4 col-md-3">'
                        + '                 <input type="text" id="input_mcautelares_ffinal_' + imputadoId + '" placeholder="FECHA DE TERMINO" class="form-control fecha fechaMedidasIgualesFinal"/>'
                        + '             </div>'
                        + '         </div></div>'
                        + '         <!-- /seccion de datos para todas las medidas -->'
                        + '         <!-- seccion mensaje para ingresar al menos una Suspensi&oacute;n Condicional  -->'
                        + '         <div class="form-group"><div class="col-xs-10 col-xs-offset-1 col-sm-10 col-sm-offset-1 col-md-10 col-md-offset-1" id="mensajeMedidaMinima_' + imputadoId + '"></div></div>'
                        + '         <!-- /seccion mensaje para ingresar al menos una Suspensi&oacute;n Condicional  -->'
                        + '         <!-- <div class="form-group"> <!-- botones - ->'
                        + '             <div class="col-xs-offset-1 col-xs-11">'
                        + '                     <input type="submit" class="btn btn-primary" value="Limpiar datos del Imputado" onclick="cleanImputadoInfoFields(' + imputadoId + ')" id="btn_mcautelares_imputado_clean"/>'
                        + '             </div>'
                        + '         </div> <!-- botones/ - -> --> <!-- Suspensi&oacute;n Condicional/ -->'
                        + '         <div class="form-group">'
            ...
            fillCombo(tiposMedidas,'tipossuspensioncondicionales/TipossuspensioncondicionalesFacade','cveTipoSuspensionCondicional','desTipoSuspensionCondicional');
    ...
    */
        ...
        var test = $(' table [id^=tablaMedidasCautelares_]').each( function(k,v){
            ...
            if( $('#imputadoCheck_' + idImputado).prop('checked') ){
                ...
                if( arregloMedidas.length == 0 ){
                    $('#collapse' + idImputado).collapse("show");
                    showMessage('Debe definir al menos una Suspensi&oacute;n Condicional.','information','','mensajeMedidaMinima_' + idImputado);
                    estado = false;
                }else{
                    estado = true;
                }
    ...
    /**
    * Busca Imputados de las Suspensi&oacute;n Condicional, si existe lo borra y reduce en 1 el contador
    ...
    */
    ...
    /**
    * FunciOn para la validaciOn de checks antes de guardar la Suspensi&oacute;n Condicional
    */
    ...
    */
    ...
    /**
    * FunciOn para guardar las Suspensi&oacute;n Condicional
    */
    ...
    function saveMcautelares(){
        ...
        if(idActuacion == ''){
            //es insercion
            accion = 'guardaSuspensionCondicional';  //'guardaMedidasCautelares';
        }else{
            //es actualizacion
            accion = 'actualizaSuspensionCondicional'; //'actualizaMedidasCautelares';
        }
        ...
        if(mcState == true && imputadosState == true ){ //&& medidasState == true){
            ...
            if(estadoApelaciones == true && estadoImputados == true && estadoImputados2 == true && medidaImputados == true){
                //guarda Suspensi&oacute;n Condicional
                $.post("../fachadas/sigejupe/actuaciones/ActuacionesFacade.Class.php",
                    {
        ...
        $.post("../fachadas/sigejupe/actuaciones/ActuacionesFacade.Class.php",
            {
                idActuacion:idActuacion,
                activo:activo,
                accion:'borraSuspensionCondicional' //'borraMedidaCautelar'
            },function(response){
            var object = eval('(' + response + ')');
            var totalRecords = object.totalCount;
            var message = object.text;
        ...
        $.each(imputadosList, function(index,value){
            ...
            //verificar si el imputado tiene apelacion definida
                ...
                if(elemento.apelacionSentido == 0 || elemento.apelacionNumero == '' || elemento.apelacionAnio == '' || elemento.apelacionSala == 0){
                    ...
                    //abre el div de la Suspensi&oacute;n Condicional
    ...
    */
    function loadApelacionInfo(fullId){
        ...
        var tablaInfo = '<table><tr><td style="text-align:right;">Apelaci&oacute;n de:</td>'
            + '<td style="text-align:left; padding-left:10px;"><b>' + $.trim($('#collapsed' + idImputado[0] ).text()) + '</b></td></tr>'
            + '<tr><td style="text-align:right;">Para la Suspensi&oacute;n Condicional:</td>'
            + '<td style="text-align:left; padding-left:10px;"><b>' + $('#medidaImputado_' + fullId ).text() + '</b></td></tr></table>';
    ...
    */
    ...
    /**
    * FunciOn buscar Suspensi&oacute;n Condicional con los parametros definidos
    */
        ...
        $.post("../fachadas/sigejupe/actuaciones/ActuacionesFacade.Class.php",
            {
                ...
                pag:page,
                cantxPag:cantReg,
                accion:'buscarSuspensionCondicional' //'buscarMedidasCautelares'
            },function(response){
                var object = eval('(' + response + ')');
                var totalRecords = object.totalCount;
                if(totalRecords>0){
    ...
    function imputadosMedidaCautelar(idReferencia, idActuacion){
        $.ajax({
            ...
            data: {
                idActuacion:idActuacion,
                idReferencia:idReferencia,
                accion:'imputadosSuspensionCondicional' //'imputadosMedidaCautelar'
            },
            success: function (response) {
    ...
    */
    function imputadosTableCheck(imputados,tipoCarpeta){
        ...
        $.each(imputados, function(k,v){
            ...
            comboEspecial('tipossuspensioncondicionales/TipossuspensioncondicionalesFacade.Class.php','select_mcautelares_medidas_'+idImputadoCarpeta,v.cveTipoMedidaCautelar,'cveTipoSuspensionCondicional','desTipoSuspensionCondicional');
    ...
    llenareditor = function (value) {
        try {
            editor.ready(function () {
                setTimeout(function(){
/*                    if(localStorage.getItem("textoObservaciones") != ''){
                        value = localStorage.getItem("textoObservaciones");
                        //localStorage.removeItem("textoObservaciones");
                    }*/
                    console.log('value');
                    console.log(value);
...
//                       alert(2);
                            if (json.data[i].cveInstancia == instancia) {
                              ...
                              $("#cveTipoJuzgado, #cveTipoJuzgado_busqueda").append($('<option selected></option>').val(json.data[i].cveJuzgado+"/"+json.data[i].cveTipojuzgado).html(json.data[i].desJuzgado));                               
                            }
                        }
                        if (json.data[i].cveInstancia == instancia) {
//                       alert(3);
...
//                       alert(5);
    ...
    function agregaRenglonMedida(idImputado,opcionId,opcionTxt){
        ...
        + '             <div class="col-xs-12 col-sm-10 col-md-10">'
        + '                 <select id="select_mcautelares_autoridad_' + idImputado + '-' + opcionId + '" class="form-control" tabindex=""></select>'
        + '             </div>'
        + '         </div> -->'
        + '         <div class="form-group">'
        + '             <label class="control-label col-xs-12 col-sm-2 col-md-2 needed">Periodo de tiempo</label>'
        + '             <div class="col-xs-6 col-sm-4 col-md-3">'
        + '                 <input type="text" id="input_mcautelares_finicial_' + idImputado + '-' + opcionId + '" placeholder="FECHA DE INICIO" class="form-control fecha"/>'
        + '             </div>'
        + '             <div class="col-xs-6 col-sm-4 col-md-3">'
        + '                 <input type="text" id="input_mcautelares_ffinal_' + idImputado + '-' + opcionId + '" placeholder="FECHA DE TERMINO" class="form-control fecha"/>'
        + '             </div>'
        + '             <div class="col-xs-2">'
        + '             </div>'
        + '         </div>'
        + '         <div class="form-group"> <!-- Apelacion -->'
        + '             <label class="control-label col-xs-12 col-sm-2 col-md-2">Apelaci&oacute;n del imputado</label>'
        + '             <div class="col-xs-12 col-sm-8 col-md-7">'
        + '                 <select id="select_mcautelares_apelacion_' + idImputado + '-' + opcionId + '" class="imputadoApelacion">'
        + '                     <option value="N">NO</option>'
        + '                     <option value="S">SI</option>'
        + '                 </select>'
        + '                 <button id="edit_' + idImputado + '-' + opcionId + '" onclick="loadApelacionInfo(\'' + idImputado + '-' + opcionId + '\')" type="button" class="btn btn-default btn-sm" aria-label="Left Align" disabled="disabled">'
        + '                     <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Editar Apelaci&oacute;n'
        + '                 </button>'
        + '             </div>'
        + '         </div> <!-- Apelacion/ -->'
        + '         <div class="form-group"><div class="col-xs-10 col-xs-offset-1 col-sm-10 col-sm-offset-1 col-md-10 col-md-offset-1" id="mensajeMedida_' + idImputado + '-' + opcionId + '"></div></div>'
        + '</div></div></td><td style="width:10%;"><button type="button" class="btn btn-danger" onclick="$(this).parent().parent().remove(); eliminaRegistroMedidaCautelar(' + idImputado + ',' + opcionId + ');"><span class="glyphicon glyphicon-trash " aria-hidden="true"></span></button></td></tr>';
    ...
    */
    ...
    $("#btn_buscaCarpeta").on('click', function(){
        ...
        var activo = 'S';
        var accion = 'buscarImputadosSuspensionCondicional'; //'obtenerAuto';
        var idActuacion = idActuacion || '';
    ...
    /**
    * ConfirmaciOn de la eliminaciOn de una Suspensi&oacute;n Condicional
    */
    ...
    function visorDocuemntos() {
            $.ajax({
                ...
                data: {idCarpetaJudicial: "", idActuacion: $('#idActuacion').val(), cveTipoDocumento: 27}, //malo
                async: false,
                dataType: 'html',
                beforeSend: function () {
    ...
    */
    ...
    /**
    * Variable para almacenar las Suspensi&oacute;n Condicional
    */
    ...
    * Variables varias
    */
    var titulos = {'titulo1':'Suspensi&oacute;n Condicional ','titulo2':'B&uacute;squeda','titulo3':'Resultados','titulo4':'Captura de Apelaci&oacute;n'};
    var cveJuzgado = $('#SysCveAdscripcion').val();
    var cveUsuario = $('#SysCveUsuarioSistema').val();
    var cveTipoActuacion = 24;
    var imputadosMC = '';
