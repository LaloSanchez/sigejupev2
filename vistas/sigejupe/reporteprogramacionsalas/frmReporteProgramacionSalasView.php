            ...
            <form id="formProgramaciones" method="post">
                <div id="contenidoReporte" style="width: 100%;">
                    ...
                    <table id="tblResultados" align="center" class="table" style="border: solid 1px #000; width: 100%;" cellspacing="0" cellpadding="2">
                        ...
                        <th style="border: solid 1px #000; width: 30%"><div style="color: #000;">CONDICI&Oacute;N</div></th>
                ...
                $.ajax({
                    ...
                    success: function (datos) {
                        try {
                            ...
                            $("#encabezado").html("Horarios de atenci&oacute;n salas " + texto);
                            ...
                            if (result.totalCount > 0) {
                                ...
                                for (var s = 0; s < arregloIdSala.length; s++) {
                                    html += '<tr id="' + arregloIdSala[s] + '" style="background-color: #00695c; color: #FFFFFF;"><td colspan="5" align="center">' + arregloSala[arregloIdSala[s]] + '</td></tr>';
