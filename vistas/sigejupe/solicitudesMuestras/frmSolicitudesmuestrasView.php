...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div id="divNumeroMuestra" style="display:none;">
                <table border='0' cellpadding="2" align="right" cellspacing="0" class="Arial12" width="20%">
                    <tr>
                        <td align="right"><strong>N&uacute;mero de Toma de Muestra:</strong></td>
                        <td align="left"><input type="text" class="frmcaja" id="numMuestra" value="" name="numMuestra" size="5" readonly></td>
                        <td align="center">/</td>
                        <td align="left"><input type="text" class="frmcaja" id="aniMuestra" value="" name="aniMuestra" size="5" readonly></td>
                    </tr>
                </table> 
            </div>
            <div class="row" >
                    ...
                    <div class="steps">
                        <ul>
                            ...
                            <!--                        <li class="step step-2 Paso2">
                                                        <a href="#"><strong>Paso 2</strong><br>Toma de Muestras y Reconocimiento De Ex&Aacute;menes F&Iacute;sicos</a>
                                                    </li>-->
                            <li class="step step-3 Paso3">
                                <a href="#"><strong>Paso 2</strong><br>Imputado(s),Victima(s) y Delitos (opcional)</a>
                            </li>
                            <li class="step step-4 Paso4">
                                <a href="#"><strong>Paso 3</strong><br>Solicitud escrita</a>
                            </li>
                            <li class="step step-5 Paso5">
                                <a href="#"><strong>Paso 4</strong><br>Terminos de uso</a>
                            </li>
                        </ul>
                    </div>  
                </div>
                    ...
                    <fieldset>
                        <div id="divPaso1" class="content col-xs-12" style="display:block;">
                            <div class="form-group" >
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                    <select class="form-control" name="cmbJuzgadoSolicitar" id="cmbJuzgadoSolicitar">
                                        <option value="0">Seleccione el juzgado a solicitar la toma de muestras</option>
                                    </select>
                                </div>                                
                            </div>
                            ...
                            <div class="form-group" >
                                <label for="txtNumCausa" class="control-label col-lg-3 col-md-3 col-sm-12 col-xs-12" >
                                    <input type="radio" value="1" name="tipoNumero" id="tipoNumero" onclick="javascript:tomamuestras.seleccionTipo(this)" checked="">&nbsp;N&uacute;mero de Causa: 
                                </label>
                                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group" >
                                <label for="txtCarpeta" class="control-label col-lg-3 col-md-3 col-sm-12 col-xs-12" >
                                    <input type="radio" value="2" name="tipoNumero" id="tipoNumero" onclick="javascript:tomamuestras.seleccionTipo(this)">&nbsp;Otro:
                                </label>
                            ...
                            <div class="form-group text-center" >
                                <button class="btn btn-primary text-right" id="btnStart" onclick="javascript:tomamuestras.validarPaso1(true)">Siguiente &gt;</button>
                            </div>
                        </div>
                        <!--                    <div id="divPaso2" class="content col-xs-12" style="display:none;">
                                                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                                    <div class="panel panel-default">
                                                        <div class="panel-heading" role="tab" id="headingOne">
                                                            <h4 class="panel-title">
                                                                <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                                    TOMA DE MUESTRAS FRACCI&Oacute;N 4
                                                                </a>
                                                            </h4>
                                                        </div>
                                                        <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                                            <div class="panel-body">
                                                                ...
                                                                <div class="form-group text-center" > 
                                                                    <button onclick="javascript:tomamuestras.addPersona()" class="btn btn-primary addPerson" >Agregar + </button> 
                                                                ...
                                                                <table id="tblPersonas" class="table table-striped table-bordered">
                                                                    <thead>
                                                                        <tr>
                                                                            <th>Nombre</th>
                                                                            <th>Domicilio</th>
                                                                            <th class="text-center" ><button class="btn btn-danger" onclick="javascript:tomamuestras.deleteRow(this)">Eliminar</button></th>
                                                                        </tr>
                                                                    </thead>
                                                                </table>
                                                    ...
                                                    <div class="panel panel-default">
                                                        <div class="panel-heading" role="tab" id="headingTwo">
                                                            <h4 class="panel-title">
                                                                <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                                                    RECONOCIMIENTO DE EX&aacute;MENES F&Iacute;SICOS FRACCI&Oacute;N 5
                                                                </a>
                                                            </h4>
                                                        </div>
                                                        <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                                            <div class="panel-body">
                                                                ...
                                                                <div class="form-group text-center" >
                                                                    <button onclick="javascript:tomamuestras.addObjeto()" class="btn btn-primary addObjeto" >Agregar + </button>
                                                                    ...
                                                                    <table id="tblObjetos" class="table table-bordered table-striped table-hover">
                                                                        <thead>
                                                                            <tr>
                                                                                <th>Descripcion</th>
                                                                                <th>Domicilio</th>
                                                                                <th  class="text-center"><button onclick="javascript:tomamuestras.deleteRow(this)" class="btn btn-danger" >Eliminar</button></th>
                                                                            </tr>
                                                                        </thead>
                                                                    </table>                                                       
                                                                </div>
                                                    ...
                                                    <div class="form-group text-center" >
                                                        <br />
                                                        <button class="btn btn-primary" onclick="javascript:tomamuestras.siguiente('liPaso1', 'liPaso2')">&lt; Anterior </button>
                                                        <button class="btn btn-primary" onclick="javascript:tomamuestras.validaPasos2()">Siguiente &gt;</button>
                                                    </div>
                        ...
                        <div id="divPaso3" class="content  col-xs-12" style="display:none">                                        
                            <div class="panel-group" id="accordiont" role="tablist" aria-multiselectable="true">
                                        ...
                                        <div class="panel-body">
                                            <div class="form-group" >
                                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" >
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12" >
                                                        <select onchange="javascript:tomamuestras.TipoPersona(this, 1)" name="cmbTipoPersona" id="cmbTipoPersona" class="form-control">
                                            ...
                                            <div class="form-group text-center" >
                                                <button class="btn btn-primary addImputado" onclick="javascript:tomamuestras.addImputados()">Agregar + </button>
                                                                    ...
                                                                    <table id="tblImputadosCausa" class="table table-bordered table-condensed table-hover">
                                                                        <thead>
                                                                            <tr>
                                                                                ...
                                                                                <th>Domicilio</th>
                                                                                <th>G&eacute;nero</th>
                                                                                <th class="text-center" ><button class="btn btn-primary" onclick="javascript:tomamuestras.addImputadosCausa(this, 'tblImputados')">Agregar</button></th>
                                                                            </tr>
                                                                        </thead>
                                                                    </table> 
                                                                </div>
                                                ...
                                                <table id="tblImputados" class="table table-bordered table-condensed table-hovers" >
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>Acciones</th>
                                                            <th style="width: 25px" class="text-center"><button class="btn btn-danger" onclick="javascript:tomamuestras.deleteRow(this)"><span><i class="fa fa-trash-o" ></i></span></button></th>
                                                        </tr>
                                                    </thead>
                                                </table>
                                            </div>
                                        ...
                                        <div class="panel-body">
                                            <div class="row" >
                                                <div class="change col-xs-12 col-md-12 col-lg-12 col-sm-12" >
                                                    <div class="form-group" >
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
                                                            <label class="control-label col-lg-3 col-md-3 col-sm-12 col-xs-12">* Tipo de Persona:</label>
                                                            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12" >
                                                                <select onchange="javascript:tomamuestras.TipoPersona(this, 2)" name="cmbTipoPersonaVictima" id="cmbTipoPersonaVictima" class="form-control">
                                                                    <option value="0" >Selecciona una Opci&oacute;n</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12" >
                                                    ...
                                                    <div class="form-group text-center " >
                                                        <button onclick="javascript:tomamuestras.addVictimas()" class="btn btn-primary addOfendido" >Agregar +</button>
                                                                            ...
                                                                            <table id="tblVictimasCausa" class="table table-bordered table-condensed table-hover table-striped" >
                                                                                <thead>
                                                                                    <tr>
                                                                                        ...
                                                                                        <th>Domicilio</th>
                                                                                        <th>G&eacute;nero</th>
                                                                                        <th class="text-center"><button class="btn btn-primary" onclick="javascript:tomamuestras.addVictimasCausa(this, 'tblVictimas')">Agregar</button></th>
                                                                                    </tr>
                                                                                </thead>
                                                                            </table> 
                                                                        </div>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div id="DelitosThreeTabCollapse" class="panel-collapse collapse" role="tabpanel" aria-labelledby="DelitosThreeTabCollapse">
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group text-center" >
                                                <button class="btn btn-primary addDelito" onclick="javascript:tomamuestras.addDelito()">Agregar</button>
                                                                ...
                                                                <div class="table-responsive" >
                                                                    <table id="tblDelitosCausa" class="table table-bordered table-striped table-condensed">
                                                                        <thead>
                                                                            <tr>
                                                                                <th>Delitos</th>
                                                                                <th class="text-center"><button onclick="javascrip:tomamuestras.addDelitosCausa(this, 'tblDelitos')" class="btn btn-primary" >Agregar</button></th>
                                                                            </tr>
                                                                        </thead>
                                                                    </table> 
                                                                </div>
                                ...
                                <div class="form-group text-center" >
                                    <br />
                                    <button class="btn btn-primary" onclick="javascript:tomamuestras.siguiente('liPaso1', 'liPaso3')">< Anterior </button>
                                    <button class="btn btn-primary" onclick="javascript:tomamuestras.validaPasos3()">Siguiente ></button>
                                </div>
        ...
        <!--<textarea id="txtSolicitud" placeholder="Solicitud" name="txtSolicitud" rows="15" class='form-control'></textarea>-->
                            ...
                            <div class="form-group" >
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12" >
                                    <input type="file" name="fileSolicitud" id="fileSolicitud" size="60" onchange="if (!tomamuestras.formato(this)) {
                                                this.value = ''
                                            }">
                                </div>
                            </div>
                            ...
                            <div class="form-group text-center" >
                                <button class="btn btn-primary" onclick="javascript:tomamuestras.siguiente('liPaso3', 'liPaso4')">< Anterior </button>
                                <button class="btn btn-primary" onclick="javascript:tomamuestras.validaPasos4()">Siguiente ></button>
                            </div>
                        ...
                        <div id="divPaso5" class='content col-xs-12' style='display:none;'>
                                        ...
                                        <div class="form-group" >
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" >
                                                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12" >
                                                    <button onclick="javascript:tomamuestras.addMPs('')" class="btn btn-primary" >Agregar + </button>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="form-group text-center registerMuestra" style="display:none">
                                <h3>N&uacute;mero de Toma de Muestra Registrado : <muestranumber></muestranumber></h3>
                                <h3>N&uacute;mero de Carpeta : <carpetanumber></carpetanumber></h3>
                            </div>
                            ...
                            <div class="form-group text-center registerNip" style="display:none">
                                ...
                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12" >
                                    <button class="btn btn-primary" onclick="javascript:tomamuestras.enviar()" >Enviar Solicitud con Nip</button>
                                    <button class="btn btn-primary" onclick="javascript:tomamuestras.cancelanip()" >Cancelar</button>
                                </div>
                            </div>
                            <div class="form-group text-center btnsSendSolicitud" >
                                <button id="btnAnterior" class="btn btn-primary" onclick="javascript:tomamuestras.siguiente('liPaso4', 'liPaso5')">< Anterior </button>
                                <button id="btnEnviar" class="btn btn-primary" onclick="javascript:tomamuestras.enviar()">Enviar</button>
                                <button id="btnEnviarNip" class="btn btn-primary" onclick="javascript:tomamuestras.nip()">Enviar con NIP</button>
                            </div>
                        </div>
                        <input type="hidden" name="txtIdMuestra" id="txtIdMuestra" value="">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content" id="toma-muestras">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="javascript:tomamuestras.cancelar()" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="sigejupe/solicitudesMuestras/tomademuestras.js" charset="UTF-8" ></script>
    <script>
                        var tomamuestras = new TomadeMuestras();
                        ...
                        $(function () {
                            ...
                            getMP = function () {
                                ...
                                $.getJSON(url, function (json) {
                                    if (json !== "") {
                                        tomamuestras.addMPs(json.nombre, json.paterno, json.materno);
                                    }
                                });
                            }
                            getMP();
