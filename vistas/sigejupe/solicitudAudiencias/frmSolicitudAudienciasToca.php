    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <input type="hidden" readonly class="form-control" id="hddIdSolicitudAudiencia"
                   value="<?php echo $idSolicitudAudiencia; ?>">
            <div id="divFormulario" class="form-horizontal">
                <p class="col-lg-12" style="color:darkred;">
                    Los campos marcados con (*) son obligatorios.
                </p>
                <div class="form-group col-lg-12">
                    <label class="control-label col-md-3" for="cmbJuzgados">Salas <span
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="col-md-9">
                        <select id="cmbTipoCarpeta" class="form-control" name="cmbTipoCarpeta">
                            ...
                            <option>Asunto nuevo</option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3">N&uacute;mero
                        <span class="requerido">(*)</span>
                    </label>
                    <div class="col-md-9">
                        <input type="text" id="txtNumero" class="form-inline" id="txtNumero"
                               placeholder="N&uacute;mero">/<input type="text" class="form-inline" id="txtAnio" id="txtAnio"
                               maxlength="4" placeholder="A&ntilde;o">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3">Carpeta de Investigaci&oacute;n</label>
                    <div class="col-md-6">
                        <input type="text" readonly="readonly" class="form-control mayuscula" id="txtCarpetaInvestigacion"
                               placeholder="Carpeta de Investigaci&oacute;n">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3">NUC (N&uacute;mero &uacute;nico de causa)</label>
                    <div class="col-md-6">
                        <input type="text" readonly="readonly" class="form-control mayuscula " id="txtNumeroUnicoCausa" placeholder="NUC">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3">N&uacute;mero de Imputados <span class="requerido">(*)</span>
                    </label>
                    <div class="col-md-6">
                        <input type="text" class="form-control" id="txtNumeroImputados"
                               placeholder="N&uacute;mero de Imputados" maxlength="3" onchange="validaConsignacion();">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3">N&uacute;mero de Ofendidos y/o V&iacute;ctimas <span
                            class="requerido">(*)</span></label>
                    <div class="col-md-6">
                        <input type="text" class="form-control" id="txtNumeroOfendidos"
                               placeholder="N&uacute;mero de Ofendidos y/o V&iacute;ctimas" maxlength="3">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3">N&uacute;mero de Delitos <span
                            class="requerido">(*)</span></label>
                    <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <textarea style="resize: none;" rows="5" id="txtObservaciones" class="form-control mayuscula"
            ...
            <div id="divConsulta"  class="form-horizontal" style="display: none">                                                              
                <div class="form-group col-lg-12">
                    <label class="control-label col-md-3" for="cmbJuzgadosConsulta">Salas</label>
                    <div class="col-md-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input type="text" id="txtNumeroConsulta" class="form-inline" id="txtNumeroConsulta"
                               placeholder="N&uacute;mero">/<input type="text" class="form-inline" id="txtAnioConsulta"
                               name="txtAnioConsulta" maxlength="4"
                ...
                <div class="form-group">
                    <label class="control-label col-md-3">Carpeta de Investigaci&oacute;n</label>
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="txtCarpetaInvestigacionConsulta"
                               placeholder="Carpeta de Investigaci&oacute;n">
                    </div>
                </div>
                <div class="form-group">
                        ...
                        if (datos.totalCount > 0) {
                            $.each(datos.data, function (count, object) {
                                if ((object.cveTipoCarpeta == '6')) {
                                    $('#cmbTipoCarpeta').append('<option selected value="' + object.cveTipoCarpeta + '">' + object.desTipoCarpeta + '</option>');
                                }
                            });
                        }
                    } catch (e) {
                ...
                success: function (datos) {
                    try {
                        ...
                        if (datos.totalCount > 0) {
                            $.each(datos.data, function (count, object) {
                                if ((object.cveTipoCarpeta == '6')) {
                                    $('#cmbTipoCarpetaConsulta').append('<option selected value="' + object.cveTipoCarpeta + '">' + object.desTipoCarpeta + '</option>');
                                }
                            });
                        }
                    } catch (e) {
