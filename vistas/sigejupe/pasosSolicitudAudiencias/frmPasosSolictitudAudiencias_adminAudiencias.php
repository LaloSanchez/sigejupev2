...
<script type="text/javascript">
    ...
    siguientePaso = function (paso) {
        if (paso == 1) {
            siguiente('divGeneral', 'sigejupe/solicitudAudiencias/frmSolictitudAudienciasAdminPasos.php', 1);
            ...
            if (!validaPasoUno()) {
                ...
                $('#liPaso6').find("a").removeClass("active");
                $('#liPaso7').find("a").removeClass("active");
                siguiente('divGeneral', 'sigejupe/imputadosSolicitudes/frmImputadosSolicitudesAdmin.php', 2);
                $('#divDatosAudiencias').hide('');
                $('#btnPaso2').show();
                $('#btnPaso1').hide();
                $('#btnPaso3').hide();
            ...
            if (!validaPasoUno() && !validaPasoDos()) {
                ...
                $('#liPaso6').find("a").removeClass("active");
                $('#liPaso7').find("a").removeClass("active");
                siguiente('divGeneral', 'sigejupe/ofendidosSolicitudes/frmOfendidosSolicitudesAdmin.php', 3);
                $('#divDatosAudiencias').hide('');
                $('#btnPaso3').show();
                $('#btnPaso2').hide();
                $('#btnPaso1').hide();
            ...
            if (!validaPasoUno() && !validaPasoDos() && !validaPasoTres()) {
                ...
                $('#liPaso6').find("a").removeClass("active");
                $('#liPaso7').find("a").removeClass("active");
                siguiente('divGeneral', 'sigejupe/delitosSolicitudes/frmDelitosAdmin.php', 4);
                $('#divDatosAudiencias').hide('');
                $('#btnPaso4').show();
                $('#btnPaso2').hide();
                $('#btnPaso1').hide();
            ...
            if (!validaPasoUno() && !validaPasoDos() && !validaPasoTres() && !validaPasoCuatro()) {
                ...
                $('#liPaso6').find("a").removeClass("active");
                $('#liPaso7').find("a").removeClass("active");
                siguiente('divGeneral', 'sigejupe/impofedelsolicitudes/frmImpofedelsolicitudesAdmin.php', 5);
                $('#divDatosAudiencias').hide('');
                $('#btnPaso5').show();
                $('#btnPaso2').hide();
                $('#btnPaso1').hide();
...
//            if (!validaPasoUno() && !validaPasoDos() && !validaPasoTres() && !validaPasoCuatro() && !validaPasoCinco()) {
                ...
                $('#liPaso5').find("a").removeClass("active");
                $('#liPaso7').find("a").removeClass("active");
                siguiente('divGeneral', 'sigejupe/victimas/frmVictimaSolicitudAdmin.php', 6);
                $('#divDatosAudiencias').hide('');
                $('#btnPaso6').show();
                $('#btnPaso2').hide();
                $('#btnPaso1').hide();
