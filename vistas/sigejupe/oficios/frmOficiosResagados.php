...
//echo "idActuacionPadre: <<" . $idActuacionPadre . ">><br>";
        ...
        <div class="panel-body">
            ...
            <div id="divFormulario" class="form-horizontal" data-step="1" data-intro="Este m&oacute;dulo le permite registrar un nuevo Oficio, el cual puede ser modificado y/o eliminado." data-position='left'>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input type="text" id="txtNumOficio" class="form-inline" id="txtNumOficio" placeholder="N&uacute;mero Oficio" >/<input type="text" class="form-inline" id="txtAnioOficio" id="txtAnioOficio" maxlength="4" placeholder="A&ntilde;o Oficio" value="">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-offset-3 col-md-9">
                        ...
                        <div data-step="3" data-intro="Presi&oacute;nelo para guardar o actualizar un oficio." data-position='top' class="col-md-2 botonesAdaptar" ><input type="submit" class="btn btn-primary btn-adaptar" id="inputGuardar" value="Guardar" onclick="buscarTipoCarpeta();" style="display: none"></div>                                    

                        <div class="col-md-2 botonesAdaptar" ><input type="submit" class="btn btn-primary btn-adaptar" id="inputBuscar" value="Buscar" onclick="consultarOficios(1);" style="display: none"></div>                                    
                        <div data-step="5" data-intro="Util&iacute;celo para limpiar la informaci&oacute;n seleccionada/introducida." data-position='top' class="col-md-2 botonesAdaptar" ><input type="submit" class="btn btn-primary btn-adaptar" id="inputLimpiar" value="Limpiar" onclick="limpiar();"></div>                                    
                        <div data-step="4" data-intro="De clic para buscar un oficio." data-position='top' class="col-md-2 botonesAdaptar" ><input type="submit" class="btn btn-primary btn-adaptar" id="inputConsultar" value="Consultar" onclick="consultar();" style="display: none"></div>
                        <div class="col-md-2 botonesAdaptar" ><input type="submit" class="btn btn-primary btn-adaptar" id="inputEliminar" value="Eliminar" onclick="eliminarOficios()" style="display: none"></div>                                    
                        <div class="col-md-2 botonesAdaptar" ><input type="submit" class="btn btn-primary btn-adaptar" id="inputImprimir" value="Imprimir" style="display: none" ></div>                                    
    ...
    //                    alert (json.data[0].cveJuzgado+"/"+json.data[0].cveTipojuzgado);
                        ...
                        $("#divAlertDager").html("Error al obtener tipo de <?php echo $OrigenSegundaInstancia == 1 ? ( "Tribunal de alzada") : ( "Juzgado"); ?>");
                        $("#divAlertDager").show("slide");
                        setTimeAlert("divAlertDager");
                    }
                    $('#barCarga').html("");
    ...
    //        var cveTipoCarpeta = $("#hiddenCveTipoCarpeta").val();
            ...
            var txtAnioOficio = $("#txtAnioOficio").val();
            var Destinatario = $("#Destinatario").val();  // este valor va para el campo de sintesis
            var Sintesis = $("#Sintesis").val();  // este valor va para el campo de sintesis
                    ...
                    $.ajax({
                        ...
                        success: function (datos) {
                            ...
                            if (json.totalCount > 0) {
                                ...
                                var jsonDatos = {
                                    accion: "guardarOficioManual",
                                    idActuacion: $("#hiddenIdActuacion").val(),
                                    numero: numAct,
                                    anio: aniAct,
                                    numActuacion: txtNumOficio,
                                    aniActuacion: txtAnioOficio,
    ...
    //                                cveTipoCarpeta:cveTipoCarpeta,
        ...
        guardarOficioManual = function (strDatos) {
    ...
    //                    alert(json.data[0].Sintesis);
                        if (json.data[0].Sintesis != "publicado") {
                            $("#divHideForm").hide();
    ...
    //                    }
        ...
        consultar = function () {
            ...
            $("#h5titulo").html("<span style='text-decoration: underline; cursor:pointer;' onclick='regresar();'>Registro de Oficios Rezagados</span> / Consulta de Oficios");
    ...
    //        }
            ...
            $("#h5titulo").html("<span>Registro de Oficios Rezagados</span>");
            apartado = 1;
        };

        consultarOficiosRes = function (strDatosGuaradar) {
            //**************************** consulta de oficios *************************************
            var cveJuzgadoAux = $("#cmbJuzgado").val().split("/");
            var cveJuzgado = cveJuzgadoAux[0];
            var anioOficio = $("#txtAnioOficio").val();
    ...
    //        strDatos += "&anio=" + $("#txtAnio").val();
            ...
            strDatos += "&aniActuacion=" + anioOficio;
            strDatos += "&pag=1";
            strDatos += "&cantxPag=1";
    //        strDatos += "&activo=S";
    ...
    //                ToggleLoading(1);
                ...
                success: function (datos) {
                    ...
                    if (json.totalCount > 0) {
                        if (json.data[0].activo == "N") {
    //                        alert("guardar...");
    //                        strDatosGuaradar += "&idActuacionEliminar="+json.data[0].idActuacion;
                            var jsonDatos = {
                                accion: strDatosGuaradar.accion,
                                idActuacion: strDatosGuaradar.idActuacion,
                                numero: strDatosGuaradar.numero,
                                anio: strDatosGuaradar.anio,
                                numActuacion: strDatosGuaradar.numActuacion,
                                aniActuacion: strDatosGuaradar.aniActuacion,
                                observaciones: strDatosGuaradar.observaciones,
                                sintesis: strDatosGuaradar.sintesis,
                                destinatario: strDatosGuaradar.destinatario,
                                cveTipoActuacion: 7,
                                cveAccion: strDatosGuaradar.cveAccion,
                                cveJuzgado: strDatosGuaradar.cveJuzgado,
                                cveUsuario: strDatosGuaradar.cveUsuario,
                                cveEstatus: strDatosGuaradar.cveEstatus,
                                idReferencia: strDatosGuaradar.idReferencia,
                                cveTipoCarpeta: strDatosGuaradar.cveTipoCarpeta,
                                idActuacionAntecede: strDatosGuaradar.idActuacionAntecede,
                                idActuacionEliminar: json.data[0].idActuacion,
                                activo: "S"
                            };

                            guardarOficioManual(jsonDatos);
                        } else {
                            var desc = "";
                            if (json.data[0].cveTipoCarpeta == "" || json.data[0].cveTipoCarpeta == "null" || json.data[0].cveTipoCarpeta == null) {
                                desc = "Sin Relacion";
                            } else {
                                desc = json.data[0].descTipoCarpeta;
                            }
                            $("#divAlertInfo").html('El numero de oficio ya existe: ' + desc + ' ' + json.data[0].numero + '/' + json.data[0].anio);
                        ...
                        if (anioActual == anioOficio) {
                            ...
                            $.ajax({
                                ...
                                success: function (datos) {
                                    ...
                                    if (json.totalCount == 0) {
                                        //$("#txtNumOficio").val(1);
                                        $("#divAlertInfo").html('EL CONTADOR NO HA SIDO INICIALIZADO');
                                        $("#divAlertInfo").show("slide");
                                        setTimeAlert("divAlertInfo");
                                    } else {
                                        //                              $("#txtNumOficio").val((parseInt(json.data[0].numero)));
    //                                    alert($("#txtNumOficio").val()+" - "+json.data[0].numero)
                                        if (parseInt($("#txtNumOficio").val()) <= parseInt(json.data[0].numero)) {
    //                                        alert("hacer insert");
                                            var jsonDatos2 = {
                                                accion: "guardarOficioResagado",
                                                idActuacion: strDatosGuaradar.idActuacion,
                                                numero: strDatosGuaradar.numero,
                                                anio: strDatosGuaradar.anio,
                                                numActuacion: strDatosGuaradar.numActuacion,
                                            ...
                                            //                          alert("va mandar a guardar...");  
                                            guardarOficioManual(jsonDatos2);
                                        } else {
                                            $("#divAlertInfo").html('EL NUMERO DE OFICIO DEBE SER MENOR O IGUAL AL MAS ACTUAL: [' + parseInt(json.data[0].numero) + "], <br> VERIFIQUE EL CAMPO");
                                            $("#divAlertInfo").show("slide");
                                            setTimeAlert("divAlertInfo");
                                        }
                                    }
    ...
    //                          alert("va mandar a guardar...");  
                            ...
                            alert("el año del oficio debe ser menor o igual al año en curso..." + anioActual + " < " + anioOficio);
                        }
    ...
    //                    $('#cmbPaginacion').find('option').remove().end().append('<option value="0"></option>').val('0');
        ...
        consultarOficios = function () {
            ...
            if (error == 0) {
                $.ajax({
                    ...
                    success: function (datos) {
                        ...
                        if (json.totalCount > 0) {
                            ...
                            $("#h5titulo").html("<span style='text-decoration: underline; cursor:pointer;' onclick='regresar2();'>Registro de Oficios Rezagados</span> / <span style='text-decoration: underline; cursor:pointer;' onclick='regresarConsultar();'>Consulta de Oficios</span> / Resultados");
                ...
                $("#divAlertDager").html("Seleccione el <?php echo $OrigenSegundaInstancia == 1 ? ( "Tribunal de alzada") : ( "Juzgado"); ?>");
                $("#divAlertDager").show("slide");
                setTimeAlert("divAlertDager");
            }
        ...
        regresarConsultar = function () {
            changeDivFormOficio(1);
            $("#cmbPaginacion").val(1);
            $("#h5titulo").html("<span style='text-decoration: underline; cursor:pointer;' onclick='regresar();'>Registro de Oficios Rezagados</span> / <span>Consulta de Oficios</span>");
        };
    ...
    //                  alert(datos);
                    ...
                    if (json.totalCount > 0) {
                        ...
                        $("#txtAnio").val(json.data[0].anio);
                        $("#txtNumOficio").val(json.data[0].numActuacion);
                        $("#txtAnioOficio").val(json.data[0].aniActuacion);
    ...
    //    }
        ...
        limpiar = function () {
            ...
            if (procedencia == 0) { // proviene del arbol
    ...
    //                    alert("insert: "+createRecord+" consulta: "+readRecord+" act: "+updateRecord+" elim: "+deleteRecord);
        ...
        buscarAcuerdo = function () {
            ...
            if ($('#buscaAcuerdo').prop('checked')) {
                ...
                if (error == 0) {
                    ...
                    strDatos += "&anio=" + $("#txtAnio").val();
                    strDatos += "&cveTipoCarpeta=" + cveTipoCarpeta;
                    strDatos += "&cveTipoActuacion=2";// busca solo acuerdos
                    strDatos += "&activo=S";           //actuaciones activas
                    strDatos += "&pag=" + pag;
                    strDatos += "&cantxPag=" + cantReg;        // cantidad de registros a mostrar en paginacion
                    strDatos += "&cveJuzgado=" + cveJuzgado[0];
                            ...
                            if (json.totalCount > 0) {
                                ...
                                for (var i = 0; i < json.total; i++) {
                                    ...
                                    if (json.data[i].cveTipoActuacion == "2") {
                                        ...
                                        //if(json.data[i].cveEstatus == "3"){
                                        table += "<tr  bgcolor='#EDF9E8' onmouseout='this.style.backgroundColor=\"#EDF9E8\"' onmouseover='this.style.backgroundColor=\"#9CC9A4\"' style='cursor: pointer; background-color: rgb(237, 249, 232);' onclick=\"consutaIdActuacion('" + json.data[i].idActuacion + "','" + json.data[i].descTipoResolucion + "',' " + json.data[i].fechaRegistro + "')\">";
                                        //}else{
                                        //    table += "<tr>";
                                        //}    
                                        table += "<td > " + (i + 1) + "</td>";
        ...
        consutaIdActuacion = function (id, desResolucion, fecha) {
            // se asigna el idActiuacion del acuerdo
            $("#hiddenIdActuacionAcuerdo").val(id);
            $("#divConsultaActuaciones").hide();
            $("#divTableResultActuaciones").hide();
            $("#acuerdoSel").html("Resoluci&oacute;n Acuerdo: " + desResolucion + " - " + fecha);
    ...
    //                    alert(datos);
                    ...
                    if (json.totalCount > 0) {
                        if (json.data[0].cveTipoActuacion == "2") {
