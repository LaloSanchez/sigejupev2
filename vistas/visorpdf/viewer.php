...
-->
<?php
#echo "<input class='frmCaja' type='hidden' name='hdnTipoConsulta' id='hdnTipoConsulta' value='" . $_GET["tipoConsulta"] . "'>";
echo "<input class='frmCaja' type='hidden' name='hdnArchivo' id='hdnArchivo' value='" . $_GET["archivo"] . "'>";
#echo "<input class='frmCaja' type='hidden' name='hdnIdUsuarioExterno' id='hdnIdUsuarioExterno' value='" . $_GET["idUsuarioExterno"] . "'>";
