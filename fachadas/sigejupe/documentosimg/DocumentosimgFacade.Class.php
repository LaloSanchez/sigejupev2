...
class DocumentosimgFacade {
    ...
    public function validarDocumentosimg($DocumentosimgDto) {
        ...
        $DocumentosimgDto->setidCarpetaJudicial(strtoupper(str_ireplace("'", "", trim(utf8_decode((phpversion() <= 5.5) ? mb_strtoupper($DocumentosimgDto->getidCarpetaJudicial(), "utf8") : strtoupper($DocumentosimgDto->getidCarpetaJudicial()))))));
        if ($this->esFecha($DocumentosimgDto->getidCarpetaJudicial())) {
            $DocumentosimgDto->setidCarpetaJudicial($this->fechaMysql($DocumentosimgDto->getidCarpetaJudicial()));
        }
