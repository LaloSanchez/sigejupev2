...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
    include_once(dirname(__FILE__) . "/../../../controladores/sigejupe/reportes/IndicadorseleccionadoController.Class.php");

    class IndicadorseleccionadoFacade {

        public function __construct() {
            
        }

        public function indicadorSeleccionadoWebService($datos) {
            $paginacion = array();
            ...
            return $this->consultarIndicadorSeleccionado($datos, $paginacion);
        }
        ...
        public function consultarIndicadorSeleccionado($datos, $paginacion = null) {
            ...
            $indicadorSeleccionadoController = new IndicadorseleccionadoController();
            $respuesta = $indicadorSeleccionadoController->consultarIndicadorSeleccionado($datos, $paginacion);
            if ($respuesta != "") {
                return $respuesta;
            }
...
//----------------------------
    ...
    if ($accion == "consultar_indicador") {
        ...
        echo $indicadorseleccionadoFacade->consultarIndicadorSeleccionado($datos, $param);
    }
} else {
