...
//            exit;
        ...
        public function generarAcuerdos($idsCarpetas,$param =null){
            $trajectoria = new trajectoriasCarpetas();
            $rsAcuerdos = $trajectoria->generarAcuerdo($idsCarpetas,$param);
            return $rsAcuerdos;
        }
        ...
        if($accion == "consultar"){
            ...
            echo $carpetas;
        }else if($accion == "generarAcuerdo"){
            $idsCarpetas = $_POST["acordar"];       
            $acuerdos = $trayectoriaFacade->generarAcuerdos($idsCarpetas,$param);
            echo $acuerdos;
        }
