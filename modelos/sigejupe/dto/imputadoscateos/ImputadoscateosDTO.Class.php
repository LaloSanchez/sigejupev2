...
class ImputadoscateosDTO {
    private $idImputadoCateo;
    ...
    private $telefono;
    private $email;
    public function getIdImputadoCateo(){
        return $this->idImputadoCateo;
    }
    public function setIdImputadoCateo($idImputadoCateo){
        $this->idImputadoCateo=$idImputadoCateo;
    }
    ...
    public function toString(){
        return array("idImputadoCateo"=>$this->idImputadoCateo,
