...
class SentenciasapeladasDTO {
    private $idSentenciaApelada;
    private $idImputadoSentencia;
    private $cveSentido;
    private $NumToca;
    private $AnioToca;
    private $CveSala;
    ...
    public function getIdSentenciaApelada(){
        return $this->idSentenciaApelada;
    }
    public function setIdSentenciaApelada($idSentenciaApelada){
        $this->idSentenciaApelada=$idSentenciaApelada;
    }
    public function getIdImputadoSentencia(){
        return $this->idImputadoSentencia;
    }
    public function setIdImputadoSentencia($idImputadoSentencia){
    ...
    public function toString(){
        return array("idSentenciaApelada"=>$this->idSentenciaApelada,
"idImputadoSentencia"=>$this->idImputadoSentencia,
