...
//$this->_proveedor->connect();
        ...
        if ($documentosimgDto->getIdDocumentoImg() != "") {
            $sql.="idDocumentoImg";
            if (($documentosimgDto->getIdCarpetaJudicial() != "") || ($documentosimgDto->getIdActuacion() != "") || ($documentosimgDto->getCveTipoDocumento() != "") || ($documentosimgDto->getFechaDocumento() != "") || ($documentosimgDto->getFechaModificacion() != "") || ($documentosimgDto->getObservaciones() != "") || ($documentosimgDto->getCveUsuario() != "") || ($documentosimgDto->getActivo() != "")) {
                $sql.=",";
            }
        }
        if ($documentosimgDto->getIdCarpetaJudicial() != "") {
        ...
        if ($documentosimgDto->getIdCarpetaJudicial() != "") {
            $sql.="'" . $documentosimgDto->getIdCarpetaJudicial() . "'";
            if (($documentosimgDto->getIdActuacion() != "") || ($documentosimgDto->getCveTipoDocumento() != "") || ($documentosimgDto->getFechaDocumento() != "") || ($documentosimgDto->getFechaModificacion() != "") || ($documentosimgDto->getObservaciones() != "") || ($documentosimgDto->getCveUsuario() != "") || ($documentosimgDto->getActivo() != "")) {
                $sql.=",";
            }
        }
...
//$this->_proveedor->connect();
        ...
        if ($documentosimgDto->getIdDocumentoImg() != "") {
            ...
            if (($documentosimgDto->getIdCarpetaJudicial() != "") || ($documentosimgDto->getIdActuacion() != "") || ($documentosimgDto->getCveTipoDocumento() != "") || ($documentosimgDto->getFechaDocumento() != "") || ($documentosimgDto->getFechaModificacion() != "") || ($documentosimgDto->getObservaciones() != "") || ($documentosimgDto->getCveUsuario() != "") || ($documentosimgDto->getActivo() != "") || ($documentosimgDto->getFechaActualizacion() != "") || ($documentosimgDto->getFechaRegistro() != "")) {
                $sql.=",";
            }
        }
        if ($documentosimgDto->getIdCarpetaJudicial() != "") {
            $sql.="idCarpetaJudicial='" . $documentosimgDto->getIdCarpetaJudicial() . "'";
...
//$this->_proveedor->connect();
        ...
        $sql = "SELECT idDocumentoImg,idCarpetaJudicial,idActuacion,cveTipoDocumento,fechaDocumento,fechaModificacion,observaciones,cveUsuario,activo,fechaActualizacion,fechaRegistro FROM tbldocumentosimg ";
        if (($documentosimgDto->getIdDocumentoImg() != "") || ($documentosimgDto->getIdCarpetaJudicial() != "") || ($documentosimgDto->getIdActuacion() != "") || ($documentosimgDto->getCveTipoDocumento() != "") || ($documentosimgDto->getFechaDocumento() != "") || ($documentosimgDto->getFechaModificacion() != "") || ($documentosimgDto->getObservaciones() != "") || ($documentosimgDto->getCveUsuario() != "") || ($documentosimgDto->getActivo() != "") || ($documentosimgDto->getFechaActualizacion() != "") || ($documentosimgDto->getFechaRegistro() != "")) {
            $sql.=" WHERE ";
        }
        if ($documentosimgDto->getIdDocumentoImg() != "") {
            $sql.="idDocumentoImg='" . $documentosimgDto->getIdDocumentoImg() . "'";
        ...
        if ($documentosimgDto->getIdCarpetaJudicial() != "" && $documentosimgDto->getIdCarpetaJudicial() > 0) {
            $sql.="idCarpetaJudicial='" . $documentosimgDto->getIdCarpetaJudicial() . "'";
            if (($documentosimgDto->getIdActuacion() != "") || ($documentosimgDto->getCveTipoDocumento() != "") || ($documentosimgDto->getFechaDocumento() != "") || ($documentosimgDto->getFechaModificacion() != "") || ($documentosimgDto->getObservaciones() != "") || ($documentosimgDto->getCveUsuario() != "") || ($documentosimgDto->getActivo() != "") || ($documentosimgDto->getFechaActualizacion() != "") || ($documentosimgDto->getFechaRegistro() != "")) {
                $sql.=" AND ";
            }
        }
        if ($documentosimgDto->getIdActuacion() != "" && $documentosimgDto->getIdActuacion() > 0) {
            $sql.="idActuacion='" . $documentosimgDto->getIdActuacion() . "'";
            if (($documentosimgDto->getCveTipoDocumento() != "") || ($documentosimgDto->getFechaDocumento() != "") || ($documentosimgDto->getFechaModificacion() != "") || ($documentosimgDto->getObservaciones() != "") || ($documentosimgDto->getCveUsuario() != "") || ($documentosimgDto->getActivo() != "") || ($documentosimgDto->getFechaActualizacion() != "") || ($documentosimgDto->getFechaRegistro() != "")) {
                $sql.=" AND ";
            }
