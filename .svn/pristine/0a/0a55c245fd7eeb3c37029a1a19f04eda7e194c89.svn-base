...
public function selectEstatussolicitudescateos($EstatussolicitudescateosDto,$proveedor=null, $orden = ""){
...
$EstatussolicitudescateosDto = $EstatussolicitudescateosDao->selectEstatussolicitudescateos($EstatussolicitudescateosDto,$orden,$proveedor);
return $EstatussolicitudescateosDto;
}
