...
class Security
{
    ...
    /**
     * Crea una nueva instancia de la clase Security
     *
    ...
    /**
     * Elimina las etiquetas malignas de un string.
     *
    ...
    /**
     * Procesa un Texto para limpiarse.
     *
     * @param string $str
     *
     * @return string
    ...
    /**
     * Genera un hash XSS si es necesario y lo retorna
     *
     * @return string
     */
    ...
    /**
     * Decodificacion de entidades HTML.
     *
     * @param string $str
     *
     * @return string
    ...
    /**
     * Callback decodificacion de entidades HTML.
     *
     * @param array $match
     *
     * @return string
