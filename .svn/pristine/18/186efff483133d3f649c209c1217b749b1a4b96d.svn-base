...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h5 class="panel-title">                                                            
                Reporte de Disponibilidad de Salas por Juzgado                        
            </h5>
        </div>
    ...
    <script type="text/javascript">
        ...
        exportarReporte = function (accion, div) {
            ...
            var nombreArchivo = "REPORTE_DISPONIBILIDAD_SALAS_JUZGADO";
        ...
        $(function () {
            ...
            var permisos = obtenerPermisosFormulario("REPORTES", "DISPONIBILIDAD DE SALAS JUZGADO");
