        ...
        if ($param != "") {
            ...
            if (!$errorDatos) {
                ...
                if (!$error) {
                    ...
                    $SolicitudesordenesDto->setAnio($anioCarpeta); #año Carpeta Judicial
...
//                    $idJuezOrden = 17; #LIC.	VARGAS	QUEZADA	IRMA ISABEL
                ...
                #ACTUALIZAMOS INFORMACIÓN DE LA SOLICITUD
                if (!$error) {
                    ...
                    if (!$error) {
                        ...
                        foreach ($celulares as $celular) {
                            if ($celular != "") {
                                ...
                                $e = $asterisk2->llamar("10.22.157.61", $celular, "./../../../llamadas/", $nombrearchivo, "outboundmsg3");
                                //$e = "";
...
//                                echo "<br><br>";
                ...
                if (!$error) {
                    ...
                    if (($bolStatusMailJuez == true) && ($bolStatusMailAdm == true)) {
                        $BitacoramovimientosDto->setObservaciones("AGREGO SOLICITUD DE ORDEN DE APREHENSION NUMERO: " . $OrdenesDto->getNumeroOrden() . " AÑO: " . $OrdenesDto->getAnioOrden() . " JUEZ" . $idJuezOrden . " ENVIO CORREO ELECTRONICO A EL JUEZ Y EL ADMINISTRADOR DEL JUZGADO");
                    } else {
                        $observaciones = "AGREGO SOLICITUD DE ORDEN DE APREHENSION NUMERO: " . $OrdenesDto->getNumeroOrden() . " AÑO: " . $OrdenesDto->getAnioOrden() . " JUEZ" . $idJuezOrden . " ";
            ...
            if ($solicitudesordenesDto != "" && count($solicitudesordenesDto) > 0) {
                ...
                if ($solicitudesordenesDto->getCveEstatusSolicitudOrden() == "1" || $solicitudesordenesDto->getCveEstatusSolicitudOrden() == "2") {
                    ...
                    if (!$errorCancelacion) {
                        ...
                        #PROCESO PARA ENVIAR CORREO ELECTRONICO AL JUEZ NOTIFICANDO LA CANCELACIÓN DE LA AOLICITUD DE LA ORDEN DE APREHENSION
                        $objDatCorreo = $this->plantillaCorreo("ordenes");
                        if ($objDatCorreo != "" && count($objDatCorreo) > 0) {
                            if ($emails != "") {
                      ...
                      se encuentra <b>CANCELADA</b>.";
                                        ...
                                        while ($intentos <= 5) {
                                            ...
                                            $BitacoranotificacionesDto->setAnio($ordenesDto->getAnioOrden()); #AÑO DE LA ORDEN
                    ...
                    if (!$errorCancelacion) {
                      ...
                      se encuentra <b>CANCELADA</b>.";
                                ...
                                $BitacoranotificacionesDto->setIdReferencia($ordenesDto->getIdOrden()); #ID DE LA ORDEN
                                $BitacoranotificacionesDto->setNumero($ordenesDto->getNumeroOrden()); #NUMERO DE LA ORDEN
                                $BitacoranotificacionesDto->setAnio($ordenesDto->getAnioOrden()); #AÑO DEL LA ORDEN
                                $BitacoranotificacionesDto->setCvejuzgado($solicitudesordenesDto->getCveJuzgadoDesahoga()); #JUZGADO A SOLICITAR
                                $BitacoranotificacionesDto->setCveUsuario($solicitudesordenesDto->getCveUsuario()); #Id de el usuario al que se le envio el correo
                                $BitacoranotificacionesDto->setMedio($ordenesDto->getEmail());
                                $BitacoranotificacionesDto->setMovimiento("NO TIENE CORREO ELECTRONICO REGISTRADO - CANCELACIÓN DE SOLICITUD");
        ...
        if (!$errorDatos) {
            ...
            if ($ordenesDto != "" && count($ordenesDto) > 0) {
                ...
                if ($solicitudesordenesDto != "" && count($solicitudesordenesDto) > 0) {
                    ...
                    if ($solicitudesordenesDto->getCveEstatusSolicitudOrden() == "4") {
                        return array("type" => "Error", "text" => utf8_encode("LA ORDEN DE APREHENSIÓN SE ENCUENTRA CANCELADO"));
                    }
                                        ...
                                        if ((trim($emailJuez) != "") && (strlen($emailJuez) > 1)) {
                                           ...
                                           la cual se encuentra en el referido sistema inform&aacute;tico para su consulta y atenci&oacute;n respectiva.";
                                            ...
                                            while ($intentos <= 5) {
                                                ...
                                                $BitacoranotificacionesDto->setAnio($ordenesDto->getAnioOrden()); #AÑO DEL ORDEN DE APREHENSION
                                                $BitacoranotificacionesDto->setCvejuzgado($solicitudesordenesDto->getCveJuzgadoDesahoga()); #JUZGADO A SOLICITAR
