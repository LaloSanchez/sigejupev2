...
class TelefonosofendidossolicitudesController extends ValidaSolicitudOfendido {
    ...
    public function agregarTelefonoOfendido($TelefonosofendidossolicitudesDto, $proveedor = '', $usaBitacora = true)
    {
        ...
        $validaSolicitudAudiencia = $this->validarEstatusSolicitudByIdOfendido($TelefonosofendidossolicitudesDto->getIdOfendidoSolicitud(), 'agregar', 'tel&eacute;fono, celular, email');
        ...
        if ($TelefonosofendidossolicitudesDto->getTelefono() == '') $TelefonosofendidossolicitudesDto->setTelefono(' ');
        if ($TelefonosofendidossolicitudesDto->getCelular() == '') $TelefonosofendidossolicitudesDto->setCelular(' ');
        ...
        try {
            ...
            if (!count($telefonoResponse)) throw new Exception('no se pudo guardar el teléfono del ofendido');
    ...
    public function modificarTelefonoOfendido($TelefonosofendidossolicitudesDto, $proveedor = '', $usaBitacora = false)
    {
        ...
        try {
            ...
            if (!count($telefonoResponse)) throw new Exception('no se pudo actualizar el teléfono del ofendido');
    ...
    public function eliminarTelefonoOfendido($TelefonosofendidossolicitudesDto, $proveedor = '')
    {
        ...
        try {
            ...
            if (!$telefonoResponse) throw new Exception('no se pudo eliminar el teléfono del ofendido');
