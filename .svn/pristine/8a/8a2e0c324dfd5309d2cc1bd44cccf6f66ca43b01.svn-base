...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
                    ...
                    <div class="steps">
                        <ul>
                            ...
                            <li id="liPaso3" class="step step-3 Paso3">
                                <a href="#"><strong>Paso 3</strong><br>Agravios</a>
                            </li>
                            <li id="liPaso4" class="step step-4 Paso4">
                                <a href="#"><strong>Paso 4</strong><br>Apelacion</a>
                            </li>
                            <li id="liPaso6" class="step step-6 Paso6">
                                <a href="#"><strong>Paso 5</strong><br>T&eacute;rminos de uso</a>
                            </li>
                        </ul>
                    </div>  
                </div>
                ...
                <form name="frmSolicitud" class="form-horizontal" id="frmSolicitud" method="POST" action="solicitudCateoController.php" target="oculto" enctype="multipart/form-data" onsubmit="return false;">            
                            ...
                            <div class='content col-xs-12'>
                                <div class="col-md-12" >
                                    ...
                                    <div class="form-group text-center buttons" >
                                        <button class="btn btn-primary" onclick="javascript:apelacionCateos.inicia(1, 1)">Consultar</button>
                                ...
                                <div class="paginacion col-md-12" style="display:none" >    
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div id="divPaginador" class="form-group col-md-3" >
                                            ...
                                            <select  name="cmbPaginacion" id="cmbPaginacion" onchange="javascript:apelacionCateos.inicia(1, 0)">
                                                <option value="1"></option>
                                            </select>
                                        </div>
                                        <div id="divPaginador" class="form-group col-md-4" >
                                            <label class="control-label">Registros por p&aacute;gina:</label>
                                            <select  name="cmbNumReg" id="cmbNumReg" onchange="javascript:apelacionCateos.inicia(1, 1)">
                    ...
                    <div id="divPaso2" class='content col-xs-12 ' style='display:none;'>
                        <div class="col-xs-12">
                            ...
                            <div class="form-group text-center" >
                                <button class="btn btn-primary" onclick="javascript:apelacionCateos.limpiar(2)">Limpiar</button>
                    ...
                    <div id="divPaso3" class='content' style='display:none;'>
                        ...
                        <div id="divAgravios" class="col-xs-12" >
                            <h3 class="text-center" >Agravios</h3>
                            <div class="form-group" >
                                <div class="col-xs-12" >
                                    <script id="descAgravios" type="text/plain" style="width: 98%; height: 300px; margin: 0px auto;"></script>
                                </div>
                            </div>
                        </div>

                        <div class="form-group text-center" >
                            <button class="btn btn-primary" onclick="javascript:apelacionCateos.limpiar(3)">Limpiar</button>
                    ...
                    <div id="divPaso4" class='content' style='display:none;'>
                        <div id="divNotaNegado" class="col-xs-12" >
                            <h3 class="text-center" >Apelaci&oacute;n</h3>
                            <div class="form-group" >
                                <div class="col-xs-12" >
                                    <script id="descApelacion" type="text/plain" style="width: 98%; height: 300px; margin: 0px auto;"></script>
                                </div>
                            </div>
                            <div class="form-group" >
                        ...
                        <div class="form-group text-center" >
                            <button class="btn btn-primary" onclick="javascript:apelacionCateos.limpiar(4)">Limpiar</button>
                            <button class="btn btn-primary" onclick="javascript:apelacionCateos.siguiente('liPaso3', 'liPaso4')">< Anterior </button>
                            <button class="btn btn-primary" onclick="javascript:apelacionCateos.validarPaso4('S')">Siguiente ></button>
                        </div>
                    </div>
                    <div id="divPaso5" class='content' style='display:none;'>
                        ...
                        <div id="botonesTerminar">
                            ...
                            <div class="form-group text-center" >
                                <button class="btn btn-primary" id="limpiar6" name="limpiar6" onclick="javascript:apelacionCateos.limpiar(5)">Limpiar</button>
                                <button class="btn btn-primary" id="btnAnterior" name="anterior6" onclick="javascript:apelacionCateos.siguiente('liPaso4', 'liPaso5')">< Anterior </button>
    ...
    <script src="sigejupe/apelacioncateos/apelacioncateos.js" ></script>
    ...
    <script>
                                    ...
                                    $(function () {
                                        ...
                                        UE.delEditor("descAgravios");
                                        var ued = UE.getEditor('descAgravios');
                                        ued.ready(function () {
                                            ued.setContent("");
                                        });
                                        UE.delEditor("descApelacion");
                                        var ueA = UE.getEditor('descApelacion');
                                        ueA.ready(function () {
                                            ueA.setContent("");
                                        });
                                    });
