...
class AutoRadicacionEjecucionController {
    ...
    public function terminarCarpetaJudicial($idCarpetaJudicial, $proveedor = null)
    {
        try {
            ...
            $beginLog = "/**************************/ ";
            $logger = new Logger("/../../logs/", "AutoRadicacionEjecucion");
            //Se consultan los datos de la carpeta judicial origen
...
//            $logger->w_onError($beginLog . "Se consulta imputadosCarpetas con datos: " . serialize($imputadosCarpetas));
            ...
            /*
             *se consultan los imputados carpetas con id carpeta que contengan la etapa procesal correspondiente a la carpeta origen
             */
            ...
            $imputadosCarpetasEtapaDto->setCveEtapaProcesal($carpetasJudicialesDto[0]->getCveEtapaProcesal());
            $imputadosCarpetasEtapa = $imputadosCarpetasEtapaDao->selectImputadoscarpetas($imputadosCarpetasEtapaDto, "", $proveedor);
            $logger->w_onError($beginLog . "Se consulta imputadosCarpetas con idcarpetajudicial: " . $idCarpetaJudicial . " que esten activos y no tengan sobreseimiento");
            $logger->w_onError($beginLog . "Se consulta imputadosCarpetas con datos: " . serialize($imputadosCarpetasEtapa));
            /*
             *
             */
            ...
            /*
             * Si ya no hay imputados activos en la etapa procesal correspondiente
             * o se encuentran en una etapa procesal diferente a la de la carpeta origen
             * o tienen sobreseimiento, se procede a terminar la carpeta origen
             */
            if ( $imputadosCarpetasEtapa == '' ) {
