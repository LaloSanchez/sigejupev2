...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h5 class="panel-title" id="h5titulo">                                                            
                Atenci&oacute;n de ceresos a adscripciones externas
            </h5>
        </div>
        <div class="panel-body">
            ...
            <div id="divFormulario" class="form-horizontal">
                ...
                <div class="form-group">                                                                
                    <label class="control-label col-xs-3 needed">Adscripci&oacute;n externa:</label>
                    <div class="col-xs-9">
    ...
    <!--            <div class="form-group">                                                                
                ...
                <div class="form-group">
                    <div class="col-xs-offset-3 col-xs-9">
                        ...
                        <input type="submit" class="btn btn-primary" id="inputBuscar" value="Buscar" onclick="consultarCeresosAds();" style="display: none">                                    
                        ...
                        <input type="submit" class="btn btn-primary" id="inputEliminar" value="Eliminar" onclick="eliminarCeresosAds()" style="display: none">                                    
            ...
            <div id="divConsulta" style="display: none" class="col-xs-12">
                <div class="col-xs-12">
                    ...
                    <div id="divPaginador" class="form-group col-xs-2" >
                        ...
                        <select  name="cmbPaginacion" id="cmbPaginacion" onchange="consultarCeresosAds();">
                            <option value="1">1</option>
                        </select>
                    </div>
                    <div id="divPaginador" class="form-group col-xs-4" >
                        <label class="control-label">Registros por p&aacute;gina:</label>
                        <select  name="cmbNumReg" id="cmbNumReg" onchange="pasarPaginaUno(); consultarCeresosAds(); ">
    ...
    <script type="text/javascript">
        ...
        cargaAdscripciones = function () {
            ...
            var strDatos = "accion=listarAdscripcionesTodas";
            $.ajax({
                type: "POST",
        ...
        validacion = function () {
            ...
            var cveAdscripcion = $("#cmbMinisterioPublico").val();
            ...
            if (cveAdscripcion == 0) {
                error = 2;
                mensaje += "   - Adscripci&oacute;n externa";
            }
            ...
            if (error == 0) {
                ...
                strDatos += "&idCeresoAdscripcion=" + $("#hiddenIdCeresoAdscripcion").val();
                strDatos += "&cveCereso=" + cveCereso;
                strDatos += "&cveAdscripcion=" + cveAdscripcion;  
                strDatos += "&cveUsuarioSesion=" + cveUsuarioSesion; 
                strDatos += "&cvePerfilSesion=" + cvePerfilSesion; 
                strDatos += "&juzgadoSesion=" + juzgadoSesion; 
                if($("#hiddenIdCeresoAdscripcion").val() == ""){
                    strDatos += "&cveAccion=242" ; 
                }else{
                    strDatos += "&cveAccion=243" ; 
                }    
                strDatos += "&activo=S";
                
                guardarCeresosAdscripciones(strDatos);
        ...
        guardarCeresosAdscripciones = function (strDatos) {
    ...
    //                            alert(datos);
        ...
        consultar = function () {
            ...
            $("#h5titulo").html("<span style='text-decoration: underline; cursor:pointer;' onclick='regresar();'>Atenci&oacute;n de ceresos a adscripciones externas</span> / Consulta de ceresos adscripciones");
    ...
    //        $("#inputEliminar").show();
            //$("#inputGuardar").show();
            //$("#inputImprimir").show();
            $("#h5titulo").html("<span>Atenci&oacute;n de ceresos a adscripciones externas</span>");
        };
    ...
    //                ToggleLoading(1);
                ...
                success: function (datos) {
                    ...
                    if (json.totalCount > 0) {
                        ...
                        table += "<tbody>";
                        for (var i = 0; i < json.totalCount; i++) {
                            table += "<tr onclick=\"consutaIdCeresoAds('" + json.data[i].idCeresoAdscripcion + "')\">";
                            table += "<td > " + (i + 1) + "</td>";
                            table += "<td >" + json.data[i].desCereso + " </td>";
                            table += "<td>" + json.data[i].nomAdscripcion + "</td>";
    ...
    //                                                    alert(json.data[i].observaciones);
                        ...
                        $("#h5titulo").html("<span style='text-decoration: underline; cursor:pointer;' onclick='regresar2();'>Atenci&oacute;n de ceresos a adscripciones externas</span> / <span style='text-decoration: underline; cursor:pointer;' onclick='regresarConsultar();'>Consulta de ceresos adscripciones</span> / Resultados");
    //
                    } else {
        ...
        regresarConsultar = function () {
            ...
            changeDivForm(1);
            $("#cmbPaginacion").val(1);
            $("#h5titulo").html("<span style='text-decoration: underline; cursor:pointer;' onclick='regresar();'>Atenci&oacute;n de ceresos a adscripciones externas</span> / <span>Consulta de ceresos adscripciones</span>");
        }

        consutaIdCeresoAds = function (id, descTipoCarpeta) {
            changeDivForm(1);
            var strDatos = "accion=seleccionar"; //seleccionar
            strDatos += "&idCeresoAdscripcion=" + id;
            strDatos += "&activo=S";
    ...
    //                  alert(datos);
                    ...
                    if (json.totalCount > 0) {
                        ...
                        $("#cmbMinisterioPublico").val(json.data[0].cveAdscripcion);
                    ...
                    buttons: {
                      danger: {
                        ...
                        callback: function() {
                            ...
                            strDatos += "&idCeresoAdscripcion=" + $("#hiddenIdCeresoAdscripcion").val();
                            strDatos += "&cveAccion=244"; //eliminacion de cereos adscripciones
                                ...
                                $.each(response.perfiles[0].perfil[i].permisos, function (k, vnombre) {
                                    ...
                                    if(vnombre.nomFormulario == "CERESOS"){
                                        ...
                                        $.each(hijos, function (k2, nombreHijo) {
                                            if (nombreHijo.nomFormulario == 'CERESOS ADSCRIPCIONES') {
