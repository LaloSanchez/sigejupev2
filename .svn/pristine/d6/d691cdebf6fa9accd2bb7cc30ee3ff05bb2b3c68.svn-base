            ...
            <form name="frmBitacoraCateos" class="form-horizontal" id="frmSolicitud" method="POST" target="oculto" enctype="multipart/form-data" onsubmit="return false;">            
                ...
                <div class="col-xs-12 col-md-12 detalleInfo" style="display:none" >
                    <div class="col-xs-12 col-md-12 text-center" >
                        <div class="panel-heading" >DETALLE ORDEN DE APREHENSI&Oacute;N</div>

                        <div class="table-responsive" >
                            <table id="detalleOrden" class="table table-striped table-hover table-bordered table-condensed" >
                                <thead>
                                    <tr>
                                        <th>Juzgado</th>
                                        <th>Estatus</th>
