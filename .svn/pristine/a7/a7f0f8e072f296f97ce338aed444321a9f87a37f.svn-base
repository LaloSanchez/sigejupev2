...
<div class="panel panel-default">
    <div class="panel-heading">
        <h4>Mis Solicitudes de audiencia M.P.</h4>
    </div>
...
<script type="text/javascript">
    ...
    siguientePaso = function (paso) {
        if (paso == 1) {
            siguiente('divGeneral', 'sigejupe/solicitudAudiencias/frmSolicitudAudienciasmp.php', 1);
            ...
            if (!validaPasoUno()) {
                ...
                $('#liPaso6').find("a").removeClass("active");
                $('#liPaso7').find("a").removeClass("active");
                siguiente('divGeneral', 'sigejupe/imputadosSolicitudes/frmImputadosSolicitudesmp.php', 2);
                $('#divDatosAudiencias').hide('');
                $('#btnPaso2').show();
                $('#btnPaso1').hide();
                $('#btnPaso3').hide();
            ...
            if (!validaPasoUno() && !validaPasoDos()) {
                ...
                $('#liPaso6').find("a").removeClass("active");
                $('#liPaso7').find("a").removeClass("active");
                siguiente('divGeneral', 'sigejupe/ofendidosSolicitudes/frmOfendidosSolicitudesmp.php', 3);
                $('#divDatosAudiencias').hide('');
                $('#btnPaso3').show();
                $('#btnPaso2').hide();
                $('#btnPaso1').hide();
            ...
            if (!validaPasoUno() && !validaPasoDos() && !validaPasoTres()) {
                ...
                $('#liPaso6').find("a").removeClass("active");
                $('#liPaso7').find("a").removeClass("active");
                siguiente('divGeneral', 'sigejupe/delitosSolicitudes/frmDelitosmp.php', 4);
                $('#divDatosAudiencias').hide('');
                $('#btnPaso4').show();
                $('#btnPaso2').hide();
                $('#btnPaso1').hide();
            ...
            if (!validaPasoUno() && !validaPasoDos() && !validaPasoTres() && !validaPasoCuatro()) {
                ...
                $('#liPaso6').find("a").removeClass("active");
                $('#liPaso7').find("a").removeClass("active");
                siguiente('divGeneral', 'sigejupe/impofedelsolicitudes/frmImpofedelsolicitudesmp.php', 5);
                $('#divDatosAudiencias').hide('');
                $('#btnPaso5').show();
                $('#btnPaso2').hide();
                $('#btnPaso1').hide();
...
//            if (!validaPasoUno() && !validaPasoDos() && !validaPasoTres() && !validaPasoCuatro() && !validaPasoCinco()) {
                ...
                $('#liPaso5').find("a").removeClass("active");
                $('#liPaso7').find("a").removeClass("active");
                siguiente('divGeneral', 'sigejupe/victimas/frmVictimaSolicitudmp.php', 6);
                $('#divDatosAudiencias').hide('');
                $('#btnPaso6').show();
                $('#btnPaso2').hide();
                $('#btnPaso1').hide();
            ...
            if (!validaPasoUno() && !validaPasoDos() && !validaPasoTres() && !validaPasoCuatro() && !validaPasoCinco()) {
                ...
                $('#liPaso5').find("a").removeClass("active");
                $('#liPaso6').find("a").removeClass("active");
                siguiente('divGeneral', 'sigejupe/resumensolicitudaudiencia/frmResumensolicitudaudienciamp.php', 7);
                $('#btnPaso7').show();
                $('#btnPaso2').hide();
                $('#btnPaso1').hide();
                $('#btnPaso3').hide();
            ...
            window.open("../fachadas/sigejupe/resumensolicitudaudiencia/ResumensolicitudaudienciaFacade.php?idSolicitud=" + idSolicitud + "&accion=consultaAcuse", 'Reporte', '"scrollbars=1,width=800, height=1000');
        }
    };
    ...
    validaPasoDos = function () {
        ...
        $.ajax({
            ...
            error: function (objeto, quepaso, otroobj) {
                alert("Error en la peticion de Valida Paso 2:\n\n" + otroobj);
            }
        });
        return error;
    };
    validaPasoTres = function () {
        ...
        $.ajax({
            ...
            error: function (objeto, quepaso, otroobj) {
                alert("Error en la peticion de valida paso 3:\n\n" + otroobj);
            }
        });
        return error;
    };
    validaPasoCuatro = function () {
        ...
        $.ajax({
            ...
            error: function (objeto, quepaso, otroobj) {
                alert("Error en la peticion de valida paso 4:\n\n" + otroobj);
            }
        });
        return error;
    };
    validaPasoCinco = function () {
        ...
        $.ajax({
            ...
            error: function (objeto, quepaso, otroobj) {
                alert("Error en la peticion de Valida paso 5:\n\n" + otroobj);
            }
        });
        return error;
    };
    ...
    tieneAudiencia = function () {
        if ($("#hddIdSolicitudAudiencia").val() != "") {
            ...
            $.ajax({
                ...
                error: function (objeto, quepaso, otroobj) {
                    alert("Error en la peticion de Tiene Audiencia:\n\n" + otroobj);
                }
            });
            return error;
        }
