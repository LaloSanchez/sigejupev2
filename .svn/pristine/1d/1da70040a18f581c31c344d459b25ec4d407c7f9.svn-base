        ...
        ?>
            ...
            muestraOcultaBotones = function() {
                ...
                if ( instanciaSesion === 2 && origen === "" ) {
                    $("#mostrar-imputados-editar").parent().hide();
            ...
            $(function () {
                ...
                if (cveTipoCarpetaArbol > 0) {
                    ...
                    $.ajax('../fachadas/sigejupe/carpetasjudiciales/CarpetasjudicialesFacade.Class.php', {
                        type: 'POST',
                        async: false,
                        data: {
                            accion: 'seleccionar',
                            idCarpetaJudicial: '<?php echo $idReferenciaArbol; ?>'
                        },
                        dataType: 'json',
                        beforeSend: function (objeto) {
                            ToggleLoading(1);
                        ...
                        success: function (data) {
                            ...
                            var numeroCarpeta = data.data[0].numero;
                            var anioCapeta = data.data[0].anio;

                            txtNumeroTree = numeroCarpeta;
                            txtAnioTree = anioCapeta;


                        }
                    }).error(function () {
        //                    alert('error al obtener la carpeta');
        //                    ToggleLoading(2);
                    });
