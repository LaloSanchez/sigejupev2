...
public function selectTipospersonas($TipospersonasDto){
$TipospersonasDto=$this->validarTipospersonas($TipospersonasDto);
$TipospersonasController = new TipospersonasController();
$TipospersonasDto = $TipospersonasController->selectTipospersonas($TipospersonasDto);
if($TipospersonasDto!=""){
...
$TipospersonasDto=$this->validarTipospersonas($TipospersonasDto);
$TipospersonasController = new TipospersonasController();
$TipospersonasDto = $TipospersonasController->updateTipospersonas($TipospersonasDto);
if($TipospersonasDto!=""){
$dtoToJson = new DtoToJson($TipospersonasDto);
...
$tipospersonasDto->setDesTipoPersona($desTipoPersona);
$tipospersonasDto->setActivo($activo);
$tipospersonasDto->setSoloVictima($solovictima);
