...
class ReporteCausasController {
    ...
    public function reporteCausas($carpetasjudicialesDto, $datos, $paginacion) {
        $consulta = "";
        $estatusCarpeta = "";
        $bandera = null;
        $datos["groups"] = "";
        ...
        $consulta = $this->selectCarpetaCausasRadicadas($carpetasjudicialesDto, $datos, $paginacion, $bandera);
        return $consulta;
    }

    public function selectCarpetaCausasRadicadas($carpetasjudicialesDto, $datos, $paginacion, $bandera) {
        ...
        $params["fields"] .= "ec.desEstatusCarpeta,cj.cveEstatusCarpeta, cj.idCarpetaJudicial,tj.cveTipoJuzgado,tj.desTipoJuzgado,cj.numero,cj.anio,r.desRegion,r.cveRegion,d.desDistrito,d.cveDistrito,"
                . "j.cveJuzgado,j.desJuzgado,tc.cveTipoCarpeta,tc.desTipoCarpeta,cj.carpetaInv" . $campos;
