var Ordenes = function () {
    return {
        ...
        enviarFirmar: function () {
            var este = this;
            if (confirm("Esta seguro de firmar la orden de aprehension ")) {
            ...
            if (transfer !== "" && file != "" && codigo != "") {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        transfer: transfer,
                        textRef: " SOLICITUD DE ORDEN DE APREHENSION",
                        file: file
                    },
                    async: false,
                    dataType: "json",
        ...
        getPdfSimple: function (idRegistro, origen, destino) {
            $.ajax({
                ...
                data: {
                    ...
                    cveGrupo: "",
                    cveTipoDocumento: "21", /*ordenes de aprehension*/
                    idReferenciaCarpeta: $("#idOrden").val() /*ID Orden de aprehension*/
                },
                async: false,
                dataType: "json",
                beforeSend: function (objeto) {
        ...
        sendInfo: function () {
            ...
            formData.append('cveJuzgado', $("#cmbJuzgadoProcedencia").val());
            ...
            var urlToSend = "../fachadas/sigejupe/solicitudesordenes/SolicitudesordenesFirmaFacade.Class.php"
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.type == "OK") {
                        ...
                        $("#rutaArchivoSolicitud").val("http://sigejupe.dev/solicitudespdf/" + data.filePath);
                        $("#rutaArchivoAdjunto").val(data.archivoAdjunto);
                        $("#idOrden").val(data.idOrden);
                        $("#nameArchivoSolicitud").val(data.filePath);
                        $("#btnEnviar").before(' <button class="btn btn-primary" style="display:inline-block" id="btnEnviarFirmar" name="btnEnviarFirmar" onclick="javascript:oredenes.enviarFirmar()">Enviar - Firmar</button>');
        ...
        imprimirComprobante: function (idOrden) {
            ...
            $.ajax({
                type: "POST",
                url: "../fachadas/sigejupe/solicitudesordenes/SolicitudesordenesFirmaFacade.Class.php",
                ...
                success: function (datos) {
                    ...
                    if (datos.type == "OK") {
                        ...
                        $("#divAlertSuccess").show("slide");
                        setTimeAlert("divAlertSuccess");
                        window.location.href = '../fachadas/sigejupe/solicitudesordenes/SolicitudesordenesFirmaFacade.Class.php?action=decargaSolicitudOrdenDownload&idOrden=' + idOrden;
        ...
        editRow: function (object, table) {
            if (table == "tblPersonas") {
                ...
                $(".addPerson").hide();
                $(".editPerson").html("<button class='btn btn-primary' onclick='javascript:oredenes.editPerson(" + index + ")' >Editar</button> "
                        + "<button class='btn btn-primary' onclick='javascript:oredenes.cancelEdit(\".addPerson\", \".editPerson\")' >Cancelar</button>");
            }
            ...
            if (table == "tblDelitos") {
                ...
                $(".addDelito").hide();
                $(".editDelito").html("<button class='btn btn-primary' onclick='javascript:oredenes.editDelito(" + index + ")' >Editar</button> "
                        + "<button class='btn btn-primary' onclick='javascript:oredenes.cancelEdit(\".addDelito\", \".editDelito\")' >Cancelar</button>");
            }
            ...
            if (table == "tblImputados") {
                ...
                $(".addImputado").hide();
                $(".editImputado").html("<button class='btn btn-primary' onclick='javascript:oredenes.editImputado(" + index + ")' >Editar</button> "
                        + "<button class='btn btn-primary' onclick='javascript:oredenes.cancelEdit(\".addImputado\", \".editImputado\")' >Cancelar</button>");
            }
            ...
            if (table == "tblVictimas") {
                ...
                $(".addOfendido").hide();
                $(".editOfendido").html("<button class='btn btn-primary' onclick='javascript:oredenes.editOfendido(" + index + ")' >Editar</button> "
                        + "<button class='btn btn-primary' onclick='javascript:oredenes.cancelEdit(\".addOfendido\", \".editOfendido\")' >Cancelar</button>");
            }
        },
