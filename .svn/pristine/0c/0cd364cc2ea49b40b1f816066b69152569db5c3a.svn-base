...
if(($tiposdocumentosDto->getDescTipoDocumento()!="") ||($tiposdocumentosDto->getExtencion()!="") ||($tiposdocumentosDto->getActivo()!="") ){
$sql.=",";
}
}
if($tiposdocumentosDto->getDescTipoDocumento()!=""){
$sql.="descTipoDocumento";
if(($tiposdocumentosDto->getExtencion()!="") ||($tiposdocumentosDto->getActivo()!="") ){
$sql.=",";
}
}
if($tiposdocumentosDto->getExtencion()!=""){
$sql.="extencion";
...
if($tiposdocumentosDto->getExtencion()!=""){
$sql.="'".$tiposdocumentosDto->getExtencion()."'";
if(($tiposdocumentosDto->getActivo()!="") ){
$sql.=",";
}
}
...
if(($tiposdocumentosDto->getDescTipoDocumento()!="") ||($tiposdocumentosDto->getExtencion()!="") ||($tiposdocumentosDto->getActivo()!="") ||($tiposdocumentosDto->getFechaActualizacion()!="") ||($tiposdocumentosDto->getFechaRegistro()!="") ){
$sql.=",";
}
}
if($tiposdocumentosDto->getDescTipoDocumento()!=""){
$sql.="descTipoDocumento='".$tiposdocumentosDto->getDescTipoDocumento()."'";
if(($tiposdocumentosDto->getExtencion()!="") ||($tiposdocumentosDto->getActivo()!="") ||($tiposdocumentosDto->getFechaActualizacion()!="") ||($tiposdocumentosDto->getFechaRegistro()!="") ){
$sql.=",";
}
}
if($tiposdocumentosDto->getExtencion()!=""){
$sql.="extencion='".$tiposdocumentosDto->getExtencion()."'";
...
if(($tiposdocumentosDto->getCveTipoDocumento()!="") ||($tiposdocumentosDto->getDescTipoDocumento()!="") ||($tiposdocumentosDto->getExtencion()!="") ||($tiposdocumentosDto->getActivo()!="") ||($tiposdocumentosDto->getFechaActualizacion()!="") ||($tiposdocumentosDto->getFechaRegistro()!="") ){
$sql.=" WHERE ";
}
if($tiposdocumentosDto->getCveTipoDocumento()!=""){
$sql.="cveTipoDocumento=".$tiposdocumentosDto->getCveTipoDocumento()."";
...
if($tiposdocumentosDto->getExtencion()!=""){
$sql.="extension='".$tiposdocumentosDto->getExtencion()."'";
if(($tiposdocumentosDto->getActivo()!="") ||($tiposdocumentosDto->getFechaActualizacion()!="") ||($tiposdocumentosDto->getFechaRegistro()!="") ){
$sql.=" AND ";
}
}
...
$tmp[$contador]->setExtencion($row["extension"]);
