...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
    ...
    class SolicitudesordenesFacade {
        ...
        public function selectSolicitudesordenes($SolicitudesordenesDto) {
            ...
            $SolicitudesordenesDto = $SolicitudesordenesController->selectSolicitudesordenes($SolicitudesordenesDto);
        ...
        public function insertSolicitudesordenes($param = "") {
            $SolicitudesOrdenesController = new SolicitudesordenesController();
            return $SolicitudesordensDto = $SolicitudesOrdenesController->insertSolicitudesordenes($param);
        }

        public function updateSolicitudesordenes($SolicitudesordenesDto) {
            $SolicitudesordenesDto = $this->validarSolicitudesordenes($SolicitudesordenesDto);
            $SolicitudesordenesController = new SolicitudesordenesController();
            $SolicitudesordenesDto = $SolicitudesordenesController->updateSolicitudesordenes($SolicitudesordenesDto);
            if ($SolicitudesordenesDto != "") {
                $dtoToJson = new DtoToJson($SolicitudesordenesDto);
...
//            $idJuez = 1521;
                ...
                if ($juzgadoresDto != "" && count($juzgadoresDto) > 0) {
                    ...
                    $SolicitudesordenesController = new SolicitudesordenesController();
                    $resultados = $SolicitudesordenesController->consultaOrden($juzgadoresDto->getIdJuzgador(), $param);
        ...
        public function deleteSolicitudesordenes($SolicitudesordenesDto) {
            $SolicitudesordenesDto = $this->validarSolicitudesordenes($SolicitudesordenesDto);
            $SolicitudesordenesController = new SolicitudesordenesController();
            $SolicitudesordenesDto = $SolicitudesordenesController->deleteSolicitudesordenes($SolicitudesordenesDto);
        ...
        public function consultaOrdenDetalle($idOrden, $juez) {
            if ($idOrden != "" && $idOrden != 0) {
                $SolicitudesordensController = new SolicitudesordenesController();
                ...
                if ($resultados["type"] == "OK") {
                    ...
                    foreach ($resultados["data"] as $resultado) {
                        ...
                        $orden = " order by idDocumentoImg DESC limit 1";
                        $documentosdto = $documentosDAO->selectDocumentosimg($documentosdto, $orden);
                        if ($documentosdto != "") {
                            ...
                            if ($imagenesDto != "") {
                                ...
                                if (trim($imagenesDto->getRuta()) != "") {
                                    ...
                                    $json .= ', "documento":"./fachadas/sigejupe/solicitudesordenes/descargarArchivo.php?idComprobante=' . $resultado["orden"]->getIdOrden() . '"';
        ...
        public function cancelarSolicitudOrden($idSolicitudOrden, $motivoCancelacion) {
            if ($idSolicitudOrden != "" && $idSolicitudOrden > 0) {
                $SolicitudesordenesController = new SolicitudesordenesController();
                $SolicitudesordenesDto = $SolicitudesordenesController->cancelarSolicitudOrden($idSolicitudOrden, $motivoCancelacion);
...
//        }
        ...
        public function getInfoWS($idJuzgado) {
            $solicitudCtr = new SolicitudesordenesController();
        ...
        public function cambioStatus($idSolicitudOrden, $cambiarStatus, $motivo) {
            if (($idSolicitudOrden != '') && ($cambiarStatus > 0) && ($motivo != '')) {
                $consultaCtr = new SolicitudesordenesController();
                $resultado = $consultaCtr->cambioStatus($idSolicitudOrden, $cambiarStatus, $motivo);
                return $resultado;
            }
            return array("type" => 'Error');
        }
...
#OTROS DATOS
    ...
    if (isset($_SESSION["cveUsuarioSistema"])) {
        if (($accion == "guardar") && ($idSolicitudOrden == "")) {
            ...
            // --> Accion para obtener la informacion a travez del Web Service
            $idJuzgado = $_POST["juzgado"];
            $resultado = $solicitudesordenesFacade->getAdminInfoJuzgadorWS("10322");
            echo $resultado;
        } else if (($accion == 'cambioStatus')) {
            $cambiarStatus = $_POST['cambiarStatus'];
            $motivo = $_POST['motivo'];
            $datosBusqueda = $solicitudesordenesFacade->cambioStatus($idSolicitudOrden, $cambiarStatus, $motivo);
            echo json_encode($datosBusqueda, true);
        }
    } else {
