...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
    ...
    <!--<textarea id="txtSolicitud" placeholder="Solicitud" name="txtSolicitud" rows="15" class='form-control'></textarea>-->
                        ...
                        <div id="divPaso5" class='content col-xs-12' style='display:none;'>
                            ...
                            <div class="form-group text-center" >
                                ...
                                <button id="btnEnviar" class="btn btn-primary" onclick="javascript:cateos.enviar()">Guardar - Pendiente Firma</button>
                            </div>
                        </div>
    ...
    <script src="sigejupe/solicitudesCateos/cateosFirma.js?v=<?php echo date('His'); ?>" charset="UTF-8" ></script>
    <script>
