...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
        ...
        <div class="panel-body">
                ...
                <div class="tab-content tabs-flat">
                    <div class="tabbable tabs-left">
                        ...
                        <ul id="myTab3" class="nav nav-tabs">
                            ...
                            <li class="tab-sky ">
                                <a href="#divEfectosSecuales" data-toggle="tab" aria-expanded="false">Efectos </a>
                            </li>
                        </ul>
                            ...
                            <div class="tab-pane active" id="divViolenciaGenero">
                                <div id="divLlenaDatosViolencia" style="display:none">
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <label class="control-label" for="cmbFactorSocial"> Factor social</label>
                                        <div>
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <label class="control-label" for="cmbHomicidioDoloso"> Homicidio doloso</label>
                                        <div>
            ...
            <script type="text/javascript">
                ...
                comboEfectos = function () {
                    $.ajax({
                        ...
                        success: function (datos) {
                            try {
                                $('#cmbEfecto').empty();
                                $('#cmbEfecto').append('<option value="0">Seleccione una opcion</option>');
                    ...
                    $.ajax({
                        ...
                        success: function (datos) {
                            try {
                                ...
                                $('#cmbDetalleEfecto').append('<option value="0">Seleccione una opcion</option>');
                                if (datos.totalCount > 0) {
                                    $.each(datos.data, function (count, object) {
                    ...
                    $.ajax({
                        ...
                        success: function (datos) {
                            try {
                                ...
                                $('#cmbFactorSocial').append('<option value="0">Seleccione una opcion</option>');
                                if (datos.totalCount > 0) {
                                    $.each(datos.data, function (count, object) {
                    ...
                    $.ajax({
                        ...
                        success: function (datos) {
                            try {
                                ...
                                $('#cmbHomicidioDoloso').append('<option value="0">Seleccione una opcion</option>');
                                if (datos.totalCount > 0) {
                                    $.each(datos.data, function (count, object) {
                ...
                comboPaisOrigen = function () {
                    $.ajax({
                        ...
                        success: function (datos) {
                            try {
                                $('#cmbPaisOrigen').empty();
                                $('#cmbPaisOrigen').append('<option value="0">Seleccione una opcion</option>');
                                if (datos.totalCount > 0) {
                                    $.each(datos.data, function (count, object) {
                ...
                comboEstadoOrigen = function () {
                    ...
                    $('#cmbEstadoOrigen').append('<option value="0">Seleccione una opcion</option>');
                    $('#cmbMunicipioOrigen').empty();
                    $('#cmbMunicipioOrigen').append('<option value="0">Seleccione una opcion</option>');
                    $("#txtestadoOrigen").val("");
                    ...
                    $.ajax({
                        ...
                        success: function (datos) {
                            try {
                                ...
                                $('#cmbPaisDestino').append('<option value="0">Seleccione una opcion</option>');
                                if (datos.totalCount > 0) {
                                    $.each(datos.data, function (count, object) {
                ...
                comboEstadoDestino = function () {
                    ...
                    $('#cmbEstadoDestino').append('<option value="0">Seleccione una opcion</option>');
                    $('#cmbMunicipioDestino').empty();
                    $('#cmbMunicipioDestino').append('<option value="0">Seleccione una opcion</option>');
                ...
                comboTipoTrata = function () {
                    $.ajax({
                        ...
                        success: function (datos) {
                            try {
                                $('#cmbTipoTrata').empty();
                                $('#cmbTipoTrata').append('<option value="0">Seleccione una opcion</option>');
                                if (datos.totalCount > 0) {
                                    $.each(datos.data, function (count, object) {
                    ...
                    $.ajax({
                        ...
                        success: function (datos) {
                            try {
                                ...
                                $('#cmbTransportacion').append('<option value="0">Seleccione una opcion</option>');
                                if (datos.totalCount > 0) {
                                    $.each(datos.data, function (count, object) {
                ...
                comboAmbitoAcoso = function () {
                    $.ajax({
                        ...
                        success: function (datos) {
                            try {
                                $('#cmbAmbito').empty();
                                $('#cmbAmbito').append('<option value="0">Seleccione una opcion</option>');
                                if (datos.totalCount > 0) {
                                    $.each(datos.data, function (count, object) {
                ...
                comboConducta = function () {
                    $.ajax({
                        ...
                        success: function (datos) {
                            try {
                                $('#cmbCondcuta').empty();
                                $('#cmbCondcuta').append('<option value="0">Seleccione una opcion</option>');
                                if (datos.totalCount > 0) {
                                    $.each(datos.data, function (count, object) {
                    ...
                    $.ajax({
                        ...
                        success: function (datos) {
                            try {
                                ...
                                $('#cmbDetalleConducta').append('<option value="0">Seleccione una opcion</option>');
                                if (datos.totalCount > 0) {
                                    $.each(datos.data, function (count, object) {
    ...
    //                if ($("input[name=chbxRalacion]:checked").length == 1 && $("input[name=chbxRalacion]:checked").length != 0) {
    ...
    //                } else {
    //                    alert("Solo puede seleccionar una relacion");
    //                    $("#chbxRalacion input[type=checkbox]").prop('checked', false);
    //                }
                };
                validaOpcionesRelacion = function (id) {
                    $.ajax({
                        type: "POST", url: "../fachadas/sigejupe/impofedelsolicitudes/ImpofedelsolicitudesFacade.Class.php",
                        async: false,
                        dataType: "json",
                        ...
                        success: function (datos) {
                            ...
                            if (datos.status == 'ok') {
                                ...
                                for (var i = 0; i < datos.data.length; i++) {
                                    ...
                                    table += "<td><input type='checkbox' id='chbxRalacion' name='chbxRalacion' value='" + datos.data[i].idImpOfeDelSolicitud + "' onclick='seleccionaRelacion(" + datos.data[i].idImpOfeDelSolicitud + ");'></td>";
                                    table += "</tr>";
                                }
                                table += '</table>';
                ...
                agregaEfecto = function () {
                    ...
                    if (validaAEfectos()) {
                        $.ajax({
                            type: "POST",
                            url: "../fachadas/sigejupe/violencia/ViolenciaFacade.php",
                            async: false,
                            dataType: "json",
                            data: {accion: "guardaEfectosViolencia",
                                ...
                                idImpOfeDelSolicitud: $('input:checkbox[name=chbxRalacion]:checked').val(),
    //                            idImpOfeDelSolicitud: $('#chbxRalacion').val(),
                            ...
                            success: function (datos) {
                                if (datos.status == 'ok') {
                                    ...
                                    $("#divAlertInfoViolencia").html("");
                                    $("#divAlertInfoViolencia").html(datos.mnj);
                                    $("#divAlertInfoViolencia").show("");
                                    setTimeAlert("divAlertInfoViolencia");
                                }
                            },
                            error: function (objeto, quepaso, otroobj) {
                                alert("Error en la peticion de Consulta de Audiencia:\n\n" + otroobj);
    ...
    //                        idImpOfeDelSolicitud: $('#chbxRalacion').val(),
                        ...
                        success: function (datos) {
                            ...
                            if (datos.status == 'ok') {
                                ...
                                table += '<tr class="trGridAgregaTabla">';
                                table += '<th>Efecto</th>';
                                table += '<th>Detalle del efecto</th>';
                                ...
                                for (var i = 0; i < datos.totalCount; i++) {
                                    for (var x = 0; x < datos.data[i].dataDetalle.length; x++) {
                                        ...
                                        table += '<td onclick = "seleccionaEfecto(' + datos.data[i].idViolenciaDeGenero + "," + datos.data[i].dataDetalle[x].idEfectoOfendido + ')">' + datos.data[i].desEfecto + '</td>';
                                        table += '<td onclick = "seleccionaEfecto(' + datos.data[i].idViolenciaDeGenero + "," + datos.data[i].dataDetalle[x].idEfectoOfendido + ')">' + datos.data[i].dataDetalle[x].desDetalleEfecto + '</td>';
                        ...
                        success: function (datos) {
                            ...
                            if (datos.status == 'ok') {
                                ...
                                for (var i = 0; i < datos.totalCount; i++) {
                                    ...
                                    table += '<td onclick = "seleccionaSexualGeneral(' + datos.data[i].idSexual + ')">' + datos.data[i].desModalidad + '</td>';
                                    table += '<td onclick = "seleccionaSexualGeneral(' + datos.data[i].idSexual + ')">' + datos.data[i].desAmbito + '</td>';
