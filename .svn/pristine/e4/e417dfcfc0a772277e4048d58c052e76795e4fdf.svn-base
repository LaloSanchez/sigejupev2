...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h5 class="panel-title">                                                            
                Simulador de Apelaci&oacute;n Cateos                           
            </h5>
        </div>
            ...
            <div id="divFormulario" class="form-horizontal">
                ...
                <div class="form-group">
                    <div class="col-xs-offset-3 col-xs-9">
                        <input type="submit" class="btn btn-primary consulta" value="Consultar" onclick="consultarProgramacionApelaCateos()">
    ...
    <script type="text/javascript">
        ...
        consultarProgramacionApelaCateos = function () {
            ...
            if (fechaInicio == "") {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        fechaFinal: fechaFin,
                        activo: "S",
                        accion: "consultarSimulacionApelaCateos"},
                    async: true,
                    dataType: "html",
