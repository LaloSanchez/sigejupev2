...
public class Escaner implements MorenaConstants {
    ...
    public void escanear(String p, int n,boolean duplex, boolean encolor) throws TwainException, FileNotFoundException {
        try {
            path = p + "\\";
            index = n;
            ...
            System.out.println("Color: " + encolor);
...
//            }
            ...
            if (source != null) {
                ...
                if(duplex==true){
                 System.out.println("Modo Duplex");   
                 source.setDuplexEnabled(true);
                }
                
                if(encolor==true){ 
                    System.out.println("Modo color");
                    source.setColorMode();
                }
                    ...
                    do {
                        ...
                        if (imagen.getStatus() != ImageConsumer.IMAGEERROR) {
                            ...
                            try {
                                ...
                                String ruta = path + this.prefix + index;
                                count++;
                                if (this.count == 1) {
                                    vImages = new Vector();
                                    vImages.add(ruta);
            ...
            if (opcion == 0) {
                this.escanear(p, index, duplex, encolor);
            }
        } catch (TwainException ee) {
