...
class DomiciliosofendidoscarpetasDTO {
    private $idDomicilioOfendidoCarpeta;
    ...
    public function getIdDomicilioOfendidoCarpeta(){
        return $this->idDomicilioOfendidoCarpeta;
    }
    public function setIdDomicilioOfendidoCarpeta($idDomicilioOfendidoCarpeta){
        $this->idDomicilioOfendidoCarpeta=$idDomicilioOfendidoCarpeta;
    }
    ...
    function getDomicilioProcesal() {
        return $this->DomicilioProcesal;
    }

    function setDomicilioProcesal($DomicilioProcesal) {
        $this->DomicilioProcesal = $DomicilioProcesal;
        return $this;
    }

    public function toString(){
        return array("idDomicilioOfendidoCarpeta"=>$this->idDomicilioOfendidoCarpeta,
