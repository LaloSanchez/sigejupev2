...
class DelitoscarpetasController {
    ...
    public function bajaDelitosCarpetas($DelitoscarpetasDto, $proveedor = null) {
        ...
        if ($delitosCarpetas != "") {
            ...
            if ($numDelitos > 1) {
                $impofedelCarpetasTmp = new ImpofedelcarpetasDTO();
                $impofedelCarpetasTmp->setIdDelitoCarpeta($DelitoscarpetasDto->getIdDelitoCarpeta());
                $impofedelCarpetasTmp->setActivo('S');
                $impofedelCarpetasTmp = $ImpofedelcarpetasDao->selectImpofedelcarpetas($impofedelCarpetasTmp, "", $this->proveedor);
                if ( $impofedelCarpetasTmp != "" ) {
                    foreach ( $impofedelCarpetasTmp as $impofedel ) {
                        $validaEliminar = $this->validaEliminarDelitoRelacionImpofedel($impofedel, $this->proveedor);
    ...
    public function validaEliminarDelitoRelacionImpofedel($impofedelCarpetasDto, $proveedor = null) {
        if ($proveedor == null) {
            $this->proveedor = new Proveedor('mysql', 'sigejupe');
            $this->proveedor->connect();
        } else {
        ...
        if ( $formulacionImputacionDto != "" ) {
            $eliminar = false;
            $mensaje[] = array(utf8_encode("No se puede eliminar el registro ya que existe una relación con formulación de imputación para este delito"));
        }
        ...
        if ( $imputadosEjecSentenciasDto != "" ) {
            $eliminar = false;
            $mensaje[] = array(utf8_encode("No se puede eliminar el registro debido a que existe una relación con auto de radicación a ejecución de sentencia para este delito"));
        }
        ...
        if ( $imputadosSentenciasDto != "" ) {
            $eliminar = false;
            $mensaje[] = array(utf8_encode("No se puede eliminar el registro debido a que existe una relación con sentencias activas para este delito"));
        }
