...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
            ...
            <div id="divFormulario" class="form-horizontal">
                <div id="divPanelControl">
                    ...
                    <div id="divMes"style="display: none">
                        <div class="form-group">
                            <label class="col-md-4 control-label needed">Mes (Beneficio)</label>
                            <div class="col-md-5">
                    ...
                    <div id="divFecha"style="display: none">
                        <div class="form-group">
                            <label class="col-md-4 control-label needed">Fecha Inicial (Beneficio)</label>
                            <div class="col-md-5">
                                <input type="text" id="fechaConsultar" placeholder="FECHA INICIAL" class="form-control datepicker"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label needed">Fecha Final (Beneficio)</label>
                            <div class="col-md-5">
                    ...
                    <div class="form-group"> 
                        <label class="control-label col-md-4">Tipo de beneficio</label>
                        <div class="col-md-1">
                            <input type="checkbox" id="checkTipoBeneficio" class="form-inline" onclick="tipoBeneficio()">
                        </div>
                        <div class="col-md-3" id="divTipoBeneficio" style="display:none">
                            <select class="form-control" name="cmbTipoBeneficio" id="cmbTipoBeneficio">
                ...
                <div class="form-group">
                    <div class="col-xs-offset-3 col-xs-9">
                        <input type="submit" class="btn btn-primary" id="inputConsultar" value="Consultar" onclick="previoConsultar(true, 1);"> 
                        ...
                        <input type="submit" class="btn btn-primary exporta" id="inputExportarPDF" value="Exportar PDF" onclick="exportar('exportarPDF', 'divTableNivel');" style="display:none">
    ...
    <script type="text/javascript">
        ...
        exportar = function (accion, div) {
            var usuario = '<?php echo $_SESSION["nombre"]; ?>';
            var nombreArchivo = "REPORTE_BENEFICIOS";
        ...
        limpiar = function (bandera) {
            ...
            $("#hiddenVariables").val("");
            $("#h5titulo").html("Reporte de Beneficios");
            $("#checkTipoBeneficio").prop("checked", "");
            $("#radio1").prop("checked", "");
            $("#radio2").prop("checked", "");
            $("#radio3").prop("checked", "");
            $("#divGrafica").html("");
        ...
        tipoBeneficio = function () {
            $("#cmbTipoBeneficio").val(0);
            if ($("#checkTipoBeneficio").is(":checked")) {
                $("#divTipoBeneficio").show();
            } else {
                $("#divTipoBeneficio").hide();
            }
        };
        radio = function () {
            $("#txtAnioCarpeta").val("");
        ...
        filtro = function () {
            ...
            $("#idLabelDescripcion").text("Reporte Beneficios" + mensaje);
            if ($("#checkTipoBeneficio").is(":checked")) {
                strDatos += "&tipoBeneficio=S";
                if ($("#cmbTipoBeneficio").val() != 0) {
                    strDatos += "&cveTipoBeneficio=" + $("#cmbTipoBeneficio").val();
                }
            }
            return strDatos;
        };
        ...
        gestorNivel = function (json, bandera) {
            ...
            switch ($("#hiddenNivel").val()) {
                case "1":
                    ...
                    if (json.totalCount > 0) {
                        ...
                        for (var i = 0; i < json.totalCount; i++) {
                            ...
                            if ($("#checkTipoBeneficio").is(":checked")) {
                                table += "<td>" + json.resultados[i].desTipoBeneficioES + "</td>";
                            }
                ...
                case "4":
                    ...
                    break;
                case "5":
                    table += "<th>N&uacute;m.</th><th>Imputado</th><th>Tipo Beneficio</th>";
                    ...
                    for (var i = 0; i < json.totalCount; i++) {
                        ...
                        table += "<td>" + fechaMySQLaNormal(json.resultados[i].fechaTermina) + "</td>";
                        table += "</tr> ";
                    }
                    break;
            }
        ...
        consultar = function (bandera, nivel) {
            ...
            var strDatos = "accion=consultar_beneficios_Reporte";
            strDatos += "&activo=S";
            ...
            $.ajax({
                type: "POST",
                url: "../fachadas/sigejupe/reportes/ReportebeneficiosFacade.Class.php",
                data: strDatos,
                async: true,
                dataType: "html",
        ...
        switch ($("#hiddenNivel").val()) {
            case "1":
                ...
                for (var i = 0; i < json.totalCount; i++) {
                         ...
                         if ($("#checkTipoBeneficio").is(":checked")) {
                            categorias[i] = json.resultados[i].desTipoBeneficioES;
                        }else{
                            categorias[i] = "BENEFICIOS";
                        }
...
//        }
    ...
    cambiarGrafica = function () {
        ...
        calcularPaginas = function () {
            $("#inputRegresar2").hide();
            var url = "../fachadas/sigejupe/reportes/ReportebeneficiosFacade.Class.php";
            var strDatos = "accion=consultar_beneficios_Reporte";
        ...
        encabezado = function () {
            ...
            $("#h5titulo").html("<span style='text-decoration: underline; cursor:pointer;' onclick='regresar(0,false);'>Reporte de Beneficios</span>" + mensaje);
        };
        ...
        cargarTipoBeneficiosES = function () {
            var strDatos = "accion=consultar";
            strDatos += "&activo=S";
            $.ajax({
                type: "POST",
                url: "../fachadas/sigejupe/tiposbeneficioses/TiposbeneficiosesFacade.Class.php",
                data: strDatos,
                async: true,
                dataType: "html",
                beforeSend: function (objeto) {
                ...
                success: function (datos) {
                    ...
                    if (json.totalCount > 0) {
                        for (var i = 0; i < json.totalCount; i++) {
                            $("#cmbTipoBeneficio").append($('<option></option>').val(json.data[i].cveTipoBeneficioES).html(json.data[i].desTipoBeneficioES));
                        }
                    }
                },
                error: function (objeto, quepaso, otroobj) {
                    mostrarMensaje("Error en la peticion (cargar Tipos de beneficios):\n\n" + quepaso, 3);
                }
            });
        };
                                ...
                                $.each(response.perfiles[0].perfil[i].permisos, function (k, vnombre) {
                                    if (vnombre.nomFormulario == "REPORTES") {
                                        ...
                                        $.each(hijos, function (k2, nombreHijo) {
                                            if (nombreHijo.nomFormulario == 'BENEFICIOS') {
