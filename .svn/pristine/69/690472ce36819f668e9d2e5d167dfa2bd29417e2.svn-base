...
class OfendidoscateosDTO {
    private $idOfendidoCateo;
    ...
    private $telefono;
    private $email;
    public function getIdOfendidoCateo(){
        return $this->idOfendidoCateo;
    }
    public function setIdOfendidoCateo($idOfendidoCateo){
        $this->idOfendidoCateo=$idOfendidoCateo;
    }
    ...
    public function toString(){
        return array("idOfendidoCateo"=>$this->idOfendidoCateo,
