...
$idCarpetaJudicial = $_POST['idCarpetaJudicial'] > 0 ? $_POST['idCarpetaJudicial'] : 0;
$idActuacion = $_POST['idActuacion'] > 0 ? $_POST['idActuacion'] : 0;
            ...
            descargarFoja = function () {
                ...
                if (permiteDescarga) 
                {
                    try 
                    {
                        ...
                        formulario.action = "../controladores/sigejupe/imagenes/DescargaImagenesController.Class.php";
...
//                        var arrFojaGestor = json.data;
                    ...
                    for( var index = 1; index < size; index++ )
                    {
                        ...
                        {
                            var right = left + 1;
                            if( parseInt(json.data[left].posicion) > parseInt(json.data[right].posicion) )
                            {
                                tmp = json.data[left];
                                json.data[left] = json.data[right];
                                json.data[right] = tmp;
                            }
                        }
                    }
                ...
                if (idImagenesBorrar != "") {
                    if (confirm("Est� seguro de eliminar las imagenes seleccionadas?")) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "../controladores/sigejupe/imagenes/ImagenesController.Class.php",
                            data: {action: "borrarImagenes", idImagenesBorrar: idImagenesBorrar, idCarpetaJudicial: idCarpetaJudicial, idActuacion: idActuacion, cveTipoDocumento:cveTipoDocumento},
                            async: false,
                            dataType: "html",
                            beforeSend: function (objeto) {
                        ...
                        <tr>
                            ...
                            <td valign="top">
                                <ul id="ulMenuSup" style="height: 48px; background: #2e8463; /* Old browsers */
                                    ...
                                    <li id="liBtnOrdenar" class="opcMenuSup"><img name="BtnOrdenar" id="BtnOrdenar" src="visorpdf/imgMenuVisor/btnOrdenar.png" title="Modificar Imagenes" onClick="actualizarArchivos();" class="imgBtnMenu"></li>
