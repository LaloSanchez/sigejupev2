    ...
    <body>
        ...
        <script>
            ...
            function geocodeAddress(geocoder, resultsMap) {
                var pais = parent.document.getElementById("cmbPaisDomicilioImputado");
                pais = getTextCombo(pais, pais.value);
                var estado = parent.document.getElementById("cmbEstadoDomicilioImputado");
                estado = getTextCombo(estado, estado.value);
                var municipio = parent.document.getElementById("cmbMunicipioDomicilioImputado");
