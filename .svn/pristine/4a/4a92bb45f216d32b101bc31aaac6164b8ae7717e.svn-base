...
////POST para arbol
    ...
    <div class="panel panel-default" >
        <div id="divFormulario" style="display:none">
            ...
            <div class="panel-body">
                ...
                <div  class="form-horizontal" data-step="1" data-intro="Este m&oacute;dulo le permite registrar un nuevo auto de vinculaci&oacute;n a proceso, el cual puede ser modificado y/o eliminado." data-position='top'>
                    ...
                    <div id="divFijos">
                        ...
                        <div class="form-group">                                                                
                            <label for="cveTipoJuzgado" class="control-label col-md-3 needed" data-step="2" data-position='right'>Juzgados:</label>
                            <div class="col-md-9">
                                <div class="col-md-9">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                ...
                                &nbsp;
                                <div class="col-md-2">
                                    <button class="btn btn-primary" id="btnOficios" data-toggle="modal" ><i class="glyphicon glyphicon-refresh glyphicon-refresh-animate"></i>Consultar Oficios</button>
                                </div>
                                <div id="conectando" style="display: none;">
                                    <span class="label label-success"> <i class="glyphicon glyphicon-refresh glyphicon-refresh-animate"></i> Cargando ... </span>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <div class="col-md-9">
                                        ...
                                        <textarea rows="2" id="sintesisOficio" class="form-control" disabled placeholder="SINTESIS"  val="" class="form-inline numerico"  tabindex="3"></textarea> 
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="form-group"> <!-- Impofedel -->
                            ...
                            <div id="principalTablaImpofedel" class="col-md-10 table-responsive">
                                <div class="">
                    ...
                    <div class="form-group"> <!-- Imputados -->
                        <label class="control-label col-md-3 ">Seleccione imputados para agregar defensor</label>
                        <div class="col-md-9 table-responsive" id="tablaImputados">

                        </div>
                        <label class="control-label col-md-3"></label>
                        <div class="col-md-3">
                            <button class=" btn btn-primary" id="btnAsignarDefensor" data-toggle="modal" >Nuevo Defensor </button>
                        </div>
                    </div>
                    <div class="form-group"> 
                        <label class="control-label col-md-3 ">Nuevo defensor</label>
                        <div class="col-md-9 table-responsive" id="divTablaDefensores">
                    ...
                    <div class="form-group"> 
                        ...
                        <div class="col-md-9">
                            <div class="col-md-3">
                                <select class=" Relacionado form-control" name="cmbTipoResolucion" disabled onChange="activarSintesis()" id="cmbTipoResolucion">
                                    <option value="">Seleccione una opci&oacute;n</option>
                                </select>
                            </div>
                            <div class="col-md-1"><button class=" btn btn-primary" id="btnBuscarResolucion" disabled data-toggle="modal" >Buscar </button></div>
                    ...
                    <div class="form-group"> 
                        <label class="control-label col-md-3 ">S&iacute;ntesis de Resoluci&oacute;n Combatida:</label>
                        <div class="col-md-9">
                            <div class="col-md-4">
                                <input type="text" id="sintesis" style="text-transform:uppercase;" onkeyup="javascript:this.value.toUpperCase();" disabled val="" class=" form-control form-inline col-md-10"/>
                            </div> 
                            <div class="form-group"> 
                    ...
                    <div class="form-group" id="btnNormal">
                        <div class="col-md-offset-3 col-md-9" id="divBotones">
                            <div class="col-md-2 botonesAdaptar" data-step="3" data-intro="Presi&oacute;nelo para guardar o actualizar un oficio." data-position='top'>                                        
                                <input type="submit" class="btn btn-primary btn-adaptar" value="Guardar" onclick="guardarRemision()" id="btn_auto_save"/>
                            </div>
                    ...
                    <div class="form-group" id="btnArbol" style="display:none">
                        <div class="col-md-offset-3 col-md-9" id="divBotones">
                            <div class="col-md-2 botonesAdaptar" data-step="3" data-intro="Presi&oacute;nelo para guardar o actualizar un oficio." data-position='top'>                                        
                                <input type="submit" class="btn btn-primary btn-adaptar" value="Guardar" onclick="guardarRemision()" id="btn_auto_save2"/>
                            </div>
                            <div class="col-md-2 botonesAdaptar botonesArbol" data-step="4" id="divImprimir" data-intro="Util&iacute;celo para limpiar la informaci&oacute;n seleccionada/introducida." data-position='top'>                                        
                                <input type="submit" class="btn btn-primary btn-adaptar" value="Imprimir" onclick="imprimirRecibo()" id="btn_imprimir"/>
                            </div>
            ...
            <div class="panel-body">
                <div class="form-horizontal">
                    ...
                    <div class="form-group"> 
                        ...
                        <div class="col-md-9"><div class="col-md-9"><select id="cmbTipoCarpeta" class="form-control"><option value="0">Seleccione una opción</option></select></div></div>
                    </div>
                    <div class="form-group">
    ...
    <script type="text/javascript">
                                ...
                                $.each(response.perfiles[0].perfil[i].permisos, function (k, vnombre) {
                                    if (vnombre.nomFormulario == "SECRETARIO DE TRIBUNAL DE ALZADA") {
                                        ...
                                        $.each(hijos, function (k2, nombreHijo) {
                                            if (nombreHijo.nomFormulario == 'REMISION DE APELACION') {
        ...
        function cargarDefensor(idImputado, contador, nombreImputado) {
            var defensorArray = new Object();
            defensorArray.idImputado = idImputado;
            defensorArray.numeroDefensor = contador;
            defensorArray.nombreImputado = nombreImputado;
    ...
    // activa y desactuva la sintesis
        ...
        function impOfeDelTable(idReferencia) {
            ...
            $.ajax({
                ...
                var message = '';
                var tabla = '';
                var tabla2 = "<div class='col-md-9'>";
                listaImputados = [];
                listaOfendidos = [];
                tabla2 += '<table class="table table-hover table-striped table-bordered">';
                tabla2 += '<thead><tr><th>No.</th><th>Imputado</th><th>Defensor(es)</th><th></th></tr></thead><tbody >';
                var ofendidosAux = [];
                if (totalRecords > 0) {
                    ...
                    for (var i = 0; i < totalRecords; i++) {
                        ...
                        if (imputadosArr.indexOf(referencia[i].idImputadoCarpeta) != -1) {
                        } else {
                            imputadosArr.push(referencia[i].idImputadoCarpeta);
                            //tabla += "<td><label class='needed'>agregar<input type='button' id='botonCargarDefensor" + referencia[i].idImpOfeDelCarpeta + "' style='display:none' onclick='cargarModalDefensor(" + referencia[i].idImputadoCarpeta + ")'></label></td>";
                            tabla += "</tr>";
                            tabla2 += "<tr >";
                            tabla2 += "<td>" + (i + 1) + "</td>";
                            if (referencia[i].cveTipoPersona == "3") {
                                tabla2 += "<td >" + referencia[i].nombreMoral + "</td>";
                            } else {
                                tabla2 += "<td >" + referencia[i].nombre + " " + referencia[i].paterno + " " + referencia[i].materno + "</td>";
                            }
                            tabla2 += "<td>" + obtenerDefensores(referencia[i].idImputadoCarpeta) + "</td>";
                            tabla2 += "<td><label><input type='checkbox' class='imputadosCheck' nombreimputado='" + referencia[i].nombreImputado + "'  id='checkImput" + referencia[i].idImputadoCarpeta + "'  value='" + referencia[i].idImputadoCarpeta + "' ></label></td>";
                            tabla2 += "</tr>";
                        }
                    }
                    tabla2 += '<tbody></table></div>';
                    $("#tablaImpofedel").html(tabla);
                    $("#tablaImputados").html(tabla2);
                } else {
    ...
    //                cleanFields(4);
            ...
            $.ajax({
                ...
                if (totalRecords > 0) {
                    ...
                    if (referencia[0].detenido == "S") {
                        tabla = "<select class='form-control' name='cmbDetenido" + idImputado + "' id='cmbDetenido" + idImputado + "'>" +
                                "<option value='1' selected>PRISION</option> " +
                                "<option value='2'>LIBRE</option> " +
                                "</select> <div id='divFechaDet" + idImputado + "'><label class='needed'>Fecha de detenci&oacuten</label><input type='text' placeholder='dd/mm/aaaa'  id='fechaDet" + idImputado + "' disabled value='" + fechaMySQLaNormal(referencia[0].fechaControlDet) + "' class='form-control datepicker fecha validFecDet'></div>";
                    } else {
                        tabla = "<select class='form-control' name='cmbDetenido" + idImputado + "' id='cmbDetenido" + idImputado + "'>" +
        ...
        function calcularConsignacion() {
            ...
            for (var i = 0; i < impofedelList.lenght; i++) {
                if ($("#cmbDetenido" + impofedelList[i]).val() == "2") {
                    validaS = true;
                }
                if ($("#cmbDetenido" + impofedelList[i]).val() == "1") {
                    validaN = true;
                }
            }
            if (validaS && validaN) {
        ...
        function consultarRemision() {
            ...
            var strDatos = "accion=consultarRemisionToca";
    ...
    //        cleanFields();
            ...
            $.ajax({
                ...
                if (json.Estatus == "ok") {
                    if (totalRecords > 0) {
                        var tabla = "<table id='tblResultadosGridAct2'  width='100%' border='1' style='border-collapse: collapse;' class='table table-hover table-striped table-bordered'>";
                        tabla += "<thead><tr>";
                        tabla += "<td>No.</td><td>Toca</td><td>Causa</td><td>Remision</td><td>S&iacute;ntesis</td><td>Fecha registro</td>";
                        ...
                        for (var i = 0; i < totalRecords; i++) {
                            ...
                            tabla += "<td> " + data[i].toca[0].numeroRemision + "/" + data[i].causa[0].anioRemision + "</td>";
                            tabla += "<td> " + data[i].toca[0].sintesis + "</td>";
                            tabla += "<td> " + fechaMySQLaNormal(data[i].toca[0].fechaRegistro) + "</td>";
                            tabla += "</tr>";
                        }
                        tabla += "</tbody></table>";
                    ...
                    //cargar los datos en todos los campos
        ...
        function getPages(page, cantReg) {
            var cantReg = $("#cmbNumReg").val();
            var strDatos = "accion=getPaginasRemisionToca";
            strDatos += "&paginacion=true";
            strDatos += "&cantxPag=" + cantReg;
            strDatos += "&pag=" + $("#cmbPaginacion").val();
            strDatos += "&cveJuzgado=" + $("#cmbTipoJuzgadoToca").val().split("/")[0];
        ...
        function cargarDatos(json, i, val) {
            ...
            $("#hiddenTipoJuzgado").val(json[i].toca[0].cvejuzgadoC);
            $("#hiddenTipoCarpeta").val(json[i].toca[0].cveTipoCarpetaC);
            $("#Sala").val(obtenerJuzgado(json[i].toca[0].cvejuzgadoC));
            $("#cmbRecurso").val(json[i].toca[0].cveRecurso);
            $("#fechaCoTras").val(fechaNormal(json[i].toca[0].fecTraslado));
            $("#cmbTipoResolucion").val(json[i].toca[0].cveCatResolucionCombatida);
            $("#hiddenidResolucionCombatida").val(json[i].toca[0].idResolucionCombatida);
            $("#hiddenidResolucionCarpetaCombatida").val(json[i].toca[0].idResolucionesCarpetasCombatidas);
            $("#fechaInterRec").val(fechaNormal(json[i].toca[0].fecInterponeRecurso));
            $("#sintesis").val(json[i].toca[0].sintesis);
            $("#observaciones").val(json[i].toca[0].observaciones);
            $("#fechaNotiSeAu").val(fechaNormal(json[i].toca[0].fecNotifica));
            var fechaReg = "";
            if (json[i].toca[0].idResolucionCombatida != "") {
                fechaReg = obtenerResolucionCombatidaFecha(json[i].toca[0].idResolucionCombatida);
            }
            $("#fechaRegistroRes").val(fechaMySQLaNormal(fechaReg));
            $("#fechaIntAd").val(fechaNormal(json[i].toca[0].fecAdhesion));
            $("#cmbTipoEfecto").val(json[i].toca[0].cveEfecto);
            $("#radioAgravio" + json[i].toca[0].agravios).prop("checked", true);
            $("#radioEmplazamineto" + json[i].toca[0].emplazamiento).prop("checked", true);
            $("#hiddenIdRemision").val(json[i].toca[0].idRemisionApelacion);
            $("#idActuacion").val(json[i].toca[0].idActuacion);
            $("#hiddenidReferencia").val(json[i].toca[0].idReferencia);
            $("#observaciones").val(json[i].toca[0].observaciones)
            impOfeDelTable(json[i].toca[0].idReferencia);
            seleccionarImpofedel(json[i].impofedel);
            contadorDefensores = parseInt(obtenerContadorDefensor(json[i].toca[0].idReferencia)) + 1;

            //alert(contadorDefensores);
            $("#divFijos :input").each(function () {
        ...
        function obtenerDefensores(idImputadoCarpeta) {
            //ajax para obtener el nombre del juzgado seleccionado
            var page = $("#cmbPaginacion").val();
            var cantReg = $("#cmbNumReg").val();
            var strDatos = "accion=consultar";
            ...
            $.ajax({
                ...
                if (totalRecords > 0) {
                    for (var i = 0; i < totalRecords; i++) {
                        ...
                        nombreDefensores += referencia[i].nombre;
                    }

                } else {
                }
            });
            return nombreDefensores;
        }
        ...
        function obtenerActuacionesRemisiones(idActuacion, idActuacionCarpeta) {
            var cantReg = $("#cmbNumReg").val();
            var strDatos = "accion=buscarActuacionRemision";
            strDatos += "&paginacion=true";
            strDatos += "&cantxPag=" + cantReg;
            strDatos += "&pag=" + $("#cmbPaginacion").val();
            strDatos += "&idActuacion=" + idActuacion;
            //strDatos += "&listaApelantes=" + (JSON.stringify(listaApelantes));
            $.ajax({
                async: false,
                type: 'POST',
                url: "../fachadas/sigejupe/remisionapelaciones/RemisionapelacionesFacade.Class.php",
                data: {listaApelantes: (JSON.stringify(listaApelantes)),
                    idActuacion: idActuacion, pag: $("#cmbPaginacion").val()
                ...
                var message = json.mnj;
                if (json.Estatus == "ok") {
                    var tabla = "<table id='tblResultadosGridAct'  width='100%' border='1' style='border-collapse: collapse;' class='table table-hover table-striped table-bordered'>";
                    tabla += "<tr>";
                    tabla += "<td>Consecutivo</td><td>Toca</td><td>Causa</td><td>Remision</td><td>Sintesis</td><td>Fecha registro</td>";
                    tabla += "</tr>";
                    var data = json.resultados;
                    // guardarDatos();
                    for (var i = 0; i < totalRecords; i++) {
                        ...
                        tabla += "<td > " + (i + 1) + "</td>";
                        tabla += "<td > " + data[i].toca[0].numeroC + "/" + data[i].toca[0].anioC + "</td>";
                        tabla += "<td > " + data[i].causa[0].numeroC + "/" + data[i].causa[0].anioC + "</td>";
                        tabla += "<td > " + data[i].toca[0].numeroRemision + "/" + data[i].causa[0].anioRemision + "</td>";
                        tabla += "<td > " + data[i].toca[0].sintesis + "</td>";
                        tabla += "<td > " + fechaMySQLaNormal(data[i].toca[0].fechaRegistro) + "</td>";
                        tabla += "</tr>";
        ...
        function guardarRemision() {         //campos de captura de Remision
            ...
            var numero = $("#numeroToca").val();
            var anio = $("#anioToca").val();
            var cveTipoCarpeta = $("#hiddenTipoCarpeta").val();
            var cveJuzgado = $('#hiddenTipoJuzgado').val();
            ...
            var accion = 'actualizarRemisionApelacion';
    ...
    //        if (idResolucionCombatida != "") {
    //            if (obtenerActuacionesRemisiones(idResolucionCombatida)) {
    //
    //            }
    //        }
            //alert(strDatos);
            ...
            //imputadosState = false;
            if (imputadosState == true && remisionState[0] == true) {
                //$("#btn_auto_save").hide();
                $.ajax({
                    async: false,
                    type: 'POST',
                    ...
                    data: {idOficio: $("#hiddenidOficio").val(), idResolucionCombatida: idResolucionCombatida,
                        ...
                        , listaDefensores: listaDefensoresEnv, stringImpofedel: stringImpofedelEnv
                    },
                }).done(function (response) {
                    var json = eval('(' + response + ')');
                    var totalRecords = json.totalCount;
        ...
        cargaJuzgadosRemision = function () {
            var strDatos = "accion=region";
            $.ajax({
                type: "POST",
                url: "../fachadas/sigejupe/juzgados/JuzgadosFacade.Class.php",
                data: strDatos,
        ...
        function obtieneDatosCarpeta() {
            var hiddenidReferencia = $('#hiddenidReferenciaArbol').val();
         ...
         * function para formar Tabla de apelantes a partir de una lista de arrays
         * @type type     */
        function formarTablaDefensores() {
            if (listaDefensores.length > 0) {
                var tabla = " ";
                tabla += '<table class="table table-hover table-striped table-bordered">';
                tabla += '<thead><tr><th>No.</th><th>Imputado</th><th>Defensor.</th><th></th></tr></thead><tbody >';
                for (var i = 0; i < listaDefensores.length; i++) {
                    tabla += "<tr>";
                    tabla += "<td>" + (i + 1) + " </td>";
                    tabla += "<td>" + listaDefensores[i].nombreImputado + " </td>";
                    tabla += "<td> Defensor" + listaDefensores[i].numeroDefensor + " </td>";
                    tabla += "<td><img src='img/eliminar.png' width='27px' style='cursor:pointer;' class='btnElimApel' onclick='eliminarDefensor(" + i + ")'></td>";
                    tabla += "</tr>";
                }
                tabla += '</tbody ></table>';
                return tabla;
        ...
        function actualizarApelante() {
            ...
            if ($("#cmbTipoApelante").val() != "" && $("#domicilio").val() != "" && nombre && correo) {
                ...
                $("#apelantesTbody").html(formarTablaApelantes());
                $("#btnsabe").show();
                $("#btnActAp").hide();
                limpiarApelante();
            } else {
        ...
        function eliminarDefensor(id) {
            var borrar = true;
            var num = listaDefensores[id].numeroDefensor;
            $("#checkImput" + listaDefensores[id].idImputado).prop('disabled', false);
            listaDefensores.splice(id, 1);
            if (listaDefensores.length == 0) {
                contadorDefensores = parseInt(obtenerContadorDefensor($("#hiddenidReferencia").val())) + 1;
            }
            $("#divTablaDefensores").html(formarTablaDefensores());
        }
        ...
        function cargarApelantes(json, i, val) {
            if (val) {
                json = $.parseJSON(json);
            }
            listaDefensores = [];
        ...
        function SeleccionarOficio(json, i) {
            //alert(json[i].aniActuacion);
            //var jsonDatos = JSON.stringify(json);
            $("#numeroOficio").val(json[i].numActuacion);
            $("#sintesisOficio").val(json[i].sintesis);
            $("#anioOficio").val(json[i].aniActuacion);
            $("#hiddenidOficio").val(json[i].idActuacion);
        }
        /*
         * function para seleccionar los datos de la resolucion    */
        function SeleccionarResolucion(json, i, cveTipoResolucion) {
        ...
        function SeleccionarResolucion2(json, i, cveTipoResolucion) {
    //        $("#sintesis").val(obtenerResolucionDes(cveTipoResolucion));
        ...
        imprimirRecibo = function () {
            ...
            window.open("../fachadas/sigejupe/remisionapelaciones/RemisionapelacionesAcuse.Class.php?idActuacion=" + idActuacion + "&accion=consultaAcuse", 'Reporte', '"scrollbars=1,width=800, height=1000');
        };
        ...
        var ImputadosArr = [];
        var listaDefensores = [];
        var contadorDefensores = 1;
        function obtenerContadorDefensor(idCarpetaJudicial) {
            var numeroDefensor = 0;
            $.ajax({
                async: false,
                type: 'POST',
                global: false,
                url: "../fachadas/sigejupe/numerosdefensores/NumerosdefensoresFacade.Class.php",
                ...
                if (totalRecords > 0) {
                    for (var i = 0; i < totalRecords; i++) {
                        if (numeroDefensor < referencia[i].numeroDefensor) {
                            numeroDefensor = parseInt(referencia[i].numeroDefensor);
                        }
                    }
                }
            });
            return numeroDefensor;
        }
...
//           setPermissions();
            ...
            $("#cmbTipoDefensor").change(function () {
                if ($("#cmbTipoDefensor").val() == 1) {
                    $("#nombreDefensor").val("REQUIERE DEFENSOR PÙBLICO")
                } else {
                    $("#nombreDefensor").val("")
                }
    ...
    //            }
            ...
            $("#btnOficios").click(function () {
                ...
                $.ajax({
                    ...
                    if (totalRecords > 0) {
                        ...
                        var index = (parseInt(json.pag) - 1) * parseInt(numReg);
                        for (var i = 0; i < totalRecords; i++) {
            ...
            $("#btnAsignarDefensor").click(function () {
                var cont = 0;
