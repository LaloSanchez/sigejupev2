...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div id="divFormulario" class="form-horizontal">
                <div><input type="checkbox" id="ckbtribunal" onchange="asignaTribunal();">Tribunal por ejercicio de facultad de atracci&oacute;n</div>
                <div><input type="checkbox" id="ckbmismoJuzgador" onchange="asignaTribunal();">Mismo juzgador anterior</div>
    ...
    <script>
        ...
        asignaTribunal = function () {
            if ($('#ckbtribunal').is(':checked')) {
                parent.$('#tribunal').val('S');
            } else {
                parent.$('#tribunal').val('N');
            }

            if ($('#ckbmismoJuzgador').is(':checked')) {
                parent.$('#mismoJuzgador').val('S');
            } else {
                parent.$('#mismoJuzgador').val('N');
            }
        };
