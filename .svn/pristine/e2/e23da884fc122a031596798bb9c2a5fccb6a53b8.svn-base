...
'use strict';
var DEFAULT_URL = document.getElementById("hdnArchivo").value.trim();
//var TIPOCONSULTA = document.getElementById("hdnTipoConsulta").value.trim();
//var IDUSUARIOEXTERNO = document.getElementById("hdnIdUsuarioExterno").value.trim();
var IDFOJA = document.getElementById("hdnIdFoja").value.trim();
var IDCARPETAJUDICIAL = document.getElementById("hdnIdCarpetaJudicial").value.trim();
var IDACTUACION = document.getElementById("hdnIdActuacion").value.trim();
var IDDOCUMENTOIMAGEN = document.getElementById("hdnIdDocumentoImagen").value.trim();
...
//        if (TIPOCONSULTA == "2") {
////            if (confirm("El servicio de Impresion tiendra un costo, �desea seguir?")) {
//                $.ajax({
//                    type: "POST",
//                    url: "../../controller/externos/ExternosController.php",
//                    data: {action: "cobroImpresion", idUsuarioExterno: IDUSUARIOEXTERNO, idFoja: IDFOJA,
//                        idCarpetaJudicial: IDCARPETAJUDICIAL, idActuacion: IDACTUACION, idDocumentoImagen: IDDOCUMENTOIMAGEN},
//                    async: false,
//                    dataType: "html",
//                    beforeSend: function (objeto) {
//                        $('#divFoja').html("<span class=\"Arial14\"><b>Obteniendo informaci�n</b></span>");
//                    },
...
//                            }
//                        } else {
//                            alert("Error consultar informaci�n de pago");
//                        }
//                    },
...
//                });
//                this.close();
//                window.parent.window.parent.actualizaSaldos();
////            }
//        } else {
            window.print();
//        }
...
//        if (TIPOCONSULTA == "2") {
////            if (confirm("El servicio de descarga tiendra un costo, �desea seguir?")) {
//                $.ajax({
//                    type: "POST",
//                    url: "../../controller/externos/ExternosController.php",
//                    data: {action: "cobroDescarga", idUsuarioExterno: IDUSUARIOEXTERNO, idFoja: IDFOJA,
//                        idCarpetaJudicial: IDCARPETAJUDICIAL, idActuacion: IDACTUACION, idDocumentoImagen: IDDOCUMENTOIMAGEN},
//                    async: false,
//                    dataType: "html",
//                    beforeSend: function (objeto) {
...
var PDFViewerApplication = {
    ...
    load: function pdfViewLoad(pdfDocument, scale) {
        ...
        pdfDocument.getMetadata().then(function (data) {
            ...
            console.log('URL de archivo: '+DEFAULT_URL);
            var pdfTitle;
