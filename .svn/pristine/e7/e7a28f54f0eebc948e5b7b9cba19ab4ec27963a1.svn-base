...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
        ...
        <div class="panel-body">
            ...
            <div id="divFormulario" class="form-horizontal">
                ...
                <div class="form-group col-lg-12">
                    <label class="control-label col-xs-3" for="cmbJuzgados">Juzgados  <span class="requerido">(*)</span></label>
                    <div class="col-xs-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-6">
                        <input type="text" class="form-control mayuscula " id="fechaRadicacion" name="fechaRadicacion" placeholder="Fecha de Radicaci&oacute;n" >
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-xs-3">Juez Propietario <span class="requerido">(*)</span></label>
                ...
                <div class="form-group col-lg-12">
                    <label class="control-label col-xs-3" for="cmbConsignacionA">Consignaciones Acciones <span class="requerido">(*)</span></label>
                    <div class="col-xs-9">
    ...
    <script type="text/javascript">
        ...
        comboJuzgados = function () {
            var str_data = "accion=distrito";
            var idCarpeta = $("#hddIdCarpetaJudicial").val();
            if ( idCarpeta != "" && idCarpeta > 0 ) {
                str_data = "accion=getJuzgadoCarpeta&idCarpeta=" + idCarpeta;
            }
            $.ajax({
                type: "POST",
                        ...
                        try{
                            ...
                            if(result.totalCount > 0){
                                ...
                                if ( $("#cmbTipoCarpeta").val() == 4 ) {
                                    html += '<select id="idJuzgadorPropietario" name="idJuzgadorPropietario" class="js-example-basic-multiple" multiple="multiple" style="width: 100%;">';
                                } else {
                    ...
                    try {
                        if (datos.totalCount > 0) {
                            ...
                            if(cveTipocarpeta == "4") {
                                ...
                                $('#divJuez').find('#idJuzgadorPropietario').val(arreglo).trigger("change");
                                //alert($('#divJuez').find('#idJuzgadorPropietario').attr('name'));
                            } else {
    ...
    //                            }
        ...
        validateStep1 = function () {
            ...
            if ( $("#fechaRadicacion").val() === '' ) {
                mensaje += "*La Fecha de Radicaci\u00f3n es requerida \n";
                error = true;
            }
            if ( $('#cmbTipoCarpeta').val() == "4" ) {
                if ( $("#idJuzgadorPropietario").val() == null || $("#idJuzgadorPropietario").val() == "" ) {
                    mensaje = "*Debe seleccionar tres jueces propietarios para causas de tribunal\n";
                    error = true;
                } else if ( parseInt($("#idJuzgadorPropietario").val().length) < 3  ) {
                    mensaje = "*Debe seleccionar tres jueces propietarios para causas de tribunal\n";
                    error = true;
                }
            } else {
                if( $("#idJuzgadorPropietario").val() == "" || $("#idJuzgadorPropietario").val() == "0" ) {
                    mensaje += "*Debe indicar un juez propietario para la carpeta\n";
                    error = true;
                }
            }
            ...
            if (!validateStep1()) {
                ...
                $.ajax({
                    ...
                    data: {accion: "guarda",
                        ...
                        idJuzgador: $("#idJuzgadorPropietario").val(),
                        ...
                        cveConsignacionA: $('#cmbConsignacionA').val(),
                        cveEstatusCarpeta: $("#cmbEstatusCarpeta").val(),
                        cveEtapaProcesal: $("#cmbEtapaProcesal").val(),
    ...
    //                    cantxPag: cantReg
                ...
                success: function (datos) {
                    if (datos.totalCount > 0) {
                        ...
                        table += '<th>Fecha Radicaci&oacute;n</th>';
                        table += '</tr>';
                        table += '</thead>';
                        table += "<tbody>";
                        for (var i = 0; i < datos.totalCount; i++) {
                            var fecha = datos.data[i].fechaRegistro.split(" ");
                            var fechaRadicacion = datos.data[i].fechaRadicacion.split(" ");
                            table += "<tr>";
                            ...
                            table += "<td onclick='consutaId(" + datos.data[i].idCarpetaJudicial + ")' >" + formatoFecha(fechaRadicacion[0]) + "</td>";
                            table += "</tr>";
                        }
                        table += "</tbody>";
                        table += "</table>";
            ...
            $.ajax({
                ...
                success: function (datos) {
                    ...
                    if (datos.totalCount > 0) {
                        ...
                        $("#fechaRadicacion").val(formatoFecha(datos.data[0].fechaRadicacion));
    ...
    //    };
        ...
        $(function () {
            ...
            if ( parseInt(anio) < parseInt(anioActual) ) {
                console.log(anio);
            ...
            $('#fechaRadicacion').on("dp.change", function (e) {
                var anio = $("#txtAnio").val();
                var fecha = new Date();
                ...
                $('#fechaRadicacion').data("DateTimePicker").minDate(minFechaRadicacion);
                $('#fechaRadicacion').data("DateTimePicker").maxDate(maxFechaRadicacion);
