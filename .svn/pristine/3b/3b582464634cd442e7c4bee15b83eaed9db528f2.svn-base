        ...
        if ($idOrden != "" && $idOrden > 0) {
            ...
            if (file_exists("./../../../solicitudespdf/" . $OrdenesDto->getQr() . ".pdf")) {
                ...
                if (!$error) {
                    ...
                    $html.="</tr>\n";
                    $html.="<tr>\n";
                    $html.="<td colspan='2' style='text-align: center; width: 100%;font-size: 8pt'>M&oacute;dulo de Solicitudes de Orden de Aprehension del Sistema de Gesti&oacute;n Judicial Penal (SIGEJUPE) del Poder Judicial del Estado de M&eacute;xico</td>";
                    $html.="</tr>\n";
                    $html.="<tr>\n";
                }
