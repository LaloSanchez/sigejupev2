...
" . $condiciones . $otrascond;
        ...
        //echo $SelectDao->selectDAO($params, null, $paginacion, $bar);
...
//        }
        ...
        $SelectDao = new SelectDAO();
        echo $SelectDao->selectDAO($params, null, $paginacion, $bar)+3;
        return $SelectDao->selectDAO($params, null, $paginacion, $bar);
    }
