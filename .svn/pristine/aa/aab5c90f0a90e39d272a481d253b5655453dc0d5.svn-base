...
//                if (txtCarpeta.val().trim() == "" && txtNuc.val().trim() == "") {
                if (txtCarpeta.val().trim() == "") {
                    txtMensaje += 'La carpeta de investigaci\u00f3n \u00f3 el NUC son requeridos<br />';
                    error = true;
                }
            }
...
//            var txtSolicitud = document.getElementById("txtSolicitud");
        ...
        sendInfo: function () {
            ...
            var datos = {
                ...
                "juzgadoProcedencia": $("#cmbJuzgadoSolicitar").val(),
                "carpetaInv": $("#txtCarpeta").val(),
//                "nuc": $("#txtNuc").val(),
                ...
                "tutoresArray": $("#tutores_array").val(),
            };
...
//            formData.append('nuc', $("#txtNuc").val());
            ...
            var urlToSend = "../fachadas/sigejupe/solicitudescateos/SolicitudescateosFacade.Class.php"
            $.ajax({
...
//                        setTimeAlert("divAlertSuccess");
                        ...
                        if (data.numeroCarpeta != "/") {
                            $("carpetanumber").text(data.numeroCarpeta);
                            $(".carpeta").show();
                        }
                        if (data.numeroAuxiliar != "/") {
                            $("auxiliarnumber").text(data.numeroAuxiliar);
                            $(".auxiliar").show();
                        }
                        $(".registerNip").hide();
                        $("#btnEnviarNip").hide();
            ...
            $.ajax({
                ...
                success: function (datos) {
                    ...
                    if (datos.type == "OK") {
                        ...
                        $("#divAlertSuccess").show("slide");
                        setTimeAlert("divAlertSuccess");
                        window.location.href = '../fachadas/sigejupe/solicitudescateos/SolicitudescateosFacade.Class.php?action=decargaSolicitudCateoDownload&idCateo=' + idCateo;
