...
class TipospersonasDTO {
    ...
    public function getSoloVictima(){
        return $this->soloVictima;
    }
    public function setSoloVictima($soloVictima){
        $this->soloVictima=$soloVictima;
    }
