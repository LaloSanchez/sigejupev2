...
$DocumentosimgDto->setidCarpetaJudicial(strtoupper(str_ireplace("'","",trim($DocumentosimgDto->getidCarpetaJudicial()))));
$DocumentosimgDto->setidActuacion(strtoupper(str_ireplace("'","",trim($DocumentosimgDto->getidActuacion()))));
...
$DocumentosimgDto->setactivo(strtoupper(str_ireplace("'","",trim($DocumentosimgDto->getactivo()))));
