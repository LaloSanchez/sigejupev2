...
//            }
//            if ($datos["cveEstatusAudiencia"] != 0) {
//                $tipo_juzgado .= " AND ea.cveEstatusAudiencia=" . $datos["cveEstatusAudiencia"];
//            }
//            
//            if ($datos["cveRegion"] != "") {
...
//            cata.desCatAudiencia,tc.desTipoCarpeta,a.detenido,sala.desSala";
//            $tablas = " tbltiposcarpetas tc,tblsalas sala,tblaudiencias a LEFT JOIN tbljuzgados j ON a.cveJuzgado = j.cveJuzgado    
//            LEFT JOIN tbltiposjuzgados tj ON j.cveTipojuzgado = tj.cveTipoJuzgado
//            LEFT JOIN tbldistritos d ON j.cveDistrito  = d.cveDistrito
//            LEFT JOIN tblregiones r ON j.cveRegion = r.cveRegion 
//            INNER JOIN tblcataudiencias cata ON a.cveCatAudiencia=cata.cveCatAudiencia 
//            INNER JOIN tblsolicitudesaudiencias sa ON a.idSolicitudAudiencia=sa.idSolicitudAudiencia
//            INNER JOIN tbletapasprocesales ep ON cata.cveEtapaProcesal=ep.cveEtapaProcesal, tblestatusaudiencias ea";
//            $condiciones = " a.activo='S' AND d.activo='S' AND r.activo='S' AND sa.activo='S' AND ea.cveEstatusAudiencia=a.cveEstatusAudiencia AND ep.activo='S'
...
//            c.cveDistrito,c.desDistrito,c.duracionAudiencia,c.desCatAudiencia,c.desTipoCarpeta,c.detenido,c.desSala";
//            } else {
