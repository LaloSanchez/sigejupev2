...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h5 class="panel-title">                                                            
                Modificaci&oacute;n de Disponibilidad de Jueces para Apelaci&oacute;n de Cateos                           
            </h5>
        </div>
        <div class="panel-body">
            ...
            <div id="divFormulario" class="form-horizontal">
                ...
                <form method="post" id="formProgramacionJuzgadores">
                    <input type="hidden" id="idProgramacionApelaCateo" class="form-control selecto2" name="idProgramacionApelaCateo">
                    <input type="hidden" id="hddIdProgramacionApelaCateo" name="hddIdProgramacionApelaCateo">
                    ...
                    <div class="form-group programacion" style="display: block;">
                        ...
                        <div class="col-xs-5 col-sm-3 col-md-2">
                            ...
                            <span class="requerido">
                                NOTA: si se selecciona en hora final la hora 06:59:59, a la fecha final seleccionada se le sumar&aacute;ra un d&iacute;a al guardar el registro
                            </span>
                        </div>
                    </div>
                </form>
                ...
                <div class="form-group">
                    <div class="col-xs-offset-3 col-xs-9">
                        <input type="submit" class="btn btn-primary consulta" value="Consultar" onclick="consultarProgramacionApelaCateo()">
    ...
    <script type="text/javascript">
        ...
        consultarProgramacionApelaCateo = function () {
            var cveJuzgado = $("#cveJuzgado").val();
            var idJuzgador = $("#idJuzgador").val();
            var fechaInicio = $("#fechaInicial").val();
            var fechaFin = $("#fechaFinal").val();
            $("#hddIdProgramacionApelaCateo").val("");
            $("#idProgramacionApelaCateo").val("");
    //        if (cveJuzgado == "") {
    ...
    //        } else 
            if (fechaInicio == "") {
                ...
                $.ajax({
                    type: "POST",
                    url: "../fachadas/sigejupe/programacionapelacateos/ProgramacionapelacateosFacade.Class.php",
                    data: {
                        ...
                        fechaFin: fechaFin,
                        activo: "S",
                        accion: "consultarProgramacionApelaCateo"},
                    async: true,
                    dataType: "html",
                                ...
                                if ($("#mostrarCalendario").is(":checked")) {
                                    ...
                                    for (var n = 0; n < result.totalCount; n++) {
                                        ...
                                        events.push({
                                            ...
                                            url: result.data[n].idProgramacionApelaCateo,
                                            color: 'green'
                                        });
                                    }
                                    ...
                                    var calendar = $("#contenidoReporte").fullCalendar({
                                        ...
                                        eventClick: function (event) {
                                            if (event) {
                                                seleccionarProgramacionApelaCateo(event.url);
                                                return false;
                                            }
                                        },
                                        allDay: false
                                    ...
                                    html += '<table class="table" id="datosProgramacionApelaCateos">';
                                    html += '<thead>';
                                    html += '<th>No</th>';
                                    ...
                                    for (var n = 0; n < result.totalCount; n++) {
                                        ...
                                        html += "<tr class='datosProgramacion' id='" + result.data[n].idProgramacionApelaCateo + "' style='border: solid 1px #000;'>";
                                        if (result.data[n].Dia == "SABADO" || result.data[n].Dia == "DOMINGO") {
                                            html += "<td style='border: solid 1px #000; background-color: #ddd !important;' onClick='seleccionarProgramacionApelaCateo(" + result.data[n].idProgramacionApelaCateo + ")'>" + c + "</td>";
                                            html += "<td style='border: solid 1px #000; background-color: #ddd !important;' onClick='seleccionarProgramacionApelaCateo(" + result.data[n].idProgramacionApelaCateo + ")'>" + result.data[n].Dia + "</td>";
                                            html += "<td style='border: solid 1px #000; background-color: #ddd !important;' onClick='seleccionarProgramacionApelaCateo(" + result.data[n].idProgramacionApelaCateo + ")'><b>" + formatoFecha(fechaHoraInicio[0]) + "</b>&nbsp;&nbsp;&nbsp;" + fechaHoraInicio[1] + "&nbsp;&nbsp;-&nbsp;&nbsp;<b>" + formatoFecha(fechaHoraTermino[0]) + "</b>&nbsp;&nbsp;&nbsp;" + fechaHoraTermino[1] + "</td>";
                                            html += "<td style='border: solid 1px #000; background-color: #ddd !important;' onClick='seleccionarProgramacionApelaCateo(" + result.data[n].idProgramacionApelaCateo + ")'>" + result.data[n].Nombre + '</td>';
                                            html += "<td style='border: solid 1px #000; background-color: #ddd !important;' onClick='seleccionarProgramacionApelaCateo(" + result.data[n].idProgramacionApelaCateo + ")'>" + result.data[n].desJuzgado + '</td>';
                                            html += "<td style='border: solid 1px #000; background-color: #ddd !important;'><input type='checkbox' onClick='registrosEliminarApelaCateo()' class='eliminarApelaCateo' value='" + result.data[n].idProgramacionApelaCateo + "'></td>";
                                        } else {
                                            html += "<td style='border: solid 1px #000;' onClick='seleccionarProgramacionApelaCateo(" + result.data[n].idProgramacionApelaCateo + ")'>" + c + "</td>";
                                            html += "<td style='border: solid 1px #000;' onClick='seleccionarProgramacionApelaCateo(" + result.data[n].idProgramacionApelaCateo + ")'>" + result.data[n].Dia + "</td>";
                                            html += "<td style='border: solid 1px #000;' onClick='seleccionarProgramacionApelaCateo(" + result.data[n].idProgramacionApelaCateo + ")'><b>" + formatoFecha(fechaHoraInicio[0]) + "</b>&nbsp;&nbsp;&nbsp;" + fechaHoraInicio[1] + "&nbsp;&nbsp;-&nbsp;&nbsp;<b>" + formatoFecha(fechaHoraTermino[0]) + "</b>&nbsp;&nbsp;&nbsp;" + fechaHoraTermino[1] + "</td>";
                                            html += "<td style='border: solid 1px #000;' onClick='seleccionarProgramacionApelaCateo(" + result.data[n].idProgramacionApelaCateo + ")'>" + result.data[n].Nombre + '</td>';
                                            html += "<td style='border: solid 1px #000;' onClick='seleccionarProgramacionApelaCateo(" + result.data[n].idProgramacionApelaCateo + ")'>" + result.data[n].desJuzgado + '</td>';
                                            html += "<td style='border: solid 1px #000;'><input type='checkbox' class='eliminarApelaCateo' onClick='registrosEliminarApelaCateo()' value='" + result.data[n].idProgramacionApelaCateo + "'></td>";
                                        }
                                    ...
                                    /*html += '<th>FECHA</th>';
                                     ...
                                     html += "<tr class='datosProgramacion' style='border: solid 1px #000;' onClick='seleccionarProgramacionApelaCateo(" + result.data[i].idProgramacionApelaCateo + ")'>";
        ...
        function seleccionaTodo() {
            if ($("#seleccionaTodo").is(":checked")) {
                $('.eliminarApelaCateo').prop("checked", true);
            } else {
                $('.eliminarApelaCateo').prop("checked", false);
            }
            registrosEliminarApelaCateo();
        }

        //$(document).on('click', '.eliminarApelaCateo', function(){
        function registrosEliminarApelaCateo() {
            var registros = new Array();
            var idApelaCateos = new Array();
            $('#datosProgramacionApelaCateos tr').each(function () {
                if ($(this).find('.eliminarApelaCateo').is(':checked')) {
                    idApelaCateos = {
                        idProgramacionApelaCateo: $(this).find('.eliminarApelaCateo').val()
                    };
                    registros[registros.length] = idApelaCateos;
                }
            });
            //console.log(idApelaCateos);

            console.log(registros);
            ///Se convierte el arreglo de registros en json
            var idApelaCateosJson = JSON.stringify(registros);
            idApelaCateosJson = decodeURIComponent(idApelaCateosJson);
            $("#hddIdProgramacionApelaCateo").val("");
            if (parseInt(registros.length) > 0) {
                $("#hddIdProgramacionApelaCateo").val(idApelaCateosJson);
            }
        }
        //});

        function seleccionarProgramacionApelaCateo(obj) {

            $.ajax({
                type: "POST",
                url: "../fachadas/sigejupe/programacionapelacateos/ProgramacionapelacateosFacade.Class.php",
                data: {idProgramacionApelaCateo: obj, accion: 'seleccionar'},
                async: false,
                dataType: "json",
                beforeSend: function (objeto) {
                    ToggleLoading(1);
                ...
                success: function (datos) {
                    try {
                        if (datos.totalCount > 0) {
                            ...
                            $("#idProgramacionApelaCateo").val(datos.data[0].idProgramacionApelaCateo);
                            $("#cveJuzgado").val(datos.data[0].cveJuzgado).trigger("change");
                            ...
                            $("#" + datos.data[0].idProgramacionApelaCateo).addClass("success");
        ...
        function guardar() {
            if (validar()) {
                ...
                $.ajax({
                    ...
                    url: "../fachadas/sigejupe/programacionapelacateos/ProgramacionapelacateosFacade.Class.php",
                    data: {
                        idProgramacionApelaCateo: $("#idProgramacionApelaCateo").val(),
            ...
            bootbox.dialog({
                ...
                buttons: {
                    danger: {
                        ...
                        callback: function () {
                            if ($("#hddIdProgramacionApelaCateo").val() != "") {
                                $.ajax({
                                    type: "POST",
                                    url: "../fachadas/sigejupe/programacionapelacateos/ProgramacionapelacateosFacade.Class.php",
                                    data: {
                                        ...
                                        activo: 'N',
                                        idProgramacionesApelaCateos: $("#hddIdProgramacionApelaCateo").val()
                                    },
                                    async: true,
                                    dataType: "json",
                                    beforeSend: function (objeto) {
                    ...
                    success: function (datos) {
                        try {
                            ...
                            if (result.totalCount > 0) {
                                ...
                                for (var n = 0; n < result.totalCount; n++) {
                                    if (result.data[n].cveTipoJuzgador == "6") {
        ...
        function validarEliminacion() {
            if ($("#idProgramacionApelaCateo").val() == "") {
