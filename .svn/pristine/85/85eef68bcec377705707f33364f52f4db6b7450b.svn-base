...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
    ...
    <style type="text/css">
        ...
        #divMenssage{                
            ...
            color: #284740;
            background: #FFFFFF;
            text-transform: uppercase;// pruebaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa aqui 
        ...
        <div  id="panelPrincipal" class="panel-body">
            <div id="divFormulario" class="form-horizontal">
                <div id="divPanelControl">
                    ...
                    <!--                <div class="form-group">
                                        <label class="control-label col-md-4">Promedio de duraci&oacute;n de audiencias</label>
                                        <div class="col-md-5">
                                            <input type="checkbox" id="promedioDuracionAudiencias" class="form-inline" onclick="promedioDuracionAudiencias()">
                                        </div>
                                    </div>
                                    <div id="divPorEtapaProcesal" style="display: none;">
                                        <div class="form-group">
                                            <label class="control-label col-md-5">Por etapa procesal</label>
                                            <div class="col-md-5">
                                                <input type="checkbox" id="porEtapaProcesal" class="form-inline" onclick="porEtapaProcesal();">
                                            </div>
                                        </div>
                                    </div>-->
                    <!--                <div id="divEtapaProcesal" style="display: none;">
                                        <div class="form-group"> 
                                            <label class="control-label col-md-6">Etapa procesal</label>
                                            <div class="col-md-5">
                                                <select class="form-control Relacionado" name="cmbEtapaProcesal2" id="cmbEtapaProcesal2">
                    ...
                    <div id="APJ">
                        <div class="form-group">
                            <label class="control-label col-md-4">Audiencias por Juez</label>
                            <div class="col-md-5">
                                <input type="checkbox" id="audienciasPorJuez" class="form-inline" onclick="audienciasPorJuez()">
                            </div>
                        </div>
                        <div id="divPorJuez">
                            <div class="form-group"> 
                                <label class="control-label col-md-5">Juez</label>
                                <div class="col-md-5">
                                    <div id="divCmbRelaciones" class="logobox"></div>
                                    <select class="form-control Relacionado" name="cmbPorJuez" id="cmbPorJuez">
                                        <option value="0">Seleccione una opci&oacute;n</option>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div id="ADI">
                        <div class="form-group">
                            <label class="control-label col-md-4">Audiencias de Iniciales</label>
                            <div class="col-md-5">
                                <input type="checkbox" id="audienciasDeIniciales" class="form-inline" onclick="audienciasDeIniciales()">
                            </div>
                        </div>
                    </div>
                    <!--                <div id="ADJ">
                                        <div class="form-group">
                                            <label class="control-label col-md-4">Audiencias por Etapa Procesal</label>
                                            <div class="col-md-5">
                                                <input type="checkbox" id="audienciasDeJuicio" class="form-inline" onclick="audienciasDeJuicio()">
                                            </div>
                                        </div>
                                        <div id="divEP" style="display: none;">
                                            <div class="form-group"> 
                                                <label class="control-label col-md-5">Etapa procesal</label>
                                                <div class="col-md-5">
                                                    <div id="divCmbRelaciones" class="logobox"></div>
                                                    <select class="form-control Relacionado" name="cmbEtapaProcesal" id="cmbEtapaProcesal">
                                                        <option value="0">Seleccione una opci&oacute;n</option>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div id="divPJ" style="display: none;">
                                            <div class="form-group">
                                                <label class="control-label col-md-5">Por Juez</label>
                                                <div class="col-md-5">
                                                    <input type="checkbox" id="porJuez" class="form-inline" onclick="porJuez();">
                                                </div>
                                            </div>
                                        </div>
                                        <div id="divJuzgadores" style="display: none;">
                                            <div class="form-group"> 
                                                <label class="control-label col-md-6">Juez</label>
                                                <div class="col-md-5">
                                                    <div id="divCmbRelaciones" class="logobox"></div>
                                                    <select class="form-control Relacionado" name="cmbJuzgadores" id="cmbJuzgadores">
                                                        <option value="0">Seleccione una opci&oacute;n</option>
                                                    </select>
                                                </div>
                                            </div>
                    ...
                    <!--                <div id="AAJDC">
                                        <div class="form-group">
                                            <label class="control-label col-md-4">Audiencias ante Jueces de Control</label>
                                            <div class="col-md-5">
                                                <input type="checkbox" id="audienciasAJDC" class="form-inline" onclick="audienciasAJDC()">
                                            </div>
                                        </div>
                                    </div>-->
                    ...
                    <div class="form-group" id="divTipoJuzgado"> 
                        <label class="control-label col-md-4">Estatus Audiencia</label>
                        <div class="col-md-5">
                            <div id="divCmbRelaciones" class="logobox"></div>
                            <select class="form-control Relacionado" name="cmbEstatusAudiencia" id="cmbEstatusAudiencia">
                                <option value="0">Seleccione una opci&oacute;n</option>
                            </select>
                        </div>                                
                    </div>
                    <div class="form-group" id="divCatAudiencia"> 
                        <label class="control-label col-md-4">Categoria de Audiencia</label>
                        <div class="col-md-5">
                            <div id="divCmbRelaciones" class="logobox"></div>
                            <select class="form-control Relacionado" name="cmbCatAudiencia" id="cmbCatAudiencia">
                    ...
                    <!--                <div id="divDelitos">
                                        <div class="form-group">
                                            <label class="control-label col-md-4">Delito</label>
                                            <div class="col-md-5">
                                                <input type="checkbox" id="checkDelito" class="form-inline">
                                            </div>
                                        </div>
                                        <div id="divcmbDelito">
                                            <div class="form-group"> 
                                                <label class="control-label col-md-5">Delitos</label>
                                                <div class="col-md-5">
                                                    <div id="divCmbRelaciones" class="logobox"></div>
                                                    <select class="form-control Relacionado" name="cmbDelito" id="cmbPorJuez">
                                                        <option value="0">Seleccione una opci&oacute;n</option>
                                                    </select>
                                                </div>
                                            </div>
    ...
    <script type="text/javascript">
        ...
        gestorNivel = function (json, bandera) {
            ...
            switch ($("#hiddenNivel").val()) {
                ...
                case "5":
                    ...
                    if ($("#checkDetalle").is(":checked")) {
                        table += "<th>Fecha Inicial</th><th>Fecha Final</th><th>Audiencia</th><th>Carpeta</th><th>Estatus Audiencia</th><th>Naturaleza</th>";
                    } else {
                        table += "<th>Fecha Inicial</th><th>Fecha Final</th><th>Audiencia</th><th>Carpeta</th><th>Sala</th><th>Detenido</th><th>Estatus Audiencia</th><th>Naturaleza</th>";
                    }

                    //table += "<th>Audiencia</th><th>Fecha Inicial</th><th>Fecha Final</th>";
                    if ($("#promedioDuracionAudiencias").is(':checked')) {
                        //                    table += "<th>Duraci\u00f3n Audiencia</th>";
                        table += "<th>Duraci\u00f3n promedio por Audiencia</th>";
                    }
                    table += "</tr></thead><tbody>";
                    for (var i = 0; i < json.totalCount; i++) {
                        ...
                        //table += "<td>AUDIENCIA: " + json.resultados[i].numero + "/" + json.resultados[i].anio + "</td>";
                        ...
                        if ($("#checkDetalle").is(":checked")) {
                            ...
                            table += "<td>" + mensajeDetenido(json.resultados[i].detenido) + "</td>";
                        }
                        table += "<td>" + json.resultados[i].desEstatusAudiencia + "</td>";
                        table += "<td>" + json.resultados[i].desNaturaleza + "</td>";
                        if ($("#promedioDuracionAudiencias").is(':checked')) {
                            //                        table += "<td>" + json.resultados[i].duracionAudiencia + " Hrs.</td>";
                            table += "<td>" + horaMySQLaNormal(json.resultados[i].duracionAudiencia) + " Hrs.</td>";
                        }
                        table += "</tr> ";
                        subTotal = -(i + 1 + indice);
        ...
        consultar = function (bandera, nivel) {
            ...
            $.ajax({
                type: "POST",
                url: "../fachadas/sigejupe/reportes/ReporteAudienciasv2Facade.Class.php",
                data: strDatos,
                async: true,
                dataType: "html",
            ...
            switch ($("#hiddenNivel").val()) {
                case "1":
                    ...
                    for (var i = 0; i < json.totalCount; i++) {
                        ...
                        if (!graficar) {
                            graficar = false;
                        } else if ($("#audienciasPorJuez").is(":checked")) {
                            categorias[i] = json.resultados[i].nombre + " " + json.resultados[i].paterno + " " + json.resultados[i].materno;
                        } else {
                            categorias[i] = "AUDIENCIAS";
                        }
        ...
        preGraficar = function (categorias, series, nombreX, nombreY, json) {
            ...
            var options = {
                ...
                tooltip: {
                    formatter: function () {
                        if (this.x) {
                            return "<span style='color{point.color}'>" + this.x + "</span><br><b>" + numeroDecimalOEntero(this.y) + " " + nombreY + "</b>";
                        } else {
                            return "<b>" + numeroDecimalOEntero(this.y) + " " + nombreY + "</b>";
                        }
                    }
                },
                yAxis: {
                ...
                dataLabels: {
                    enabled: true,
                    formatter: function () {
                        return numeroDecimalOEntero(this.y);
                    }, style: {
                        color: "#FFFFF",
                        fontWeight: 'bold',
            ...
            options.series[0].dataLabels = {enabled: true, align: 'center', inside: true, formatter: function () {
                    return numeroDecimalOEntero(this.y)/* + " " + nombreY*/;
        ...
        calcularPaginas = function () {
            $("#divRegresar").hide();
            var url = "../fachadas/sigejupe/reportes/ReporteAudienciasv2Facade.Class.php";
            var strDatos = "accion=consultar_Audiencias_Reporte";
        ...
        cargarCatAudiencias = function () {
            ...
            $.ajax({
                ...
                success: function (datos) {
                    ...
                    if (json.totalCount > 0) {
                        for (var i = 0; i < json.totalCount; i++) {
                            $("#cmbCatAudiencia").append($('<option></option>').val(json.data[i].cveCatAudiencia).html(json.data[i].desCatAudiencia));
                        }
                    }
                },
                error: function (objeto, quepaso, otroobj) {
        ...
        $(function () {
            if (grupo == 128 || grupo == 97 || cveUsuarioSesion == 849) {
                $("#divDetalle").show();
            }
