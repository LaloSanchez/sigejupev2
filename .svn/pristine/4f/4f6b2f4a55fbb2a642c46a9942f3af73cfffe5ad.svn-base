...
include_once(dirname(__FILE__) . "/../../../controladores/sigejupe/reportes/ReporteCargaJuecesController.Class.php");
include_once(dirname(__FILE__) . "/../../../controladores/sigejupe/reportes/ReporteCargaMagistradosController.Class.php");


class ReporteCargaJuecesFacade {
    ...
    public function reporteCarga($datos, $paginacion, $accion) {
        $reporteCargaController = new reporteCargaJuecesController();
        ...
        }else if($accion == "ConsultarCargaJueces_ReporteGeneralTocas"){
            $reporteCargaController = new ReporteCargaMagistradosController();
            $datosCarga = $reporteCargaController->reporteCargaToca($datos, $paginacion, $accion);
        } else {
...
if ($accion == "ConsultarCargaJueces_ReporteGeneral") {
    ...
    echo $reporteCargaJuecesFacade->ReporteCarga($datos, $paginacion, $accion);
    ...
    $reporteCargaJuecesFacade->ReporteCarga($datos, $paginacion, $accion);
}
