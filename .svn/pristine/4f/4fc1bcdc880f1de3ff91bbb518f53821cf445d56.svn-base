...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
                    ...
                    <fieldset>
                        <div id="divPaso1" class="content col-xs-12" style="display:block;">
                            ...
                            <div class="form-group" >
                                <label for="txtNumCausa" class="control-label col-lg-3 col-md-3 col-sm-12 col-xs-12" >
                                    <input type="radio" value="1" name="tipoNumero" id="tipoNumero" onclick="javascript:ordenes.seleccionTipo(this)" checked="">&nbsp;N&uacute;mero de Causa: 
                                </label>
                                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group" >
                                <label for="txtCarpeta" class="control-label col-lg-3 col-md-3 col-sm-12 col-xs-12" >
                                    <input type="radio" value="2" name="tipoNumero" id="tipoNumero" onclick="javascript:ordenes.seleccionTipo(this)">&nbsp;Otro:
                                </label>
                                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
                                        <label for="txtCarpeta" class="control-label col-lg-3 col-md-3 col-sm-12 col-xs-12" >Carpeta de Investigaci&oacute;n o NUC:</label>
                                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12" >
                            ...
                            <div class="form-group text-center" >
                                <button class="btn btn-primary text-right" id="btnStart" onclick="javascript:ordenes.validarPaso1(true)">Siguiente &gt;</button>
                            </div>
                        </div>
                        <div id="divPaso3" class="content  col-xs-12" style="display:none">                                        
                            <div class="panel-group" id="accordiont" role="tablist" aria-multiselectable="true">
                                        ...
                                        <div class="panel-body">
                                            <div class="form-group" >
                                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" >
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12" >
                                                        <select onchange="javascript:ordenes.TipoPersona(this, 1)" name="cmbTipoPersona" id="cmbTipoPersona" class="form-control">
                                            ...
                                            <div class="form-group text-center" >
                                                <button class="btn btn-primary addImputado" onclick="javascript:ordenes.addImputados()">Agregar + </button>
                                                                    ...
                                                                    <table id="tblImputadosCausa" class="table table-bordered table-condensed table-hover">
                                                                        <thead>
                                                                            <tr>
                                                                                ...
                                                                                <th>Domicilio</th>
                                                                                <th>G&eacute;nero</th>
                                                                                <th class="text-center" ><button class="btn btn-primary" onclick="javascript:ordenes.addImputadosCausa(this, 'tblImputados')">Agregar</button></th>
                                                                            </tr>
                                                                        </thead>
                                                                    </table> 
                                                                </div>
                                                ...
                                                <table id="tblImputados" class="table table-bordered table-condensed table-hovers" >
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>Domicilio</th>
                                                            <th>G&eacute;nero</th>
                                                            <th class="text-center"><button class="btn btn-danger" onclick="javascript:ordenes.deleteRow(this)">Eliminar</button></th>
                                                        </tr>
                                                    </thead>
                                                </table>
                                            </div>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div id="VictimasThreeTabcollapse" class="panel-collapse collapse" role="tabpanel" aria-labelledby="VictimasThreeTab">
                                        <div class="panel-body">
                                                ...
                                                <div class="change col-xs-12 col-md-12 col-lg-12 col-sm-12" >
                                                    <div class="form-group" >
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
                                                            <label class="control-label col-lg-3 col-md-3 col-sm-12 col-xs-12">* Tipo de Persona:</label>
                                                            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12" >
                                                                <select onchange="javascript:ordenes.TipoPersona(this, 2)" name="cmbTipoPersonaVictima" id="cmbTipoPersonaVictima" class="form-control">
                                                                    <option value="0" >Selecciona una Opci&oacute;n</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="form-group text-center " >
                                                <button onclick="javascript:ordenes.addVictimas()" class="btn btn-primary addOfendido" >Agregar +</button>
                                                                    ...
                                                                    <table id="tblVictimasCausa" class="table table-bordered table-condensed table-hover table-striped" >
                                                                        <thead>
                                                                            <tr>
                                                                                ...
                                                                                <th>Domicilio</th>
                                                                                <th>G&eacute;nero</th>
                                                                                <th class="text-center"><button class="btn btn-primary" onclick="javascript:ordenes.addVictimasCausa(this, 'tblVictimas')">Agregar</button></th>
                                                                            </tr>
                                                                        </thead>
                                                                    </table> 
                                                                </div>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div id="DelitosThreeTabCollapse" class="panel-collapse collapse" role="tabpanel" aria-labelledby="DelitosThreeTabCollapse">
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group text-center" >
                                                <button class="btn btn-primary addDelito" onclick="javascript:ordenes.addDelito()">Agregar</button>
                                                                ...
                                                                <div class="table-responsive" >
                                                                    <table id="tblDelitosCausa" class="table table-bordered table-striped table-condensed">
                                                                        <thead>
                                                                            <tr>
                                                                                <th>Delitos</th>
                                                                                <th class="text-center"><button onclick="javascrip:ordenes.addDelitosCausa(this, 'tblDelitos')" class="btn btn-primary" >Agregar</button></th>
                                                                            </tr>
                                                                        </thead>
                                                                    </table> 
                                                                </div>
                                ...
                                <div class="form-group text-center" >
                                    <br />
                                    <!--<button class="btn btn-primary" onclick="javascript:ordenes.siguiente('liPaso2', 'liPaso3')">< Anterior </button>-->
                                    <button class="btn btn-primary" onclick="javascript:ordenes.siguiente('liPaso1', 'liPaso3')">< Anterior </button>
                                    <button class="btn btn-primary" onclick="javascript:ordenes.validaPasos3(true)">Siguiente ></button>
                                </div>
                        ...
                        <div id="divPaso4" class='content col-xs-12' style='display:none;'>
                            ...
                            <div class="form-group" >
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12" >
                                    <input type="file" name="fileSolicitud" id="fileSolicitud" size="60" onchange="if (!ordenes.formato(this)) {
                                                this.value = ''
                                            }">
                                </div>
                            </div>
                            ...
                            <div class="form-group text-center" >
                                <button class="btn btn-primary" onclick="javascript:ordenes.siguiente('liPaso3', 'liPaso4')">< Anterior </button>
                                <button class="btn btn-primary" onclick="javascript:ordenes.validaPasos4()">Siguiente ></button>
                            </div>
                        ...
                        <div id="divPaso5" class='content col-xs-12' style='display:none;'>
                                        ...
                                        <div class="form-group" >
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" >
                                                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12" >
                                                    <button onclick="javascript:ordenes.addMPs('')" class="btn btn-primary" >Agregar + </button>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="form-group text-center registerNip" style="display:none">
                                ...
                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12" >
                                    <button class="btn btn-primary" onclick="javascript:ordenes.enviar()" >Enviar Solicitud con Nip</button>
                                    <button class="btn btn-primary" onclick="javascript:ordenes.cancelanip()" >Cancelar</button>
                                </div>
                            </div>

                            <div class="form-group text-center btnsSendSolicitud" >
                                <button id="btnAnterior" class="btn btn-primary" onclick="javascript:ordenes.siguiente('liPaso4', 'liPaso5')">< Anterior </button>
                                <button id="btnEnviar" class="btn btn-primary" onclick="javascript:ordenes.enviar()">Enviar</button>
                                <button id="btnEnviarNip" class="btn btn-primary" onclick="javascript:ordenes.nip()">Enviar con NIP</button>
    ...
    <script src="sigejupe/solicitudesCateos/ordenes.js" charset="UTF-8" ></script>
    <script>
                                    ...
                                    $(function () {
                                        ...
                                        getMP = function () {
                                            ...
                                            $.getJSON(url, function (json) {
                                                if (json !== "") {
                                                    ordenes.addMPs(json.nombre, json.paterno, json.materno);
                                                }
                                            });
                                        }
                                        getMP();
