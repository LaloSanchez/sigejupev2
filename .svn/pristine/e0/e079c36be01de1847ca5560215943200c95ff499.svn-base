...
class DomiciliosimputadossolicitudesDTO {

    private $idDomicilioImputadoSolicitud;
    ...
    public function getIdDomicilioImputadoSolicitud() {
        return $this->idDomicilioImputadoSolicitud;
    }

    public function setIdDomicilioImputadoSolicitud($idDomicilioImputadoSolicitud) {
        $this->idDomicilioImputadoSolicitud = $idDomicilioImputadoSolicitud;
    }
    ...
    public function toString() {
        return array("idDomicilioImputadoSolicitud" => $this->idDomicilioImputadoSolicitud,
