...
//Reporte audiencias
include_once(dirname(__FILE__) . "/../../../controladores/sigejupe/reportes/ReporteAudienciasv2Controller.Class.php");
...
class ReporteAudienciasv2Facade {
    ...
    public function indicadorAudienciasPrevio($datos, $param) {
        $indicadorAudienciasController = new ReporteAudienciasv2Controller();
    ...
    public function reporteAudienciasPrevio($audienciasDto, $datos, $param) {
        $reporteAudienciasController = new ReporteAudienciasv2Controller();
...
$audienciasFacade = new ReporteAudienciasv2Facade();
...
if ($accion == "consultar_Audiencias_Reporte") {
    ...
    @$datos["cveCatAudiencia"] = strtoupper(str_ireplace("'", "", trim($_POST["cveCatAudiencia"])));
