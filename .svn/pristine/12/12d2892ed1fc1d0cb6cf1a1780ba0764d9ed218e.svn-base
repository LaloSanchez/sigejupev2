...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h5 class="panel-title">                                                            
                ADMINISTRACI&Oacute;N DE SOLICITUDES
            ...
            <div id="divInfoAdmin"  class="form-horizontal">                                                              
                ...
                <div class="form-group">
                    <div class="col-md-offset-3 col-md-9">
                        <input type="submit" class="btn btn-primary" value="Consultar" onclick="consultaPasoUnoAdmin(1)">   
                ...
                <div id="divConsultaGridAdmin" style="display: none" class="col-md-12">
                    ...
                    <div class="col-md-6">
                        <div class="form-group col-md-3">
                            <label class="control-label" id="totalRegAdmin"></label>
                        </div>

                        <div id="divPaginadorAdmin" class="form-group col-md-3" >
                            <label class="control-label">Pagina:</label>
                            <select  name="cmbPaginacionAdmin" id="cmbPaginacionAdmin" onchange="consultaPasoUnoAdmin(0);">
                                <option value="1"></option>
                            </select>
                        </div>
                        <div id="divPaginadorAdmin" class="form-group col-md-4" >
                            <label class="control-label">Registros por p&aacute;gina:</label>
                            <select  name="cmbNumRegAdmin" id="cmbNumRegAdmin" onchange="consultaPasoUnoAdmin(1);">
    ...
    <script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function (datos) {
                    ...
                    if (json.totalCount > 0) {
                        ...
                        $("#totalRegAdmin").html("<b> Total: " + json.totalCount + "</b>");
        ...
        consultaPasoUnoAdmin = function (pagAux) {
    //        $("#pasos").html("");
            $("#pasos").hide("");
            ...
            if (!error) {
                ...
                $.ajax({
                    ...
                    success: function (datos) {
                        if (datos.totalCount > 0) {
                            var table = "";
                            table += '<table id="tblResultados1" class="table table-hover table-striped table-bordered">';
                            table += '<thead>';
                            table += '<tr>';
                            table += '<th>No</th>';
                            table += '<th>Estatus</th>';
                            ...
                            for (var i = 0; i < datos.totalCount; i++) {
                                table += "<tr>";
                                table += "<td onclick=\"seleccionar('" + datos.data[i].idSolicitudAudiencia + "','" + datos.data[i].desJuzgado + "')\" >" + (i + 1) + "</td>";
                                table += "<td onclick='seleccionar(" + datos.data[i].idSolicitudAudiencia + ")' >" + datos.data[i].desEstatusSolictud + "</td>";
                                table += "<td onclick='seleccionar(" + datos.data[i].idSolicitudAudiencia + ")' >" + datos.data[i].desJuzgado + "</td>";
                                table += "<td onclick='seleccionar(" + datos.data[i].idSolicitudAudiencia + ")' >" + datos.data[i].desTipoCarpeta + "</td>";
                                if (datos.data[i].numero != "" && datos.data[i].numero != null) {
                                    table += "<td onclick='seleccionar(" + datos.data[i].idSolicitudAudiencia + ")' >" + datos.data[i].numero + "/" + datos.data[i].anio + "</td>";
                                } else {
                                    table += "<td onclick='seleccionar(" + datos.data[i].idSolicitudAudiencia + ")' >N/A</td>";
                                }
                                if (datos.data[i].carpetaInv != "" && datos.data[i].carpetaInv != null) {
                                    table += "<td onclick='seleccionar(" + datos.data[i].idSolicitudAudiencia + ")' >" + datos.data[i].carpetaInv + "</td>";
                                } else {
                                    table += "<td onclick='seleccionar(" + datos.data[i].idSolicitudAudiencia + ")' >N/A</td>";
                                }
                                if (datos.data[i].nuc != "" && datos.data[i].nuc != null) {
                                    table += "<td onclick='seleccionar(" + datos.data[i].idSolicitudAudiencia + ")' >" + datos.data[i].nuc + "</td>";
                                } else {
                                    table += "<td onclick='seleccionar(" + datos.data[i].idSolicitudAudiencia + ")' >N/A</td>";
                                }
                                table += "<td onclick='seleccionar(" + datos.data[i].idSolicitudAudiencia + ")' >" + datos.data[i].desAudiencia + "</td>";
                                table += "<td onclick='seleccionar(" + datos.data[i].idSolicitudAudiencia + ")' >" + datos.data[i].fechaRegistro + "</td>";
                                table += "</tr>";
                            }
                            table += "</tbody>";
                            table += "</table>";
