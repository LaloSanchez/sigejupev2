...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
            ...
            <div id="divFormulario" class="form-horizontal">
                <div id="divPanelControl">
                    ...
                    <div id="APJ">
                        ...
                        <div id="divPorJuez">
                            <!--                        <div class="form-group"> 
                                                        <label class="control-label col-md-4">Etapa procesal</label>
                                                        <div class="col-md-5">
                                                    ...
                                                    <div class="form-group"> 
                                                        <label class="control-label col-md-4">Tipo Juez</label>
                                                        <div class="col-md-5">
                                                            <div id="divCmbRelaciones" class="logobox"></div>
                                                            <select class="form-control Relacionado" name="cmbTipoJuez" id="cmbTipoJuez">
                                                                <option value="0">Seleccione una opci&oacute;n</option>
                                                            </select>
                                                        </div>
                                                    </div>-->
                ...
                case "1":
                    ...
                    for (var i = 0; i < json.totalCount; i++) {
                        ...
                        if ($("#audienciasAJDC").is(':checked')) {
                            ...
                            subTotal = subTotal - totalAAJDC.replace(",", "");
                        } else {
                            if (json.totalCount > 0) {
                                table += "<td>" + json.resultados[i].totalCount + "</td>";
                                subTotal = subTotal - parseInt(json.resultados[i].totalCount.replace(",", ""));
                            } else {
                                table += "<td>0</td>";
                            }
                        }
    ...
    //        alert(strDatos);
            $.ajax({
                type: "POST",
                url: "../fachadas/sigejupe/reportes/ReporteAudienciasFacade.Class.php",
                data: strDatos,
                async: true,
                dataType: "html",
            ...
            switch ($("#hiddenNivel").val()) {
                case "1":
                    ...
                    for (var i = 0; i < json.totalCount; i++) {
                        ...
                        if ($("#audienciasAJDC").is(':checked')) {
                            categorias[i] = json.resultados[i].desTipoAudiencia;
                        } else if ($("#audienciasPorJuez").is(":checked") || $("#porJuez").is(':checked')) {
                            categorias[i] = json.resultados[i].nombre + " " + json.resultados[i].paterno + " " + json.resultados[i].materno;
                        } else if (($("#porEtapaProcesal").is(':checked') && $("#promedioDuracionAudiencias").is(':checked')) || $("#audienciasDeJuicio").is(':checked')) {
                            categorias[i] = json.resultados[i].desEtapaProcesal;
                        } else if (($("#porEtapaProcesal").is(':checked') && $("#promedioDuracionAudiencias").is(':checked'))) {
                            categorias[i] = json.resultados[i].desEtapaProcesal;
                        } else {
