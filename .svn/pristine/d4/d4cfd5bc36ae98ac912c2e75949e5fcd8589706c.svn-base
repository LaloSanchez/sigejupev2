        ...
        <div class="panel-body">
            ...
            <div id="divFormulario" class="form-horizontal">
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="col-md-9">
                        <select id="cmbJuzgados"  disabled readonly class="form-control" name="cmbJuzgados">
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="col-md-9">
                        <select id="cmbTipoCarpeta"  disabled readonly class="form-control" name="cmbTipoCarpeta">
                ...
                <div class="form-group">                                                                
                    ...
                    <div class="col-md-9">
                        <input type="text" id="txtNumero"  disabled readonly class="form-inline" id="txtNumero" placeholder="N&uacute;mero">/<input type="text" class="form-inline" id="txtAnio" id="txtAnio" maxlength="4" placeholder="A&ntilde;o">
                    </div>                                
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3">Carpeta de Investigaci&oacute;n</label>
                    <div class="col-md-6">
                        <input type="text" class="form-control mayuscula"  disabled readonly id="txtCarpetaInvestigacion" placeholder="Carpeta de Investigaci&oacute;n">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3">NUC (N&uacute;mero &uacute;nico de causa)</label>
                    <div class="col-md-6">
                        <input type="text" class="form-control mayuscula "  disabled readonly id="txtNumeroUnicoCausa" placeholder="NUC">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group col-lg-12">
                    <label class="control-label col-md-3" for="cmbAudiencia">Audiencia   <span class="requerido">(*)</span></label>
                    <div class="col-md-9">
                        <select id="cmbAudiencia"  disabled readonly class="form-control" name="cmbAudiencia">
                            <option>Seleccione una opci&oacute;n</option>
                        </select>
                    </div>
                </div>
