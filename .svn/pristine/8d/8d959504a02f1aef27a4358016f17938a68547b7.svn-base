...
public function selectTiposapelantes($TiposapelantesDto,$proveedor=null){
$TiposapelantesDto=$this->validarTiposapelantes($TiposapelantesDto);
$TiposapelantesDao = new TiposapelantesDAO();
$TiposapelantesDto = $TiposapelantesDao->selectTiposapelantes($TiposapelantesDto,$proveedor);
return $TiposapelantesDto;
}
