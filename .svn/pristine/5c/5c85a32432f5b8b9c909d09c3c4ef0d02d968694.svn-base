...
public function selectEstatussolicitudesordenes($EstatussolicitudesordenesDto,$proveedor=null){
...
$EstatussolicitudesordenesDto = $EstatussolicitudesordenesDao->selectEstatussolicitudesordenes($EstatussolicitudesordenesDto,$proveedor);
return $EstatussolicitudesordenesDto;
}
