...
class SalasController {
    ...
    public function selectSalasGeneral($SalasDto, $param, $proveedor = null) {
        $SalasDto = $this->validarSalas($SalasDto);
        $SalasDao = new SalasDAO();
        $SalasDto = $SalasDao->selectSalasGeneral($SalasDto, null, "", $param, null);
        return $SalasDto;
    }

    public function getPaginas($SalasDto, $param, $proveedor = null) {
        $SalasDto = $this->validarSalas($SalasDto);
        $SalasDao = new SalasDAO();
        $numTot = $SalasDao->selectSalasGeneral($SalasDto, null, "", $param, " count(cveSala) as totalCount ");
