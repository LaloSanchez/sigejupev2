...
-->
<?php
echo "<input class='frmCaja' type='hidden' name='hdnTipoConsulta' id='hdnTipoConsulta' value='" . (isset($_GET["tipoConsulta"]) ? $_GET["tipoConsulta"] :1 ) . "'>";
echo "<input class='frmCaja' type='hidden' name='hdnArchivo' id='hdnArchivo' value='" . $_GET["archivo"] . "'>";
echo "<input class='frmCaja' type='hidden' name='hdnIdUsuarioExterno' id='hdnIdUsuarioExterno' value='" . (isset($_GET["idUsuarioExterno"]) ? $_GET['idUsuarioExterno'] : 0). "'>";
echo "<input class='frmCaja' type='hidden' name='hdnIdFoja' id='hdnIdFoja' value='" . $_GET["idFoja"] . "'>";
echo "<input class='frmCaja' type='hidden' name='hdnIdCarpetaJudicial' id='hdnIdCarpetaJudicial' value='" . $_GET["idCarpetaJudicial"] . "'>";
echo "<input class='frmCaja' type='hidden' name='hdnIdActuacion' id='hdnIdActuacion' value='" . $_GET["idActuacion"] . "'>";
echo "<input class='frmCaja' type='hidden' name='hdnIdDocumentoImagen' id='hdnIdDocumentoImagen' value='" . $_GET["idDocumentoImagen"] . "'>";
?>
