...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
        ...
        <div class="panel-body">
            ...
            <div id="divFormulario" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-6">
                        <input type="text" class="form-control mayuscula" id="txtCarpetaInvestigacion" placeholder="Carpeta de Investigaci&oacute;n" disabled="disabled">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-xs-3" id="numero-causa">NUC (N&uacute;mero &uacute;nico de causa)</label>
                    <div class="col-xs-6">
                        <input type="text" class="form-control mayuscula " id="txtNumeroUnicoCausa" placeholder="NUC" disabled="disabled">
                    </div>
                </div>
                <div class="form-group">
                            ...
                            try{
                                ...
                                if(result.totalCount > 0){
                                    if ( parseInt(result.data[0].cveEstatusCarpeta) == 1 ) {
                                        ...
                                        $("#causaOrigen").html("Causa encontrada");
                                        cargarPartesAntecedente(result.data[0].idCarpetaJudicial);
                                    } else {
                                        $("#causaOrigen").html("<span class='requerido'>La carpeta de procedencia seleccionada ya esta Terminada, favor de verificar</span>");
                                        $("#divDatosPartesAntecedente").empty();
                                    }
                                } else{
                                    $("#causaOrigen").html("No se encontr&oacute; la causa");
                                    $("#divDatosPartesAntecedente").empty();
                                }
    ...
    //        }
            ...
            if ( $('#cmbTipoCarpeta').val() == "4" ) {
                ...
                if( $("#idJuzgador").val() == "" || $("#idJuzgador").val() == "0" ) {
                    mensaje += "*Debe indicar un juez propietario para la causa a radicar\n";
                    error = true;
                }
            }
                ...
                if ( $("#cveTipoIncompetencia").val() == "" ) {
                    ...
                    if ( $("#cveTipoIncompetencia").val() == "1" ) {
                        if ( $("#idCarpetaPadre").val() == "" || $("#idCarpetaPadre").val() == 0 ) {
                            mensaje += "*La carpeta a radicar no cuenta con Antecedente, favor de verificar\n";
                            error = true;
                        }
                        if ( $("#cveJuzgadoOrigen").val() == "" ) {
                            mensaje += "*Seleccione el juzgado de origen para radicar la carpeta\n";
                            error = true;
                        }
                        if ( $("#cveTipoCarpetaIncompetencia").val() == "" ) {
                            mensaje += "*Seleccione el tipo de carpeta de origen para radicar la carpeta\n";
                            error = true;
                        }
    ...
    //                    }
                        ...
                        if ( $("#txtCveJuzgadoOrigen").val() == "" ) {
                            mensaje += "*Capture el juzgado de origen para radicar la carpeta\n";
                            error = true;
                        }
                        if ( $("#txtCveTipoCarpetaIncompetencia").val() == "" ) {
                            mensaje += "*Capture el tipo de carpeta de origen para radicar la carpeta\n";
                            error = true;
                        }
                        if ( $("#txtNumeroIncompetencia").val() == "" ) {
                            mensaje += "*Capture el n\u00FAmero de la carpeta origen\n";
    ...
    //        }
            if ( $("#cmbTipoCarpeta").val() == 3 || $("#cmbTipoCarpeta").val() == 4 || $("#cmbTipoCarpeta").val() == 5 ) {
                ...
                if ( $("#incompetencia").val() == 'N' ) {
                    if ( $("#idCarpetaPadre").val() == "" || $("#idCarpetaPadre").val() == 0 ) {
                        mensaje += "*Debe seleccionar una carpeta Antecedente para la nueva carpeta a radicar\n";
                        error = true;
                    }
                    if ( $("#idImputado").val() == null || $("#idImputado").val() == "" ) {
                        mensaje += "*Seleccione el/los imputado(s) que se necesitan copiar a la carpeta a radicar \n";
                ...
                $.ajax({
                    ...
                    success: function (datos) {
                        ...
                        if (datos.status == 'Ok') {
                            ...
                            $("#divAlertSuccesSolicitud").html("La carpeta se guardo de forma correcta, verificar si todos los imputados, ofendidos, delitos y relaciones deben corresponder a la causa radicada").fadeIn('slow').delay(6000).fadeOut('slow');
    ...
    //                    }
        ...
        cleanStepOne = function () {
            ...
            $('#txtCarpetaInvestigacion').val("").prop("disabled", false);
            $('#txtNumeroUnicoCausa').val("").prop("disabled", false);
