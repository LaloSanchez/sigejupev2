...
include_once (dirname(__FILE__) . "/SoapClient.php");
include_once (dirname(__FILE__) . "/Entity/Account.php");
...
class Admin
{
    ...
    {
        //$this->zimbraConnect = new \sigejupev2\webservice\cliente\zimbra\ZCS\SoapClient($server);
        $this->zimbraConnect = new \sigejupev2\webservice\cliente\zimbra\ZCS\SoapClient($server, $port);
    ...
    public function getAccounts(array $attributes, $sort = null, $query = null)
    {
        ...
        foreach ($accounts->children()->SearchDirectoryResponse->children() as $account) {
            $results[] = new \sigejupev2\webservice\cliente\zimbra\ZCS\Entity\Account($account);
        }
    ...
    public function getDomains()
    {
        foreach ($this->getAllDomains()->children()->GetAllDomainsResponse->children() as $domain) {
            $results[] = new \sigejupev2\webservice\cliente\zimbra\ZCS\Entity\Domain ($domain);
        }
    ...
    public function getServers()
    {
        foreach ($this->getAllServers()->children()->GetAllServersResponse->children() as $server) {
            $results[] = new \sigejupev2\webservice\cliente\zimbra\ZCS\Entity\Server($server);
        }
    ...
    public function getServer($server, $by = 'name')
    {
        ...
        return new \sigejupev2\webservice\cliente\zimbra\ZCS\Entity\Server($servers[0]);
    }
    ...
    public function createAccount($values)
    {
        ...
        return new \sigejupev2\webservice\cliente\zimbra\ZCS\Entity\Account($accounts[0]);
    }
    ...
    public function getAccount($domain, $by, $account)
    {
        ...
        $account = new \sigejupev2\webservice\cliente\zimbra\ZCS\Entity\Account($accounts[0]);
    ...
    public function createDomain($values)
    {
        ...
        return new \sigejupev2\webservice\cliente\zimbra\ZCS\Entity\Domain($domain[0]);
    }
    ...
    public function getDomain($domain, $by = 'name', $attrs = array())
    {
        ...
        return new \sigejupev2\webservice\cliente\zimbra\ZCS\Entity\Domain($domains[0]);
    }
    ...
    public function getDistributionLists($domain)
    {
        ...
        foreach ($response->children()->SearchDirectoryResponse->children() as $listData) {
            $results[] = new \sigejupev2\webservice\cliente\zimbra\ZCS\Entity\DistributionList($listData);
        }
    ...
    public function getDistributionList($list, $by = 'id')
    {
        ...
        return new \sigejupev2\webservice\cliente\zimbra\ZCS\Entity\DistributionList($lists[0]);
    }
    ...
    public function getCos($cos, $by = 'id')
    {
        ...
        return new \sigejupev2\webservice\cliente\zimbra\ZCS\Entity\Cos($coses[0]);
    }
