...
include_once(dirname(__FILE__) . "/ComprobanteSolicitudescateosController.Class.php");
...
class SolicitudescateosFirmaController {
...
//                echo "<br><br>";
                ...
                if (!$error) {
                    ...
                    $SolicitudescateosDto->setCveEstatusSolicitudCateo("5"); #1 - REGISTRADA POR MP
...
//                        echo "<br><br>";
                ...
                if (!$error) {
                    if ($SolicitudescateosDto->getIdSolicitudCateo() != "" && $SolicitudescateosDto->getIdSolicitudCateo() > 0) {
                        ...
                        $CateosDto->setSolicitud(utf8_decode(preg_replace_callback("/\'/", "\"", $solicitud))); #descripcion de la solicitud
                ...
                if (!$error) {
                    if (count($personasArray) > 0 && $personasArray != "") {
                        ...
                        foreach ($personasArray as $persona) {
                            ...
                            $PersonasDto->setPaterno(utf8_decode(preg_replace_callback("/\'/", "\"", $persona["Paterno"])));
                            $PersonasDto->setMaterno(utf8_decode(preg_replace_callback("/\'/", "\"", $persona["Materno"])));
                            $PersonasDto->setNombre(utf8_decode(preg_replace_callback("/\'/", "\"", $persona["Nombre"])));
                            $PersonasDto->setDomicilio(utf8_decode(preg_replace_callback("/\'/", "\"", $persona["Domicilio"])));
                ...
                if (!$error) {
                    if (count($objetosArray) > 0 && $objetosArray != "") {
                        ...
                        foreach ($objetosArray as $objeto) {
                            ...
                            $ObjetosDto->setDesObjeto(utf8_decode(preg_replace_callback("/\'/", "\"", $objeto["Descripcion"])));
                            $ObjetosDto->setDomicilio(utf8_decode(preg_replace_callback("/\'/", "\"", $objeto["Domicilio"])));
                    ...
                    if (count($imputadosArray) > 0 && $imputadosArray != "") {
                        ...
                        foreach ($imputadosArray as $imputado) {
                            ...
                            if ($imputado["TipoPersona"] == "1") {
                                $ImputadoscateosDto->setNombre(utf8_decode(preg_replace_callback("/\'/", "\"", $imputado["Nombre"])));
                                $ImputadoscateosDto->setPaterno(utf8_decode(preg_replace_callback("/\'/", "\"", $imputado["Paterno"])));
                                $ImputadoscateosDto->setMaterno(utf8_decode(preg_replace_callback("/\'/", "\"", $imputado["Materno"])));
                                $ImputadoscateosDto->setAlias(utf8_decode(preg_replace_callback("/\'/", "\"", $imputado["Alias"])));
                                $ImputadoscateosDto->setCveGenero($imputado["Genero"]);
                                $ImputadoscateosDto->setDomicilio(utf8_decode(preg_replace_callback("/\'/", "\"", $imputado["Domicilio"])));
                                ...
                                $ImputadoscateosDto->setNombreMoral(utf8_decode(preg_replace_callback("/\'/", "\"", $imputado["NombreMoral"])));
                            }
                    ...
                    if (count($victimasArray) > 0 && $victimasArray != "") {
                        ...
                        foreach ($victimasArray as $victima) {
                            ...
                            if ($victima["TipoPersona"] == "1") {
                                $OfendidoscateosDto->setNombre(utf8_decode(preg_replace_callback("/\'/", "\"", $victima["Nombre"])));
                                $OfendidoscateosDto->setPaterno(utf8_decode(preg_replace_callback("/\'/", "\"", $victima["Paterno"])));
                                $OfendidoscateosDto->setMaterno(utf8_decode(preg_replace_callback("/\'/", "\"", $victima["Materno"])));
                                $OfendidoscateosDto->setCveGenero($victima["Genero"]);
                                $OfendidoscateosDto->setDomicilio(utf8_decode(preg_replace_callback("/\'/", "\"", $victima["Domicilio"])));
                                $OfendidoscateosDto->setTelefono($victima["Telefono"]);
                                $OfendidoscateosDto->setEmail($victima["Email"]);
                            } else {
                                $OfendidoscateosDto->setNombreMoral(utf8_decode(preg_replace_callback("/\'/", "\"", $victima["NombreMoral"])));
                            }
                ...
                if (!$error) {
                    if (count($mpsResponsablesArray) > 0 && $mpsResponsablesArray != "") {
                        ...
                        foreach ($mpsResponsablesArray as $mpResponsable) {
                            ...
                            $MinisteriosresponsablesDto->setNombre(utf8_decode(preg_replace_callback("/\'/", "\"", $mpResponsable["Nombre"])));
                            $MinisteriosresponsablesDto->setPaterno(utf8_decode(preg_replace_callback("/\'/", "\"", $mpResponsable["Paterno"])));
                            $MinisteriosresponsablesDto->setMaterno(utf8_decode(preg_replace_callback("/\'/", "\"", $mpResponsable["Materno"])));
...
//                                echo "<br><br>";
                ...
                if (!$error) {
                    ...
                    if (!$error) {
                        ...
                        $comprobanteSolcicitudCateo = $comprobanteSolicitudescateosController->generaComprobante($CateosDto->getIdCateo(), "1");

                        if ($comprobanteSolcicitudCateo != "" && count($comprobanteSolcicitudCateo) > 0) {
                            if ($comprobanteSolcicitudCateo["type"] == "OK") {
                                $bolGeneraPDF = true;
                            } else {
                                $detalleError = "ERROR AL GENERAR EL PDF DE LA SOLICITUD DE CATEO: " . $comprobanteSolcicitudCateo["text"];
                            }
                        }
                    }
                    /* ------------------------------------------------------------------------------------------------------- */
//                    if (($bolStatusMailJuez == true) && ($bolStatusMailAdm == true)) {
                    ...
                    if ($bolGeneraPDF == true) {
                        $tmp = array("type" => "OK",
//                            "text" => "REGISTRO DE SOLICITUD DE FORMA EXITOSA Y A SU VEZ SE REMITE CORREO ELECTRONICO",  -----ANTES DE FIRMA
                            ...
                            "fileName" => $comprobanteSolcicitudCateo["fileName"],
                            "filePath" => $comprobanteSolcicitudCateo["filePath"],
                            "archivoAdjunto" => $tutaArchivo
                        );
                    } else {
                        $tmp = array("type" => "OK",
                            "text" => "REGISTRO DE SOLICITUD DE FORMA EXITOSA, NO SE GENERO EL PDF DE LA SOLICITUD: " . $detalleError,
                            "type" => "OK",
                            "idCateo" => $CateosDto->getIdCateo(),
                            "idSolicitudCateo" => $CateosDto->getIdSolicitudCateo(),
                            "numeroCateo" => $CateosDto->getNumeroCateo() . "/" . $CateosDto->getAnioCateo(),
...
//                    }
    ...
    function notificaSolicitudCateo($idCateo) {
        $emailJuez = "";
        $bolStatusMailJuez = false;
        $bolStatusMailAdm = false;
        $emailAdministrador = "";
        ...
        if ($idCateo != "") {
            ...
            #CONSULTAMOS SOLICITUD DE CATEO
            if (!$error) {
                if ($idCateo != "" && $idCateo > 0) {
                    $CateosDao = new CateosDAO();
                    $CateosDto = new CateosDTO();
                    $CateosDto->setIdCateo($idCateo); #Id del cateo
...
//                        echo "<br><br>";
                        ...
                        $error = true;
                        $tmp = array("type" => "Error", "text" => "ERROR AL CONSULTAR LA INFORMACION DE CATEO");
                    }
                } else {
                    $error = true;
                    $tmp = array("type" => "Error", "text" => "ERROR: EL IDENTIFICADOR DE LA SOLICITUD VACIO O IGUAL A CERO");
...
//                    echo "<br><br>";
                    ...
                    $error = true;
                    $tmp = array("type" => "Error", "text" => "ERROR AL CONSULTAR LA INFORMACION DE LA SOLICITUD DE CATEO");
                }
            }
...
//                    echo "<br><br>";
                    ...
                    $error = true;
                    $tmp = array("type" => "Error", "text" => "ERROR AL CONSULTAR LA RELACION JUZGADOR - SOLICITUD DE CATEO");
                }
            }
            ...
            if (!$error) {
                ...
                $JuzgadoresDao = new JuzgadoresDAO();
                $JuzgadoresDto = new JuzgadoresDTO();
                $JuzgadoresDto->setIdJuzgador($JuzgadorescateosDto->getIdJuzgador()); #Id del juzgador turnado a resolver el cateo                
                $JuzgadoresDto = $JuzgadoresDao->selectJuzgadores($JuzgadoresDto, "", $proveedor);
                if ($JuzgadoresDto != "" && count($JuzgadoresDto) > 0) {
                    $JuzgadoresDto = $JuzgadoresDto[0];
//                    print_r($JuzgadoresDto);
//                    echo "<br><br>";
            ...
            #ACTUALIZAMOS ESTATUS DE CATEO A REGISTRADA POR EL MP
            if (!$error) {
                $SolicitudescateosUpdateDto = new SolicitudescateosDTO();
                $SolicitudescateosUpdateDto->setIdSolicitudCateo($SolicitudescateosDto->getIdSolicitudCateo());
                $SolicitudescateosUpdateDto->setCveEstatusSolicitudCateo("1");
                $SolicitudescateosUpdateDto = $SolicitudescateosDao->updateSolicitudescateos($SolicitudescateosUpdateDto, $proveedor);
                if ($SolicitudescateosUpdateDto != "" && count($SolicitudescateosUpdateDto) > 0) {
                    $SolicitudescateosUpdateDto = $SolicitudescateosUpdateDto[0];
//                    print_r($SolicitudescateosUpdateDto);
//                    echo "<br><br>";
                } else {
                    $error = true;
