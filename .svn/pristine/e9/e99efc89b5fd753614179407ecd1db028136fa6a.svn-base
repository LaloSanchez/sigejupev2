...
if (isset($_SESSION["cveUsuarioSistema"]) && $_SESSION["cveUsuarioSistema"] !== "") {
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h5 class="panel-title">                                                            
                Reporte Disponibilidad de Jueces Consejo de la Judicatura                           
            </h5>
        </div>
    ...
    <script type="text/javascript">
                ...
                $.ajax({
                    ...
                    success: function (datos) {
                        try {
                            ...
                            $("#encabezado").html("Horarios de disponibilidad de Jueces Consejo de la Judicatura, " + texto);
                            ...
                            if (result.totalCount > 0) {
                                ...
                                var c = 0;
                                html += "<table id='tblResultados' align='center' class='table' style='border: solid 1px #000; width: 100%;' cellspacing='0' cellpadding='2'>";
                                html += "<thead>";
                                html += "<tr>";
                                html += "<th style='border: solid 1px #000; width: 5%'><span style='color: #000;'>No.</span></th>";
                                html += "<th style='border: solid 1px #000; width: 30%'><span style='color: #000;'>Rol</span></th>";
                    ...
                    error: function (objeto, quepaso, otroobj) {
                        ...
                        $("#error").append('<span>Ocurri&oacute; un error al consultar los datos, intentalo de nuevo m&aacute;s tarde</span>').fadeIn('slow').delay(4000).fadeOut('slow');
        ...
        exportarReporte = function (accion, div) {
            ...
            var columnas = [];
            $.each($("#tblResultados tr"), function () {
                $.each($(this).find('th'), function () {
                    columnas.push("1");
                });
            });
            $.each($("#tblResultados td"), function () {

                $(this).attr("id", "lng");
            });
            $.each($("#tblResultados th"), function () {
                $(this).attr("id", "lng");
            });
            var numPixeles = 0;
            ...
            var nombreArchivo = "REPORTE_DISPONIBILIDAD_JUECES_CJ";
            ...
            contenido = contenido.replace(/id="del"/g, 'style="width:190px; text-align:center;"');
            contenido = contenido.replace(/id="os"/g, 'style="width:190px;text-align:center;"');
        ...
        $(function () {
            ...
            var permisos = obtenerPermisosFormulario("REPORTES", "DISPOINIBILIDAD DE JUECES CONSEJO DE LA JUDICATURA");
