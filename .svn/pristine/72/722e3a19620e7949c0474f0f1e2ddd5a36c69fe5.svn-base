                        ...
                        <div class="col-xs-12 col-md-12">
                            ...
                            <div class="widget">
                                ...
                                <div class="widget-header bordered-bottom bordered-yellow">
                                    <span class="widget-caption">Catálogo de Juzgadores</span>
    ...
    <script type="text/javascript">
        ...
        var carga_tabla             = peticion_ajax + "procesar_tabla_generica&tabla=" + id_tabla + "&f=s&columnas=sNombre,sTitulo,sNombreJuzgador,sPaterno,sMaterno,iSorteo,iProgramable,iId";
