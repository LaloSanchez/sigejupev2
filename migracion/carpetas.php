...
<html lang="en">
    <head>
        ...
        <title>Carpetas Judiciales</title>
        ...
        <!--         Timeline CSS 
                <link href="components/datatables/media/js/jquery.dataTables.min.js" rel="stylesheet">-->
...
//            object.className = "active";
    ...
    <body>
        <div class="col-lg-12">
            <h1 class="page-header">Carpetas Judiciales</h1>
        </div>
