...
//        public function selectActuaciones($actuacionesDto, $proveedor = null, $orden = "", $param = null, $fields = null) {
        ...
        if ($SolicitudesperitosDto != "") {
            ...
            //echo $cveTipo."--".$SolicitudesperitosDto[0]->getIdActuacion()."--".$cveTipoDocumento;
            $Arrayruta = $imagenesCtrl->insertaImagenGlogal($cveTipo, $SolicitudesperitosDto[0]->getIdActuacion(), $cveTipoDocumento, null); // tipo se refiere a cualquier tipo de actuacion = 2 o carpeta = 1
...
//                $SolicitudesperitosDto[0]->setCveJuzgado($juzgado[0]->getDesJuzgado());
                ...
                $json .= '"texto":' . json_encode(html_entity_decode($solicitudesDto->getObservaciones())) . ",";
