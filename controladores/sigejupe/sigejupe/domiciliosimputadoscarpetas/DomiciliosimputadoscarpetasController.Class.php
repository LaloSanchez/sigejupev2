...
//        }
    ...
    public function getPaginasDomicilios($DomiciliosimputadoscarpetasDto="",$param=null){
        ...
        if($DomiciliosimputadoscarpetasDto->getDireccion()!=''){
            $orden.=" AND (dic.direccion like '%".$DomiciliosimputadoscarpetasDto->getDireccion()."%' OR dic.colonia like '%".$DomiciliosimputadoscarpetasDto->getDireccion()."%') ";
        }               
        $orden.=" UNION all ";
        $orden.=" (";
        ...
        if($DomiciliosimputadoscarpetasDto->getDireccion()!=''){
            $orden.=" AND iex.domicilio like '%".$DomiciliosimputadoscarpetasDto->getDireccion()."%'";
        } 
        $orden.=" )";
        $DomiciliosimputadoscarpetasDto=new DomiciliosimputadoscarpetasDTO();//Se mada vacíos
