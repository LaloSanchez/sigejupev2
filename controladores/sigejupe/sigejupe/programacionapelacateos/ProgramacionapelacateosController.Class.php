        ...
        if(!$error) {
            ...
            //if($programacionApelaCateosTmp == "") {
                ...
                if($programacionApelaCateosDto != "") {
                    ...
                    $bitacoramovimientosDto = new BitacoramovimientosDTO();
                    $cveAccion = 370;
                    $descripcion = "UPDATE tabla tblprogramacionapelacioncateoscateos idProgramacionCateo: " . $programacionApelaCateosDto[0]->getIdProgramacionApelaCateo();
                    $bitacoramovimientosDto->setCveAccion($cveAccion);
    ...
    public function juezApelaCateo($programacionApelaCateosDto, $proveedor = null){
        ...
        if ( $juzgadoTmp != "" ) {
            foreach ( $juzgadoTmp as $juzgado ) {
                 ...
                 * juez está disponible para realizar la apelacion de cateo
                 */
                ...
                if($programacionApelaCateosDto!= "") {
                     ...
                     * revisar cuántas apelaciones de cateos tiene asignados, retornar el id del juzgador que tenga
...
//                        echo "</pre>";
                    ...
                    $error = true;
                    $msg = " No se encontraron jueces programados para atender apelaciones de cateos para el juzgado " . utf8_encode($juzgadoTmp[0]->getDesJuzgado()) . " en el día " . $fechaInicio[0] . " a las " . $fechaInicio[1];
                }
            }
        } else {
            $error = true;
    ...
    public function simuladorApelaCateos($programacionApelaCateosDto, $proveedor = null){
        ...
        for( $n = 0; $n < count($dias); $n++ ) {
            /*
             * Para cada uno de los días verificar que juez puede atender alguna apelacion de cateo
             */
