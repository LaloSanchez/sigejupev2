...
class BitacoraasignacionesaudienciasDAO {
    ...
    public function selectBitacoraasignacionesaudiencias($bitacorasignacionesDto, $orden = "", $proveedor = null)
    {
        ...
        $sql = "SELECT ba.idBitacoraAsignacion, sa.cveJuzgado,tc.desTipoCarpeta, sa.carpetaInv, CONCAT_WS('/',sa.numero,sa.anio) as causa, sa.nuc,
                ...
                JOIN tbltiposcarpetas tc ON sa.cveTipoCarpeta = tc.cveTipoCarpeta
        ...
        if ($bitacorasignacionesDto->cveJuzgado != '') {
            $sql .= " AND ba.cveJuzgado = " . $bitacorasignacionesDto->cveJuzgado;
        }
