        ...
        if (!$error) {
            ...
            if (!$error) {
                ...
                if ($params["texto"] != "") {
                    ...
                    $html.="</td>";
                    $html.="</tr></table>";
                    $auxString = $params["texto"];
//                    $auxString = preg_replace("/\n/", "<br>", $params["texto"]);
                    $auxString = preg_replace('/mso-bidi-font-family\:.*?(|;)/i', "", $auxString);
                    $auxString = preg_replace('/font-family\:.*?(|;)/i', "", $auxString);
                    $auxString = strip_tags($auxString, "<table><p><td><tr><strong><span><tbody><a><style><b>");
...
//                    $imagenesDto->setBase64(base64_encode($imagedata)); //SE COMENTA PARA QUE NO OCUPE TANTO ESPACIO EN LA BASE DE DATOS
                    $imagenesDto->setBase64("");
