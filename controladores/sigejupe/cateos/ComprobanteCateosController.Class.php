                    ...
                    if (file_exists("./../../../solicitudespdf/Respuesta_" . $CateosDto->getQr() . ".pdf")) {
                        ...
                        if (!$error) {
                            ...
                            if ($CateosDto->getNumeroEspecializadoCateo() != 0) {
                                ...
                                $html.="<td style='width:60%; text-align: right; font-size: 9pt' colspan='1'><strong>N&uacute;mero Cateo Especializado: </strong> " . str_pad($CateosDto->getNumeroEspecializadoCateo(), 6, '0', STR_PAD_LEFT) . "/" . $CateosDto->getAnioCateo() . "</td>";
                                $html.="</tr>";
                            }
                            $html.="<tr>";
                            $html.="<td style='width:40%; text-align: center' rowspan='1'>&nbsp;</td>";
...
//                        echo "<br><br>";
                        ...
                        if (!$error) {
                            ...
                            $html.="</tr>";
                            $html.="<tr>";
                            $html.="<td text-align: left;font-size: 10pt' colspan='4'>" . $JuzgadoresDto->getTitulo() . " " . $JuzgadoresDto->getNombre() . " " . $JuzgadoresDto->getPaterno() . " " . $JuzgadoresDto->getMaterno() . ", JUEZ DE " . $TiposjuzgadoresDto->getDesTipoJuzgador() . " del " . $JuzgadosDto->getDesJuzgado() . "</td>";
                            $html.="</tr>";
