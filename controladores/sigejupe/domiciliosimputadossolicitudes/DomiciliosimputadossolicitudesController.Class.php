    ...
    public function insertDomiciliosimputadossolicitudes($domiciliosimputadossolicitudesDto, $proveedor = null, $botacora = true) {
        ...
        if ($rsImputados != "") {
            ...
            if ($rsSolicitudAudiencia[0]->getCveEstatusSolicitud() == '1') {
                ...
                $paisesDto->setCvePais($domiciliosimputadossolicitudesDto->getCvePais());
                $paisesAudDto = $paisesDao->selectPaises($paisesDto);
                if ($paisesAudDto == "") {
                    $msg[] = array("El pais no existe en el catalogo");
                    $error = true;
                }
            ...
            $msg[] = array("No se encontro al imputado - domicilios.");
            $error = true;
        }
