...
//        valida si puede agregar domicilio
        ...
        $validaSolicitudAudiencia = $this->validarEstatusSolicitudByIdOfendido($DomiciliosofendidossolicitudesDto->getIdOfendidoSolicitud(), 'agregar', 'domicilio', $this->proveedor);
        ...
        try {
            ...
            if (!count($domicilioOfendidoResponse))
                throw new Exception('no se pudo guardar el domicilio del ofendido.');
            ...
            if (!count($bitacoraDomicilio))
                throw new Exception('no se pudo guardar la accion agregar domicilio en bitacora');
    ...
    public function modificarDomicilioOfendido($DomiciliosofendidossolicitudesDto, $proveedor = '') {
        ...
        try {
            ...
            if (!count($domicilioOfendidoResponse))
                throw new Exception('no se pudo actualizar el domicilio del ofendido.');
            ...
            if (!count($bitacoraDomicilio))
                throw new Exception('no se pudo guardar la accion actualizar domicilio en bitacora');
    ...
    public function eliminarDomicilioOfendido($DomiciliosofendidossolicitudesDto, $proveedor = '') {
        ...
        try {
            ...
            if (!$domicilioOfendidoResponse)
                throw new Exception('no se pudo eliminar el domicilio en bitacora.');
            ...
            if (!count($bitacoraDomicilio))
                throw new Exception('no se pudo guardar la accion eliminar domicilio en bitacora');
